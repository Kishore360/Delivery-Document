...
CASE WHEN a.u_cah_business_criticality IS NULL THEN 'UNSPECIFIED' ELSE UPPER(CONCAT('U_CAH_BUSINESS_CRITICALITY~CMDB_CI_APPLICATION','~','','~','','~',COALESCE(a.u_cah_business_criticality,''))) END;
