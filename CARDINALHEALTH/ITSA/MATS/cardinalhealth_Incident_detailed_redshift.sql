...
union
select 'ldb.d_internal_contact a144 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_configuration_item a18 
on (a11.configuration_item_key = a18.row_key) 
join ldb.d_internal_contact a144 
on (a18.eit_sup_leader_c_key = a144.row_key) 
union
...
on (a14.category_src_key = a145.row_key) 
union
...
on (a14.close_code_src_key = a146.row_key) 
union
...
on (a14.severity_src_key = a147.row_key) 
union
...
on (a14.state_src_key = a148.row_key) 
union
...
union
select 'ldb.d_lov_incident_opened_by_language_c a150 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_contact_mdm a114 
on (a11.opened_by_c_key = a114.row_current_key) 
join ldb.d_lov_incident_opened_by_language_c a150 
on (a114.language_c_key = a150.row_key) 
union
select 'ldb.d_lov_incident_opened_on_behalf_of_language_c a151 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_contact a115 
on (a11.opened_on_behalf_of_c_key = a115.row_key) 
join ldb.d_lov_incident_opened_on_behalf_of_language_c a151 
on (a115.language_c_key = a151.row_key) 
union
select 'ldb.d_config_item_cah_support_grp_c a152 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_configuration_item a18 
on (a11.configuration_item_key = a18.row_key) 
join ldb.d_config_item_cah_support_grp_c a152 
on (a18.cah_support_grp_src_code_c_key = a152.row_key) 
union
select 'ldb.d_internal_contact_director a153 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_contact a12 
on (a11.opened_by_key = a12.row_key) join ldb.d_internal_contact_mdm a117 
on (a12.row_current_key = a117.row_current_key) 
join ldb.d_internal_contact_director a153 
on (a117.director_c_key = a153.row_key) 
union
select 'ldb.d_internal_contact_manager a154 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_contact a12 
on (a11.opened_by_key = a12.row_key) join ldb.d_internal_contact_mdm a117 
on (a12.row_current_key = a117.row_current_key) 
join ldb.d_internal_contact_manager a154 
on (a117.manager_c_key = a154.row_key) 
union
select 'ldb.d_internal_contact_vp a155 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_contact a12 
on (a11.opened_by_key = a12.row_key) join ldb.d_internal_contact_mdm a117 
on (a12.row_current_key = a117.row_current_key) 
join ldb.d_internal_contact_vp a155 
on (a117.vp_c_key = a155.row_key) 
union
select 'ldb.d_calendar_fiscal_period a156 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_calendar_greg_fiscal_c a111 
on (a11.opened_on_key = a111.greogrian_calendar_key) join ldb.d_calendar_date_fiscal a112 
on (a111.fiscal_key = a112.row_key) 
join ldb.d_calendar_fiscal_period a156 
on (a112.period_start_date_key = a156.row_key) 
union
select 'ldb.d_calendar_fiscal_quarter a157 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_calendar_greg_fiscal_c a111 
on (a11.opened_on_key = a111.greogrian_calendar_key) join ldb.d_calendar_date_fiscal a112 
on (a111.fiscal_key = a112.row_key) 
join ldb.d_calendar_fiscal_quarter a157 
on (a112.quarter_start_date_key = a157.row_key) 
union
select 'ldb.d_calendar_fiscal_year a158 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_calendar_greg_fiscal_c a111 
on (a11.opened_on_key = a111.greogrian_calendar_key) join ldb.d_calendar_date_fiscal a112 
on (a111.fiscal_key = a112.row_key) 
join ldb.d_calendar_fiscal_year a158 
on (a112.year_start_date_key = a158.row_key) 