...
select'ldb.d_master_item' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_request_item             a11 
left outer join ldb.d_master_item         a12
...
select'ldb.d_request' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_request_item             a11 
left outer join ldb.d_request        a111
...
select'ldb.d_request_item_lov_catalog_item_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_request_item             a11 
left outer join ldb.d_request_item_lov_catalog_item_c        a113
...
select'ldb.d_internal_contact_requested_for_ri_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_request_item             a11 
left outer join ldb.d_internal_contact_requested_for_ri_c        a119
...
select'ldb.d_internal_contact_task_closed_by' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_request_item             a11 
left outer join ldb.d_internal_contact_task_closed_by        a120
...
left outer join ldb.d_master_item         a12
on (a11.catalog_item_key=a12.row_key) 
left outer join ldb.d_internal_contact_application_owner_ri_c        a122
...
left outer join ldb.d_assignment_group_level0_manager_c_relation         a16
on (a11.assignment_group_key=a16.level0_assigment_group_key) 
left outer join ldb.d_assignment_group_level0_manager_c        a123
...
left outer join ldb.d_calendar_date         a18
on (a11.opened_on_key=a18.row_key) 
left outer join ldb.d_calendar_week        a125
...
left outer join ldb.d_calendar_date_fiscal        a110
on (a19.fiscal_key=a110.row_key) 
left outer join ldb.d_calendar_fiscal_period        a126
...
left outer join ldb.d_calendar_date         a18
on (a11.opened_on_key=a18.row_key) 
left outer join ldb.d_calendar_quarter        a127
...
left outer join ldb.d_calendar_date_fiscal        a110
on (a19.fiscal_key=a110.row_key) 
left outer join ldb.d_calendar_fiscal_quarter        a128
...
left outer join ldb.d_calendar_date         a18
on (a11.opened_on_key=a18.row_key) 
left outer join ldb.d_calendar_year        a129
