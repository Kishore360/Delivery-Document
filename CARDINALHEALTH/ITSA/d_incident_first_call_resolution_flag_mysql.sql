...
SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 ...
 FROM  cardinalhealth_mdwdb.d_incident TRGT
   JOIN  cardinalhealth_mdwdb.f_incident TRGTF 
 ...
 JOIN cardinalhealth_mdwdb.d_lov_map LM ON TRGTF.state_src_key=LM.src_key AND LM.dimension_class = 'STATE~INCIDENT'
AND  LM.dimension_wh_code IN('RESOLVED','CLOSED')
 JOIN cardinalhealth_mdwdb.d_o_data_freshness FRESH  ON(FRESH.source_id=TRGTF.source_id
