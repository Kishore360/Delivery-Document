...
SELECT "d_ap_credit_memo_summary" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_ap_credit_memo_summary` UNION 
SELECT "d_ap_debit_memo_summary" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_ap_debit_memo_summary` UNION 
SELECT "d_ap_expense_category" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_ap_expense_category` UNION 
SELECT "d_ap_invoice" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_ap_invoice` UNION 
SELECT "d_ap_payment" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_ap_payment` UNION 
SELECT "d_ar_cash_sale" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_ar_cash_sale` UNION 
SELECT "d_ar_credit_memo_summary" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_ar_credit_memo_summary` UNION 
SELECT "d_ar_ct_deposit" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_ar_ct_deposit` UNION 
SELECT "d_ar_debit_memo_summary" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_ar_debit_memo_summary` UNION 
...
SELECT "d_configuration_item" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_configuration_item` UNION 
SELECT "d_contact" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_contact` UNION 
SELECT "d_cost_center" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_cost_center` UNION 
SELECT "d_currency_conversion" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_currency_conversion` UNION 
SELECT "d_customer_address" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_customer_address` UNION 
...
SELECT "d_fiscal_year" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_fiscal_year` UNION 
SELECT "d_geography" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_geography` UNION 
...
SELECT "d_internal_organization" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_internal_organization` UNION 
SELECT "d_keyword_filter" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_keyword_filter` UNION 
...
SELECT "d_organization_customer" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_organization_customer` UNION 
SELECT "d_outage_c" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_outage_c` UNION 
SELECT "d_partner" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_partner` UNION 
SELECT "d_party" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_party` UNION 
...
SELECT "d_quarter" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_quarter` UNION 
SELECT "d_request" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_request` UNION 
SELECT "d_request_item" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_request_item` UNION 
SELECT "d_request_task" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_request_task` UNION 
SELECT "d_roles" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_roles` UNION 
SELECT "d_s_data_security_group" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_s_data_security_group` UNION 
SELECT "d_s_data_security_group_attribute_elements" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_s_data_security_group_attribute_elements` UNION 
SELECT "d_s_data_security_group_users" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_s_data_security_group_users` UNION 
SELECT "d_sales_contract" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_sales_contract` UNION 
SELECT "d_sales_contract_item" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_sales_contract_item` UNION 
...
SELECT "d_supplier_item" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`d_supplier_item` UNION 
...
SELECT "f_a_sales_order_item_monthly" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_a_sales_order_item_monthly` UNION 
SELECT "f_ap_credit_memo_application" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_ap_credit_memo_application` UNION 
SELECT "f_ap_credit_memo_detail" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_ap_credit_memo_detail` UNION 
SELECT "f_ap_credit_memo_summary" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_ap_credit_memo_summary` UNION 
SELECT "f_ap_debit_memo_detail" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_ap_debit_memo_detail` UNION 
SELECT "f_ap_debit_memo_summary" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_ap_debit_memo_summary` UNION 
SELECT "f_ap_invoice" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_ap_invoice` UNION 
SELECT "f_ap_invoice_detail" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_ap_invoice_detail` UNION 
SELECT "f_ap_payment" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_ap_payment` UNION 
SELECT "f_ap_payment_application" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_ap_payment_application` UNION 
SELECT "f_ar_cash_sale" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_ar_cash_sale` UNION 
SELECT "f_ar_cash_sale_detail" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_ar_cash_sale_detail` UNION 
SELECT "f_ar_credit_memo_application" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_ar_credit_memo_application` UNION 
SELECT "f_ar_credit_memo_detail" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_ar_credit_memo_detail` UNION 
SELECT "f_ar_credit_memo_summary" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_ar_credit_memo_summary` UNION 
SELECT "f_ar_ct_deposit" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_ar_ct_deposit` UNION 
SELECT "f_ar_ct_deposit_application" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_ar_ct_deposit_application` UNION 
SELECT "f_ar_ct_refund" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_ar_ct_refund` UNION 
SELECT "f_ar_debit_memo_detail" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_ar_debit_memo_detail` UNION 
SELECT "f_ar_debit_memo_summary" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_ar_debit_memo_summary` UNION 
SELECT "f_ar_invoice" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_ar_invoice` UNION 
...
SELECT "f_keyword" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_keyword` UNION 
SELECT "f_n_ap_credit_memo_summary_monthly" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_n_ap_credit_memo_summary_monthly` UNION 
SELECT "f_n_ap_invoice_monthly" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_n_ap_invoice_monthly` UNION 
SELECT "f_n_ap_payment_monthly" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_n_ap_payment_monthly` UNION 
SELECT "f_n_ar_credit_memo_summary_monthly" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_n_ar_credit_memo_summary_monthly` UNION 
SELECT "f_n_ar_ct_deposit_monthly" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_n_ar_ct_deposit_monthly` UNION 
...
SELECT "f_problem_task" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_problem_task` UNION 
SELECT "f_purchase_order" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_purchase_order` UNION 
SELECT "f_purchase_order_detail" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_purchase_order_detail` UNION 
SELECT "f_request" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_request` UNION 
SELECT "f_request_item" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_request_item` UNION 
SELECT "f_request_task" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_request_task` UNION 
SELECT "f_response" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_response` UNION 
SELECT "f_sales_contract_item" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_sales_contract_item` UNION 
SELECT "f_sales_order" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`f_sales_order` UNION 
...
SELECT "lsm_ls_etl_latest_task_run" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`lsm_ls_etl_latest_task_run` UNION 
SELECT "lsm_ls_etl_log" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`lsm_ls_etl_log` UNION 
SELECT "lsm_ls_hierarchies" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`lsm_ls_hierarchies` UNION 
SELECT "lsm_ls_keyword_metadata" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`lsm_ls_keyword_metadata` UNION 
SELECT "lsm_ls_lov_metadata" AS table_name, COUNT(*) AS exact_row_count FROM `cardinalhealth_mdwdb`.`lsm_ls_lov_metadata` UNION 
