...
left join <<tenant>>_mdwdb.dwh_d_internal_organization IO1
on Level1=IO1.row_id 
left join <<tenant>>_mdwdb.dwh_d_internal_organization IO2
on Level2=IO2.row_id
left join <<tenant>>_mdwdb.dwh_d_internal_organization IO3
on Level3=IO3.row_id
left join <<tenant>>_mdwdb.dwh_d_internal_organization IO4
...
from <<tenant>>_mdwdb.dwh_dh_all_hierarchies  DH
