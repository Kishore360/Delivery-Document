...
FROM (SELECT COUNT(1) Count_STG, '#STG_TABLE_NAME' Table_STG FROM #STG_TABLE_NAME) STG,
(SELECT COUNT(1) Count_DWH, '#DWH_TABLE_NAME'  Table_DWH FROM #DWH_TABLE_NAME ) DWH
