...
FROM (SELECT 1 FROM #CHILD_TABLE WHERE #CHILD_DEPENDENCY_KEY NOT IN (SELECT DISTINCT #PARENT_DEPENDENCY_KEY FROM #PARENT_TABLE )AND #CHILD_DEPENDENCY_KEY NOT IN (0) LIMIT 1) A
