...
UPPER(b.requested_for)),'UNSPECIFIED')  AND c.source_id =  b.sourceinstance AND DATE_FORMAT(a.pivot_date, '%Y-%m-%d %H:%i:%s')
where a.service_request_c_key<> c.row_key and a.incident_class_c = 'ADHOC_REQ') a;