...
from (select  number,opened_at,cmdb_ci,sourceinstance,sys_id from nypres_mdsdb.incident_final 
...
join 
(select row_id,incidents_in_last_30_days_c  from nypres_mdwdb.f_configuration_item_c) trgt
on src.cmdb_ci=trgt.row_id 
where src.cnt <>trgt.incidents_in_last_30_days_c
