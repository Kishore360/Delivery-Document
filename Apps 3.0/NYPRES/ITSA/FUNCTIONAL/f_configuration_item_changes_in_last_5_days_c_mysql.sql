...
where  d.lagging_count_of_days between 0 and 4  ) t  
...
join 
(select row_id,changes_in_last_5_days_c  from nypres_mdwdb.f_configuration_item_c) trgt
on src.cmdb_ci=trgt.row_id 
where src.cnt <>trgt.changes_in_last_5_days_c
