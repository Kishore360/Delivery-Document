...
LEFT JOIN nypres_mdsdb.cmn_department_final LKP 
 ON u_used_by_department= LKP.sys_id
 WHERE COALESCE(LKP.row_key,CASE WHEN SRC.u_used_by_department IS NULL THEN 0 else -1 end)<> (TRGT.used_by_department_c_key) 
