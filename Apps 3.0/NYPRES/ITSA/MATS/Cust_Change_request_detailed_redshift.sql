...
union
select 'ldb.d_change_request_coord_manager_c a111 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request_coord_manager_c a111 
on (a11.change_coord_manager_c_key = a111.row_key) 
union
...
from ldb.f_change_request a11 
join ldb.d_incident a125 
on (a11.related_to_incident_c_key = a125.row_key) 
union
select 'ldb.d_change_request_requested_by_manager_c a126 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request_requested_by_manager_c a126 
on (a11.requested_by_manager_c_key = a126.row_key) 
union
...
on (a13.criticality_key = a128.row_key) 
union
...
on (a13.used_for_src_key = a129.row_key) 
union
