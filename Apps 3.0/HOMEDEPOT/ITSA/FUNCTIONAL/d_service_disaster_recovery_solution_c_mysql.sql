...
LEFT JOIN homedepot_mdsdb.u_disaster_recovery_solution_final LKP 
 ON ( a.u_disaster_recovery_solution= LKP.sys_id 
...
WHERE LKP.u_name<>b.disaster_recovery_solution_c)temp;