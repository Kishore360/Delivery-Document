...
LEFT JOIN homedepot_mdsdb.u_information_classification_final LKP 
 ON ( a.u_information_classification= LKP.sys_id 
...
WHERE LKP.u_name<>b.information_classification_c)temp; 