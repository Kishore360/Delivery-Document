...
where 
AA.closed_on <> CONVERT_TZ(CASE WHEN c.dimension_wh_code IN('RESOLVED','CLOSED')
AND BB.closed_at IS NULL THEN sys_updated_on ELSE BB.closed_at END, 'GMT','America/Los_Angeles'))A
