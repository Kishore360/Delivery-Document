...
from         ldb.f_change_request_closed                a11			
                join          ldb.d_calendar_date               a16
                  on          (a11.closed_on_key = a16.row_key)
                join          ldb.d_change_request_approval_c       a17
...
from         ldb.f_change_request_closed a11
                join          ldb.d_change_request_closed_status_c               a115
                  on          (a11.closed_status_src_c_key = a115.row_key)
union
...
from         ldb.f_change_request_closed	 a11			  
                join          ldb.d_request_item a118
                  on          (a11.change_document_c_key = a118.row_key)
union
...
from         ldb.f_change_request_closed	 a11			  
                join          ldb.d_internal_contact_requester_c      a121
                  on          (a11.change_requester_c_key = a121.row_key)
union
