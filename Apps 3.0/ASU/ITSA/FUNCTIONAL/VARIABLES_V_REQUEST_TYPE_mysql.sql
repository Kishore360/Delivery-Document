SELECT CASE WHEN cnt > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN cnt >0 THEN 'MDS to DWH data validation failed for VARIABLES_V_REQUEST_TYPE' ELSE 'SUCCESS' END as Message from (
...
on  a.r1= b.sys_id and a.r2=d.request_item
 where f.row_key <>a.reference_c_key)A)b ; 
