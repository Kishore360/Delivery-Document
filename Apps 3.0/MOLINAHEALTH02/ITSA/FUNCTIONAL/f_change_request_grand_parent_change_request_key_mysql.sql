SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 ...
 LEFT JOIN molinahealth_mdsdb.change_request_final PARENT 
 ON ( SRC.parent=PARENT.sys_id  
 AND SRC.sourceinstance= PARENT.sourceinstance  )
 left join molinahealth02_mdwdb.d_change_request D1
 on D1.row_id =  PARENT.parent  AND D1.source_id = PARENT.sourceinstance
 LEFT JOIN molinahealth02_mdwdb.f_change_request
TRGT 
