...
AND fieldname =  'priority' and oldvalue is not null and newvalue is not null
 ...
 join molinahealth_mdsdb.problem_final c on b.documentkey=c.sys_id
join molinahealth02_mdwdb.d_problem d on c.sys_id = d.row_id and c.sourceinstance = d. source_id
