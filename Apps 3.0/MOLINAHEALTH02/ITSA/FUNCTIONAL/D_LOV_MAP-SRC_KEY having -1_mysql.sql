...
from  molinahealth02_mdwdb.d_lov_map map
 join molinahealth02_mdwdb.d_lov lov on lov.src_rowid=map.src_rowid 
left join
...
left join molinahealth_mdsdb.sys_choice_final scf on conf.table_value= scf.name and conf.column_value = scf.element
