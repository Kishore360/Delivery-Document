...
FROM
tivo_mdsdb.core_company_final src 
LEFT JOIN tivo_mdwdb.d_internal_organization stg ON stg.row_id = CONCAT('SUBSIDIARY~',src.sys_id) AND stg.source_id = src.sourceinstance
