...
on COALESCE(DATE_FORMAT(CONVERT_TZ(a11.u_outage_start,'GMT','America/Los_Angeles'),'%Y%m%d'),'UNSPECIFIED') 
= a13.row_id
where coalesce(a13.row_key,-99)<>coalesce(a12.outage_start_c_key,-99) )a
