...
AND CASE WHEN TIMESTAMPDIFF(DAY,SRC.`DATE`,converttz_sys_val) > 0 
THEN TIMESTAMPDIFF(DAY,SRC.`DATE`,converttz_sys_val) WHEN SRC.`DATE` = convertz_dat_val THEN 0 ELSE NULL END
