...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_calendar_date.day_of_year' ELSE 'SUCCESS' END as Message
...
AND TRIM(LEADING '0' FROM(DATE_FORMAT(SRC.`DATE`,'%j'))) <>TRGT.day_of_year
