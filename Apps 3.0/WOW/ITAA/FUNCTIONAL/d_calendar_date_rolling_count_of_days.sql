...
AND TIMESTAMPDIFF(DAY,(SELECT MIN(DATE) FROM wow_workdb.DS_DATE_SEED WHERE DATE BETWEEN '1970-01-01 00:00:00' AND '2030-12-31 00:00:00'),SRC.`DATE`) +1 <>TRGT.rolling_count_of_days
