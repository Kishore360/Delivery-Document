...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_calendar_date.day_of_month' ELSE 'SUCCESS' END as Message
...
AND DATE_FORMAT(SRC.`DATE`,'%d') <>TRGT.day_of_month
