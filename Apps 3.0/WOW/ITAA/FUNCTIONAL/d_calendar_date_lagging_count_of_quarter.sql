...
AND CASE WHEN YEAR(SRC4.QUARTER_START_DATE)=YEAR(tz_sys_val) THEN IF(QUARTER(tz_sys_val)-QUARTER(SRC4.QUARTER_START_DATE)<0,NULL,QUARTER(tz_sys_val)-QUARTER(SRC4.QUARTER_START_DATE)) ELSE IF(TIMESTAMPDIFF(QUARTER,SRC4.QUARTER_START_DATE,tz_sys_val)<=0,NULL,TIMESTAMPDIFF(QUARTER,SRC4.QUARTER_START_DATE,tz_sys_val)) END <>TRGT.lagging_count_of_quarter
