...
AND CASE WHEN YEAR(SRC4.QUARTER_START_DATE)=YEAR(converttz_sys_val) THEN IF(QUARTER(converttz_sys_val)-QUARTER(SRC4.QUARTER_START_DATE)<0,NULL,QUARTER(converttz_sys_val)-QUARTER(SRC4.QUARTER_START_DATE)) ELSE IF(TIMESTAMPDIFF(QUARTER,SRC4.QUARTER_START_DATE,converttz_sys_val)<=0,NULL,TIMESTAMPDIFF(QUARTER,SRC4.QUARTER_START_DATE,converttz_sys_val)) END <>TRGT.lagging_count_of_quarter
