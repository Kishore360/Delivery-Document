...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_calendar_date.calendar_name' ELSE 'SUCCESS' END as Message
...
AND 'Greogrian Calendar' <>TRGT.calendar_name;