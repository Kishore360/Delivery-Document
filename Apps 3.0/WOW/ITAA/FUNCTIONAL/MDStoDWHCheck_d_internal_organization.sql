...
,coalesce(SRC.changed_by,''),coalesce(_tz(SRC.created_on,L.source_time_zone,L.target_time_zone,''),coalesce(_tz(SRC.changed_on,L.source_time_zone,L.target_time_zone,'') ) )
