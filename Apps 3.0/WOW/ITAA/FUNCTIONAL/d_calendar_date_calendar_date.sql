...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_calendar_date.calendar_date' ELSE 'SUCCESS' END as Message
...
AND DATE(SRC.`DATE`) <>TRGT.calendar_date;