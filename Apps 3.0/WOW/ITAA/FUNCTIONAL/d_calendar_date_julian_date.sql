...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_calendar_date.julian_date' ELSE 'SUCCESS' END as Message
...
AND ROUND((UNIX_TIMESTAMP(SRC.`DATE`) /(60*60*24)) + 2440587.5) <>TRGT.julian_date
