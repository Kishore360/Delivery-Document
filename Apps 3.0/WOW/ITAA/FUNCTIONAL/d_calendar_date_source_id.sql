...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_calendar_date.source_id' ELSE 'SUCCESS' END as Message
...
AND CAST(0 AS SIGNED) <>TRGT.source_id
