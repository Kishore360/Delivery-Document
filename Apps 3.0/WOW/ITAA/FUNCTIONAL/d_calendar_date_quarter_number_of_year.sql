...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_calendar_date.quarter_number_of_year' ELSE 'SUCCESS' END as Message
...
AND QUARTER(SRC.`DATE`) <>TRGT.quarter_number_of_year
