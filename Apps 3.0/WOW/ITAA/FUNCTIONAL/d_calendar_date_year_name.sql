...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_calendar_date.year_name' ELSE 'SUCCESS' END as Message
...
AND CAST(DATE_FORMAT(SRC.`DATE`,'%Y') AS SIGNED) <>TRGT.year_name
