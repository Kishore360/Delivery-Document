...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_calendar_date.adjustment_period_flag' ELSE 'SUCCESS' END as Message
...
AND 'N' <>TRGT.adjustment_period_flag
