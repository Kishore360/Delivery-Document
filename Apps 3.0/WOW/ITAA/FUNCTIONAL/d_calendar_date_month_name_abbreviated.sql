...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_calendar_date.month_name_abbreviated' ELSE 'SUCCESS' END as Message
...
AND DATE_FORMAT(SRC.`DATE`,'%b') <>TRGT.month_name_abbreviated
