...
from wow_mdwdb.d_lov lov where  source_id=2 and dimension_class 
not in (select class_value from wow_workdb.lsm_ls_system_variables where enable_flag='Y'  )  and dimension_class 
...
'CATEGORY~INCIDENT',
'RESOLUTION_CODE~INCIDENT_OUTAGE',
'RESOLUTION_GROUP~INCIDENT_OUTAGE',
'RESOLUTION_SOURCE~INCIDENT_OUTAGE'
