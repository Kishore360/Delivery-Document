...
SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 ...
 FROM molinahealth_mdsdb.change_request_final SRC
  LEFT JOIN (select row_key,row_id,parent_change_request_key from molinahealth02_mdwdb.d_change_request) PARENT 
 ON coalesce(SRC.parent,'UNSPECIFIED')= PARENT.row_id 
 JOIN molinahealth02_mdwdb.d_change_request TRGT 
