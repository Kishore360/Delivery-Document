...
from  ldb.f_incident_resolved a11 
join ldb.d_task_urgency  a15 on (a11.urgency_src_key=a15.row_key)
UNION 
select 'ldb.d_task_priority' as Table_Name, count(a11.row_key) Row_Count
from  ldb.f_incident_resolved a11 
join ldb.d_task_priority a16 on (a11.priority_src_key=a16.row_key)
UNION 
select 'ldb.d_task_impact' as Table_Name, count(a11.row_key) Row_Count
from  ldb.f_incident_resolved a11 
join ldb.d_task_impact a17 on (a11.impact_src_key=a17.row_key)
UNION 
...
from  ldb.f_incident_resolved a11  
join ldb.d_internal_organization_department a24  on (a11.opened_by_department_key=a24.row_key)
UNION 
...
from ldb.f_incident_resolved a11  
join ldb.d_internal_contact_opened_by_c a26  on (a11.last_resolved_by_key =a26.row_key)
UNION 
SELECT 'ldb.d_internal_contact' as Table_Name, count(a11.row_key) as Row_count
FROM ldb.f_incident_resolved a11 
JOIN ldb.d_internal_contact a12 ON (a11.last_resolved_by_key=a12.row_key)
UNION 
