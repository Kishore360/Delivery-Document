...
SUM(CASE WHEN req_task.opened_on_key BETWEEN mon.month_start_date_key AND mon.month_end_date_key and req_task.dormancy_age_c <=7 then 0 else 1 END ) AS dormant_count_c
...
where 
a.dormant_count_c<>b.dormant_count_c)a