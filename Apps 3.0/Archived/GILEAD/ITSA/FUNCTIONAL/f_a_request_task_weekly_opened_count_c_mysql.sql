...
(SELECT  mon.row_key as week_start_date_key,
      ...
      SUM(CASE WHEN req_task.opened_on_key BETWEEN mon.week_start_date_key AND mon.week_end_date_key and req_task.closed_on_key is null then 1 else 0 END) as opened_count_c
