...
CASE WHEN CNT > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 ...
 ON ( SRC.u_application= LKP.row_id 
AND SRC.sourceinstance= LKP.source_id )
 WHERE COALESCE(LKP.row_key,CASE WHEN SRC.u_application IS NULL THEN 0 else -1 end)<> (TRGT.configuration_item_application_c_key))temp;
