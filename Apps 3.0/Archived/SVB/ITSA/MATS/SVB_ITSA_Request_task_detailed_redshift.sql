...
union
select'ldb.d_request_task_contact_type_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_request_task       a11
 join ldb.d_request_task       a12
on (a11.request_task_key = a12.row_key)
join ldb.d_request_task_contact_type_c       a119
on (a12.contact_type_src_c_key = a119.row_key)
