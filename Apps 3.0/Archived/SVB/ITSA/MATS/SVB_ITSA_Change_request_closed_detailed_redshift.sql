...
union
select'ldb.d_change_request_closure_status_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_change_request_closed       a11 
join ldb.d_change_request_closure_status_c       a116
...
union
select'ldb.d_lov_unplanned_impact_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_change_request_closed       a11
 join ldb.d_change_request       a13
on (a11.change_request_key = a13.row_key)
join ldb.d_lov_unplanned_impact_c       a126
on (a13.unplanned_impact_c_key = a126.row_key)
union
select'ldb.d_lov_closure_code_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_change_request_closed       a11 
 join ldb.d_change_request       a13
on (a11.change_request_key = a13.row_key)
join ldb.d_lov_closure_code_c       a127
on (a13.closure_code_c_key = a127.row_key)
union
select'ldb.d_lov_expedite_reason_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_change_request_closed       a11 
 join ldb.d_change_request       a13
on (a11.change_request_key = a13.row_key)
join ldb.d_lov_expedite_reason_c       a128
on (a13.expedite_reason_c_key = a128.row_key)
union
select'ldb.d_lov_phase_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_change_request_closed       a11 
 join ldb.d_change_request       a13
on (a11.change_request_key = a13.row_key)
join ldb.d_lov_phase_c       a129
on (a13.phase_c_key = a129.row_key)
union
select'ldb.d_lov_phase_state_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_change_request_closed       a11
 join ldb.d_change_request       a13
on (a11.change_request_key = a13.row_key)
join ldb.d_lov_phase_state_c       a130
on (a13.phase_state_c_key = a130.row_key)
union
