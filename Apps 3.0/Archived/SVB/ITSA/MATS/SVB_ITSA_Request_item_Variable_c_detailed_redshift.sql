...
select'ldb.d_request_item_variable_project_number_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_request_item       a11 
join ldb.d_request_item_variable_project_number_c       a18
...
select'ldb.d_internal_contact_requested_for_manager_c' as Table_Name, count(a11.row_key) Row_Count
 ...
 join ldb.d_internal_contact_requested_for       a16
on (a11.requested_for_key = a16.row_key)
join ldb.d_internal_contact_requested_for_manager_c       a126
on (a16.manager_c_key = a126.row_key)
union
