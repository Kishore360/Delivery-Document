...
select  trgt.exclude_task_c_flag as target , (case when ((lkp.name not like 'ITSM-LOB-Branchinfo%' and lkp.name not like 'ITSM-LOB-HumanSystems%' and
...
as source
from  bbandt_mdsdb.task_final src 
