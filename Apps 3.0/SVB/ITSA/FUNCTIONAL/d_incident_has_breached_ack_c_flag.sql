SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_incident.has_breached_ack_c_flag' ELSE 'SUCCESS' END as Message
 FROM(select a12.incident_key,group_concat(a12.outcome_flag) as src,has_breached_ack_c_flag trgt from svb_mdwdb.d_incident  a11
...
and a13.sla_category ='Acknowledgement'
and a13.type_c='SLA'
