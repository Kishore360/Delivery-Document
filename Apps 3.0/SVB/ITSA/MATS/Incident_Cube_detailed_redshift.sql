...
union
select 'ldb.d_configuration_item_application_c a19 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
...
union
select 'ldb.d_incident_open_to_resolve_duration_agebucket_c a112 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
...
union
select 'ldb.d_incident_dormancybucket a116 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
...
union
select 'ldb.d_lov_incident_environment_src_c a118 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_lov_incident_environment_src_c a118 
on (a11.inc_environment_c_src_key = a118.row_key) 
union
select 'ldb.d_escalation_c a119 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
...
union
select 'ldb.d_lov_incident_type_incident_c a122 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_lov_incident_type_incident_c a122 
on (a11.incident_type_src_c_key = a122.row_key) 
union
select 'ldb.d_incident_outage_type_c a123 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_incident_outage_type_c a123 
on (a11.outage_type_c_key = a123.row_key) 
union
select 'ldb.d_parent_incident a124 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_parent_incident a124 
on (a11.parent_incident_key = a124.row_key) 
union
select 'ldb.d_internal_contact_reported_by_c a125 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_contact_reported_by_c a125 
on (a11.reported_by_c_key = a125.row_key) 
union
select 'ldb.d_incident_close_code_c a126 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
...
union
select 'ldb.d_portfolio_owner_c a137 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_configuration_item a18 
on (a11.configuration_item_key = a18.row_key) 
