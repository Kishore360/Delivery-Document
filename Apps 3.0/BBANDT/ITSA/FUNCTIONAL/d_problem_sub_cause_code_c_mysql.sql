...
LEFT JOIN bbandt_mdwdb.d_lov LKP 
 ON  LKP.dimension_class =  'SUB_CAUSE_CODE_C~PROBLEM' and (concat('SUB_CAUSE_CODE_C~PROBLEM~',upper(SRC.u_cause_code),'~~',upper(SRC.u_sub_cause_code))= LKP.row_id AND SRC.sourceinstance= LKP.source_id )
