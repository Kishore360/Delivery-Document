...
LEFT JOIN bbandt_mdwdb.d_lov LKP 
 ON  LKP.dimension_class =  'CLOSE_CODE_C~CHANGE_REQUEST' and (concat('CLOSE_CODE_C~CHANGE_REQUEST~',SRC.state,'~~',upper(SRC.u_close_code))= LKP.row_id AND SRC.sourceinstance= LKP.source_id )
