...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for problem.priority_downgraded_c_flag' ELSE 'SUCCESS' END as Message from (
...
join tjx_mdwdb.d_problem d on c.sys_id = d.row_id and c.sourceinstance = d. source_id
