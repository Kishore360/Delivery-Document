 ...
 CASE WHEN CNT >0 THEN 'MDS to DWH data validation failed for f_problem.dormancy_age' ELSE 'SUCCESS' END as Message
 FROM 
...
and etl_run_number=TRGT.etl_run_number),'America/New_York','GMT')),0)<> TRGT.dormancy_age_c)temp;
