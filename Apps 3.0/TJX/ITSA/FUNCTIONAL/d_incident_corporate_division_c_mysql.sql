...
CASE WHEN CNT >0 THEN 'MDS to DWH data validation failed for d_incident.corporate_division_c' ELSE 'SUCCESS' END as Message
FROM 
...
WHERE LKP.name<> (TRGT.corporate_division_c))temp;