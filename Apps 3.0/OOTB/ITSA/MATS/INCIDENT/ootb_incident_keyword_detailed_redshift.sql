...
union
select 'ldb.dh_assignment_group_tier_hierarchy a14 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_keyword a11 
join ldb.dh_assignment_group_tier_hierarchy a14 
on (a11.assignment_group_key = a14.user_group_tier_key) 
union
select 'ldb.dh_assignment_group_type_hierarchy a15 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_keyword a11 
