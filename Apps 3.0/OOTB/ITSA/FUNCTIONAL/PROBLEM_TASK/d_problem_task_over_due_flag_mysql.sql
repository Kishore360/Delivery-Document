...
WHERE soft_deleted_flag='N' and  REQ_ITM.over_due_flag <> CASE WHEN (REQ_ITM.active_flag = 'Y'and soft_deleted_flag='N') && (REQ_ITM.due_on < (SELECT max(lastupdated) AS lastupdated
