...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_calendar_date.month_number_of_year' ELSE 'SUCCESS' END as Message
...
AND DATE_FORMAT(SRC.`DATE`,'%c') <>TRGT.month_number_of_year
