...
SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for t_task_activity.task_attribute_wh_old_value ' 
...
AND COALESCE(SRC.oldvalue,'') <> COALESCE(TRGT.task_attribute_wh_old_value,'') 
