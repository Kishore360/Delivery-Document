...
on (F.request_item_key=TGT2.task_key AND TGT2.task_attribute_wh_name = 'state' AND SRC.sourceinstance=TGT2.source_id and TGT2.primary_sequence_id = 1)
...
on SRC.documentkey = F.row_id
left join <<tenant>>_mdwdb.f_request_item_activity TGT2
on (F.request_item_key=TGT2.task_key AND TGT2.task_attribute_wh_name = 'stage' AND SRC.sourceinstance=TGT2.source_id and TGT2.primary_sequence_id = 1)
