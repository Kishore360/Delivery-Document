...
SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_request_task.over_due_flag' ELSE 'SUCCESS' END as Message
 ...
 WHERE COALESCE( CASE WHEN SRC.active = 1 and coalesce( SRC.due_date,0) < convert_tz(FRESH.lastupdated, 'America/Los_Angeles','GMT')
