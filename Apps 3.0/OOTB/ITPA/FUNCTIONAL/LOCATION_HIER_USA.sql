...
FROM <<tenant>>_mdsdb.us_d_location_final lev_0
LEFT JOIN <<tenant>>_mdsdb.us_d_location_final lev_1
ON(lev_0.parent_row_id = lev_1.row_id)
LEFT JOIN <<tenant>>_mdsdb.us_d_location_final lev_2
ON(lev_1.parent_row_id = lev_2.row_id)
LEFT JOIN <<tenant>>_mdsdb.us_d_location_final lev_3
ON(lev_2.parent_row_id = lev_3.row_id)
LEFT JOIN <<tenant>>_mdsdb.us_d_location_final lev_4
ON(lev_3.parent_row_id = lev_4.row_id)
LEFT JOIN <<tenant>>_mdsdb.us_d_location_final lev_5
