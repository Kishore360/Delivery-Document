...
SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 ...
 WHERE COALESCE( CASE WHEN SRC.due_date is NULL then 'N'when SRC.active = 1 and coalesce( SRC.due_date,0) < convert_tz(FRESH.lastupdated , tz.target_time_zone, tz.source_time_zone)
