...
LEFT JOIN <<tenant>>_mdwdb.d_domain level_0
ON a.s0  = level_0.row_id 
LEFT JOIN  <<tenant>>_mdwdb.d_domain level_1
ON a.s1  = level_1.row_id 
LEFT JOIN  <<tenant>>_mdwdb.d_domain level_2
ON a.s2  = level_2.row_id 
LEFT JOIN  <<tenant>>_mdwdb.d_domain level_3
ON a.s3  = level_3.row_id 
LEFT JOIN  <<tenant>>_mdwdb.d_domain level_4
ON a.s4  = level_4.row_id 
LEFT JOIN  <<tenant>>_mdwdb.d_domain level_5
