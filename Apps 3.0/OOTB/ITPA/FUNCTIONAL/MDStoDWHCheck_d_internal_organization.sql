...
join <<tenant>>_mdwdb.d_internal_organization TRGT
...
,coalesce(SRC.changed_by,''),coalesce(convert_tz(SRC.created_on,L.source_time_zone,L.target_time_zone),''),coalesce(convert_tz(SRC.changed_on,L.source_time_zone,L.target_time_zone),'') )
