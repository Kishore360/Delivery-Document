...
where column_name in ('row_key','row_id','source_id','etl_run_number','soft_deleted_flag','created_by','changed_by','created_on','changed_on','dw_inserted_on','dw_updated_on','row_dn_key','row_current_key')and table_name = '<<tablename>>' and table_schema = '<<tenant>>_mdwdb'
