...
Case when lvd.data_type ='DECIMAL(22,10)' THEN cast(qa.value as DECIMAL) else null end
when (c.label ='Reference' and lvd.variable_type='Reference') then null end <> trgt.numeric_value)c
