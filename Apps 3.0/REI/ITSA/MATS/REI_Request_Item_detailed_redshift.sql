...
union
select 'ldb.d_request_item_variable_requested_completion_date_c a13 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_request_item a11 
...
on (a14.row_current_key = a110.row_current_key) 
union
...
on (a16.department_c_key = a116.row_key) 
union
