...
select'ldb.d_time_card_category' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_time_entry       a11 
join ldb.d_time_card_category       a118
on (a11.category_src_key=a118.row_key)
union
select'ldb.d_time_card_charge_type' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_time_entry       a11 
join ldb.d_time_card_charge_type       a119
on (a11.charge_type_key=a119.row_key)
union
select'ldb.d_time_card_state' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_time_entry       a11 
join ldb.d_time_card_state       a120
...
on (a17.project_priority_src_key=a125.row_key)
union
...
on (a17.project_phase_src_key=a126.row_key)
union
...
on (a17.project_state_src_key=a127.row_key)
union
