SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 ...
 FROM 
gogo_mdsdb.d_work_order_task_c as dim
  ...
  where  dim.first_time_fix_c_flag<>  case when lov.dimension_code='3' or (lov.dimension_code='4' and incomplete_reason in ('rerouted','airline_assistance','Opened_in_error')) then 'Y' else 'N' end