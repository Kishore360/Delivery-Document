...
FROM (
 select number,a.SYS_ID,b.failure_flag,u_success_status,oldvalue,newvalue,change_ever_failed_c_flag,count(1)-- u_success_status, oldvalue, newvalue,a.SYS_ID,b.change_ever_failed_c_flag ,d.documentkey
