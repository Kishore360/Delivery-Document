...
CASE WHEN CNT >0 THEN 'MDS to DWH data validation failed for d_problem.over_due_flag' ELSE 'SUCCESS' END as Message
...
and SRC.due_date is not null and SRC.active=1)
 THEN 'Y' ELSE 'N' END <> TRGT.over_due_flag)temp;
