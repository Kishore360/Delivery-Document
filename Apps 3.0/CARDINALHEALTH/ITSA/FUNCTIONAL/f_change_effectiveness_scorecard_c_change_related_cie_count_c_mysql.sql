...
CASE WHEN COUNT(1) >0 THEN 'MDS to DWH data validation failed for f_change_effectiveness_scorecard_c.change_related_cie_count_c'
...
WHERE  u_change_related_cie <> change_related_cie_count_c;