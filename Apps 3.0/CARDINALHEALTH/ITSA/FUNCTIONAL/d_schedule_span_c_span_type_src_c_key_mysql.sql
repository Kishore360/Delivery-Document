...
join  cardinalhealth_mdwdb.d_schedule_span_c a13
 ...
 join cardinalhealth_mdwdb.d_lov sc on sc.row_id=UPPER(CONCAT('TYPE~CMN_SCHEDULE_SPAN','~','','~','','~',COALESCE(a13s.type,'')))
  WHERE COALESCE(sc.row_key ) <> a13.span_type_src_c_key;
