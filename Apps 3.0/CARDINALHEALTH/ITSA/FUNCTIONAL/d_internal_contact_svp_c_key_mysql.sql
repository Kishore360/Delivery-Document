...
ON e.row_id= COALESCE(concat('INTERNAL_CONTACT~',b.u_svp),'UNSPECIFIED')AND e.source_id=b.sourceinstance
where a.svp_c_key<>case when b.u_svp is null then 0  ELSE (e.row_key) END)temp;
