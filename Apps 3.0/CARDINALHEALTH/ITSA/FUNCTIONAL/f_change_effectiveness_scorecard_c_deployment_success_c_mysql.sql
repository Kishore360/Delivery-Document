...
CASE WHEN COUNT(1) >0 THEN 'MDS to DWH data validation failed for f_change_effectiveness_scorecard_c.deployment_success_c'
...
WHERE  u_deployment_success <> deployment_success_c;