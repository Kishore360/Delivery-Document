...
ON c.row_id = COALESCE(concat('INTERNAL_CONTACT~',b.u_cah_level_4_product_owner_ad),'UNSPECIFIED') AND c.source_id = b.sourceinstance
where a.cah_level_4_c_key <> (c.row_key);
