...
AND SRC.sourceinstance= LKP.source_id )
 WHERE TRGT.soft_deleted_flag='N' and LKP.soft_deleted_flag='N' and   COALESCE(LKP.row_key,CASE WHEN SRC.project_manager IS NULL THEN 0 else -1 end)<> (TRGT.manager_c_key)