...
question_text LIKE '%Please enter a title for this request%' 
...
where case when (d.v_enter_title_c <> COALESCE(a.value,'')
OR (d.v_enter_title_c is null AND COALESCE(a.value,'') is not null)) then COALESCE(a.value,'') end <>d.v_enter_title_c)c
