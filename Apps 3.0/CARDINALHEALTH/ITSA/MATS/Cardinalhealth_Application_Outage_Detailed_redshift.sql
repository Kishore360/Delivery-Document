select 'ldb.f_application_outage_c a11 ' as Table_name, count(1) Row_Count
...
union
select 'ldb.d_calendar_greg_fiscal_c a13 ' as Table_name, count(1) Row_Count
from ldb.f_application_outage_c a11 
join ldb.d_calendar_greg_fiscal_c a13 
on (a11.outage_start_key = a13.greogrian_calendar_key) 
union
...
on (a11.outage_start_key = a15.row_key) 
union
select 'ldb.d_internal_contact_business_owner_c a16 ' as Table_name, count(1) Row_Count
from ldb.f_application_outage_c a11 
join ldb.d_configuration_item a12 
on (a11.configuration_item_key = a12.row_key) 
...
union
select 'ldb.d_config_item_cah_business_process_c a17 ' as Table_name, count(1) Row_Count
from ldb.f_application_outage_c a11 
join ldb.d_configuration_item a12 
on (a11.configuration_item_key = a12.row_key) 
...
union
select 'ldb.d_config_item_cah_bus_criticl_c a18 ' as Table_name, count(1) Row_Count
from ldb.f_application_outage_c a11 
join ldb.d_configuration_item a12 
on (a11.configuration_item_key = a12.row_key) 
...
union
select 'ldb.d_config_item_cah_bus_segment_c a19 ' as Table_name, count(1) Row_Count
from ldb.f_application_outage_c a11 
join ldb.d_configuration_item a12 
on (a11.configuration_item_key = a12.row_key) 
...
union
select 'ldb.d_config_item_cah_bus_unit_c a110 ' as Table_name, count(1) Row_Count
from ldb.f_application_outage_c a11 
join ldb.d_configuration_item a12 
on (a11.configuration_item_key = a12.row_key) 
...
union
select 'ldb.d_config_item_level_2_c a111 ' as Table_name, count(1) Row_Count
from ldb.f_application_outage_c a11 
join ldb.d_configuration_item a12 
on (a11.configuration_item_key = a12.row_key) 
...
union
select 'ldb.d_config_item_sla_c a112 ' as Table_name, count(1) Row_Count
from ldb.f_application_outage_c a11 
join ldb.d_configuration_item a12 
on (a11.configuration_item_key = a12.row_key) 
...
union
select 'ldb.d_config_item_cah_health_hardware_c a113 ' as Table_name, count(1) Row_Count
from ldb.f_application_outage_c a11 
join ldb.d_configuration_item a12 
on (a11.configuration_item_key = a12.row_key) 
...
union
select 'ldb.d_internal_contact_level_3_c a114 ' as Table_name, count(1) Row_Count
from ldb.f_application_outage_c a11 
join ldb.d_configuration_item a12 
on (a11.configuration_item_key = a12.row_key) 
...
union
select 'ldb.d_internal_contact_level_4_c a115 ' as Table_name, count(1) Row_Count
from ldb.f_application_outage_c a11 
join ldb.d_configuration_item a12 
on (a11.configuration_item_key = a12.row_key) 
...
union
select 'ldb.d_internal_contact_level_5_c a116 ' as Table_name, count(1) Row_Count
from ldb.f_application_outage_c a11 
join ldb.d_configuration_item a12 
on (a11.configuration_item_key = a12.row_key) 
...
union
select 'ldb.d_schedule_configuration_item_maintenance_schedule_c a117 ' as Table_name, count(1) Row_Count
from ldb.f_application_outage_c a11 
join ldb.d_configuration_item a12 
on (a11.configuration_item_key = a12.row_key) 
...
union
select 'ldb.d_config_item_cah_health_overall_c a119 ' as Table_name, count(1) Row_Count
from ldb.f_application_outage_c a11 
join ldb.d_configuration_item a12 
on (a11.configuration_item_key = a12.row_key) 
...
union
select 'ldb.d_schedule_configuration_item_schedule_c a120 ' as Table_name, count(1) Row_Count
from ldb.f_application_outage_c a11 
join ldb.d_configuration_item a12 
on (a11.configuration_item_key = a12.row_key) 
...
union
select 'ldb.d_config_item_cah_health_software_c a121 ' as Table_name, count(1) Row_Count
from ldb.f_application_outage_c a11 
join ldb.d_configuration_item a12 
on (a11.configuration_item_key = a12.row_key) 
...
union
select 'ldb.d_calendar_fiscal_period a122 ' as Table_name, count(1) Row_Count
from ldb.f_application_outage_c a11 
join ldb.d_calendar_greg_fiscal_c a13 
on (a11.outage_start_key = a13.greogrian_calendar_key) join ldb.d_calendar_date_fiscal a14 
on (a13.fiscal_key = a14.row_key) 
join ldb.d_calendar_fiscal_period a122 
on (a14.period_start_date_key = a122.row_key) 
union
select 'ldb.d_calendar_fiscal_year a123 ' as Table_name, count(1) Row_Count
from ldb.f_application_outage_c a11 
join ldb.d_calendar_greg_fiscal_c a13 
on (a11.outage_start_key = a13.greogrian_calendar_key) join ldb.d_calendar_date_fiscal a14 
on (a13.fiscal_key = a14.row_key) 
