...
select'ldb.d_internal_contact_assign_to_rt_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_request_item_task_c             a11 
left outer join ldb.d_internal_contact_assign_to_rt_c         a112
...
left outer join ldb.d_calendar_date_closed_rt_c         a16
on (a11.closed_on_key=a16.row_key) 
left outer join ldb.d_calendar_week_closed_rt_c         a117
...
left outer join ldb.d_calendar_date_rt_c         a18
on (a11.opened_on_key=a18.row_key) 
left outer join ldb.d_calendar_week_rt_c         a118
...
left outer join ldb.d_calendar_date_closed_rt_c         a16
on (a11.closed_on_key=a16.row_key) 
left outer join ldb.d_calendar_month_closed_rt_c         a119
...
left outer join ldb.d_calendar_date_rt_c         a18
on (a11.opened_on_key=a18.row_key) 
left outer join ldb.d_calendar_month_rt_c         a120
...
left outer join ldb.d_calendar_date_closed_rt_c         a16
on (a11.closed_on_key=a16.row_key) 
left outer join ldb.d_calendar_quarter_closed_rt_c         a121
...
left outer join ldb.d_calendar_date_rt_c         a18
on (a11.opened_on_key=a18.row_key) 
left outer join ldb.d_calendar_quarter_rt_c         a122
...
left outer join ldb.d_calendar_date_closed_rt_c         a16
on (a11.closed_on_key=a16.row_key) 
left outer join ldb.d_calendar_year_closed_rt_c         a123
...
left outer join ldb.d_calendar_date_rt_c         a18
on (a11.opened_on_key=a18.row_key) 
left outer join ldb.d_calendar_year_rt_c         a124
