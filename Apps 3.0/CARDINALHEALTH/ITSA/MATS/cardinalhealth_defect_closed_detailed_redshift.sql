...
on (a11.closed_on_key = a111.greogrian_calendar_key) 
union
...
from ldb.f_defect_rm_closed_c a11 
join ldb.d_internal_contact a13 
on (a11.closed_by_key = a13.row_key) join ldb.d_internal_contact_mdm a113 
on (a13.row_current_key = a113.row_current_key) 
...
from ldb.f_defect_rm_closed_c a11 
join ldb.d_calendar_greg_fiscal_c a111 
on (a11.closed_on_key = a111.greogrian_calendar_key) join ldb.d_calendar_date_fiscal a112 
on (a111.fiscal_key = a112.row_key) 
