...
truncate table cardinalhealth_workdb.fs_skill_call_summary_aux;
...
concat(''AUX~CCA~~~'',trim(syn.value)) as aux_src_code_id,
...
JOIN cardinalhealth_mdsdb.hsplit_final splt ON (syn.acd_no = splt.acd)
...
SET @sql = CONCAT('INSERT INTO cardinalhealth_workdb.fs_skill_call_summary_aux (row_id, source_id,parent_row_id, time_id, day_id, shift_id, skill_id, acd_id, aux_code_src_id, aux_time,  created_by, changed_by, created_on, changed_on, pivot_date)
