...
join jnj_mdwdb.d_internal_contact a13 on COALESCE(CONCAT ('INTERNAL_CONTACT~',a12.u_change_manager), 'UNSPECIFIED')= a13.row_id
WHERE 
a11.change_manager_c_key <> a13.row_key
)E;