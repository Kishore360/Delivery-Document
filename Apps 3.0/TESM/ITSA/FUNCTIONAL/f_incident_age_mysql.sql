...
WHERE TIMESTAMPDIFF(SECOND,SRC.opened_at,(SELECT CONVERT_TZ(MAX(lastupdated),'America/Los_Angeles','GMT') AS lastupdated FROM tesm_mdwdb.d_o_data_freshness WHERE sourcename like 'ServiceNow%'))<> f.age
