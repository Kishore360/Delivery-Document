...
UNION 
SELECT 'd_internal_contact_request_item_opened_by_c' as Table_Name,Count(a.row_key) as Row_count
FROM ldb.f_request_item_closed_c a 
JOIN ldb.d_internal_contact_request_item_opened_by_c b ON a.opened_by_key=b.row_key
