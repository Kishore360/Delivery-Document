...
union
select 'ldb.d_request_item_state a15 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_request_item a11 
join ldb.d_request_item_state a15 
...
union
select 'ldb.d_sc_req_item_priority a18 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_request_item a11 
join ldb.d_sc_req_item_priority a18 
