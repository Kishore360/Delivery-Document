...
from      ldb.f_problem   a11 
 join        ldb.d_lov_problem_category_c                a115
                  on         (a11.problem_category_src_c_key = a115.row_key)
union
...
union
select'd_internal_contact_validated_by_c' as Table_Name, count(a11.row_key) Row_Count
from      ldb.f_problem   a11 
 join        ldb.d_internal_contact_validated_by_c                a121
                  on         (a11.validated_by_c_key = a121.row_key)
union
