...
UNION 
select 'ldb.d_change_request_parent_task_c ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request_closed a11 
JOIN ldb.d_change_request_parent_task_c b ON a11.parent_task_c_key=b.row_key
UNION 
select 'ldb.d_change_request_approval ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request_closed a11 
JOIN ldb.d_change_request_approval b ON a11.approval_state_src_key=b.row_key
UNION 
select 'ldb.d_internal_contact_change_request_opened_by_c ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request_closed a11 
JOIN ldb.d_internal_contact_change_request_opened_by_c b ON a11.closed_by_key=b.row_key
