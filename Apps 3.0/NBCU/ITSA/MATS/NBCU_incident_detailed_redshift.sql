...
union
select 'ldb.d_lov_problem_category_incident_c a132 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_lov_problem_category_incident_c a132 
on (a11.problem_category_c_key = a132.row_key) 
union
select 'ldb.d_lov_region_c a133 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_lov_region_c a133 
on (a11.region_c_key = a133.row_key) 
union
select 'ldb.d_lov_resolved_via_c a134 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_lov_resolved_via_c a134 
on (a11.resolved_via_c_key = a134.row_key) 
union
select 'ldb.d_lov_root_cause_category_c a135 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_lov_root_cause_category_c a135 
on (a11.root_cause_category_src_c_key = a135.row_key) 
union
select 'ldb.d_lov_u_reason_for_l1_resolveable_c a136 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_lov_u_reason_for_l1_resolveable_c a136 
on (a11.reason_for_l1_resolveable_c_reason_for_l1_resolveable_key = a136.row_key) 
union
select 'ldb.d_lov_source_c a137 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_lov_source_c a137 
on (a11.source_src_c_key = a137.row_key) 
union
select 'ldb.d_task_impact a138 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_task_impact a138 
on (a11.impact_src_key = a138.row_key) 
union
...
union
select 'ldb.d_internal_contact_assigned_to_manager_c a141 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_contact_assigned_to a15 
on (a11.assigned_to_key = a15.row_key) 
join ldb.d_internal_contact_assigned_to_manager_c a141 
on (a15.manager_c_key = a141.row_key) 
union
select 'ldb.dh_user_group_level1 a142 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_organization_group a16 
on (a11.assignment_group_key = a16.row_key) join ldb.dh_user_group_hierarchy a17 
on (a16.row_dn_key = a17.lev_0_key) 
join ldb.dh_user_group_level1 a142 
on (a17.lev_1_key = a142.row_key) 
union
select 'ldb.d_internal_contact_group_manager_c a143 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_organization_group a16 
on (a11.assignment_group_key = a16.row_key) 
join ldb.d_internal_contact_group_manager_c a143 
on (a16.org_manager_c_key = a143.row_key) 
union
select 'ldb.d_internal_organization_group_parent_c a144 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_organization_group a16 
on (a11.assignment_group_key = a16.row_key) 
join ldb.d_internal_organization_group_parent_c a144 
on (a16.parent_c_key = a144.row_key) 
union
...
on (a18.criticality_key = a145.row_key) 
union
...
on (a18.used_for_src_key = a146.row_key) 
union
select 'ldb.d_lov_incident_dispatch_reason_c a147 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_incident a113 
on (a11.incident_key = a113.row_key) 
join ldb.d_lov_incident_dispatch_reason_c a147 
on (a113.dispatch_reason_src_c_key = a147.row_key) 
union
select 'ldb.d_incident_category a148 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_incident a113 
on (a11.incident_key = a113.row_key) 
join ldb.d_incident_category a148 
on (a113.category_src_key = a148.row_key) 
union
select 'ldb.d_incident_close_code a149 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_incident a113 
on (a11.incident_key = a113.row_key) 
join ldb.d_incident_close_code a149 
on (a113.close_code_src_key = a149.row_key) 
union
...
on (a113.severity_src_key = a150.row_key) 
union
...
on (a113.state_src_key = a151.row_key) 
union
...
on (a113.sub_category_src_key = a152.row_key) 
union
select 'ldb.d_parent_incident a153 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_incident a113 
on (a11.incident_key = a113.row_key) 
join ldb.d_parent_incident a153 
on (a113.parent_incident_key = a153.row_key) 
union
select 'ldb.dh_user_resolver_group_level1_c a154 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_organization_resolver_group_c a118 
on (a11.resolver_group_c_key = a118.row_key) join ldb.dh_resolver_group_hierarchy_c a119 
on (a118.row_dn_key = a119.lev_0_key) 
join ldb.dh_user_resolver_group_level1_c a154 
on (a119.lev_1_key = a154.row_key) 
union
select 'ldb.dh_user_group_level2 a155 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_organization_group a16 
on (a11.assignment_group_key = a16.row_key) join ldb.dh_user_group_hierarchy a17 
on (a16.row_dn_key = a17.lev_0_key) 
join ldb.dh_user_group_level2 a155 
on (a17.lev_2_key = a155.row_key) 
union
select 'ldb.d_calendar_month a156 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_calendar_date a110 
on (a11.opened_on_key = a110.row_key) 
join ldb.d_calendar_month a156 
on (a110.month_start_date_key = a156.row_key) 
union
select 'ldb.dh_user_resolver_group_level2_c a157 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_organization_resolver_group_c a118 
on (a11.resolver_group_c_key = a118.row_key) join ldb.dh_resolver_group_hierarchy_c a119 
on (a118.row_dn_key = a119.lev_0_key) 
join ldb.dh_user_resolver_group_level2_c a157 
on (a119.lev_2_key = a157.row_key) 
union
select 'ldb.dh_user_group_level3 a158 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_organization_group a16 
on (a11.assignment_group_key = a16.row_key) join ldb.dh_user_group_hierarchy a17 
on (a16.row_dn_key = a17.lev_0_key) 
join ldb.dh_user_group_level3 a158 
on (a17.lev_3_key = a158.row_key) 
union
select 'ldb.dh_user_resolver_group_level3_c a159 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_organization_resolver_group_c a118 
on (a11.resolver_group_c_key = a118.row_key) join ldb.dh_resolver_group_hierarchy_c a119 
on (a118.row_dn_key = a119.lev_0_key) 
join ldb.dh_user_resolver_group_level3_c a159 
on (a119.lev_3_key = a159.row_key) 
union
select 'ldb.dh_user_group_level4 a160 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_organization_group a16 
on (a11.assignment_group_key = a16.row_key) join ldb.dh_user_group_hierarchy a17 
on (a16.row_dn_key = a17.lev_0_key) 
join ldb.dh_user_group_level4 a160 
on (a17.lev_4_key = a160.row_key) 
union
select 'ldb.dh_user_resolver_group_level4_c a161 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_organization_resolver_group_c a118 
on (a11.resolver_group_c_key = a118.row_key) join ldb.dh_resolver_group_hierarchy_c a119 
on (a118.row_dn_key = a119.lev_0_key) 
join ldb.dh_user_resolver_group_level4_c a161 
on (a119.lev_4_key = a161.row_key) 
union
select 'ldb.dh_user_group_level5 a162 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_organization_group a16 
on (a11.assignment_group_key = a16.row_key) join ldb.dh_user_group_hierarchy a17 
on (a16.row_dn_key = a17.lev_0_key) 
join ldb.dh_user_group_level5 a162 
on (a17.lev_5_key = a162.row_key) 
union
select 'ldb.dh_user_resolver_group_level5_c a163 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_organization_resolver_group_c a118 
on (a11.resolver_group_c_key = a118.row_key) join ldb.dh_resolver_group_hierarchy_c a119 
on (a118.row_dn_key = a119.lev_0_key) 
join ldb.dh_user_resolver_group_level5_c a163 
on (a119.lev_5_key = a163.row_key) 
