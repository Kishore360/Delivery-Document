...
on sc_request_final.sys_id = src.sys_id and sc_request_final.sourceinstance = src.sourceinstance
where 
CONVERT_TZ(coalesce(src.fulfilled_on,sc_request_final.closed_at),'GMT','America/New_York')<>trgt.fulfilled_on_c