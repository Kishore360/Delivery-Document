...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for d_application.hosted_by_state_c' ELSE 'SUCCESS' END as Message 
FROM (
...
where coalesce(SRC.u_hosted_by_state ,'UNSPECIFIED')<>TRGT.hosted_by_state_c
)temp;
