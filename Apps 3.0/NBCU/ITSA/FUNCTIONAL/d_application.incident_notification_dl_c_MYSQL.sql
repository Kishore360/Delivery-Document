...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for d_application.incident_notification_dl_c' ELSE 'SUCCESS' END as Message 
FROM (
...
where coalesce(SRC.u_imc_dl ,'UNSPECIFIED')<>TRGT.incident_notification_dl_c
)temp;
