...
ON (TRGTF.request_key =TRGT.row_key AND TRGTF.source_id =TRGT.source_id)
LEFT JOIN nbcu_mdwdb.d_lov_map LM ON  (TRGTF.state_src_key = LM.src_key and LM.dimension_class='REQUEST_STATE~SC_REQUEST')
