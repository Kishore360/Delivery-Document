...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for d_application.application_id_c' ELSE 'SUCCESS' END as Message 
FROM (
...
where coalesce(SRC.u_application_id ,'UNSPECIFIED')<>TRGT.application_id_c
)temp;
