...
left join nbcu_mdwdb.d_calendar_date d on DATE_FORMAT(CONVERT_TZ(a.sys_created_on,'GMT','America/New_York'),'%Y%m%d') =d.row_id and a.sourceinstance=d.source_id
