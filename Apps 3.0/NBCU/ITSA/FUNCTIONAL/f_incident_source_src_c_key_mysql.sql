 ...
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_incident.source_src_c_key' ELSE 'SUCCESS' END as Message
  FROM nbcu_mdsdb.incident_final SRC
 LEFT JOIN nbcu_mdwdb.f_incident TRGT 
