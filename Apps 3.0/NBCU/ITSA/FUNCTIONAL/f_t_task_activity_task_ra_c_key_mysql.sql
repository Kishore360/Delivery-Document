...
left join 	nbcu_mdwdb.d_task d  on COALESCE( CONCAT('CONTACT_TYPE','~','TASK','~','~','~',UPPER(a.contact_type)),'UNSPECIFIED') =d.row_id
join nbcu_mdwdb.f_t_task_activity fs
...
or update_count<>fs.task_update_count_c
