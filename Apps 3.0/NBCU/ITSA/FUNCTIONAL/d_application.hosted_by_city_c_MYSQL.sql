...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for d_application.hosted_by_city_c' ELSE 'SUCCESS' END as Message 
FROM (
...
where coalesce(SRC.u_hosted_by_city ,'UNSPECIFIED')<>TRGT.hosted_by_city_c
)temp;
