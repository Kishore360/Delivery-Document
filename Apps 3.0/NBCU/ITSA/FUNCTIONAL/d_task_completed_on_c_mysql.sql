...
select count(1) as cnt from  nbcu_mdwdb.d_task a 
    join nbcu_mdsdb.task_final i on a.row_id=i.sys_id and a.source_id=i.sourceinstance
     join nbcu_mdsdb.sc_request_final sc on sc.sys_id=i.sys_id and sc.sourceinstance=i.sourceinstance
                 join nbcu_mdsdb.incident_final inc on inc.sys_id=i.sys_id and inc.sourceinstance=i.sourceinstance
                 join nbcu_mdsdb.problem_final pr on pr.sys_id=i.sys_id and pr.sourceinstance=i.sourceinstance
                 join nbcu_mdsdb.problem_task_final prt on prt.sys_id=i.sys_id and prt.sourceinstance=i.sourceinstance
                 join nbcu_mdsdb.sc_req_item_final sri on sri.sys_id=i.sys_id and sri.sourceinstance=i.sourceinstance
                 join nbcu_mdsdb.sc_task_final sct on sct.sys_id=i.sys_id and sct.sourceinstance=i.sourceinstance
                 join nbcu_mdsdb.change_request_final cr on cr.sys_id=i.sys_id and cr.sourceinstance=i.sourceinstance
