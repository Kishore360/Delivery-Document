...
lov.dimension_class like '%TRANSFERRED_REASON~INCIDENT%'
and CONCAT('TRANSFERRED_REASON~INCIDENT~~~',SRC.u_transferred_reason)=lov.row_id

 
where lov.row_key<>c.transferred_reason_c_key
)i; 