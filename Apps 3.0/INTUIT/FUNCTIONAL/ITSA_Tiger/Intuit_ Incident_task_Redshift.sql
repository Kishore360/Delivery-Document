...
on (a11.reported_type_src_key_c = a115.row_key)
union
...
on (a11.close_code_src_code_key = a118.row_key)
union
...
on (a11.opened_by_key_c = a121.row_key)
union
...
on (a15.manager_key_c = a125.row_key)
union
