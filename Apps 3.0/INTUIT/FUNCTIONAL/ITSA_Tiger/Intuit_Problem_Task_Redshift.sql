...
on (a11.initial_incident_key_c = a111.row_key)
union
...
on (a11.infrastructure_category_src_key_c = a112.row_key)
union
...
on (a11.problem_state_src_key = a120.row_key and a11.state_src_key = a120.row_key)
union
