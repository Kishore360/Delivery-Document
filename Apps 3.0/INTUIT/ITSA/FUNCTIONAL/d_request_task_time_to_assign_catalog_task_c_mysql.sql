...
where  b.tablename='sc_task'
	AND b.fieldname='assgined_to'
	AND b.oldvalue IS NULL AND a.time_to_assign_catalog_task_c<> COALESCE(CONVERT_TZ(b.sys_created_on,'GMT' ,'America/Los_Angeles'),a.created_on))b;