...
CASE WHEN CNT THEN 'MDS to DWH data validation failed for d_macm_c_buss_test_comp_date' ELSE 'SUCCESS' END as Message
FROM
(
...
WHERE COALESCE(CONVERT_TZ(SRC.u_buss_test_comp_date,'GMT','US/Central'),'UNSPECIFIED')<>TRGT.buss_test_comp_date
)a;