...
CASE WHEN CNT THEN 'MDS to DWH data validation failed for d_macm_c_deploy_app_date' ELSE 'SUCCESS' END as Message
FROM
(
...
WHERE COALESCE(CONVERT_TZ(SRC.u_deploy_app_date,'GMT','US/Central'),'UNSPECIFIED')<>TRGT.deploy_app_date
)a;