...
FROM pan_mdsdb.task_final task
join pan_mdsdb.task_sla_final src on task.sys_id=src.task and task.sourceinstance=src.sourceinstance
LEFT OUTER JOIN pan_mdwdb.d_incident_tasks_c x 
