...
union
select 'ldb.d_lov_method_of_contact_view_c a120 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_lov_method_of_contact_view_c a120 
...
union
select 'ldb.d_lov_type_view_c a129 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_lov_type_view_c a129 
