select 'ldb.f_ad_hoc_request_c a11 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_ad_hoc_request_c a11 
union
select 'ldb.d_ci_autofill_c a12 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_ad_hoc_request_c a11 
...
union
select 'ldb.d_ad_hoc_request_c a15 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_ad_hoc_request_c a11 
