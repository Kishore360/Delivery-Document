select 'ldb.a_ad_hoc_request_weekly_c a11 ' as Table_name, count(a11.row_key) Row_Count
from ldb.a_ad_hoc_request_weekly_c a11 
union
...
union
select 'ldb.d_region_c a17 ' as Table_name, count(a11.row_key) Row_Count
from ldb.a_ad_hoc_request_weekly_c a11 
join ldb.d_region_c a17 
on (a11.region_key = a17.row_key) 
union
select 'ldb.d_ad_hoc_request_priority_c a18 ' as Table_name, count(a11.row_key) Row_Count
from ldb.a_ad_hoc_request_weekly_c a11 
join ldb.d_ad_hoc_request_priority_c a18 
on (a11.priority_src_key = a18.row_key) 
union
select 'ldb.d_ad_hoc_request_reported_type_c a19 ' as Table_name, count(a11.row_key) Row_Count
from ldb.a_ad_hoc_request_weekly_c a11 
join ldb.d_ad_hoc_request_reported_type_c a19 
on (a11.reported_type_src_key = a19.row_key) 
union
select 'ldb.d_ad_hoc_request_state_c a110 ' as Table_name, count(a11.row_key) Row_Count
from ldb.a_ad_hoc_request_weekly_c a11 
