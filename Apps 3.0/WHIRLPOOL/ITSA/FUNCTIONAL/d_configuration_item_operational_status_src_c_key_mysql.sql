...
JOIN whirlpool_mdwdb.d_lov SRC1 ON 
COALESCE(CONCAT('OPERATIONAL_STATUS~CMDB_CI~~~',UPPER(SRC.operational_status)),'UNSPECIFIED')=SRC1.sys_id and SRC.sourceinstance=SRC1.sourceinstance
