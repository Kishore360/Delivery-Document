...
FROM whirlpool_mdwdb.d_asset d
JOIN whirlpool_mdwdb.f_asset f ON d.row_key=f.asset_key
JOIN whirlpool_mdwdb.d_lov l ON f.asset_status_key=l.row_key AND dimension_name= 'Installed'
JOIN whirlpool_mdwdb.d_model_category  m ON f.model_category_key = m.row_key AND category_name = 'Computers'
