...
from  rambus_mdwdb.d_lov_map map
 join rambus_mdwdb.d_lov lov on lov.src_rowid=map.src_rowid  and lov.source_id=map.source_id
left join
...
left join rambus_mdsdb.sys_choice_final scf on conf.table_value= scf.name and conf.column_value = scf.element
