...
FROM mercuryins_mdsdb.u_asc_ticket_final 

)A
 JOIN  
(SELECT  f.asc_incident_last_resolved_on_c_key,f.source_id,f.ROW_ID FROM  mercuryins_mdwdb.f_incident_asc_c f
join mercuryins_mdwdb.d_lov_map dlm ON f.asc_incident_state_c_key = dlm.src_key and f.asc_incident_state_src_code_c=dlm.dimension_code 
