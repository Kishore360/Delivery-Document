...
CASE WHEN cnt >0 THEN 'MDS to DWH data validation failed for f_incident_asc_c.last_resolved_on' ELSE 'data matched' END as
 Message  from (
...
left join mercuryins_mdwdb.f_incident_asc_c f on f.incident_asc_c_key=TRGT.row_key
