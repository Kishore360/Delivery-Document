...
from mercuryinsurance_mdwdb.f_incident f
 join mercuryinsurance_mdwdb.d_lov_map d on src_key=state_src_key
 join mercuryinsurance_mdwdb.d_lov lov on lov.dimension_class=d.dimension_class and lov.dimension_code=d.dimension_code 
