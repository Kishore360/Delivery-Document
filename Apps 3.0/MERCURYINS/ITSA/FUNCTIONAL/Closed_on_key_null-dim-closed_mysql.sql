select CASE WHEN cnt > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 ...
 FROM(
select count(1) cnt
from mercuryins_mdwdb.f_incident f
 join mercuryins_mdwdb.d_lov_map d on src_key=state_src_key
 join mercuryins_mdwdb.d_lov lov on lov.dimension_class=d.dimension_class and lov.dimension_code=d.dimension_code 
