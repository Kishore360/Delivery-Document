...
(select count(1) cnt  from mercuryins_mdwdb.f_cmdb_ci_name_c t right join (
...
from mercuryins_mdsdb.change_request_final a 
...
left join mercuryins_mdwdb.d_configuration_item b on a.name_id=b.row_id  
