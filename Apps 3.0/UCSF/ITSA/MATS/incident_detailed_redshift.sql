...
union
select 'ldb.d_internal_organization_department_c a15 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_organization_group a14 
on (a11.assignment_group_key = a14.row_key) 
join ldb.d_internal_organization_department_c a15 
...
on (a14.row_dn_key = a16.lev_0_key) 
union
...
union
select 'ldb.d_incident_lastest_reassignment_c a110 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_incident_lastest_reassignment_c a110 
on (a11.incident_key = a110.incident_key) 
union
...
on (a11.location_display_c_key = a112.row_key) 
union
...
on (a11.def_assignment_group_c_key = a114.row_key) 
union
...
union
select 'ldb.d_internal_contact_task_opened_by a118 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_contact_task_opened_by a118 
on (a11.opened_by_key = a118.row_key) 
union
...
from ldb.f_incident a11 
join ldb.d_internal_organization_group a14 
on (a11.assignment_group_key = a14.row_key) join ldb.dh_user_group_hierarchy a16 
on (a14.row_dn_key = a16.lev_0_key) 
join ldb.dh_user_group_level1 a124 
on (a16.lev_1_key = a124.row_key) 
union
select 'ldb.d_internal_contact_sys_grp_mgr_c a125 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_organization_group a14 
on (a11.assignment_group_key = a14.row_key) 
join ldb.d_internal_contact_sys_grp_mgr_c a125 
on (a14.manager_key = a125.row_key) 
union
...
on (a19.severity_src_key = a127.row_key) 
union
...
on (a19.state_src_key = a128.row_key) 
union
