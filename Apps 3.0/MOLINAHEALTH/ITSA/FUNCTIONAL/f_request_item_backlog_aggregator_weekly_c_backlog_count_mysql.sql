...
on d.row_id in (select distinct aggregate_c_key from molinahealth_mdwdb.f_request_item_backlog_aggregator_weekly_c)
...
on coalesce(a.catalog_item,'UNSPECIFIED')=coalesce(b.name,'UNSPECIFIED')  and a.aggregate_c_key=b.week_end_date
