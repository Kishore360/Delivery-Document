...
case when COALESCE(convert_tz(src.sys_updated_on,'UTC','America/Los_Angeles'),'1970-01-01') <> COALESCE(trgt.changed_on,'1970-01-01') then src.sys_id else '' end as failures,

case when COALESCE(convert_tz(src.sys_updated_on,'UTC','America/Los_Angeles'),'1970-01-01') <> COALESCE(trgt.changed_on,'1970-01-01') then 1 else 0 end as failures_cnt
