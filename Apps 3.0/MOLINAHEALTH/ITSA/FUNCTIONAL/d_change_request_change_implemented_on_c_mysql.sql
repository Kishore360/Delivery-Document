...
from 
(select 
case when COALESCE(CONVERT_TZ(lkp.change_implemented_on,'UTC','America/Los_Angeles'),'1970-01-01 00:00:00') <> COALESCE(trgt.change_implemented_on_c,'1970-01-01 00:00:00') then src.sys_id else '' end as failures,
case when COALESCE(CONVERT_TZ(lkp.change_implemented_on,'UTC','America/Los_Angeles'),'1970-01-01 00:00:00') <> COALESCE(trgt.change_implemented_on_c,'1970-01-01 00:00:00') then 1 else 0 end as failures_cnt
