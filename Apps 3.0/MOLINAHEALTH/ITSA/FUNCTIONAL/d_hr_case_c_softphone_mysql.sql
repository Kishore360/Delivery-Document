...
case when COALESCE(src.softphone,'UNSPECIFIED') <> COALESCE(trgt.softphone,'UNSPECIFIED') then src.record_id else '' end as failures,

case when COALESCE(src.softphone,'UNSPECIFIED') <> COALESCE(trgt.softphone,'UNSPECIFIED') then 1 else 0 end as failures_cnt
