...
FROM molinahealth_mdsdb.problem_final SRC  LEFT JOIN molinahealth_mdwdb.d_problem TRGT  ON (SRC.sys_id =TRGT.row_id   AND SRC.sourceinstance= TRGT.source_id  ) WHERE 
