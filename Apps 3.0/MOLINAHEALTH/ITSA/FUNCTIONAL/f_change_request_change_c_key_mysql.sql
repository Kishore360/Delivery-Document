 ...
 ON ( UPPER(u_related_change_request))= LKP.row_id 
 
AND SRC.sourceinstance= LKP.source_id 
 WHERE COALESCE(LKP.row_key,CASE WHEN SRC.u_related_change_request IS NULL THEN 0 else -1 end)<> (TRGT.change_c_key)
