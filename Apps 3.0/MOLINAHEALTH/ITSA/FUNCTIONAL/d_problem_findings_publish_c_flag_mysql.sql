...
left join 
(select sys_id,sourceinstance,sum(timestampdiff(day,convert_tz(state_created_on,'UTC','America/Los_Angeles'),convert_tz(Result_code_created_on,'UTC','America/Los_Angeles'))) as findings_publish_duration
from 
(select
