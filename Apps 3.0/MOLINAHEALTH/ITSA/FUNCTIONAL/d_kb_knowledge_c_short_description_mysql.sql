...
from 
(select 
case when src.short_description is not null then 1 else 0 end as src_not_null_count,

case when trgt.short_description is not null and trgt.short_description <>  'UNSPECIFIED' then 1 else 0 end as trgt_not_null_count,
