SELECT 
-- COALESCE(lkp.row_key,CASE WHEN src.parent IS NULL THEN 0 else -1 end), trgt.parent_c_key
CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_request_item.parent_c_key' ELSE 'SUCCESS' END as Message
