...
FROM molinahealth_mdwdb.d_o_data_freshness WHERE sourcename like 'ServiceNow%'),<<DW_TARGET_TIME_ZONE>>,<<TENANT_SSI_TIME_ZONE>>)then 'Y' else 'N' END),
 (TRGT.over_due_flag )
from
molinahealth_mdsdb.problem_final SRC
LEFT JOIN molinahealth_mdwdb.d_problem TRGT 
