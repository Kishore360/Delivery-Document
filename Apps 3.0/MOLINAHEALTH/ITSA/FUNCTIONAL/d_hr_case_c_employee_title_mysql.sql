...
case when COALESCE(src.employee_title,'UNSPECIFIED') <> COALESCE(trgt.employee_title,'UNSPECIFIED') then src.record_id else '' end as failures,

case when COALESCE(src.employee_title,'UNSPECIFIED') <> COALESCE(trgt.employee_title,'UNSPECIFIED') then 1 else 0 end as failures_cnt
