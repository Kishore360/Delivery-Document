...
case when COALESCE(src.nice_call_record,'UNSPECIFIED') <> COALESCE(trgt.nice_call_record,'UNSPECIFIED') then src.record_id else '' end as failures,

case when COALESCE(src.nice_call_record,'UNSPECIFIED') <> COALESCE(trgt.nice_call_record,'UNSPECIFIED') then 1 else 0 end as failures_cnt
