...
case when COALESCE(CONVERT_TZ(COALESCE(lkp.fulfilled_on,src.closed_at),'UTC','America/Los_Angeles'),'1970-01-01 00:00:00') <> 
coalesce(trgt.fulfilled_on_c,'1970-01-01 00:00:00') then src.sys_id else '' end as failures,

case when COALESCE(CONVERT_TZ(COALESCE(lkp.fulfilled_on,src.closed_at),'UTC','America/Los_Angeles'),'1970-01-01 00:00:00') <>
 coalesce(trgt.fulfilled_on_c,'1970-01-01 00:00:00') then 1 else 0 end as failures_cnt
