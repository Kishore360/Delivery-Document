...
)a where  incident_met_resolution_sla_c_flag  not in ('N') and 
-- could not handle this QA issue condition here, but Checks this condition in 
-- d_incident_met_resolution_flag_Max_Sys_created_on_mysql
   met_resolution_sla_flag<>incident_met_resolution_sla_c_flag)a