...
case when COALESCE(src.first_name,'UNSPECIFIED') <> COALESCE(trgt.employee_first_name,'UNSPECIFIED') then src.record_id else '' end as failures,

case when COALESCE(src.first_name,'UNSPECIFIED') <> COALESCE(trgt.employee_first_name,'UNSPECIFIED') then 1 else 0 end as failures_cnt
