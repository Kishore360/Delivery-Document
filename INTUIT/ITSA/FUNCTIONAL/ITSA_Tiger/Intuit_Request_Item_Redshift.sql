...
select'ldb.d_calendar_date_closed' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_request_item             a11 
join ldb.d_calendar_date_closed      a18
...
select'ldb.d_task_contacttype_req_item_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_request_item             a11 
join ldb.d_task_contacttype_req_item_c      a111
on (a11.reported_type_src_key_c = a111.row_key)
union
...
join ldb.d_internal_contact      a14
on (a11.assigned_to_key = a14.row_key) 
join ldb.d_internal_contact_manager_c      a119
on (a14.manager_key_c = a119.row_key)
union
