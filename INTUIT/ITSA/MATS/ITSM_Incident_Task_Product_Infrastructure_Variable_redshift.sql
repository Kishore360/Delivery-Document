...
select  			'f_incident_task_c' as Table_Name,count(a11.row_key) Row_Count 
from 				ldb.f_incident_task_c a11 
union
select  		'ldb.d_internal_organization_legalentity_incident_c' as Table_Name,count(a11.row_key) Row_Count 
from			ldb.f_incident_task_c	a11
...
select  		'ldb.d_internal_organization_department_incident_c' as Table_Name,count(a11.row_key) Row_Count 
from			ldb.f_incident_task_c	a11
...
select  		'ldb.d_internal_contact_incident_c' as Table_Name,count(a11.row_key) Row_Count 
from			ldb.f_incident_task_c	a11
