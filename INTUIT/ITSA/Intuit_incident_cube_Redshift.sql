...
on (a11.business_service_key_c = a113.row_key)
union
...
on (a11.infrastructure_category_src_key_c = a119.row_key)
union
...
on (a11.opened_by_key_c = a120.row_key)
union
...
on (a11.symptom_src_key_c = a122.row_key)
union
...
on (a16.manager_key_c = a128.row_key)
union
...
on (a11.sub_type_key_c = a130.row_key)
)a
)b