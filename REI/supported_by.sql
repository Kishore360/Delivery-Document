...
FROM (select count(1) as cnt from rei_workdb.d_configuration_item a inner join rei_mdsdb.cmdb_ci_final
...
where
a.supported_by  <> CONCAT_WS(' ',c.first_name, c.last_name) or
a.managed_by  <> CONCAT_WS(' ',d.first_name, d.last_name))c;
