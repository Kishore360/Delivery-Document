...
when b.expense_account_number is null then 

b.expense_account_number="TBD" else 

b.expense_account_number end)
and 

a.u_expense_account_number<> 

b.expense_account_number;
