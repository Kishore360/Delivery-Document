SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 ...
 FROM  mercuryinsurance_mdwdb.d_incident TRGT
   JOIN  mercuryinsurance_mdwdb.f_incident TRGTF 
 ...
 JOIN mercuryinsurance_mdwdb.d_lov_map LM ON TRGTF.state_src_key=LM.src_key AND LM.dimension_class = 'STATE~INCIDENT'
