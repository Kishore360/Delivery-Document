SELECT CASE WHEN cnt > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 ...
 FROM
(
select count(1) as cnt from(SELECT SRC.sys_id,TRGT.row_id, COALESCE( CASE WHEN SRC.caused_by is not null then 'Y' else 'N' END,'')as abc,
COALESCE(TRGT.caused_by_change_flag ,'')as def
