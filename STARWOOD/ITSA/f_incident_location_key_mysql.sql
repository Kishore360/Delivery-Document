...
(SELECT SRC.sys_id,TRGT.row_id,COALESCE(LKP.row_key,CASE WHEN SRC.location IS NULL THEN 0 else '-1' end)abc, COALESCE(TRGT.location_key,'')def
...
LEFT JOIN starwood_mdwdb.d_location LKP 
