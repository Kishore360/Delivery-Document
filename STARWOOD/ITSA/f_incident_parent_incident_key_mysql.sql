...
(SELECT SRC.sys_id,TRGT.row_id,COALESCE(LKP.row_key,CASE WHEN SRC.parent_incident IS NULL THEN 0 else '-1' end)as abc, COALESCE(TRGT.parent_incident_key,'') as def
