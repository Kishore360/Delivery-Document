...
(SELECT SRC.sys_id,TRGT.row_id,COALESCE(LKP.row_key,CASE WHEN SRC.problem_id IS NULL THEN 0 else '-1' end)as abc, COALESCE(TRGT.problem_key,'') as def
...
LEFT JOIN starwood_mdwdb.d_problem LKP 
