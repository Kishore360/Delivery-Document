...
FROM ( select count(1) cnt from weillcornell_mdsdb.incident_final a
inner join weillcornell_mdwdb.f_incident b on a.sys_id=b.row_id and a.sourceinstance=b.source_id and b.row_key <100
left outer join weillcornell_mdwdb.d_lov c on a.u_trouble=c.dimension_code and dimension_class='TROUBLE~INCIDENT'
