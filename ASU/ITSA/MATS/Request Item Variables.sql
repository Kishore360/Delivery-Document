...
on (a11. v_campus = a12.row_key)
 ...
 from  ldb.f_request_item             a11 
left outer join  ldb.d_request_item_variable_u_request_type        a12
...
union
 ...
 from  ldb.f_request_item             a11 
left outer join  ldb.d_request_item_variable_request_type         a12
on (a11. v_request_type = a12.row_key)
union
 select'd_request_item_u_request_category' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_request_item             a11 
left outer join  ldb.d_request_item_variable_u_request_category         a12
