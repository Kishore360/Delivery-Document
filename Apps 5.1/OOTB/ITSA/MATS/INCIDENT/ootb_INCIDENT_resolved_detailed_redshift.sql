 select'f_incident_resolved' as Table_Name, count(1) Row_Count
...
union
select'd_configuration_item' as Table_Name, count(1) Row_Count
from  ldb.f_incident_resolved             a11 
join ldb.d_configuration_item       a13
on (a11.configuration_item_key = a13.row_key)
union
select'd_customer' as Table_Name, count(1) Row_Count
from  ldb.f_incident_resolved             a11 
join ldb.d_customer       a14
on (a11.customer_key = a14.row_key)
union
select'd_customer_mdm' as Table_Name, count(1) Row_Count
from  ldb.f_incident_resolved             a11
join ldb.d_customer       a14
on (a11.customer_key = a14.row_key)
...
union
select'd_domain' as Table_Name, count(1) Row_Count
from  ldb.f_incident_resolved             a11 
join ldb.d_domain       a16
on (a11.domain_key = a16.row_key)
union
select'd_incident' as Table_Name, count(1) Row_Count
from  ldb.f_incident_resolved             a11 
join ldb.d_incident       a17
on (a11.incident_key = a17.row_key)
union
select'd_incident_category' as Table_Name, count(1) Row_Count
from  ldb.f_incident_resolved             a11 
join ldb.d_incident       a17
on (a11.incident_key = a17.row_key)
...
union
select'd_incident_close_code' as Table_Name, count(1) Row_Count
from  ldb.f_incident_resolved             a11 
join ldb.d_incident       a17
on (a11.incident_key = a17.row_key)
...
union
select'd_incident_severity' as Table_Name, count(1) Row_Count
from  ldb.f_incident_resolved             a11 
join ldb.d_incident       a17
on (a11.incident_key = a17.row_key)
...
union
select'd_incident_state' as Table_Name, count(1) Row_Count
from  ldb.f_incident_resolved             a11 
join ldb.d_incident       a17
on (a11.incident_key = a17.row_key)
...
union
select'd_incident_subcategory' as Table_Name, count(1) Row_Count
from  ldb.f_incident_resolved             a11 
join ldb.d_incident       a17
on (a11.incident_key = a17.row_key)
...
on (a11.last_resolved_by_key = a113.row_key)
union
...
from  ldb.f_incident_resolved             a11 
join ldb.d_internal_contact a113 on (a11.last_resolved_by_key=a113.row_key)
...
union
select'd_change_request' as Table_Name, count(1) Row_Count
from  ldb.f_incident_resolved             a11 
join ldb.d_change_request      a125
on (a11.change_request_key = a125.row_key)
union
select'd_change_request_caused_by' as Table_Name, count(1) Row_Count
from  ldb.f_incident_resolved             a11 
...
union
select 'dh_user_group_hierarchy' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
...
union
select 'dh_user_group_level1' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_internal_organization_group a15 
on (a11.assignment_group_key = a15.row_key) 
join ldb.dh_user_group_hierarchy a16 
...
union
select 'dh_user_group_level2' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_internal_organization_group a15 
...
union
select 'dh_user_group_level3' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_internal_organization_group a15 
on (a11.assignment_group_key = a15.row_key) join ldb.dh_user_group_hierarchy a16 
on (a15.row_dn_key = a16.lev_0_key) 
...
union
select 'dh_user_group_level4' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_internal_organization_group a15 
on (a11.assignment_group_key = a15.row_key) join ldb.dh_user_group_hierarchy a16 
on (a15.row_dn_key = a16.lev_0_key) 
...
union
select 'd_business_service' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join	ldb.d_business_service	a12
	  on 	(a11.business_service_key = a12.row_key)
union
select 'd_business_service_criticality' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join	ldb.d_business_service	a12
	  on 	(a11.business_service_key = a12.row_key)
...
union
select 'd_business_service_used_for' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join	ldb.d_business_service	a12
	  on 	(a11.business_service_key = a12.row_key)
...
union 
select 'd_problem' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
...
union
select'd_incident_agebucket' as Table_Name, count(1) Row_Count
from  ldb.f_incident_resolved             a11 
   join          ldb.d_incident_agebucket      a125
                  on          (a11.age_key = a125.row_key)
				  union
				  select'd_employee_location' as Table_Name, count(1) Row_Count
from  ldb.f_incident_resolved             a11
join ldb.d_internal_contact       a113
on (a11.last_resolved_by_key = a113.row_key)
join ldb.d_internal_contact_mdm       a114
