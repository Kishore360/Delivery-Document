...
union
select 'ldb.d_business_service a12 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_business_service a12 
on (a11.business_service_key = a12.row_key)
union
select 'ldb.d_location a12 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_location a12 
on (a11.location_key = a12.row_key)
union
select 'ldb.d_parent_task a12 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
...
union
select 'ldb.d_internal_organization_department a12 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
...
union
select 'ldb.d_internal_contact a17 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_internal_contact a17 
on (a11.assigned_to_key = a17.row_key) 

union
select 'ldb.d_internal_contact_assigned_to a17 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
...
union
select 'ldb.d_task a19 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_task a19 
...
union
select 'ldb.d_task_state a111 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_task a12 on a11.task_key=a12.row_key
join ldb.d_task_state a111 
on (a12.state_src_key = a111.row_key) 
union
select 'ldb.d_task_type a110 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_task a12 on a11.task_key=a12.row_key
join ldb.d_task_type a110 
on (a12.task_type_src_key = a110.row_key) 
union
select 'ldb.d_task_urgency a111 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_task a12 on a11.task_key=a12.row_key
...
union
select 'ldb.d_calendar_week a113 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_calendar_date a14 
on (a11.opened_on_key = a14.row_key) 
...
union
select 'ldb.d_calendar_quarter a114 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_calendar_date a14 
on (a11.opened_on_key = a14.row_key) 
...
union
select 'ldb.d_calendar_year a115 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_calendar_date a14 
on (a11.opened_on_key = a14.row_key) 
...
select 'ldb.d_task_approval a110 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_task a12 on a11.task_key=a12.row_key
join ldb.d_task_approval a110 
on (a12.approval_src_key = a110.row_key) 
union
select 'ldb.d_task_closed_by a111 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_task a12 on a11.task_key=a12.row_key
join ldb.d_task_closed_by a111 
on (a12.closed_by_key = a111.row_key) 
union
select 'ldb.d_task_contacttype a110 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_task a12 on a11.task_key=a12.row_key
join ldb.d_task_contacttype a110 
on (a12.contact_type_src_key = a110.row_key) 
union
select 'ldb.d_task_impact a111 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_task a12 on a11.task_key=a12.row_key
...
union
select 'ldb.d_task_opened_by a111 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_task a12 on a11.task_key=a12.row_key
