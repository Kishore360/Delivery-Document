select 'ldb.f_task a11 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
union
...
union
select 'ldb.d_task a17 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_task a17 
on (a11.task_key = a17.row_key) 
union
select 'ldb.d_parent_task a18 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_task a17 
on (a11.task_key = a17.row_key) 
...
union
select 'ldb.d_application a19 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_application a19 
on (a11.application_key = a19.row_key) 
union
select 'ldb.d_business_service a110 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_business_service a110 
on (a11.business_service_key = a110.row_key) 
union
select 'ldb.d_configuration_item a111 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_configuration_item a111 
on (a11.configuration_item_key = a111.row_key) 
union
select 'ldb.d_internal_contact_mdm a112 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_internal_contact a12 
on (a11.opened_by_key = a12.row_key) 
...
union
select 'ldb.dh_user_group_level1 a114 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_internal_organization_group a14 
...
union
select 'ldb.d_calendar_month a115 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_calendar_date a16 
on (a11.opened_on_key = a16.row_key) 
...
union
select 'ldb.d_task_approval a116 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_task a17 
on (a11.task_key = a17.row_key) 
...
union
select 'ldb.d_task_closed_by a117 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_task a17 
on (a11.task_key = a17.row_key) 
...
union
select 'ldb.d_task_contacttype a118 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_task a17 
on (a11.task_key = a17.row_key) 
...
union
select 'ldb.d_task_impact a119 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_task a17 
on (a11.task_key = a17.row_key) 
...
union
select 'ldb.d_task_opened_by a120 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_task a17 
on (a11.task_key = a17.row_key) 
...
union
select 'ldb.d_task_priority a121 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_task a17 
on (a11.task_key = a17.row_key) 
...
union
select 'ldb.d_task_state a122 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_task a17 
on (a11.task_key = a17.row_key) 
...
union
select 'ldb.d_task_type a123 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_task a17 
on (a11.task_key = a17.row_key) 
...
union
select 'ldb.d_task_urgency a124 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_task a17 
on (a11.task_key = a17.row_key) 
...
union
select 'ldb.dh_user_group_level2 a125 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_internal_organization_group a14 
on (a11.assignment_group_key = a14.row_key) join ldb.dh_user_group_hierarchy a15 
on (a14.row_dn_key = a15.lev_0_key) 
join ldb.dh_user_group_level2 a125 
on (a15.lev_2_key = a125.row_key) 
union
select 'ldb.dh_user_group_level3 a126 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_internal_organization_group a14 
on (a11.assignment_group_key = a14.row_key) join ldb.dh_user_group_hierarchy a15 
on (a14.row_dn_key = a15.lev_0_key) 
join ldb.dh_user_group_level3 a126 
on (a15.lev_3_key = a126.row_key) 
union
select 'ldb.dh_user_group_level4 a127 ' as Table_name, count(1) Row_Count
from ldb.f_task a11 
join ldb.d_internal_organization_group a14 
on (a11.assignment_group_key = a14.row_key) join ldb.dh_user_group_hierarchy a15 
on (a14.row_dn_key = a15.lev_0_key) 
join ldb.dh_user_group_level4 a127 
on (a15.lev_4_key = a127.row_key) 
