...
join ldb.dh_user_group_hierarchy       a16
on (a15.row_dn_key = a16.lev_0_key)
join ldb.dh_user_group_level2       a127
on (a16.lev_2_key = a127.row_key)
union
...
join ldb.dh_user_group_hierarchy       a16
on (a15.row_dn_key = a16.lev_0_key)
join ldb.dh_user_group_level4       a131
on (a16.lev_4_key = a131.row_key)
union
...
on (a17.criticality_key = a122.row_key)
union
...
on (a17.used_for_src_key = a123.row_key)
union
...
on (a110.state_src_key = a126.row_key)
