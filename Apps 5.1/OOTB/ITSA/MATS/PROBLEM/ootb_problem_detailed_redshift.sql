 select'f_problem' as Table_Name, count(1) Row_Count
...
union
select'd_problem_state' as Table_Name, count(1) Row_Count
 from  ldb.f_problem             a11 
join ldb.d_problem_state         a19
on (a11.state_src_key = a19.row_key)
union
select'd_problem_reported_type' as Table_Name, count(1) Row_Count
 from  ldb.f_problem             a11 
join ldb.d_problem_reported_type        a110
on (a11.reported_type_src_key= a110.row_key)
union
select'd_problem_priority' as Table_Name, count(1) Row_Count
 from  ldb.f_problem             a11 
join ldb.d_problem_priority         a111
on (a11.priority_src_key= a111.row_key)
union
select'd_problem_urgency' as Table_Name, count(1) Row_Count
 from  ldb.f_problem             a11 
...
union
select'd_location_assigned_to' as Table_Name, count(1) Row_Count
 from  ldb.f_problem             a11 
...
select'd_location' as Table_Name, count(1) Row_Count
 from  ldb.f_problem             a11 
     join        ldb.d_location   a120
				  ...
				  union
				  select'd_problem_impact' as Table_Name, count(1) Row_Count
 from  ldb.f_problem             a11 
