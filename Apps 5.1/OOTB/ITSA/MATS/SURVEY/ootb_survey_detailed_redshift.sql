select'f_incident_response' as Table_Name, count(1) Row_Count
...
union
select'd_survey_question' as Table_Name, count(1) Row_Count
 from  ldb.f_incident_response             a11 
join ldb.d_survey_question         a110
on (a11.question_key = a110.row_key)
union
select'd_question_type' as Table_Name, count(1) Row_Count
 from  ldb.f_incident_response             a11 
  join ldb.d_survey_question         a110
on (a11.question_key = a110.row_key)
...
union
select'd_survey' as Table_Name, count(1) Row_Count
 from  ldb.f_incident_response             a11 
left outer join ldb.d_survey         a112
on (a11.survey_key = a112.row_key)
union
select'd_survey_instance' as Table_Name, count(1) Row_Count
 from  ldb.f_incident_response             a11 
...
union
select'd_survey_state' as Table_Name, count(1) Row_Count
 from  ldb.f_incident_response             a11 
