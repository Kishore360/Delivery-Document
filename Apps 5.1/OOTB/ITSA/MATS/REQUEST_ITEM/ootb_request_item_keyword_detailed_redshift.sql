...
union
select 'ldb.d_master_item a14 ' as Table_name, count(1) Row_Count
from ldb.f_request_item a11 
join ldb.d_master_item a14 
on (a11.catalog_item_key = a14.row_key) 
union
select 'ldb.d_request_item a15 ' as Table_name, count(1) Row_Count
from ldb.f_request_item a11 
...
union
select 'ldb.d_request a110 ' as Table_name, count(1) Row_Count
from ldb.f_request_item a11 
join ldb.d_request a110 
on (a11.request_key = a110.row_key) 
union
select 'ldb.d_sc_req_item_approval a111 ' as Table_name, count(1) Row_Count
from ldb.f_request_item a11 
join ldb.d_sc_req_item_approval a111 
on (a11.approval_state_src_key = a111.row_key) 
union
select 'ldb.d_request_item_stage a112 ' as Table_name, count(1) Row_Count
from ldb.f_request_item a11 
join ldb.d_request_item_stage a112 
on (a11.stage_src_key = a112.row_key) 
union
select 'ldb.d_request_item_state a113 ' as Table_name, count(1) Row_Count
from ldb.f_request_item a11 
join ldb.d_request_item_state a113 
on (a11.state_src_key = a113.row_key) 
union
select 'ldb.d_internal_contact_requested_for a114 ' as Table_name, count(1) Row_Count
from ldb.f_request_item a11 
join ldb.d_internal_contact_requested_for a114 
on (a11.requested_for_key = a114.row_key) 
union
select 'ldb.d_internal_contact_task_closed_by a115 ' as Table_name, count(1) Row_Count
from ldb.f_request_item a11 
