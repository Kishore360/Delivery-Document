...
union
select 'ldb.d_three_month_rolling a13 ' as Table_name, count(1) Row_Count
from ldb.f_change_request_closed a11 
join ldb.d_calendar_date a12 
on (a11.closed_on_key = a12.row_key) 
...
union
select 'ldb.d_three_week_rolling a16 ' as Table_name, count(1) Row_Count
from ldb.f_change_request_closed a11 
join ldb.d_calendar_date a12 
on (a11.closed_on_key = a12.row_key) 
...
union
select 'ldb.d_change_request_category a17 ' as Table_name, count(1) Row_Count
from ldb.f_change_request_closed a11 
join ldb.d_change_request_category a17 
on (a11.category_src_key = a17.row_key) 
union
select 'ldb.d_change_request_priority a18 ' as Table_name, count(1) Row_Count
from ldb.f_change_request_closed a11 
...
union
select 'ldb.d_change_request_scope a110 ' as Table_name, count(1) Row_Count
from ldb.f_change_request_closed a11 
join ldb.d_change_request_scope a110 
on (a11.scope_src_key = a110.row_key) 
union
select 'ldb.d_change_request_type a111 ' as Table_name, count(1) Row_Count
from ldb.f_change_request_closed a11 
...
union
select 'ldb.d_internal_organization_department a113 ' as Table_name, count(1) Row_Count
from ldb.f_change_request_closed a11 
...
union
select 'ldb.d_calendar_month_three_rolling a115 ' as Table_name, count(1) Row_Count
from ldb.f_change_request_closed a11 
join ldb.d_calendar_date a12 
...
union
select 'ldb.d_calendar_week a116 ' as Table_name, count(1) Row_Count
from ldb.f_change_request_closed a11 
join ldb.d_calendar_date a12 
on (a11.closed_on_key = a12.row_key) 
...
union
select 'ldb.dh_user_group_level1 a117 ' as Table_name, count(1) Row_Count
from ldb.f_change_request_closed a11 
join ldb.d_internal_organization_group a14 
...
union
select 'ldb.d_calendar_week_three_rolling a118 ' as Table_name, count(1) Row_Count
from ldb.f_change_request_closed a11 
join ldb.d_calendar_date a12 
...
union
select 'ldb.dh_user_group_level2 a119 ' as Table_name, count(1) Row_Count
from ldb.f_change_request_closed a11 
join ldb.d_internal_organization_group a14 
on (a11.assignment_group_key = a14.row_key) join ldb.dh_user_group_hierarchy a15 
on (a14.row_dn_key = a15.lev_0_key) 
...
union
select 'ldb.dh_user_group_level3 a120 ' as Table_name, count(1) Row_Count
from ldb.f_change_request_closed a11 
join ldb.d_internal_organization_group a14 
on (a11.assignment_group_key = a14.row_key) join ldb.dh_user_group_hierarchy a15 
on (a14.row_dn_key = a15.lev_0_key) 
...
union
select 'ldb.dh_user_group_level4 a121 ' as Table_name, count(1) Row_Count
from ldb.f_change_request_closed a11 
join ldb.d_internal_organization_group a14 
on (a11.assignment_group_key = a14.row_key) join ldb.dh_user_group_hierarchy a15 
on (a14.row_dn_key = a15.lev_0_key) 
