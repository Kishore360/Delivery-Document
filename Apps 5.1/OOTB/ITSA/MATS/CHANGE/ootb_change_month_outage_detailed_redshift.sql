select 'ldb.f_change_request_outage' as Table_Name, count(1) Row_Count
...
on (a11.change_request_configuration_item_key = a16.row_key)
union
...
on (a16.outage_type_src_key = a17.row_key)
