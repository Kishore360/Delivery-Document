select 'ldb.f_request_task_closed a11 ' as Table_name, count(1) Row_Count
...
union
select 'ldb.d_request_task a15 ' as Table_name, count(1) Row_Count
from ldb.f_request_task_closed a11 
...
union
select 'ldb.d_request_item a19 ' as Table_name, count(1) Row_Count
from ldb.f_request_task_closed a11 
