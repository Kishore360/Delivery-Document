...
JOIN schneider_mdwdb.ctm_people_final_Organization lkp ON COALESCE(CONCAT('DEPARTMENT~',SRC.department),'UNSPECIFIED')  = lkp.row_id and SRC.sourceinstance = lkp.source_id 
