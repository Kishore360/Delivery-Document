...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for d_task_sla.sla_category' ELSE 'SUCCESS' END as Message from schneider_mdsdb.SLM_Measurement SRC
