SELECT CASE WHEN cnt > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN cnt >0 THEN 'MDS to DWH data validation failed for d_nessus_vuln_incidents_c.isresolved ' ELSE 'SUCCESS' END as Message
 ...
 where case when src.isresolved = '1' then 'Y' ELSE 'N' end<>trgt.isresolved)ma	;
