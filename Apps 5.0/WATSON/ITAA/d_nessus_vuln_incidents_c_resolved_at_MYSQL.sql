SELECT CASE WHEN cnt > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN cnt >0 THEN 'MDS to DWH data validation failed for d_nessus_vuln_incidents_c.resolved_at ' ELSE 'SUCCESS' END as Message
 ...
 where left(src.resolvedat,19)<>trgt.resolved_at)ma	;
