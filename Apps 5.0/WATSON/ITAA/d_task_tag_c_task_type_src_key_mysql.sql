...
on d.row_id = COALESCE(CONCAT('TASK_TYPE~TASK~~~',e.sys_class_name),'UNSPECIFIED')

where
a.task_type_src_key <> COALESCE(d.row_key,CASE WHEN e.sys_class_name IS NULL THEN 0 else -1 end);