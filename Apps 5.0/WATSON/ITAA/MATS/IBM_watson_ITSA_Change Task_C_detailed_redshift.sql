...
on (a13.approval_src_key = a121.row_key)
union
...
on (a13.reported_type_src_key = a122.row_key)
union
...
on (a13.impact_src_key = a123.row_key)
union
...
on (a13.priority_src_key = a124.row_key)
union
...
on (a13.state_src_key = a125.row_key)
union
...
on (a13.task_type_src_key = a126.row_key)
union
...
on (a13.urgency_src_key = a127.row_key)