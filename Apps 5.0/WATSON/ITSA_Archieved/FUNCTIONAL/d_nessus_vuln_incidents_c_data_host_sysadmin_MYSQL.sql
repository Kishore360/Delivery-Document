SELECT CASE WHEN cnt > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN cnt >0 THEN 'MDS to DWH data validation failed for d_nessus_vuln_incidents_c.data_host_sysadmin ' ELSE 'SUCCESS' END as Message
 ...
 where src.data_host_sysadmin<>trgt.data_host_sysadmin)ma	;
