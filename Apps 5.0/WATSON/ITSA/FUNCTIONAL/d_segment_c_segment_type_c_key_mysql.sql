...
JOIN watson_mdsdb.u_segment_final b on  a.row_id = b.sys_id and a.source_id = b.sourceinstance
left join watson_mdwdb.d_lov d on concat('TYPE~SEGMENT~~~',u_type)=d.row_id and dimension_class ='TYPE~SEGMENT'
 where
