SELECT CASE WHEN cnt > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN cnt >0 THEN 'MDS to DWH data validation failed for d_problem.rca_status_c ' ELSE 'SUCCESS' END as Message
 ...
 where src.u_rca_status<>trgt.rca_status_c )ma