...
union
select 'ldb.d_environment_c a127 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_environment_c a127 
on (a11.environment_c_key = a127.row_key) 
union
...
union
select 'ldb.d_change_request_service_owner_c a134 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a18 
on (a11.change_request_key = a18.row_key) 
join ldb.d_change_request_service_owner_c a134 
on (a18.service_owner_c_key = a134.row_key) 
union
...
on (a17.quarter_start_date_key = a136.row_key) 
union
...
on (a17.year_start_date_key = a138.row_key) 
