...
from ldb.f_problem_state_row_count, activity  a11
join ldb.d_calendar_date  a12
on (a11.state_on_key = a12.row_key)
...
union
select 'ldb.d_problem_from_state a19' as Table_name, count(1) Row_Count
from ldb.f_problem_state_activity  a11
join ldb.d_problem_from_state a19
on (a11.from_state_key = a19.row_key)
union
select 'ldb.d_problem_impact  a110' as Table_name, count(1) Row_Count
from ldb.f_problem_state_activity  a11
join ldb.d_problem_impact  a110
on  (a11.impact_src_key = a110.row_key)
union
select 'ldb.d_problem_priority   a111' as Table_name, count(1) Row_Count
from ldb.f_problem_state_activity  a11
join ldb.d_problem_priority   a111
on (a11.priority_src_key = a111.row_key)
union
select 'ldb.d_problem_to_state  a112' as Table_name, count(1) Row_Count
from ldb.f_problem_state_activity  a11
join ldb.d_problem_to_state  a112
on (a11.to_state_key = a112.row_key)
union
select 'ldb.d_problem_urgency  a113' as Table_name, count(1) Row_Count
from ldb.f_problem_state_activity  a11
