...
from ldb.f_outage_c a11 
join ldb.d_change_request_outage_c a110 
...
union
select 'ldb.d_lov_incident_symptom_c a112 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_outage_c a11 
join ldb.d_lov_incident_symptom_c a112 
...
on (a12.week_start_date_key = a114.row_key) 
union
select 'ldb.d_incident_close_code a115 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_outage_c a11 
join ldb.d_incident a16 
on (a11.incident_key = a16.row_key) 
join ldb.d_incident_close_code a115 
on (a16.close_code_src_key = a115.row_key) 
union
...
on (a16.priority_src_key = a116.row_key) 
union
...
on (a12.year_start_date_key = a118.row_key) 