...
union
select 'ldb.d_incident_variable_scope_of_work_c a12 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_task_c a11 
join ldb.d_incident_variable_scope_of_work_c a12 
on (a11.incident_key = a12.row_key) 
union
select 'ldb.d_incident_variable_work_window_c a13 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_task_c a11 
join ldb.d_incident_variable_work_window_c a13 
on (a11.incident_key = a13.row_key) 
union
select 'ldb.d_internal_organization_legalentity_incident_c a14 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_task_c a11 
join ldb.d_internal_organization_legalentity_incident_c a14 
on (a11.incident_company_key = a14.row_key) 
union
...
union
select 'ldb.d_internal_contact_incident_c a17 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_task_c a11 
join ldb.d_internal_contact_incident_c a17 
on (a11.incident_opened_by_key = a17.row_key) 
union
select 'ldb.d_incident_variable_asset_tag_c a18 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_task_c a11 
join ldb.d_incident_variable_asset_tag_c a18 
on (a11.incident_key = a18.row_key) 
union
select 'ldb.dh_user_group_classification_hierarchy a19 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_task_c a11 
join ldb.dh_user_group_classification_hierarchy a19 
on (a11.assignment_group_key = a19.user_group_key) 
union
select 'ldb.dh_user_group_classification_hierarchy_level1 a110 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_task_c a11 
join ldb.dh_user_group_classification_hierarchy a19 
on (a11.assignment_group_key = a19.user_group_key) 
...
union
select 'ldb.dh_user_group_classification_hierarchy_incident_c a111 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_task_c a11 
join ldb.dh_user_group_classification_hierarchy_incident_c a111 
on (a11.incident_assignment_group_key = a111.user_group_key) 
union
select 'ldb.dh_user_group_classification_hierarchy_level1_incident_c a112 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_task_c a11 
join ldb.dh_user_group_classification_hierarchy_incident_c a111 
on (a11.incident_assignment_group_key = a111.user_group_key) 
join ldb.dh_user_group_classification_hierarchy_level1_incident_c a112 
on (a111.user_group_classification_level1 = a112.user_group_level1_key) 
union
...
union
select 'ldb.d_incident_variable_date_time_c a115 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_task_c a11 
join ldb.d_incident_variable_date_time_c a115 
on (a11.incident_key = a115.row_key) 
union
select 'ldb.d_calendar_date_incident a116 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_task_c a11 
join ldb.d_calendar_date_incident a116 
on (a11.incident_opened_on_key = a116.row_key) 
union
...
union
select 'ldb.d_variable_lov_c_data_center_c a124 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_task_c a11 
join ldb.d_variable_lov_c_data_center_c a124 
...
on (a17.row_current_key = a127.row_current_key) 
union
select 'ldb.d_lov_incident_task_state_c a128 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_task_c a11 
join ldb.d_lov_incident_task_state_c a128 
on (a11.state_src_key = a128.row_key) 
union
select 'ldb.d_party a129 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_task_c a11 
join ldb.d_party a129 
on (a11.primary_contact = a129.row_key) 
union
select 'ldb.d_task_priority_incident_c a130 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_task_c a11 
join ldb.d_task_priority_incident_c a130 
on (a11.incident_priority_src_key = a130.row_key) 
union
select 'ldb.d_incident_sub_type_c a131 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_task_c a11 
join ldb.d_incident_sub_type_c a131 
on (a11.sub_type_c_key = a131.row_key) 
union
select 'ldb.d_lov_incident_symptom_c a132 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_task_c a11 
join ldb.d_lov_incident_symptom_c a132 
on (a11.incident_symptom_src_c_key = a132.row_key) 
union
...
on (a114.month_start_date_key = a133.row_key) 
union
...
on (a114.week_start_date_key = a134.row_key) 
union
...
on (a117.priority_src_key = a135.row_key) 
union
...
on (a117.state_src_key = a136.row_key) 
union
select 'ldb.d_incident_task_close_code_c a137 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_task_c a11 
join ldb.d_incident_task_close_code_c a137 
on (a11.close_code_src_key = a137.row_key) 
union
...
on (a114.quarter_start_date_key = a138.row_key) 
union
