...
from bhn_mdwdb.d_lov lov where  source_id=2 and dimension_class 
not in (select class_value from bhn_workdb.lsm_ls_system_variables where enable_flag='Y'  )  and dimension_class 
