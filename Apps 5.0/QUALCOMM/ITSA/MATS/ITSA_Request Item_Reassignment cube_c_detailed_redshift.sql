...
select 'ldb.f_request_item_activity_c a11 ' as Table_name, count(1) Row_Count
...
on (a11.current_assigned_to_key = a12.row_key) 
union
...
union
select 'ldb.d_sc_req_item_priority a110 ' as Table_name, count(1) Row_Count
from ldb.f_request_item_activity_c a11 
join ldb.d_sc_req_item_priority a110 
on (a11.priority_src_key = a110.row_key) 
union
select 'ldb.d_request_item_state a111 ' as Table_name, count(1) Row_Count
from ldb.f_request_item_activity_c a11 
join ldb.d_request_item_state a111 
on (a11.current_state_src_key = a111.row_key) 
union
