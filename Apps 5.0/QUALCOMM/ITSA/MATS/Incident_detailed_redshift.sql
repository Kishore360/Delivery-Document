...
union
select 'ldb.d_incident_opened_by a112 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_incident a12 
on (a11.incident_key = a12.row_key) 
join ldb.d_incident_opened_by a112 
...
on (a19.quarter_start_date_key = a114.row_key) 
union
...
on (a19.year_start_date_key = a116.row_key) 
union
...
on (a12.parent_incident_key = a117.row_key) 
union
...
on (a14.department_key = a121.row_key) 
union
...
union
select 'ldb.d_internal_contact_u_initiator_c a128 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_contact_u_initiator_c a128 
on (a11.u_initiator_c_key = a128.row_key) 
union
...
union
select 'ldb.d_lov_incident_u_subcataction_c a130 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_incident a12 
on (a11.incident_key = a12.row_key) 
join ldb.d_lov_incident_u_subcataction_c a130 
on (a12.u_subcataction_c_key = a130.row_key) 
union
...
on (a18.criticality_key = a131.row_key) 
union
...
on (a18.used_for_src_key = a132.row_key) 
union
...
on (a12.category_src_key = a133.row_key) 
union
...
on (a12.close_code_src_key = a134.row_key) 
union
select 'ldb.d_incident_closed_by a135 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_incident a12 
on (a11.incident_key = a12.row_key) 
join ldb.d_incident_closed_by a135 
on (a12.closed_by_key = a135.row_key) 
union
...
on (a12.met_resolution_sla_flag_key = a137.row_key) 
union
...
on (a12.resolved_by_key = a138.row_key) 
union
...
union
select 'ldb.o_data_freshness a143 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_calendar_date a19 
on (a11.opened_on_key = a19.row_key) 
join ldb.o_data_freshness a143 
on (a19.source_id = a143.source_id) 
union
select 'ldb.d_internal_contact_employee_manager_c a144 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_incident a12 
on (a11.incident_key = a12.row_key) join ldb.d_incident_opened_by a112 
on (a12.opened_by_key = a112.row_key) 
