...
union
select 'ldb.d_internal_contact_request_item_requested_for_c a114 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_request_item a11 
join ldb.d_internal_contact_request_item_requested_for_c a114 
...
union
select 'ldb.d_internal_contact_request_item_opened_by_c a126 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_request_item a11 
join ldb.d_request_item a18 
on (a11.request_item_key = a18.row_key) 
join ldb.d_internal_contact_request_item_opened_by_c a126 
on (a18.opened_by_key = a126.row_key) 
union
...
on (a19.location_key = a127.row_key) 
union
