...
union
select 'ldb.d_project_parent_project a14 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) 
...
union
select 'ldb.d_project_top_project a15 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) 
...
from ldb.f_project_task a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) join ldb.d_project_top_project a15 
on (a12.top_project_key = a15.row_key) 
...
union
select 'ldb.d_internal_contact_project_manager a116 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task a11 
join ldb.d_internal_contact_project_manager a116 
on (a11.project_manager_key = a116.row_key) 
union
select 'ldb.d_lov_project_weeks_to_due_date_bucket_view a117 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task a11 
join ldb.d_lov_project_weeks_to_due_date_bucket_view a117 
on (a11.weeks_to_due_date_bucket_key = a117.row_key) 
union
...
union
select 'ldb.d_lov_project_approval_view a121 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) 
join ldb.d_lov_project_approval_view a121 
on (a12.project_approval_src_key = a121.row_key) 
union
select 'ldb.d_lov_project_contact_type_view a122 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) 
join ldb.d_lov_project_contact_type_view a122 
on (a12.project_contact_type_src_key = a122.row_key) 
union
select 'ldb.d_lov_project_escalation_view a123 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) 
join ldb.d_lov_project_escalation_view a123 
on (a12.project_escalation_src_key = a123.row_key) 
union
select 'ldb.d_lov_project_impact_view a124 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) 
join ldb.d_lov_project_impact_view a124 
on (a12.project_impact_src_key = a124.row_key) 
union
select 'ldb.d_lov_project_phase_view a125 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) 
join ldb.d_lov_project_phase_view a125 
on (a12.project_phase_src_key = a125.row_key) 
union
select 'ldb.d_lov_project_phase_type_view a126 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) 
join ldb.d_lov_project_phase_type_view a126 
on (a12.project_phase_type_src_key = a126.row_key) 
union
select 'ldb.d_lov_project_priority_view a127 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) 
join ldb.d_lov_project_priority_view a127 
on (a12.project_priority_src_key = a127.row_key) 
union
select 'ldb.d_lov_project_risk_view a128 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) 
join ldb.d_lov_project_risk_view a128 
on (a12.project_risk_src_key = a128.row_key) 
union
...
union
select 'ldb.d_lov_project_urgency_view a129 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) 
join ldb.d_lov_project_urgency_view a129 
on (a12.project_urgency_src_key = a129.row_key) 
union
...
union
select 'ldb.d_lov_portfolio_category_view a131 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) join ldb.d_project_top_project a15 
on (a12.top_project_key = a15.row_key) join ldb.d_portfolio a16 
on (a15.portfolio_key = a16.row_key) 
join ldb.d_lov_portfolio_category_view a131 
on (a16.portfolio_category_src_key = a131.row_key)