select 'ldb.f_project_task_current_year a11 ' as Table_name, count(a11.row_key) Row_Count
...
union
select 'ldb.d_lov_project_risk_bucket_view a117 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task_current_year a11 
join ldb.d_lov_project_risk_bucket_view a117 
on (a11.project_risk_color_key = a117.row_key) 
union
select 'ldb.d_lov_project_schedule_variance_bucket_view a118 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task_current_year a11 
join ldb.d_lov_project_schedule_variance_bucket_view a118 
on (a11.schedule_variance_color_key = a118.row_key) 
union
select 'ldb.d_lov_project_approval_view a119 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task_current_year a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) 
...
union
select 'ldb.d_lov_project_contact_type_view a120 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task_current_year a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) 
...
union
select 'ldb.d_lov_project_escalation_view a121 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task_current_year a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) 
...
union
select 'ldb.d_lov_project_impact_view a122 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task_current_year a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) 
...
union
select 'ldb.d_lov_project_phase_view a123 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task_current_year a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) 
...
union
select 'ldb.d_lov_project_phase_type_view a124 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task_current_year a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) 
...
union
select 'ldb.d_lov_project_priority_view a125 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task_current_year a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) 
...
union
select 'ldb.d_lov_project_risk_view a126 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task_current_year a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) 
...
union
select 'ldb.d_lov_project_urgency_view a127 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task_current_year a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) 
...
union
select 'ldb.d_lov_portfolio_category_view a128 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_project_task_current_year a11 
join ldb.d_project a12 
on (a11.project_key = a12.row_key) join ldb.d_project_top_project a15 
