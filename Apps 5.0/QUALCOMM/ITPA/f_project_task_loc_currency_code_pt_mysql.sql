...
SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_project_task.loc_currency_code' ELSE 'SUCCESS' END as Message
 ...
 WHERE COALESCE( FI.currency ,'')<> COALESCE(TRGT.loc_currency_code ,'')
