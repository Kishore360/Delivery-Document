...
union									
select 'ldb.d_request_item a16 ' as Table_name, count(1) Row_Count									
from ldb.f_request_task a11 									
join ldb.d_request_item a16 									
on (a11.request_item_key = a16.row_key) 									
union									
select 'ldb.d_request_task a17 ' as Table_name, count(1) Row_Count									
from ldb.f_request_task a11 									
...
union									
select 'ldb.d_lov_request_item_employee_type_c a112 ' as Table_name, count(1) Row_Count									
from ldb.f_request_task a11 									
join ldb.d_internal_contact_employee_type_c a13 									
on (a11.opened_by_key = a13.row_key) 									
...
union									
select 'ldb.d_sc_task_priority a113 ' as Table_name, count(1) Row_Count									
from ldb.f_request_task a11 									
join ldb.d_sc_task_priority a113 									
on (a11.priority_src_key = a113.row_key) 									
union									
select 'ldb.d_sc_task_state a114 ' as Table_name, count(1) Row_Count									
from ldb.f_request_task a11 									
...
union									
select 'ldb.d_internal_organization_group_parent_c a116 ' as Table_name, count(1) Row_Count									
from ldb.f_request_task a11 									
join ldb.d_internal_organization_group a15 									
on (a11.assignment_group_key = a15.row_key) 									
...
union									
select 'ldb.d_calendar_week a118 ' as Table_name, count(1) Row_Count									
from ldb.f_request_task a11 									
join ldb.d_calendar_date a14 									
on (a11.opened_on_key = a14.row_key) 									
