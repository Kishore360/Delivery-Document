select'f_request_item_response_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_request_item_response_c             a11 
 union
...
join ldb.d_calendar_date         a12
on (a11.requested_on_key = a12.row_key)
left join ldb.d_calendar_month        a13
...
select'd_task_survey_completed_on_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_request_item_response_c             a11 
left outer join ldb.d_task_survey_completed_on_c         a113
on (a11.completed_on_key= a113.row_key)
union
