SELECT 'ldb.f_hr_case' as TABLE_NAME, COUNT(a11.row_key) AS ROW_COUNT 
FROM ldb.f_hr_case a11
UNION 
...
FROM ldb.f_hr_case a11
JOIN ldb.d_internal_contact a19 ON (a11.opened_by_key = a19.row_key)
UNION 
