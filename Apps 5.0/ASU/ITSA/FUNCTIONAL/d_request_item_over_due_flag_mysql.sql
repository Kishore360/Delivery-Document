...
FROM asu_mdwdb.d_request_item REQ_ITM 
join asu_mdwdb.f_request_item f ON( REQ_ITM.row_key = f.request_item_key )
JOIN asu_mdwdb.d_lov_map br ON (f.state_src_key = br.src_key AND br.dimension_wh_code = 'OPEN')
