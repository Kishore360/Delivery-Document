...
FROM asu_mdwdb.d_problem_task PRB_TSK
JOIN asu_mdwdb.f_problem_task TRGT ON PRB_TSK.row_key=TRGT.problem_task_key
JOIN asu_mdwdb.d_lov_map LKP ON TRGT.state_src_key=LKP.row_key AND LKP.dimension_wh_code='OPEN'
