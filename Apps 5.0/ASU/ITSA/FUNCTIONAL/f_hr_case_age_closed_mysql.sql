...
where timestampdiff(second,convert_tz(convert_tz(SRC.opened_at,'GMT','US/Mountain'),'US/Mountain','GMT'),  
convert_tz(convert_tz(SRC.closed_at,'GMT','US/Mountain'),'US/Mountain','GMT'))<>f.age
OR f.age IS NULL
)A
