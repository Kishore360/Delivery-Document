...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for f_time_card.state_src_code' ELSE 'SUCCESS' END as Message 
...
WHERE COALESCE(SRC.STATE,'UNSPECIFIED') <> TRGT.state_src_code; 