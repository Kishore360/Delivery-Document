...
union
select 'ldb.dh_employee_level2 a118 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_time_card a11 
join ldb.d_internal_contact a12 
on (a11.employee_key = a12.row_key) join ldb.dh_employee_hierarchy a14 
on (a12.row_current_key = a14.lev_0_key) 
...
union
select 'ldb.dh_employee_level3 a120 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_time_card a11 
join ldb.d_internal_contact a12 
on (a11.employee_key = a12.row_key) join ldb.dh_employee_hierarchy a14 
on (a12.row_current_key = a14.lev_0_key) 
...
union
select 'ldb.dh_employee_level4 a121 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_time_card a11 
join ldb.d_internal_contact a12 
on (a11.employee_key = a12.row_key) join ldb.dh_employee_hierarchy a14 
on (a12.row_current_key = a14.lev_0_key) 
...
union
select 'ldb.dh_employee_level5 a122 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_time_card a11 
join ldb.d_internal_contact a12 
on (a11.employee_key = a12.row_key) join ldb.dh_employee_hierarchy a14 
on (a12.row_current_key = a14.lev_0_key) 
