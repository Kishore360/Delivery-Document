...
union
select 'ldb.d_lov_change_environment_c a124 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a12 
on (a11.change_request_key = a12.row_key) 
join ldb.d_lov_change_environment_c a124 
on (a12.change_environment_src_c_key = a124.row_key) 
union
select 'ldb.d_lov_change_is_application_outage_required_c a125 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a12 
on (a11.change_request_key = a12.row_key) 
join ldb.d_lov_change_is_application_outage_required_c a125 
on (a12.is_application_outage_required_src_c_key = a125.row_key) 
union
...
union
select 'ldb.d_change_request_close_code a131 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a12 
on (a11.change_request_key = a12.row_key) 
join ldb.d_change_request_close_code a131 
on (a12.close_code_src_key = a131.row_key) 
union
