...
union
select 'ldb.d_lov_assigneepriorchanges_bucket_c a111 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_lov_assigneepriorchanges_bucket_c a111 
on (a11.assigneepriorchanges_bucket_c_key = a111.row_key) 
union
select 'ldb.d_lov_assigneepriorfailurerate_bucket_c a112 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_lov_assigneepriorfailurerate_bucket_c a112 
on (a11.assigneepriorfailurerate_bucket_c_key = a112.row_key) 
union
...
on (a11.bu_oversight_group_c_key = a113.row_key) 
union
...
union
select 'ldb.d_internal_organization_creating_group_c a125 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_internal_organization_creating_group_c a125 
on (a11.creating_group_c_key = a125.row_key) 
union
...
on (a13.row_current_key = a128.row_current_key) 
union
select 'ldb.d_lov_change_environment_c a129 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a12 
on (a11.change_request_key = a12.row_key) 
join ldb.d_lov_change_environment_c a129 
on (a12.change_environment_src_c_key = a129.row_key) 
union
...
on (a12.is_application_outage_required_src_c_key = a131.row_key) 
union
...
union
select 'ldb.d_internal_contact_programmer_c a134 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_internal_contact_programmer_c a134 
on (a11.programmer_c_key = a134.row_key) 
union
select 'ldb.d_internal_organization_requesting_group_c a135 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_internal_organization_requesting_group_c a135 
on (a11.requesting_group_c_key = a135.row_key) 
union
...
on (a12.close_code_src_key = a140.row_key) 
union
...
on (a12.change_trigger_src_c_key = a141.row_key) 
union
select 'ldb.d_lov_change_environment_details_c a142 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a12 
on (a11.change_request_key = a12.row_key) 
join ldb.d_lov_change_environment_details_c a142 
on (a12.environment_details_src_c_key = a142.row_key) 
union
select 'ldb.d_lov_change_impact_continuity_plan_c a143 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a12 
on (a11.change_request_key = a12.row_key) 
join ldb.d_lov_change_impact_continuity_plan_c a143 
on (a12.impact_continuity_plan_src_c_key = a143.row_key) 
union
select 'ldb.d_lov_change_impact_availability_plan_c a144 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a12 
on (a11.change_request_key = a12.row_key) 
join ldb.d_lov_change_impact_availability_plan_c a144 
on (a12.impact_availability_plan_src_c_key = a144.row_key) 
union
select 'ldb.d_lov_change_server_outage_c a145 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a12 
on (a11.change_request_key = a12.row_key) 
join ldb.d_lov_change_server_outage_c a145 
on (a12.server_outage_src_c_key = a145.row_key) 
union
select 'ldb.d_lov_change_mf_online_inst_newcopy_met_c a146 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a12 
on (a11.change_request_key = a12.row_key) 
join ldb.d_lov_change_mf_online_inst_newcopy_met_c a146 
on (a12.mf_online_inst_newcopy_met_src_c_key = a146.row_key) 
union
select 'ldb.d_lov_change_outage_type_c a147 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a12 
on (a11.change_request_key = a12.row_key) 
join ldb.d_lov_change_outage_type_c a147 
on (a12.outage_type_src_c_key = a147.row_key) 
union
select 'ldb.d_lov_change_reason_for_application_outage_c a148 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a12 
on (a11.change_request_key = a12.row_key) 
join ldb.d_lov_change_reason_for_application_outage_c a148 
on (a12.reason_for_application_outage_src_c_key = a148.row_key) 
union
select 'ldb.d_lov_change_sub_category_c a149 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a12 
on (a11.change_request_key = a12.row_key) 
join ldb.d_lov_change_sub_category_c a149 
on (a12.sub_category_src_c_key = a149.row_key) 
union
...
on (a17.quarter_start_date_key = a150.row_key) 
union
...
on (a17.year_start_date_key = a151.row_key) 
