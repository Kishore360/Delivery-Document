select 'ldb.f_incident_resolved a11 ' as Table_name, count(1) Row_Count
...
union
select 'ldb.d_business_service a15 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_business_service a15 
on (a11.business_service_key = a15.row_key) 
union
select 'ldb.d_calendar_date a16 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
...
union
select 'ldb.d_internal_contact_opened_by_c a19 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_internal_contact_opened_by_c a19 
on (a11.last_resolved_by_key = a19.row_key) 
union
...
union
select 'ldb.d_internal_contact_assigned_to a111 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_internal_contact_assigned_to a111 
on (a11.assigned_to_key = a111.row_key) 
union
select 'ldb.d_change_request_caused_by a112 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_change_request_caused_by a112 
on (a11.caused_by_change_key = a112.row_key) 
union
select 'ldb.d_change_request a113 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
...
union
select 'ldb.d_internal_organization_department a116 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_internal_contact a12
on a12.row_key=a11.last_resolved_by_key
join ldb.d_internal_organization_department a117 									
on (a12.department_key= a117.row_key) 
union
select 'ldb.d_internal_contact_mdm a117 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_internal_contact a13 
on (a11.last_resolved_by_key = a13.row_key) 
...
union
select 'ldb.d_calendar_time_hour a118 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_calendar_time a14 
on (a11.opened_time_key = a14.row_key) 
...
union
select 'ldb.d_incident_agebucket a119 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_incident_agebucket a119 
on (a11.age_key = a119.row_key) 
union
select 'ldb.d_lov_incident_method_of_contact_c a120 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_lov_incident_method_of_contact_c a120 
on (a11.method_of_contact_c_key = a120.row_key) 
union
select 'ldb.d_flag_c a121 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_flag_c a121 
on (a11.sd_touch_flag_c_key = a121.row_key) 
union
select 'ldb.d_lov_incident_service_type_c a122 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_lov_incident_service_type_c a122 
on (a11.service_type_c_key = a122.row_key) 
union
select 'ldb.d_lov_incident_resolver_department_c a123 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_lov_incident_resolver_department_c a123 
on (a11.resolver_department_c_key = a123.row_key) 
union
select 'ldb.d_incident_impact a124 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_incident_impact a124 
on (a11.impact_src_key = a124.row_key) 
union
select 'ldb.d_location a125 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
...
union
select 'ldb.d_incident_contacttype a127 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_incident_contacttype a127 
on (a11.reported_type_src_key = a127.row_key) 
union
select 'ldb.d_incident_urgency a128 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_incident_urgency a128 
on (a11.urgency_src_key = a128.row_key) 
union
select 'ldb.d_lov_incident_type_c a129 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_lov_incident_type_c a129 
on (a11.type_c_key = a129.row_key) 
union
select 'ldb.d_lov_incident_who_is_affected_c a130 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
...
union
select 'ldb.d_business_service_used_for a132 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_business_service a15 
on (a11.business_service_key = a15.row_key) 
...
union
select 'ldb.d_incident_category a133 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_incident a17 
on (a11.incident_key = a17.row_key) 
...
union
select 'ldb.d_incident_close_code a134 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_incident a17 
on (a11.incident_key = a17.row_key) 
...
union
select 'ldb.d_incident_severity a135 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_incident a17 
on (a11.incident_key = a17.row_key) 
...
union
select 'ldb.d_incident_state a136 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_incident a17 
on (a11.incident_key = a17.row_key) 
...
union
select 'ldb.d_incident_subcategory a137 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_incident a17 
on (a11.incident_key = a17.row_key) 
...
union
select 'ldb.d_internal_organization_group_parent_c a138 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_internal_organization_group a110 
on (a11.assignment_group_key = a110.row_key) 
...
union
select 'ldb.d_calendar_month a139 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_calendar_date a16 
on (a11.last_resolved_on_key = a16.row_key) 
...
union
select 'ldb.d_calendar_week a140 ' as Table_name, count(1) Row_Count
from ldb.f_incident_resolved a11 
join ldb.d_calendar_date a16 
on (a11.last_resolved_on_key = a16.row_key) 
