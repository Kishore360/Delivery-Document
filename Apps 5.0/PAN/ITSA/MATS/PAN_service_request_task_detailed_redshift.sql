...
union
select 'ldb.d_internal_contact_closed_by_c a19 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_sr_task_c a11 
...
union
select 'ldb.d_lov_service_request_category_c a112 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_sr_task_c a11 
join ldb.d_service_request_c a14 
on (a11.service_request_c_key = a14.row_key) 
...
on (a13.quarter_start_date_key = a119.row_key) 
union
