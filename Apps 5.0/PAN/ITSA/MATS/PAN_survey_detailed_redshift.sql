...
union
select 'ldb.d_survey_question a18 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_response a11 
...
union
select 'ldb.d_survey_instance a115 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_response a11 
...
on (a17.parent_row_key_c = a119.row_key) 
union
select 'ldb.d_question_type a120 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_response a11 
join ldb.d_survey_question a18 
on (a11.question_key = a18.row_key) 
...
on (a14.year_start_date_key = a122.row_key) 