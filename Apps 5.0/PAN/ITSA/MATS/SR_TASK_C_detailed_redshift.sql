...
union
select 'ldb.d_sr_task_c a16 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_sr_task_c a11 
...
union
select 'ldb.d_duration_c a113 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_sr_task_c a11 
...
union
select 'ldb.d_lov_service_request_category_c a116 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_sr_task_c a11 
join ldb.d_service_request_c a15 
on (a11.service_request_c_key = a15.row_key) 
...
union
select 'ldb.d_internal_organization_dpt_c a117 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_sr_task_c a11 
join ldb.d_sr_task_c a16 
on (a11.sr_task_c_key = a16.row_key) 
...
union
select 'ldb.d_calendar_fiscal_year a118 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_sr_task_c a11 
join ldb.d_calendar_date_fiscal a13 
on (a11.opened_on_key = a13.row_key) 
