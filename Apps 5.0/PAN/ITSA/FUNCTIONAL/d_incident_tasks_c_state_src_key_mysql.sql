...
LEFT JOIN pan_mdwdb.d_lov LKP 
 ...
 WHERE LKP.soft_deleted_flag='N' and TRGT.soft_deleted_flag='N' and  COALESCE(LKP.row_key,CASE WHEN SRC.state IS NULL THEN 0 else '-1' end)<> COALESCE(TRGT.state_src_key,'')