...
(select sys_id, sourceinstance, contact_type from pan_mdsdb.u_service_request_final where cdctype<>'D') s 

left join  pan_mdwdb.f_service_request_c  t
on s.sys_id=t.row_id and s.sourceinstance = t.source_id 

LEFT JOIN (select row_id,source_id, row_key from pan_mdwdb.d_lov where soft_deleted_flag<>'Y') l  
