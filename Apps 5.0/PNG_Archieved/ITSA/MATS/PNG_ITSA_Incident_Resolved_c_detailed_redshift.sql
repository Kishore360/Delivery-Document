...
join ldb.d_ag_manager_role_vp_dir_ad_c a16 
on (a11.inc_assignment_group_key = a16.internal_organization_key) 
join ldb.d_internal_contact_associate_director_c a17 
on (a16.associate_director_key = a17.row_key) 
union
...
on (a11.last_resolved_on_key = a111.row_key) 
union
...
join ldb.d_ag_manager_role_vp_dir_ad_c a16 
on (a11.inc_assignment_group_key = a16.internal_organization_key) 
join ldb.d_internal_contact_director_c a115 
on (a16.director_key = a115.row_key) 
union
...
on (a111.month_start_date_key = a116.row_key) 
union
...
on (a114.parent_incident_key = a117.row_key) 
union
...
join ldb.d_ag_manager_role_vp_dir_ad_c a16 
on (a11.inc_assignment_group_key = a16.internal_organization_key) 
join ldb.d_internal_contact_vp_c a120 
on (a16.vp_key = a120.row_key) 
union
...
on (a15.hour_24_format_num = a128.hour_24_format_num) 
union
...
on (a110.criticality_key = a133.row_key) 
union
...
on (a110.used_for_src_key = a134.row_key) 
union
...
on (a111.week_start_date_key = a135.row_key) 
union
...
on (a14.year_start_date_key = a136.row_key) 
union
...
on (a114.category_src_key = a137.row_key) 
union
...
on (a114.close_code_src_key = a138.row_key) 
union
...
on (a114.priority_src_key = a140.row_key) 
union
...
on (a114.met_resolution_sla_flag_key = a141.row_key) 
union
...
join ldb.d_incident a114 
on (a11.incident_key = a114.row_key) 
join ldb.d_internal_contact_incident_opened_for_c a147 
on (a114.opened_for_key = a147.row_key) 
union
select 'ldb.d_lov_incident_service_type_c a148 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_resolved  a11 
join ldb.d_incident a114 
on (a11.incident_key = a114.row_key) 
join ldb.d_lov_incident_service_type_c a148 
on (a114.service_type_src_c_key = a148.row_key) 
union
select 'ldb.d_lov_incident_why_not_cwt_c a149 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_resolved  a11 
join ldb.d_incident a114 
on (a11.incident_key = a114.row_key) 
join ldb.d_lov_incident_why_not_cwt_c a149 
on (a114.why_now_cwt_src_c_key = a149.row_key) 
union
...
on (a111.quarter_start_date_key = a150.row_key) 
union
...
on (a111.year_start_date_key = a152.row_key) 
