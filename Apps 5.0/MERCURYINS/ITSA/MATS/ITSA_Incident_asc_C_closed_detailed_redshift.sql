select 'ldb.f_incident_asc_closed_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_incident_asc_closed_c       a11 
union
...
on (a11.asc_incident_closed_on_key = a15.row_key)
union
...
on (a11.asc_incident_closed_by_key = a116.row_key)
union
