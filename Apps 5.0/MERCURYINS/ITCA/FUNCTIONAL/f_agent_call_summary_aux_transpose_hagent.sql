...
truncate table mercuryins_workdb.fs_agent_call_summary_aux;
...
SET @sql = CONCAT(
'INSERT INTO mercuryins_workdb.fs_agent_call_summary_aux (ROW_ID,SOURCE_ID,PARENT_ROW_ID,TIME_ID,DAY_ID,EMPLOYEE_ID,SKILL_ID,SHIFT_ID,LOCATION_ID,DEPARTMENT_ID,COST_CENTER_ID,AUX_CODE_SRC_ID,ACD_ID,AUX_TIME,CREATED_BY,CHANGED_BY,CREATED_ON,CHANGED_ON,PIVOT_DATE)
