SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_agent_non_acd_changed_on' ELSE 'SUCCESS' END as Message
FROM (
select TRGT.CHANGED_ON from 
