...
JOIN gilead_mdwdb.d_configuration_item_aggregator_c TRGT ON (src.sys_id =TRGT.row_id  AND src.sourceinstance= TRGT.source_id)
where Current_flag='Y'
and case when src.u_business_criticality is null then 'Y' else 'N' end <>TRGT.missing_business_criticality_flag;
