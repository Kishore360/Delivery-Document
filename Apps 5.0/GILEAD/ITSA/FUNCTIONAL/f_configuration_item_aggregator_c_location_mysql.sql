...
JOIN gilead_mdwdb.f_configuration_item_aggregator_c TRGT ON (cmn.name= SUBSTRING_INDEX( SUBSTRING_INDEX(TRGT.row_id,'~',4),'~',-1) and SRC.sourceinstance=TRGT.source_id)
