...
union
select 'ldb.d_internal_contact_requested_for a17 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_request_item_closed a11 
...
union
select 'ldb.d_internal_contact_task_closed_by a122 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_request_item_closed a11 
