...
union
select  'd_business_servicerow_count, ' as Table_Name,count(a11.row_key) Row_Count
from ldb.f_change_request a11
...
union
select  'd_lov_change_request_outcome_c' as Table_Name,count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a17
on (a11.change_request_key = a17.row_key)
...
union
select  'd_lov_change_request_outcome_reason_c' as Table_Name,count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a17
on (a11.change_request_key = a17.row_key)
...
on (a16.quarter_start_date_key = a131.row_key)
union
...
on (a16.year_start_date_key = a132.row_key)
