...
union
select 'ldb.d_internal_contact_customer_c a16 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_task_fss_c_keyword a11 
 join ldb.d_internal_contact_customer_c a16 
 on (a11.customer_c_key = a16.row_key)  
union
...
select 'ldb.d_lov_customer_geo_c a115 ' as Table_name, count(a11.row_key) Row_Count
 ...
 on (a13.customer_geo_c_key = a115.row_key)  
union
select 'ldb.d_lov_hold_type_c a116 ' as Table_name, count(a11.row_key) Row_Count
 ...
 on (a13.hold_type_c_key = a116.row_key)  
union
select 'ldb.d_lov_payment_request_type_c a117 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_task_fss_c_keyword a11 
 join ldb.d_task_fss_c a13 
 on (a11.task_fss_c_key = a13.row_key) 
 join ldb.d_lov_payment_request_type_c a117 
 on (a13.payment_request_type_c_key = a117.row_key)  
union
select 'ldb.d_lov_priority_c a118 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_task_fss_c_keyword a11 
 join ldb.d_task_fss_c a13 
 on (a11.task_fss_c_key = a13.row_key) 
 join ldb.d_lov_priority_c a118 
 on (a13.priority_c_key = a118.row_key)  
union
select 'ldb.d_lov_supplier_type_c a119 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_task_fss_c_keyword a11 
 join ldb.d_task_fss_c a13 
 on (a11.task_fss_c_key = a13.row_key) 
 join ldb.d_lov_supplier_type_c a119 
 on (a13.supplier_type_c_key = a119.row_key)  
