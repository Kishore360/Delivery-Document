...
union
select 'ldb.d_problem_from_state a17 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_state_activity a11 
 join ldb.d_problem_from_state a17 
	on (a11.from_state_key = a17.row_key)  
union
select 'ldb.d_problem_impact a18 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_state_activity a11 
...
union
select 'ldb.d_problem_to_state a110 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_state_activity a11 
...
union
select 'ldb.d_problem_state a112 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_state_activity a11 
