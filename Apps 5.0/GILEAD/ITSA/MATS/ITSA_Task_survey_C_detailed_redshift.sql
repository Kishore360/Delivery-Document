...
union
select 'ldb.d_survey_question a17 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_task_response_c a11 
 join ldb.d_survey_question a17 
	on (a11.question_key = a17.row_key)  
union
select 'ldb.d_internal_organization_asst_group_c a18 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_task_response_c a11 
 join ldb.d_internal_organization_asst_group_c a18 
	on (a11.asmt_assignment_group_c_key = a18.row_key)  
union
select 'ldb.d_internal_contact_asst_assigned_to_c a19 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_task_response_c a11 
...
union
select 'ldb.d_configuration_item_survey_causing_ci_c a112 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_task_response_c a11 
...
union
select 'ldb.d_internal_contact_request_item_task_response_c a115 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_task_response_c a11 
 join ldb.d_internal_contact_request_item_task_response_c a115 
	on (a11.request_task_assigned_to_c_key = a115.row_key)  
union
select 'ldb.d_internal_organization_request_item_task_response_c a116 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_task_response_c a11 
...
union
select 'ldb.d_survey a117 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_task_response_c a11 
...
union
select 'ldb.d_location_site_c a122 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_task_response_c a11 
 join ldb.d_location a16 
 on (a11.location_key = a16.row_key) 
