...
union
select 'ldb.d_customer_mdm a113 ' as Table_name, count(1) Row_Count
from ldb.f_incident_keyword a11 
join ldb.d_customer a12 
on (a11.customer_key = a12.row_key) 
...
union
select 'ldb.d_calendar_time_hour a115 ' as Table_name, count(1) Row_Count
from ldb.f_incident_keyword a11 
join ldb.d_calendar_time a14 
on (a11.opened_time_key = a14.row_key) 
...
union
select 'ldb.d_calendar_week a121 ' as Table_name, count(1) Row_Count
from ldb.f_incident_keyword a11 
join ldb.d_calendar_date a17 
on (a11.opened_on_key = a17.row_key) 
...
union
select 'ldb.d_employee_location a122 ' as Table_name, count(1) Row_Count
from ldb.f_incident_keyword a11 
join ldb.d_internal_contact a13 
