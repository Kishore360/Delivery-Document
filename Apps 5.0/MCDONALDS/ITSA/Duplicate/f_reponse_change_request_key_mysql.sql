...
LEFT JOIN mcdonalds_mdwdb.f_response trgt ON src.sys_id = trgt.row_id AND src.sourceinstance = trgt.source_id
LEFT JOIN mcdonalds_mdwdb.d_change_request lkp ON COALESCE(src.task,'UNSPECIFIED') = lkp.row_id
