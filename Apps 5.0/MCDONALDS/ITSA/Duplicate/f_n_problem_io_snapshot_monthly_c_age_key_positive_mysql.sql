...
FROM (   
            select assignment_group_key,priority_src_key,business_service_key,month_start_key,floor((age/86400)/ending_backlog) as  age_populated ,
case when floor((age/86400)/ending_backlog) between 0 and 4 then 71142
     ...
     from  mcdonalds_mdwdb.f_n_problem_io_snapshot_monthly_c
