...
FROM     mcdonalds_mdwdb.f_n_request_item_vdr_io_snapshot_weekly_c
Join mcdonalds_mdwdb.d_internal_contact a12 ON assigned_to_key = a12.row_key
--  where    prev_week_start_key='20180122' and a12.full_name='Aakanksha Sharma' and  priority_src_key=54610 and business_service_c_key= 49 and 
 -- prev_week_start_key>=20180101 and prev_week_start_key<=20180601 
