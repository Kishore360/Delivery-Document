...
FROM ( select a.assignment_gp_manager_key,a.priority_src_key,b.business_service_key,a.month_start_key,b.prev_month_start_key,coalesce(age,0),coalesce(prev_age,0) from (
