...
FROM ( select a.assignment_gp_manager_key,a.priority_src_key,b.business_service_key,a.week_start_key,b.prev_week_start_key,coalesce(age,0),coalesce(prev_age,0) from (
