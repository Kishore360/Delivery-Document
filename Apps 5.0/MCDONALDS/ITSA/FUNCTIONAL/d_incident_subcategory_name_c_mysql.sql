...
from 
(select count(1) as cnt  from (select sys_id, sourceinstance,cdctime,u_subcategory from  mcdonalds_mdsdb.incident_final) src 
left join mcdonalds_mdsdb.u_subcategory_final src1 on src.u_subcategory=src1.sys_id and src.sourceinstance=src1.sourceinstance
