...
left join mcdonalds_mdwdb.d_gbl_c e on d.sys_id=row_id and e.source_id=d.sourceinstance
...
left join mcdonalds_mdwdb.d_internal_contact a on concat('INTERNAL_CONTACT~',c.sys_id)=a.row_id and e.source_id=d.sourceinstance
