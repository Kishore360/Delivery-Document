...
join mcdonalds_mdwdb.d_configuration_item a on b.sys_id=a.row_id and b.sourceinstance=a.source_id
 join (select source_id,max(lastupdated) as lastupdated from mcdonalds_mdwdb.d_o_data_freshness group by source_id) f1 on (f1.source_id = c.sourceinstance)
