SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 ...
 from
 mcdonalds_mdwdb.f_incident_task_c f 
join mcdonalds_mdwdb.d_incident_task_c d on d.row_key = f.incident_task_c_key
JOIN mcdonalds_mdwdb.d_lov_map br ON f.incident_task_c_key = br.src_key and br.dimension_wh_code='OPEN' 
