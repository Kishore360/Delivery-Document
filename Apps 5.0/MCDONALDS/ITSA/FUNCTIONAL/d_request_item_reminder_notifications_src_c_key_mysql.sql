...
where (src.cdctime<=f1.lastupdated) and COALESCE(lkp.row_key,CASE WHEN src.u_reminder_notifications IS NULL THEN 0 else -1 end)<> trgt.reminder_notifications_src_c_key;