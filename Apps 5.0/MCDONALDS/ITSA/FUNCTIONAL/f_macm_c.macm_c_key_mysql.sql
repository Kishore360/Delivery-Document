...
from(select sys_id, sourceinstance,cdctime from mcdonalds_mdsdb.x_scafe_mcdcr_chan_mcdcr_change_request_final) src 
 LEFT JOIN mcdonalds_mdwdb.d_macm_c LKP ON src.sys_id= LKP.row_id 
