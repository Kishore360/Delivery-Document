...
CASE WHEN cnt>0  THEN 'MDS to DWH data validation failed for d_request_item.domain_c' ELSE 'SUCCESS' END as Message
from 
...
where (src.cdctime<=f1.lastupdated) and  COALESCE(src1.domain ,'UNSPECIFIED') <> trgt.domain_c) temp;