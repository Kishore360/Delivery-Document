...
mcdonalds_mdwdb.f_incident f  ON sys_id=row_id and sourceinstance=source_id
...
( SELECT * FROM mcdonalds_mdsdb.incident_final where CDCTYPE<>'D' and  opened_at < coalesce(resolved_at,closed_at)) SRC 