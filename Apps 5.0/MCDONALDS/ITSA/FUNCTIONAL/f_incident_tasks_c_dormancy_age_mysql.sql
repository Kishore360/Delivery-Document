 ...
 FROM mcdonalds_mdsdb.u_incident_tasks_final SRC 
  JOIN mcdonalds_mdwdb.f_incident_tasks_c TRGT 
 ON (SRC.sys_id =TRGT.row_id 
 AND SRC.sourceinstance= TRGT.source_id )
 JOIN mcdonalds_mdwdb.d_incident_tasks_c trgtf on TRGT.incident_tasks_c_key=trgtf.row_key
