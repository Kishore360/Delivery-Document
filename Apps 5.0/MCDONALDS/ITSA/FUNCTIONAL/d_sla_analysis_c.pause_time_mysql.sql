...
CASE WHEN cnt>0  THEN 'MDS to DWH data validation failed for d_sla_analysis_c.pause_time' ELSE 'SUCCESS' END as Message
from 
...
where (src.cdctime<=f1.lastupdated) and  CONVERT_TZ(c.pause_time,'GMT','US/Central') <> trgt.pause_time) temp;