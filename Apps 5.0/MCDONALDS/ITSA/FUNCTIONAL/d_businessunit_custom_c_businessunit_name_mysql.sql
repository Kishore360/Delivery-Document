...
from 
(select count(1) as cnt  from  mcdonalds_mdsdb.us_bu_manager_vendor_map_c_final  src 
left join mcdonalds_mdwdb.d_businessunit_custom_c trgt  ON src.business_unit=trgt.businessunit_name  and src.sourceinstance=trgt.source_id
