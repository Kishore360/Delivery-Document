...
-- union query for f_asset_status_weekly_duration--
select 'ldb.f_asset_status_weekly_duration a11 ' as Table_name, count(a11.row_key) Row_Count
...
-- union query for f_n_asset_weekly--
...
-- union query for f_n_asset_status_history_weekly--
