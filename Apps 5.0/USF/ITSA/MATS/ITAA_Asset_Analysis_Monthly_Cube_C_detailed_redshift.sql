...
-- union query for f_asset_status_monthly_duration--
select 'ldb.f_asset_status_monthly_duration a11 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_asset_status_monthly_duration a11 
union
...
-- union query for f_n_asset_monthly--
...
-- union query for f_n_asset_status_history_monthly--
select 'ldb.f_n_asset_status_history_monthly a11 ' as Table_name, count(a11.row_key) Row_Count
