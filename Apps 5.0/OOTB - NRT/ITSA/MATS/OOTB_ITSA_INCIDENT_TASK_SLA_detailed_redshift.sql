select 'ldb.f_incident_task_sla' as Table_Name, count(1) Row_Count
...
union
select'ldb.d_task_sla' as Table_Name, count(1) Row_Count
 from  ldb.f_incident_task_sla       a11 
join ldb.d_task_sla       a17
on (a11.sla_key = a17.row_key)
union
select'ldb.d_task_sla_stage' as Table_Name, count(1) Row_Count
 from  ldb.f_incident_task_sla       a11 
...
union
select'ldb.d_task_sla_name' as Table_Name, count(1) Row_Count
 from  ldb.f_incident_task_sla       a11 
 join ldb.d_task_sla       a17
on (a11.sla_key = a17.row_key)
