...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for f_cmdb_relationship_c.parent_configuration_item_c_key' ELSE 'SUCCESS' END as Message 
FROM rogers_mdsdb.cmdb_rel_ci_final SRC
JOIN rogers_mdwdb.f_cmdb_relationship_c TRGT 
ON (SRC.sys_id = TRGT.row_id AND SRC.sourceinstance = TRGT.source_id )  
LEFT JOIN rogers_mdwdb.d_configuration_item LKP 
