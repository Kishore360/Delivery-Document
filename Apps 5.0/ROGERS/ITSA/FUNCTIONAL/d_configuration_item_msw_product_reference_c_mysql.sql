...
LEFT JOIN rogers_mdsdb.cmdb_ci_app_server_final app
...
LEFT JOIN rogers_mdsdb.core_company_final core_company2 
...
when ci.sys_class_name in (select distinct sys_class_name from rogers_mdsdb.cmdb_ci_app_server_final) 
