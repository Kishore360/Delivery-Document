...
left  join rogers_mdsdb.sys_user_final b on caller_id=b.sys_id 
left  join rogers_mdwdb.d_internal_contact b2 on b2.identification_number=b.employee_number 
left  join rogers_mdwdb.d_incident b1 on b1.row_id=a.sys_id 
