...
select a.msd msd,(abc/def)*100.0 from 
...
join rogersdev_mdwdb.f_incident f11 on f.incident_key=f11.incident_key
join rogersdev_mdwdb.d_survey_instance d on f.survey_instance_key=d.row_key
join rogersdev_mdwdb.d_survey_wizard_c dw on d.survey_wizard_c_key=dw.row_key
join rogersdev_mdwdb.f_response fr on f.survey_instance_key=fr.survey_instance_key
join rogersdev_mdwdb.d_survey_question dq on fr.question_key=dq.row_key
