...
on COALESCE(CONCAT('INTERNAL_CONTACT~',ci.managed_by),'UNSPECIFIED')=d.row_id
where d.soft_deleted_flag='N' and managed_by_c_key <> coalesce(d.row_key,case when ci.managed_by is null then 0 else -1 end))a
