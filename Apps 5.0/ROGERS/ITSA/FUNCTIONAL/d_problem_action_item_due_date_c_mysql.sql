...
(select number,convert_tz(max(s1.sys_created_on),'GMT','America/Los_Angeles' ) as Due_on,d.due_on due_on_trgt from rogersdev_mdsdb.problem_final s
join rogers_mdsdb.u_pm_action_items_final s1 on s.u_problem=s1.u_pm_number
