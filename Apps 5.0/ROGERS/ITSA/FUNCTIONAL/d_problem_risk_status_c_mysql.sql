...
and case when s.short_description like '%status%' then substring(s.short_description,instr(s.short_description,'status')+7)  else "UNSPECIFIED"end<>risk_status_c)a
