...
-- convert_tz(max(s1.sys_created_on),'GMT','America/New_York' ) as Due_on,d.action_item_due_date_c due_on_trgt 
from rogers_mdsdb.problem_final s
join rogers_mdsdb.u_pm_action_items_final s1 on s.sys_id=s1.u_pm_number
-- LEFT JOIN rogers_mdwdb.d_lov l on concat('STATE~PROBLEM_TASK~~~',u_status)=row_id
