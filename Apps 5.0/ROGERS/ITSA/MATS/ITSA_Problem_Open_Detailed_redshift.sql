...
union
select'ldb.d_internal_organization_pit_lead_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_problem       a11 
...
union
select'ldb.d_internal_contact_investigation_lead_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_problem       a11 
...
union
select'ldb.d_lov_problem_subcategory_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_problem       a11 
...
union
select'ldb.d_lov_problem_rca_agebucket_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_problem       a11 
...
union
select'ldb.d_problem_related_problem_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_problem       a11 
...
union
select'ldb.d_lov_problem_primary_closure_code_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_problem       a11 
 join ldb.d_problem       a112
on (a11.problem_key=a112.row_key)
...
union
select'ldb.d_lov_problem_substatus_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_problem       a11 
 join ldb.d_problem       a112
on (a11.problem_key=a112.row_key)
...
union
select'ldb.d_lov_problem_reason_for_disqualification_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_problem       a11 
 join ldb.d_problem       a112
on (a11.problem_key=a112.row_key)
...
union
select'ldb.d_lov_problem_reason_for_non_implementation_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_problem       a11 
 join ldb.d_problem       a112
on (a11.problem_key=a112.row_key)
...
union
select'ldb.d_lov_problem_secondary_closure_code_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_problem       a11 
 join ldb.d_problem       a112
on (a11.problem_key=a112.row_key)
