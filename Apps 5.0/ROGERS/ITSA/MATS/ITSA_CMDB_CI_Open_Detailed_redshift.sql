...
union
select'ldb.d_lov_cmdb_dr_enabled_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_configuration_item_c       a11
 join ldb.d_application       a12
on (a11.application_key=a12.row_key)
...
union
select'ldb.d_internal_contact_app_development_manager_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_configuration_item_c       a11
 join ldb.d_application       a12
on (a11.application_key=a12.row_key)
...
union
select'ldb.d_internal_contact_app_development_prime_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_configuration_item_c       a11 
 join ldb.d_application       a12
on (a11.application_key=a12.row_key)
...
union
select'ldb.d_lov_cmdb_sox_senstive_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_configuration_item_c       a11 
 join ldb.d_application       a12
on (a11.application_key=a12.row_key)
...
union
select'ldb.d_internal_contact_app_support_director_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_configuration_item_c       a11 
 join ldb.d_application       a12
on (a11.application_key=a12.row_key)
...
union
select'ldb.d_internal_contact_app_support_manager_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_configuration_item_c       a11
 join ldb.d_application       a12
on (a11.application_key=a12.row_key)
