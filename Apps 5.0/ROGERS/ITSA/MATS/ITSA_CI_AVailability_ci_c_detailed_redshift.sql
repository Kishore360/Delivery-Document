...
union
select 'ldb.d_application_schedule_c a12 ' as Table_name, count(1) Row_Count
from ldb.f_application_availability_c a11 
...
union
select 'ldb.d_business_application_c a15 ' as Table_name, count(1) Row_Count
from ldb.f_application_availability_c a11 
join	ldb.d_business_application_c	a12
	  on 	(a11.business_application_c_key = a12.row_key)
	  union
select 'ldb.d_outage_type_app_avail_c a15 ' as Table_name, count(1) Row_Count
from ldb.f_application_availability_c a11 	  
	  ...
	  union
select 'ldb.d_internal_contact_portfolio_owner_c a15 ' as Table_name, count(1) Row_Count
from ldb.f_application_availability_c a11 
join	ldb.d_application_schedule_c	a12
	  on 	(a11.application_schedule_c_key = a12.row_key)
	join	ldb.d_internal_contact_portfolio_owner_c	a112
	  ...
	  union
select 'ldb.d_internal_contact_technical_owner_c a15 ' as Table_name, count(1) Row_Count
from ldb.f_application_availability_c a11 
join	ldb.d_application_schedule_c	a12
	  on 	(a11.application_schedule_c_key = a12.row_key)
	join	ldb.d_internal_contact_technical_owner_c	a113
	  ...
	  union
	  select 'ldb.d_internal_contact_supported_by_app_avail_c a15 ' as Table_name, count(1) Row_Count
from ldb.f_application_availability_c a11 
join	ldb.d_business_application_c	a12
	  on 	(a11.business_application_c_key = a12.row_key)
	join	ldb.d_internal_contact_supported_by_app_avail_c	a114
	  ...
	  union
	  select 'ldb.d_lov_business_application_environment_c a15 ' as Table_name, count(1) Row_Count
from ldb.f_application_availability_c a11 
join	ldb.d_business_application_c	a12
	  on 	(a11.business_application_c_key = a12.row_key)
	join	ldb.d_lov_business_application_environment_c	a115
	  ...
	  union
	  select 'ldb.d_lov_business_application_operational_status_c a15 ' as Table_name, count(1) Row_Count
from ldb.f_application_availability_c a11 
join	ldb.d_business_application_c	a12
	  on 	(a11.business_application_c_key = a12.row_key)
	join	ldb.d_lov_business_application_operational_status_c	a116
	  ...
	  union
	  select 'ldb.d_internal_contact_owned_by_app_avail_c a15 ' as Table_name, count(1) Row_Count
from ldb.f_application_availability_c a11 
join	ldb.d_business_application_c	a12
	  on 	(a11.business_application_c_key = a12.row_key)
	join	ldb.d_internal_contact_owned_by_app_avail_c	a117
	  ...
	  union
	  select 'ldb.d_lov_business_application_type_c a15 ' as Table_name, count(1) Row_Count
from ldb.f_application_availability_c a11 
join	ldb.d_business_application_c	a12
	  on 	(a11.business_application_c_key = a12.row_key)
