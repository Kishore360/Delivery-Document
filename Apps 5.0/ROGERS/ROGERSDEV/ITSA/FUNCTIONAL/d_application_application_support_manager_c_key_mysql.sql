...
on COALESCE(CONCAT('INTERNAL_CONTACT~',b.u_support_manager),'UNSPECIFIED') = c.row_id
where coalesce(c.row_key,case when b.u_support_manager is null then 0 else -1 end)<>a.application_support_manager_c_key)a
=======
