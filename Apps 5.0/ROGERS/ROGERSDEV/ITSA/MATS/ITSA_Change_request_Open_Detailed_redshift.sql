...
union
select 'ldb.d_internal_contact_task_for_c a117 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
...
union
select 'ldb.d_incident a126 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
...
union
select 'ldb.dh_user_group_level1 a129 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_internal_organization_group a14 
...
union
select 'ldb.d_lov_change_request_sub_status_c a134 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a18 
on (a11.change_request_key = a18.row_key) 
...
union
select 'ldb.d_lov_change_request_sub_category_c a135 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a18 
on (a11.change_request_key = a18.row_key) 
...
union
select 'ldb.d_lov_change_request_environment_c a136 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a18 
on (a11.change_request_key = a18.row_key) 
