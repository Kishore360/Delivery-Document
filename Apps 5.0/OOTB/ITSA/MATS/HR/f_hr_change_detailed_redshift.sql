select 'ldb.f_hr_change a11 ' as Table_name, count(a11.row_key) Row_Count
...
union
select 'ldb.dh_employee_hierarchy a13 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_hr_change a11 
join ldb.d_internal_contact a12 
on (a11.requested_for_key = a12.row_key) 
...
union
select 'ldb.d_hr_change_category a19 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_hr_change a11 
join ldb.d_hr_change_category a19 
on (a11.category_src_key = a19.row_key) 
union
select 'ldb.d_hr_change_impact a110 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_hr_change a11 
...
union
select 'ldb.d_hr_change_priority a112 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_hr_change a11 
join ldb.d_hr_change_priority a112 
on (a11.priority_src_key = a112.row_key) 
union
select 'ldb.d_hr_change_urgency a113 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_hr_change a11 
...
union
select 'ldb.dh_employee_level2 a116 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_hr_change a11 
join ldb.d_internal_contact a12 
on (a11.requested_for_key = a12.row_key) join ldb.dh_employee_hierarchy a13 
on (a12.row_current_key = a13.lev_0_key) 
...
union
select 'ldb.dh_employee_level3 a117 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_hr_change a11 
join ldb.d_internal_contact a12 
on (a11.requested_for_key = a12.row_key) join ldb.dh_employee_hierarchy a13 
on (a12.row_current_key = a13.lev_0_key) 
...
union
select 'ldb.dh_employee_level4 a118 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_hr_change a11 
join ldb.d_internal_contact a12 
on (a11.requested_for_key = a12.row_key) join ldb.dh_employee_hierarchy a13 
on (a12.row_current_key = a13.lev_0_key) 
...
union
select 'ldb.dh_employee_level5 a119 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_hr_change a11 
join ldb.d_internal_contact a12 
on (a11.requested_for_key = a12.row_key) join ldb.dh_employee_hierarchy a13 
on (a12.row_current_key = a13.lev_0_key) 
