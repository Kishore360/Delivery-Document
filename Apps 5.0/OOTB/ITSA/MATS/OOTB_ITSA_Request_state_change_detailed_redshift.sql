...
union
select 'ldb.d_sc_request_from_stage a110 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_request_activity a11 
join ldb.d_sc_request_from_stage a110 
on (a11.from_stage_key = a110.row_key) 
union
select 'ldb.d_sc_request_from_request_state a111 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_request_activity a11 
...
union
select 'ldb.d_sc_request_to_stage a115 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_request_activity a11 
join ldb.d_sc_request_to_stage a115 
on (a11.to_stage_key = a115.row_key) 
union
select 'ldb.d_sc_request_to_request_state a116 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_request_activity a11 
