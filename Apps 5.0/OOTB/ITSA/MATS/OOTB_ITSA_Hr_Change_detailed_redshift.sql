select 'ldb.f_hr_change' as Table_Name, count(a11.row_key) Row_Count
...
union
select'ldb.d_hr_change_impact' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_hr_change       a11 
...
union
select'ldb.d_hr_change_priority' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_hr_change       a11 
join ldb.d_hr_change_priority       a112
on (a11.priority_src_key = a112.row_key)
union
select'ldb.d_hr_change_urgency' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_hr_change       a11 
