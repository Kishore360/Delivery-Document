...
on (a11.n_key=a112.row_key) 
union
select'ldb.d_lov_portfolio_cost_variance_bucket_view' as Table_Name,count(a11.row_key)Row_Count 
from ldb.f_n_project_task_monthly a11 
join ldb.d_lov_portfolio_cost_variance_bucket_view a113 
on (a11.portfolio_cost_variance_color_key=a113.row_key) 
union
select'ldb.d_lov_portfolio_effort_variance_bucket_view' as Table_Name,count(a11.row_key)Row_Count 
from ldb.f_n_project_task_monthly a11 
join ldb.d_lov_portfolio_effort_variance_bucket_view a114 
on (a11.portfolio_effort_variance_color_key=a114.row_key) 
union
select'ldb.d_internal_contact_project_manager' as Table_Name,count(a11.row_key)Row_Count 
from ldb.f_n_project_task_monthly a11 
join ldb.d_internal_contact_project_manager a115 
on (a11.project_manager_key=a115.row_key) 
union
select'ldb.d_lov_project_risk_bucket_view' as Table_Name,count(a11.row_key)Row_Count 
from ldb.f_n_project_task_monthly a11 
join ldb.d_lov_project_risk_bucket_view a116 
on (a11.project_risk_color_key=a116.row_key) 
union
select'ldb.d_lov_project_schedule_variance_bucket_view' as Table_Name,count(a11.row_key)Row_Count 
from ldb.f_n_project_task_monthly a11 
join ldb.d_lov_project_schedule_variance_bucket_view a117 
on (a11.schedule_variance_color_key=a117.row_key) 
union
select'ldb.d_project_parent_project' as Table_Name,count(a11.row_key)Row_Count 
from ldb.f_n_project_task_monthly a11 
join ldb.d_project a12 
on (a11.project_key=a12.row_key)
join ldb.d_project_parent_project a118 
on (a12.parent_project_key=a118.row_key) 
union
select'ldb.d_lov_project_state_view' as Table_Name,count(a11.row_key)Row_Count 
from ldb.f_n_project_task_monthly a11 
join ldb.d_project a12 
on (a11.project_key=a12.row_key)
join ldb.d_lov_project_state_view a119 
on (a12.project_state_src_key=a119.row_key) 
union
...
on (a14.portfolio_category_src_key=a122.row_key)