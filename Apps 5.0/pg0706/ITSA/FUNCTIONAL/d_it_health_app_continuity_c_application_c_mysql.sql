SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_it_health_app_continuity_c.application_c' ELSE 'SUCCESS' END as Message
 FROM
...
where SRC.Application<>TRGT.application_c