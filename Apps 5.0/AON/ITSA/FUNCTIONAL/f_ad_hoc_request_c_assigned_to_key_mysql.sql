...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for f_ad_hoc_request_c.assigned_to_key'
 ...
 ON ( concat( 'INTERNAL_CONTACT~' ,upper( SRC.assigned_to)) = LKP.row_id AND SRC.sourceinstance = LKP.source_id ) 
