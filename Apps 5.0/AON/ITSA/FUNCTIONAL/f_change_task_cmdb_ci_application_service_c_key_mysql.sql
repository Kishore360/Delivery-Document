 ...
 CASE WHEN cnt > 0 THEN 'MDS to DWH data validation failed for f_change_task.cmdb_ci_application_service_c_key' ELSE 'SUCCESS' END as Message  
 FROM (select count(1) as cnt from aon_mdsdb.change_task_final SRC
...
join aon_mdsdb.u_business_unit_sub_lookup_final bu2 
-- --check this part for subdivision
