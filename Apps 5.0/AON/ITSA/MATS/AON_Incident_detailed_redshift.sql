...
union
select 'ldb.d_product_cat_item_c a124 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_product_cat_item_c a124 
on (a11.product_key = a124.row_key) 
union
select 'ldb.d_lov_symptom_c a125 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_lov_symptom_c a125 
on (a11.symptom_src_c_key = a125.row_key) 
union
select 'ldb.d_technical_service_c a126 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_technical_service_c a126 
on (a11.technical_service_c_key = a126.row_key) 
union
...
on (a17.used_for_src_key = a128.row_key) 
union
...
on (a18.month_start_date_key = a129.row_key) 
union
...
on (a111.severity_src_key = a136.row_key) 
union
...
on (a111.state_src_key = a137.row_key) 
union
...
on (a111.sub_category_src_key = a138.row_key) 
union
