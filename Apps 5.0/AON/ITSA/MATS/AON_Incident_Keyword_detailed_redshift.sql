...
union
select 'ldb.d_parent_incident a112 ' as Table_name, count(1) Row_Count
from ldb.f_incident_keyword a11 
join ldb.d_incident a111 
on (a11.table_row_key = a111.row_key) 
...
union
select 'ldb.d_internal_organization_legalentity a113 ' as Table_name, count(1) Row_Count
from ldb.f_incident_keyword a11 
...
union
select 'ldb.d_incident_contacttype a117 ' as Table_name, count(1) Row_Count
from ldb.f_incident_keyword a11 
join ldb.d_incident_contacttype a117 
on (a11.reported_type_src_key = a117.row_key) 
union
select 'ldb.d_incident_impact a118 ' as Table_name, count(1) Row_Count
from ldb.f_incident_keyword a11 
join ldb.d_incident_impact a118 
on (a11.impact_src_key = a118.row_key) 
union
select 'ldb.d_incident_urgency a119 ' as Table_name, count(1) Row_Count
from ldb.f_incident_keyword a11 
join ldb.d_incident_urgency a119 
on (a11.urgency_src_key = a119.row_key) 
union
select 'ldb.d_location a120 ' as Table_name, count(1) Row_Count
from ldb.f_incident_keyword a11 
join ldb.d_location a120 
on (a11.location_key = a120.row_key) 
union
select 'ldb.d_calendar_month a121 ' as Table_name, count(1) Row_Count
from ldb.f_incident_keyword a11 
join ldb.d_calendar_date a17 
on (a11.opened_on_key = a17.row_key) 
...
union
select 'ldb.d_incident_priority a125 ' as Table_name, count(1) Row_Count
from ldb.f_incident_keyword a11 
join ldb.d_incident_priority a125 
on (a11.priority_src_key = a125.row_key) 
union
select 'ldb.d_incident_severity a126 ' as Table_name, count(1) Row_Count
from ldb.f_incident_keyword a11 
join ldb.d_incident_severity a126 
on (a11.severity_src_key = a126.row_key) 
union
select 'ldb.d_incident_state a127 ' as Table_name, count(1) Row_Count
from ldb.f_incident_keyword a11 
