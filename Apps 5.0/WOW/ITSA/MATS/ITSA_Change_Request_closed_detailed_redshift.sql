select 'ldb.f_change_request_closed_closed a11 ' as Table_name, count(a11.row_key) Row_Count
...
union
select 'ldb.d_internal_contact_change_assigned_to_manager_c a125 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request_closed a11 
join ldb.d_internal_contact_assigned_to a15 
on (a11.assigned_to_key = a15.row_key) 
...
union
select 'ldb.d_lov_change_request_change_outcome_c a126 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request_closed a11 
join ldb.d_change_request a14 
on (a11.change_request_key = a14.row_key) 
join ldb.d_lov_change_request_change_outcome_c a126 
on (a14.change_outcome_c_key = a126.row_key) 
union
...
on (a13.quarter_start_date_key = a127.row_key) 
union
...
on (a13.year_start_date_key = a128.row_key) 
