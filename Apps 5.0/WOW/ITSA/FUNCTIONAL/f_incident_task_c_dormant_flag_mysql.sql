...
from  wow_mdwdb.d_incident_task_c b
left join wow_mdwdb.f_incident_task_c l1
ON b.row_key=l1.incident_task_key  AND  b.source_id=l1.source_id 
left join wow_mdwdb.d_lov_map l2
...
FROM wow_mdwdb.d_o_data_freshness WHERE sourcename like 'ServiceNow%'))>30  then 'Y' else 'N'
