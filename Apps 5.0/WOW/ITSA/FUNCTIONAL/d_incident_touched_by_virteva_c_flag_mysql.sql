...
CASE WHEN cnt >0 THEN 'MDS to DWH data validation failed for d_incident.touched_by_virteva_c_flag' ELSE 'SUCCESS' END as Message
from
(select count(1) cnt from
wow_mdwdb.d_incident trg
join (select documentkey,sourceinstance from wow_mdsdb.sys_audit_final 
 where fieldname='assignment_group' and tablename='incident' and
 ...
 from wow_mdsdb.incident_final where assignment_group='af54b3910f5f710066e76ab8b1050ebb'
  ) temp
