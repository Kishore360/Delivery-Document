...
'MDS to DWH data validation failed for d_internal_contact.parent_row_id'  ELSE 'SUCCESS' END 
...
WHERE coalesce(concat('INTERNAL_CONTACT','~',SRC.managerloginid),'UNSPECIFIED') <> TRGT.parent_row_id