...
JOIN schneider_mdwdb.d_internal_contact TRGT ON coalesce(CONCAT('INTERNAL_CONTACT','~',SRC.managerloginid),'UNSPECIFIED')  = TRGT.row_id AND SRC.sourceinstance = TRGT.source_id 
