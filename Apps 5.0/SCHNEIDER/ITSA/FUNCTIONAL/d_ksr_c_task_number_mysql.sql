...
THEN 'MDS to DWH data validation failed for d_ksr_c.task_number' else 'SUCCESS' end as message
...
WHERE coalesce(SRC.originatingid,'UNSPECIFIED') <> (TRGT.task_number)
