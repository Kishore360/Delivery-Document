...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for f_task_sla.incident_id' ELSE 'SUCCESS' END as Message from schneider_mdsdb.SLM_Measurement SRC
