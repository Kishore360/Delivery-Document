...
THEN 'MDS to DWH data validation failed for d_ksr_c.opened_on' else 'SUCCESS' end as message
...
WHERE convert_tz(SRC.create_date,'GMT', 'America/Los_Angeles') <> (TRGT.opened_on)
