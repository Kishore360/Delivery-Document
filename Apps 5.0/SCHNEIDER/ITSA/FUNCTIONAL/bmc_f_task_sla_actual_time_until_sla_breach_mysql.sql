...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for f_task_sla.actual_time_until_sla_breach' ELSE 'SUCCESS' END as Message from schneider_mdsdb.SLM_Measurement SRC
