...
CASE WHEN cnt >0 THEN 'MDS to DWH data validation failed for f_incident.configuration_item_key' 
ELSE 'MDS to DWH data validation passed for f_incident.configuration_item_key' END as Message from 
(select count(1) cnt 
