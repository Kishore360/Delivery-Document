...
left join schneider_mdsdb.ctm_people_final_final src_lkp on src.assignee_login_id = src_lkp.remedy_login_id and src.sourceinstance = src_lkp.sourceinstance
