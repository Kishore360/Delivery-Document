SELECT CASE WHEN count(1)  THEN 'FAILURE' ELSE 'SUCCESS' END as Result, CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for d_application.managed_by' 
...
and coalesce(LKP1.full_name,'UNSPECIFIED')<> coalesce(managed_by,'');