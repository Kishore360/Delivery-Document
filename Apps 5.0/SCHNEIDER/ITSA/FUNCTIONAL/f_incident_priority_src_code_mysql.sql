...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_incident.priority_src_code' 
ELSE 'MDS to DWH data validation passed for f_incident.priority_src_code' END as Message
(select count(1) cnt 
