...
THEN 'MDS to DWH data validation failed for d_ksr_c.form_name' else 'SUCCESS' end as message
...
WHERE coalesce(SRC.multi_purpose_info,'UNSPECIFIED') <> (TRGT.form_name)
