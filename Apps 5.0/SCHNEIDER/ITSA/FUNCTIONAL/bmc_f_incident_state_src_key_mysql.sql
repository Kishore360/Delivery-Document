...
CASE WHEN cnt >0 THEN 'MDS to DWH data validation failed for f_incident.state_src_key' 
ELSE 'MDS to DWH data validation passed for f_incident.state_src_key' END as Message from 
(select count(1) cnt 
