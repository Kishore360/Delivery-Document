...
THEN 'MDS to DWH data validation failed for d_ksr_c.ksr_number' else 'SUCCESS' end as message
...
WHERE coalesce(SRC.customersurveyid,'UNSPECIFIED') <> (TRGT.ksr_number)
