...
union
select 'ldb.d_internal_contact_customer_c a110 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_contact_customer_c a110 
on (a11.caller_c_key = a110.row_key) 
union
...
on (a111.state_src_key = a114.row_key) 
union
...
on (a17.month_start_date_key = a115.row_key) 
union
...
on (a111.parent_incident_key = a116.row_key) 
union
...
union
select 'ldb.d_ksr_c a126 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_ksr_c a126 
on (a11.ksr_c_key = a126.row_key) 
union
...
on (a17.week_start_date_key = a129.row_key) 
union
select 'ldb.d_internal_contact_master_employee_c a130 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_contact_customer_c a110 
on (a11.caller_c_key = a110.row_key) 
join ldb.d_internal_contact_master_employee_c a130 
on (a110.bmc_row_key_c = a130.row_key ) 
union
...
on (a111.category_src_key = a131.row_key) 
union
...
on (a111.close_code_src_key = a132.row_key) 
union
select 'ldb.d_internal_contact_person_contact_c a133 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_incident a111 
on (a11.incident_key = a111.row_key) 
join ldb.d_internal_contact_person_contact_c a133 
on (a111.person_contact_c_key = a133.row_key) 
union
...
on (a111.priority_src_key = a134.row_key) 
union
...
on (a111.met_resolution_sla_flag_key = a135.row_key) 
union
...
on (a111.met_response_sla_flag_key = a136.row_key) 
union
...
union
select 'ldb.d_incident_service_type a138 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11 
join ldb.d_incident a111 
on (a11.incident_key = a111.row_key) 
join ldb.d_incident_service_type a138 
on (a111.service_type_key = a138.row_key) 
union
