...
on (a111.state_src_key = a113.row_key) 
union
...
on (a18.month_start_date_key = a114.row_key) 
union
...
on (a111.priority_src_key = a131.row_key) 
union
...
on (a111.met_resolution_sla_flag_key = a132.row_key) 
union
...
on (a111.met_response_sla_flag_key = a133.row_key) 
union
