...
union
select 'ldb.d_internal_organization_change_request_ci_approval_group_c a112 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_internal_organization_change_request_ci_approval_group_c a112 
on (a11.approval_group_c_key = a112.row_key) 
union
...
union
select 'ldb.d_internal_contact_change_request_manager_c a117 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_internal_contact_change_request_manager_c a117 
on (a11.change_manager_c_key = a117.row_key) 
union
...
union
select 'ldb.d_configuration_item_change_request_service_offering_c a122 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_configuration_item_change_request_service_offering_c a122 
on (a11.service_offering_c_key = a122.row_key) 
union
...
union
select 'ldb.d_internal_contact_change_request_ci_owned_by_c a130 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_internal_contact_change_request_ci_owned_by_c a130 
on (a11.owned_by_c_key = a130.row_key) 
union
...
on (a13.close_code_src_key = a135.row_key) 
union
select 'ldb.d_lov_change_request_multi_service_impact_c a136 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a13 
on (a11.change_request_key = a13.row_key) 
join ldb.d_lov_change_request_multi_service_impact_c a136 
on (a13.multi_service_impact_src_c_key = a136.row_key) 
union
select 'ldb.d_lov_change_request_require_downtime_c a137 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a13 
on (a11.change_request_key = a13.row_key) 
join ldb.d_lov_change_request_require_downtime_c a137 
on (a13.require_downtime_src_c_key = a137.row_key) 
union
select 'ldb.d_lov_change_request_service_type_c a138 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a13 
on (a11.change_request_key = a13.row_key) 
join ldb.d_lov_change_request_service_type_c a138 
on (a13.service_type_src_c_key = a138.row_key) 
union
select 'ldb.d_lov_change_request_capability_to_detect_c a139 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a13 
on (a11.change_request_key = a13.row_key) 
join ldb.d_lov_change_request_capability_to_detect_c a139 
on (a13.capability_to_detect_src_c_key = a139.row_key) 
union
...
on (a18.quarter_start_date_key = a141.row_key) 
union
...
on (a18.year_start_date_key = a142.row_key) 
