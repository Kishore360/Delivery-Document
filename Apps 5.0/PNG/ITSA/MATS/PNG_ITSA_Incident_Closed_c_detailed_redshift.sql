...
on (a111.closed_by_key = a131.row_key) 
union
...
UNION 
select 'ldb.d_ag_manager_role_vp_dir_ad_c' as Table_Name, count(a11.row_key) Row_Count
from  ldb.f_incident_closed  a11 
JOIN ldb.d_ag_manager_role_vp_dir_ad_c b ON a11.assignment_group_key=b.internal_organization_key
UNION 
...
UNION 
select 'ldb.d_internal_contact_associate_director_c' as Table_Name, count(a11.row_key) Row_Count
from  ldb.f_incident_closed  a11 
JOIN ldb.d_ag_manager_role_vp_dir_ad_c b ON a11.assignment_group_key=b.internal_organization_key
