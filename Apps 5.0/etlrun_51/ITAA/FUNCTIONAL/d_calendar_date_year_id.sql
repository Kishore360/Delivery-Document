...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_calendar_date.year_id' ELSE 'SUCCESS' END as Message
...
AND CAST(DATE_FORMAT(SRC.`DATE`,'%Y') AS SIGNED) <>TRGT.year_id
