...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_calendar_date.month_name' ELSE 'SUCCESS' END as Message
...
AND DATE_FORMAT(SRC.`DATE`,'%M') <>TRGT.month_name
