select 'ldb.f_incident_reassignment_analysis_summary_c a11 ' as Table_name, count(a11.incident_key) Row_Count
...
union
select 'ldb.d_incident_contacttype a16 ' as Table_name, count(a11.incident_key) Row_Count
from ldb.f_incident_reassignment_analysis_summary_c a11 
join ldb.d_incident_contacttype a16 
on (a11.reported_type_src_key = a16.row_key) 
union
select 'ldb.d_calendar_year a17 ' as Table_name, count(a11.incident_key) Row_Count
from ldb.f_incident_reassignment_analysis_summary_c a11 
join ldb.d_calendar_date a12 
on (a11.assigned_on_key = a12.row_key) 
...
union
select 'ldb.d_calendar_month_opened a18 ' as Table_name, count(a11.incident_key) Row_Count
from ldb.f_incident_reassignment_analysis_summary_c a11 
join ldb.d_calendar_date_opened a14 
on (a11.opened_on_key = a14.row_key) 
