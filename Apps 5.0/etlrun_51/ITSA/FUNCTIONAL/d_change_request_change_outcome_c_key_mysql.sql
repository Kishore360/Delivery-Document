SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 ...
 FROM wow_mdsdb.change_request_final SRC 
 LEFT JOIN wow_mdwdb.d_change_request TRGT 
...
AND SRC.sourceinstance= LKP.source_id 
 WHERE COALESCE(LKP.row_key,CASE WHEN null IS NULL THEN 0 else -1 end)<> (TRGT.change_outcome_c_key);
