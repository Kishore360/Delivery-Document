select 'ldb.f_incident_state' as Table_Name, count(a11.row_key) Row_Count
...
union
select'ldb.d_incident_state_from' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_incident_state       a11 
join ldb.d_incident_state_from       a19
on (a11.from_state_src_key=a19.row_key)
union
select'ldb.d_incident_state_to' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_incident_state       a11 
