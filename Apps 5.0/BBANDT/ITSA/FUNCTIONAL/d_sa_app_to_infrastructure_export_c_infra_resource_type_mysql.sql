SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_sa_app_to_infrastructure_export_c.infra_resource_type' ELSE 'SUCCESS' END as Message
 ...
 WHERE src.infra_resource_type <> trgt.infra_resource_type
 and src.cdctype='X';