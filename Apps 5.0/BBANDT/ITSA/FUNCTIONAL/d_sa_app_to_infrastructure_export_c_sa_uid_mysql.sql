SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_sa_app_to_infrastructure_export_c.sa_uid' ELSE 'SUCCESS' END as Message
 ...
 WHERE  coalesce(src.sa_uid,'UNSPECIFIED') <> trgt.sa_uid
 and src.cdctype='X';