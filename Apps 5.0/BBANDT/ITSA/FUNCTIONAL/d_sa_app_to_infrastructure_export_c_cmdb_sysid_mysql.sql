SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_sa_app_to_infrastructure_export_c.cmdb_sysid' ELSE 'SUCCESS' END as Message
 ...
 WHERE src.cmdb_sysid <> trgt.cmdb_sysid
 and src.cdctype='X';