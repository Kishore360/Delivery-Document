...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_task_ci_c.request_task_key' ELSE 'SUCCESS' END as Message 
...
left join bbandt_mdwdb.d_request_task lkp
