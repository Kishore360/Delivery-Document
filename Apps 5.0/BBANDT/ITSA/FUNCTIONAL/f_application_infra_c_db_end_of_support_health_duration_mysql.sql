...
CASE WHEN count(1)>1 then 'Data mismatch for f_application_infra_c.db_end_of_support_health_duration'  ELSE 'SUCCESS'  END as Message
...
where timestampdiff(SECOND, CONVERT_TZ(a16.lastupdated,'America/New_York','GMT'),a14.Support_End_Date)<>a15.db_end_of_support_health_duration
