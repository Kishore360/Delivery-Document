...
CASE WHEN count(1)>1 then 'Data mismatch for f_application_infra_c.location'  ELSE 'SUCCESS'  END as Message
...
where COALESCE(a11.location,'UNSPECIFIED')<>a12.location
and a11.cdctype='X';