SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_v_app_to_server_to_product_c.app_id' ELSE 'SUCCESS' END as Message
 ...
 WHERE COALESCE(src.app_id,'UNSPECIFIED') <> trgt.app_id
 and src.cdctype='X';
