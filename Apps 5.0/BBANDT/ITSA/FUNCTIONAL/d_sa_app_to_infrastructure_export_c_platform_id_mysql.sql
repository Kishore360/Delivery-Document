SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_sa_app_to_infrastructure_export_c.platform_id' ELSE 'SUCCESS' END as Message
 ...
 WHERE src.platform_id <> trgt.platform_id
 and src.cdctype='X';