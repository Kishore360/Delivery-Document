...
join (select max(lastupdated) as lastupdated,source_id from bbandt_mdwdb.d_o_data_freshness a group by source_id) o_data
on (src.sourceinstance=o_data.source_id )
join bbandt_mdwdb.d_archer_application_c trgt
