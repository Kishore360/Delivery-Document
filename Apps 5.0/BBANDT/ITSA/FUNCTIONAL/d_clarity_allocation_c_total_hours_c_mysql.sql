...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for d_clarity_allocation_c.total_hrs_c' ELSE 'SUCCESS' END as Message 
...
where trgt.total_hrs_c <>src.total_hrs;