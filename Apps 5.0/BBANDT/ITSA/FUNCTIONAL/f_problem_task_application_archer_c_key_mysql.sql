...
CASE WHEN count(1)>1 then 'Data mismatch for f_problem_task.application_archer_c_key'  ELSE 'SUCCESS'  END as Message
...
JOIN bbandt_mdwdb.f_problem_task TRGT ON SRC.sys_id=TRGT.row_id AND SRC.sourceinstance=TRGT.source_id
