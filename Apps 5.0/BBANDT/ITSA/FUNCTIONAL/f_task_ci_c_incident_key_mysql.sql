...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_task_ci_c.incident_key' ELSE 'SUCCESS' END as Message 
...
join bbandt_mdwdb.d_incident lkp
...
and SRC.cdctype='X' and task.CDCTYPE='X'  and lkp.soft_deleted_flag='N';
