...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for d_clarity_allocation_c.invest_id_c' ELSE 'SUCCESS' END as Message 
...
where trgt.invest_id_c <>src.invest_id;