SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_v_server_to_product_c.u_environment' ELSE 'SUCCESS' END as Message
 -- select COALESCE(src.u_environment,'UNSPECIFIED'), trgt.u_environment
