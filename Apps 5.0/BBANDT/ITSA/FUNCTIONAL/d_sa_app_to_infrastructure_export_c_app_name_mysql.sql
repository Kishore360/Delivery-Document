SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_sa_app_to_infrastructure_export_c.app_name' ELSE 'SUCCESS' END as Message
 ...
 WHERE src.app_name <> trgt.app_name
 and src.cdctype='X';