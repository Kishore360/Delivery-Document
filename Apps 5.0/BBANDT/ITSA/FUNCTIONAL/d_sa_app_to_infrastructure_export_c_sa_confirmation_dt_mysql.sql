SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_sa_app_to_infrastructure_export_c.sa_confirmation_dt' ELSE 'SUCCESS' END as Message
 ...
 WHERE src.sa_confirmation_dt <> trgt.sa_confirmation_dt
 and src.cdctype='X';