...
CASE WHEN count(1)>1 then 'Data mismatch for f_application_infra_c.infra_resource_name'  ELSE 'SUCCESS'  END as Message
...
where COALESCE(a11.infra_resource_name,'UNSPECIFIED')<>a12.infra_resource_name
and a11.cdctype='X';