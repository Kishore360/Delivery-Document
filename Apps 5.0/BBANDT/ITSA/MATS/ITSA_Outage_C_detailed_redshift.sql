...
union
select 'ldb.d_eit_application_c a112 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_outage a11
join ldb.d_eit_application_c a112
on (a11.eit_application_c_key = a112.row_key)
union
...
union
select 'ldb.d_problem a119 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_outage a11
join ldb.d_problem a119
on (a11.incident_related_problem_c_key = a119.row_key)
union
