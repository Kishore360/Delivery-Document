select 'ldb.f_incident_keyword_description_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_incident_keyword_description_c       a11 
union
select 'ldb.ldb.d_calendar_date' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_incident_keyword_description_c       a11 
join ldb.d_calendar_date       a12
on (a11.opened_on_key=a12.row_key)
union
select'ldb. ldb.d_task_priority' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_incident_keyword_description_c       a11 
join ldb.d_task_priority       a13
...
on (a11.table_row_key=a16.row_key)
union
...
select'ldb.dh_assignment_group_type_hierarchy' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_incident_keyword_description_c       a11 
join ldb.dh_assignment_group_type_hierarchy       a111
on (a11.assignment_group_key=a111.user_group_type_key)
union
...
on (a12.row_key=a113.greogrian_calendar_key)
union
...
select'ldb.d_incident_major_incident_state_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_incident_keyword_description_c       a11 
join ldb.d_incident_major_incident_state_c       a121
on (a11.u_major_incident_state_src_c_key=a121.row_key)
union
select'ldb.d_internal_contact' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_incident_keyword_description_c       a11 
join ldb.d_internal_contact       a122
on (a11.opened_on_behalf_of_c_key=a122.row_key)
union
select'ldb.d_incident_impact_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_incident_keyword_description_c       a11 
join ldb.d_incident_impact_c       a123
on (a11.u_impact_src_c_key=a123.row_key)
union
...
on (a19.level0_manager_c_key=a124.level0_manager_c_key)
union
...
on (a112.cah_ci_type_src_code_c_key=a125.row_key)
union
...
on (a112.cah_bus_criticl_src_code_c_key=a126.row_key)
union
...
on (a112.cah_bus_segment_src_code_c_key=a127.row_key)
union
...
on (a112.cah_bus_unit_src_code_c_key=a128.row_key)
union
select'ldb.d_internal_contact' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_incident_keyword_description_c       a11 
 join ldb.d_configuration_item       a112
...
on (a112.eit_sup_leader_c_key=a129.row_key)
union
...
on (a112.cah_support_grp_src_code_c_key=a130.row_key)
union
...
on (a12.month_start_date_key=a132.row_key)
union
...
on (a114.period_start_date_key=a131.row_key)
union
...
on (a114.quarter_start_date_key=a133.row_key)
union
...
on (a114.year_start_date_key=a134.row_key)
