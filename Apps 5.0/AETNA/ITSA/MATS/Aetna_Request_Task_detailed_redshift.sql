...
union
select 'ldb.d_sc_task_priority a116 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_request_task a11 
join ldb.d_sc_task_priority a116 
on (a11.priority_src_key = a116.row_key) 
union
select 'ldb.d_sc_task_state a117 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_request_task a11 
join ldb.d_sc_task_state a117 
