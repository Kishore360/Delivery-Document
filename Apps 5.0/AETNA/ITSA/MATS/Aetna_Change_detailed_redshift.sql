...
on (a15.criticality_key = a125.row_key) 
union
...
on (a15.used_for_src_key = a126.row_key) 
union
...
on (a16.month_start_date_key = a127.row_key) 
union
...
union
select 'ldb.d_lov_change_request_data_center_alerts_c a129 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a17 
on (a11.change_request_key = a17.row_key) 
join ldb.d_lov_change_request_data_center_alerts_c a129 
on (a17.data_center_alerts_src_c_key = a129.row_key) 
union
select 'ldb.d_lov_change_request_verification_method_c a130 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a17 
on (a11.change_request_key = a17.row_key) 
join ldb.d_lov_change_request_verification_method_c a130 
on (a17.verification_method_src_c_key = a130.row_key) 
union
select 'ldb.d_lov_change_request_impact_during_change_c a131 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a17 
on (a11.change_request_key = a17.row_key) 
join ldb.d_lov_change_request_impact_during_change_c a131 
on (a17.impact_during_change_src_c_key = a131.row_key) 
union
select 'ldb.d_lov_change_request_resolution_reason_c a132 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_change_request a17 
on (a11.change_request_key = a17.row_key) 
join ldb.d_lov_change_request_resolution_reason_c a132 
on (a17.resolution_reason_src_c_key = a132.row_key) 
union
...
on (a16.quarter_start_date_key = a133.row_key) 
union
...
on (a16.year_start_date_key = a134.row_key) 
