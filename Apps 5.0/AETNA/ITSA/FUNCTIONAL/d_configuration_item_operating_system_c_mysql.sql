...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for d_configuration_item.operating_system_c' ELSE 'SUCCESS' END as Message 
...
where 
COALESCE(comp.os,ser.os,'UNSPECIFIED') <> trgt.operating_system_c;