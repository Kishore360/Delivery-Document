select 'ldb.n_request_task_io_snapshot_monthly_c a11 ' as Table_name, count(a11.row_key) Row_Count
from ldb.n_request_task_io_snapshot_monthly_c a11 
union
...
on (a11.month_start_key = a13.row_key) 
union
