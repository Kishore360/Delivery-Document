select 'ldb.a_incident_weekly_c a11 ' as Table_name, count(1) Row_Count
...
union
select 'ldb.d_business_service a14 ' as Table_name, count(1) Row_Count
from ldb.a_incident_weekly_c a11 
join ldb.d_business_service a14 
on (a11.business_service_key = a14.row_key) 
union
select 'ldb.d_calendar_week a15 ' as Table_name, count(1) Row_Count
from ldb.a_incident_weekly_c a11 
join ldb.d_calendar_week a15 
on (a11.period_start_c_key = a15.row_key) 
union
select 'ldb.d_internal_contact_assignment_group_manager_c a16 ' as Table_name, count(1) Row_Count
from ldb.a_incident_weekly_c a11 
join ldb.d_internal_organization_group a12 
on (a11.assignment_group_key = a12.row_key) 
