...
from 
(select count(1) as cnt  from (select sys_id, sourceinstance, u_workplace_location, cdctime from mcd_mdsdb.incident_final) src
left join mcd_mdsdb.u_integration_srms_location_final src1 on src1.sys_id=src.u_workplace_location and src.sourceinstance=src1.sourceinstance
