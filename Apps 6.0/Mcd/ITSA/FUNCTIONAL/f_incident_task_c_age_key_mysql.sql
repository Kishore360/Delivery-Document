...
on src.sys_id = trgt.row_id and src.sourceinstance = trgt.source_id
 JOIN mcdonalds_mdwdb.d_lov lkp ON floor(trgt.age/86400) BETWEEN lkp.lower_range_value AND lkp.upper_range_value and lkp.dimension_class ='AGEBUCKET_WH~INCIDENT_TASK'
