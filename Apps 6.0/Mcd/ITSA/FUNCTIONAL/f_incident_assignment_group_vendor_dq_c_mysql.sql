...
(case when assignment_group  is  null  then 0 
 when sys_user_group.u_vendor  is  null  then 0 
  ...
  when core_company.name in ('UNSPECIFED', 'unspecified', 'Unspecified', 'null', 'spaces', 'UNALLOCATED', 'Unallocated', 
     'unallocated', 'Undefined', 'UNDEFINED', 'undefined', 'UNKONWN', 'unknown', 'Unknown') or core_company.name is null 
