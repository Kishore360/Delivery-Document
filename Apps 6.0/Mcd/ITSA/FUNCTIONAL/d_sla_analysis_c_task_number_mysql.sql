...
(select sys_id,sys_class_name,sourceinstance,number  from mcd_mdsdb.task_final 
...
join (select source_id,row_id,task_number from mcd_mdwdb.d_sla_analysis_c where soft_deleted_flag='N' )e 
