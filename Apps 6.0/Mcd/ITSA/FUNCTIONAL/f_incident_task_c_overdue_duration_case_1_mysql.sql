...
WHERE IF(CONVERT_TZ(src.due_date,'GMT','US/Central') < df.lastupdated , TIMESTAMPDIFF(SECOND,CONVERT_TZ(src.due_date,'GMT','US/Central'),df.lastupdated),0)  <> trgt.overdue_duration
;