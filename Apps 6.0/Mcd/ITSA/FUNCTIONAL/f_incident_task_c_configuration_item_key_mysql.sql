...
RIGHT JOIN (SELECT *,COALESCE(src.cmdb_ci,'UNSPECIFIED') as jn1 FROM mcd_mdsdb.incident_task_final src) src
on src.sys_id = trgt.row_id and src.sourceinstance = trgt.source_id
LEFT JOIN mcd_mdwdb.d_configuration_item lkp ON  src.jn1= lkp.row_id and src.sourceinstance = lkp.source_id
