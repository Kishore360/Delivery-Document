...
JOIN rogers6_mdsdb.incident_final p ON d.row_id=p.sys_id and p.sourceinstance=d.source_id
left join rogers6_mdwdb.d_internal_organization d1 on case                   
...
then 0 else -1 end ) <> business_unit_assignment_group_c_key  
and p.cdctype='X'  and d1.soft_deleted_flag='N' )a