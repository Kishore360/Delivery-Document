...
join rogers6_mdwdb.f_request_item f on d.row_id=f.row_id and d.source_id=f.source_id
join rogers6_mdwdb.d_request_item dr on f.request_item_key=dr.row_key
join rogers6_mdwdb.d_master_item d1 on f.catalog_item_key=d1.row_key
