...
where sla='3.3.24' and d.hcl_schedule_ac_attachment_ref ='Availability' )a1
left join 
(
...
where component_criticality_c='Important'   and dc.subcategory in ('AIX Server','UNIX Server','HPUX Server','Solaris Server')  
                       -- New addition 
