...
where sla='3.3.26' and d.hcl_schedule_ac_attachment_ref ='Availability' )a1
left join 
(
...
where component_criticality_c='Productivity'   and dc.subcategory in ('AIX Server','UNIX Server','HPUX Server','Solaris Server')  
