select 'ldb.f_incident' as Table_Name, count(1) Row_Count
 ...
 union
 select 'ldb.d_application_incident_subcategory_c' as Table_Name, count(1) Row_Count
 from  ldb.f_incident       a11
 join ldb.d_application_incident_subcategory_c p131
 on application_subcategory_c_key=p131.row_key
 union
 select'ldb.d_internal_organization_incident_pit_lead_c' as Table_Name, count(1) Row_Count
 from  ldb.f_incident       a11 
 join ldb.d_problem       a14
on (a11.problem_key = a14.row_key)
join	ldb.d_internal_organization_incident_pit_lead_c	a154
	  on 	(a14.assignment_group_for_pit_lead_c_key = a154.row_key)
 union
  select 'ldb.d_internal_contact_app_support_director_c' as Table_Name, count(1) Row_Count
 from  ldb.f_incident       a11
 join ldb.d_application_incident_subcategory_c p131
 on application_subcategory_c_key=p131.row_key
 join	ldb.d_internal_contact_app_support_director_c	a132
	  on 	(p131.application_support_director_c_key = a132.row_key)
	   union
  select 'ldb.d_internal_contact_app_support_manager_c' as Table_Name, count(1) Row_Count
 from  ldb.f_incident       a11
 join ldb.d_application_incident_subcategory_c p131
 on application_subcategory_c_key=p131.row_key
 join	ldb.d_internal_contact_app_support_manager_c	a133
	  on 	(p131.application_support_manager_c_key = a133.row_key)
	     union
  select 'ldb.d_internal_contact_app_vp_c' as Table_Name, count(1) Row_Count
 from  ldb.f_incident       a11
 join ldb.d_application_incident_subcategory_c p131
 on application_subcategory_c_key=p131.row_key
 join	ldb.d_internal_contact_app_vp_c	a134
	  on 	(p131.application_vp_c_key = a134.row_key)
 
union
select'ldb.d_business_unit_assignment_group_c' as Table_Name, count(1) Row_Count
 from  ldb.f_incident       a11 
join ldb.d_business_unit_assignment_group_c       a12
on (a11.business_unit_assignment_group_c_key = a12.row_key)
union
select'ldb.d_assignment_group_support_group_business_unit_c' as Table_Name, count(1) Row_Count
 from  ldb.f_incident       a11
 join ldb.d_business_unit_assignment_group_c       a12
on (a11.business_unit_assignment_group_c_key = a12.row_key)
...
union
select'ldb.d_internal_contact_caller_id_c' as Table_Name, count(1) Row_Count
 from  ldb.f_incident       a11 
 join ldb.d_incident       a14
on (a11.incident_key = a14.row_key)
left outer join	ldb.d_internal_contact_caller_id_c	a145
	  on 	(a14.opened_by_c_key = a145.row_key)
	  union
	  select'ldb.d_internal_organization_caller_id_department_c' as Table_Name, count(1) Row_Count
 from  ldb.f_incident       a11 
 join ldb.d_incident       a14
on (a11.incident_key = a14.row_key)
left outer join	ldb.d_internal_contact_caller_id_c	a145
	  on 	(a14.opened_by_c_key = a145.row_key)
left outer join	ldb.d_internal_organization_caller_id_department_c	a170
	  on 	(a145.department_key = a170.row_key)
union
...
union
select'ldb.d_calendar_date_closed_c' as Table_Name, count(1) Row_Count
 from  ldb.f_incident       a11 
left join ldb.d_calendar_date_closed_c       a114
on (a11.closed_on_key = a114.row_key)
union
select'ldb.d_calendar_date_opened_c' as Table_Name, count(1) Row_Count
 from  ldb.f_incident       a11 
...
union
select'ldb.d_lov_incident_incident_type_c' as Table_Name, count(1) Row_Count
 from  ldb.f_incident       a11 
 join ldb.d_incident       a14
on (a11.incident_key = a14.row_key)
...
union
select'ldb.d_lov_incident_event_type_c' as Table_Name, count(1) Row_Count
 from  ldb.f_incident       a11
 join ldb.d_incident       a14
on (a11.incident_key = a14.row_key)
...
union
select'ldb.d_incident_opened_by' as Table_Name, count(1) Row_Count
 from  ldb.f_incident       a11 
 join ldb.d_incident       a14
on (a11.incident_key = a14.row_key)
...
union
select'ldb.d_task_sla_resolution_flag' as Table_Name, count(1) Row_Count
 from  ldb.f_incident       a11
 join ldb.d_incident       a14
on (a11.incident_key = a14.row_key)
...
union
select'ldb.d_incident_resolved_by' as Table_Name, count(1) Row_Count
 from  ldb.f_incident       a11
 join ldb.d_incident       a14
on (a11.incident_key = a14.row_key)
...
union
select'ldb.d_task_sla_response_flag' as Table_Name, count(1) Row_Count
 from  ldb.f_incident       a11 
 join ldb.d_incident       a14
on (a11.incident_key = a14.row_key)
...
union
select'ldb.d_lov_incident_sub_status_c' as Table_Name, count(1) Row_Count
 from  ldb.f_incident       a11 
 join ldb.d_incident       a14
on (a11.incident_key = a14.row_key)
...
union
select'ldb.d_internal_contact_vp_svp_incident_c' as Table_Name, count(1) Row_Count
 from  ldb.f_incident       a11 
  join ldb.d_business_unit_assignment_group_c       a12
on (a11.business_unit_assignment_group_c_key = a12.row_key)
join ldb.d_assignment_group_support_group_business_unit_c       a13
...
union
select'ldb.d_internal_contact_opened_by_manager_c' as Table_Name, count(1) Row_Count
 from  ldb.f_incident       a11 
 join ldb.d_incident       a14
on (a11.incident_key = a14.row_key)

	join	ldb.d_internal_contact_opened_by_c	a153
	  on 	(a14.opened_by_key = a153.row_key)
	 join	ldb.d_internal_contact_opened_by_manager_c	a189
	  on 	(a153.manager_key = a189.row_key)
