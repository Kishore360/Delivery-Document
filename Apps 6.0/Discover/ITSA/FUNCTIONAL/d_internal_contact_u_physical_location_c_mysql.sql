...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for d_problem.u_physical_location_c' ELSE 'SUCCESS' END as Message
FROM
(
...
WHERE SRC.u_physical_location<>TRGT.u_physical_location_c
AND SRC.cdctype='X'
) temp;