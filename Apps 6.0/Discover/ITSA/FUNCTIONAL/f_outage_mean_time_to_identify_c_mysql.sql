...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for f_outage.mean_time_to_identify_c' ELSE 'SUCCESS' END as Message 
...
inner join discover_mdwdb.f_outage tgt
