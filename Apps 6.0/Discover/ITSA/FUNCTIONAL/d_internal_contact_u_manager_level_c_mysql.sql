...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for d_problem.u_manager_level_c' ELSE 'SUCCESS' END as Message
FROM
(
...
WHERE SRC.u_manager_level<>TRGT.u_manager_level_c
AND SRC.cdctype='X'
) temp;