...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for f_problem.vp_c_key' ELSE 'SUCCESS' END as Message
FROM 
(
...
LEFT JOIN discover_mdwdb.d_internal_contact LKP ON ( concat( 'INTERNAL_CONTACT~' , SRC.u_vp) = LKP.row_id 
