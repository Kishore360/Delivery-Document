...
union
select 'ldb.d_standard_change a130 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_standard_change a130
on (a11.standard_change_c_key = a130.row_key)
union
select 'ldb.d_change_template_c a131 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_change_template_c a131
on (a11.change_template_c_key = a131.row_key)
union
select 'ldb.d_change_vendor_c a132 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_change_vendor_c a132
on (a11.change_vendor_c_key = a132.row_key)
union
...
union
select 'ldb.d_lov_change_cab_review a135 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_change_request a17
on (a11.change_request_key = a17.row_key)
join ldb.d_lov_change_cab_review a135
on (a17.change_cab_review_c_key = a135.row_key)
union
...
union
select 'ldb.d_lov_change_caused_problem a137 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_change_request a17
on (a11.change_request_key = a17.row_key)
join ldb.d_lov_change_caused_problem a137
on (a17.change_caused_problem_c_key = a137.row_key)
union
select 'ldb.d_lov_change_stage a138 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_change_request a17
on (a11.change_request_key = a17.row_key)
join ldb.d_lov_change_stage a138
on (a17.change_stage_c_key = a138.row_key)
union
select 'ldb.d_lov_change_code_repository_system_c a139 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_change_request a17
on (a11.change_request_key = a17.row_key)
join ldb.d_lov_change_code_repository_system_c a139
on (a17.change_code_repository_system_c_key = a139.row_key)
union
select 'ldb.d_lov_change_communication_method a140 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_change_request a17
on (a11.change_request_key = a17.row_key)
join ldb.d_lov_change_communication_method a140
on (a17.change_communication_method_c_key = a140.row_key)
union
select 'ldb.d_lov_change_completion_code a141 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_change_request a17
on (a11.change_request_key = a17.row_key)
join ldb.d_lov_change_completion_code a141
on (a17.change_completion_code_c_key = a141.row_key)
union
select 'ldb.d_lov_change_cab_prior_to_install a142 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_change_request a17
on (a11.change_request_key = a17.row_key)
join ldb.d_lov_change_cab_prior_to_install a142
on (a17.change_cab_prior_to_install_c_key = a142.row_key)
union
select 'ldb.d_lov_change_environment a143 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_change_request a17
on (a11.change_request_key = a17.row_key)
join ldb.d_lov_change_environment a143
on (a17.change_environment_c_key = a143.row_key)
union
select 'ldb.d_lov_change_executive_flag a144 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_change_request a17
on (a11.change_request_key = a17.row_key)
join ldb.d_lov_change_executive_flag a144
on (a17.change_executive_flag_c_key = a144.row_key)
union
select 'ldb.d_lov_change_project_related a145 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_change_request a17
on (a11.change_request_key = a17.row_key)
join ldb.d_lov_change_project_related a145
on (a17.change_project_related_c_key = a145.row_key)
union
select 'ldb.d_lov_change_sponsors_risk_assessment a146 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_change_request a17
on (a11.change_request_key = a17.row_key)
join ldb.d_lov_change_sponsors_risk_assessment a146
on (a17.change_sponsors_risk_assessment_c_key = a146.row_key)
union
select 'ldb.d_lov_change_subcategory a147 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_change_request a17
on (a11.change_request_key = a17.row_key)
join ldb.d_lov_change_subcategory a147
on (a17.change_subcategory_c_key = a147.row_key)
union
