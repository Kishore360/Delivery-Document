...
where (supplier <> 'N' AND supplier IS NOT NULL) and app_hexid is not null and responsible_org_unit_hexid is not null
and cdctype='X' 
...
WHERE COALESCE(SRC1.Organization_NAME,'UNSPECIFIED')<>TRGT.rita_app_technology_supplier_name
