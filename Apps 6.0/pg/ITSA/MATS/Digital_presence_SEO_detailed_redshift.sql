select 'ldb.f_dgtl_seo_data_c a11 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_dgtl_seo_data_c a11
union
...
union
select 'ldb.d_dgtl_seo_data_c a15 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_dgtl_seo_data_c a11
join ldb.d_dgtl_seo_data_c a15
on (a11.dgtl_seo_data_c_key = a15.row_key)
union
