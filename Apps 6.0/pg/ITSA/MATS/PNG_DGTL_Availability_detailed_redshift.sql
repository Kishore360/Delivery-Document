...
union
select 'ldb.d_dgtl_availability_report_c a12 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_dgtl_availability_c a11 
join ldb.d_dgtl_availability_report_c a12 
on (a11.dgtl_availability_report_c_key = a12.row_key) 
union
