...
select 'ldb.d_problem_impact a122 ' as Table_name, count(a11.row_key) Row_Count
 ...
 union
select 'ldb.d_problem_owner_c a123 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_closed a11 
 join ldb.d_problem_owner_c a123 
	on (a11.u_problem_owner_c_key = a123.row_key)  
 union
select 'ldb.d_problem_owner_group_c a124 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_closed a11 
 join ldb.d_problem_owner_group_c a124 
	on (a11.problem_owner_group_c_key = a124.row_key)  
 union
select 'ldb.d_problem_priority a125 ' as Table_name, count(a11.row_key) Row_Count
 ...
 union
select 'ldb.d_problem_rca_accepted_by_c a126 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_closed a11 
 join ldb.d_problem_rca_accepted_by_c a126 
	on (a11.u_rca_accepted_by_c_key = a126.row_key)  
 union
select 'ldb.d_problem_rca_completed_by_c a127 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_closed a11 
 join ldb.d_problem_rca_completed_by_c a127 
	on (a11.u_rca_completed_by_c_key = a127.row_key)  
 union
select 'ldb.d_problem_solved_by_c a128 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_closed a11 
 join ldb.d_problem_solved_by_c a128 
	on (a11.u_solved_by_c_key = a128.row_key)  
 union
select 'ldb.d_lov_problem_subcategory_c a129 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_closed a11 
 join ldb.d_lov_problem_subcategory_c a129 
...
select 'ldb.d_problem_urgency a130 ' as Table_name, count(a11.row_key) Row_Count
 ...
 union
select 'ldb.d_problem_vendor_c a131 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_closed a11 
 join ldb.d_problem_vendor_c a131 
	on (a11.u_vendor_c_key = a131.row_key)  
 union
select 'ldb.d_problem_incident_c a132 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_closed a11 
 join ldb.d_problem_incident_c a132 
	on (a11.problem_incident_c_key = a132.row_key)  
 union
select 'ldb.d_problem_manager_c a133 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_closed a11 
 join ldb.d_problem_manager_c a133 
	on (a11.u_problem_manager_c_key = a133.row_key)  
 union
select 'ldb.d_problem_manager_group_c a134 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_closed a11 
 join ldb.d_problem_manager_group_c a134 
	on (a11.problem_manager_group_c_key = a134.row_key)  
 union
...
select 'ldb.d_calendar_week a138 ' as Table_name, count(a11.row_key) Row_Count
 ...
 on (a11.date_key = a19.row_key) 
	...
	on (a19.week_start_date_key = a138.row_key)  
 union
select 'ldb.d_lov_problem_close_code_c a139 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_closed a11 
 join ldb.d_problem a113 
 on (a11.problem_key = a113.row_key) 
	join ldb.d_lov_problem_close_code_c a139 
	on (a113.problem_close_code_c_key = a139.row_key)  
 union
select 'ldb.d_lov_problem_root_cause_code_level1_c a140 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_closed a11 
 join ldb.d_problem a113 
 on (a11.problem_key = a113.row_key) 
	join ldb.d_lov_problem_root_cause_code_level1_c a140 
	on (a113.problem_root_cause_code_level_1_c_key = a140.row_key)  
 union
select 'ldb.d_lov_problem_root_cause_code_level2_c a141 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_closed a11 
 join ldb.d_problem a113 
 on (a11.problem_key = a113.row_key) 
	join ldb.d_lov_problem_root_cause_code_level2_c a141 
	on (a113.problem_root_cause_code_level_2_c_key = a141.row_key)  
 union
select 'ldb.d_problem_state a142 ' as Table_name, count(a11.row_key) Row_Count
 ...
 on (a11.problem_key = a113.row_key) 
	...
	on (a113.state_src_key = a142.row_key)  
 union
...
select 'ldb.d_calendar_year a144 ' as Table_name, count(a11.row_key) Row_Count
 ...
 on (a110.quarter_start_date_key = a111.row_key) 
	...
	on (a111.year_start_date_key = a144.row_key)  