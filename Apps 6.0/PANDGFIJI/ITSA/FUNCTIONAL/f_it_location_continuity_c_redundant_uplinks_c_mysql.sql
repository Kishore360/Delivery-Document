SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_it_location_continuity_c.redundant_uplinks_c
...
where SRC.Redundant_Uplinks <> TRGT.redundant_uplinks_c
