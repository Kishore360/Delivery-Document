SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_it_location_continuity_c.tier2_3itc_score_c
...
where ROUND(SRC.Tier2_3ITC_Score,5) <> TRGT.tier2_3itc_score_c
