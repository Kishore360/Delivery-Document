...
ibmwatson_mdsdb.sys_user_group_final a12
left join ibmwatson_mdwdb.d_tribe_c a14 on a12.u_tribe=a14.row_id and a12.sourceinstance=a14.source_id
 join ibmwatson_mdwdb.d_internal_organization a122
on a122.row_id=concat('GROUP~',a12.sys_id) and a122.source_id=a12.sourceinstance
where coalesce(a14.row_key,case when a12.u_tribe is null then 0 else -1 end)<>a122.tribe_c_key and a12.CDCTYPE='X')acv
