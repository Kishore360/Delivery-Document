...
JOIN ibmwatson_mdwdb.d_lov LKP ON (COALESCE(CONCAT('OPERATIONAL_STATUS~CMDB_CI~~~',a11.operational_status),'UNSPECIFIED')= LKP.row_id
 AND a11.sourceinstance=LKP.source_id)
 left join ibmwatson_mdsdb.u_cloud_offering_final a13 on a11.sys_id = a13.sys_id
