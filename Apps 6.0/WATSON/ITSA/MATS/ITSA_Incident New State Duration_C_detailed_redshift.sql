...
union
select 'ldb.d_incident_new_state_duration_tribe_c a19 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_new_state_duration_c a11
join ldb.d_incident_new_state_duration_tribe_c a19
...
on (a14.segment_type_c_key = a111.row_key)
union
