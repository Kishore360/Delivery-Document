...
union
select 'ldb.d_ci_tribe_c a14 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_ci_tribe_c a11
join ldb.d_ci_tribe_c a14
on (a11.tribe_c_key = a14.row_key)
union
...
on (a12.segment_type_c_key = a15.row_key)
union
...
on (a13.operational_status_src_c_key = a16.row_key)