...
union
select 'ldb.d_ci_tribe_c a15 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_ci_tribe_c a11
join ldb.d_ci_tribe_c a15
...
union
select 'ldb.d_lov_configuration_item_operational_status_src_c a17 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_ci_tribe_c a11
join ldb.d_configuration_item a12
on (a11.configuration_item_key = a12.row_key)
join ldb.d_lov_configuration_item_operational_status_src_c a17
on (a12.operational_status_src_c_key = a17.row_key)
