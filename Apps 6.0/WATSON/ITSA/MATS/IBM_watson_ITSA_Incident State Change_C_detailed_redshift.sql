...
union
select 'ldb.d_tribe_c a17 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_state a11
...
union
select 'ldb.d_incident_state_to a112 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_state a11
join ldb.d_incident_state_to a112
on (a11.to_state_src_key = a112.row_key)
union
...
on (a18.segment_type_c_key = a115.row_key)
