...
left join pan6_mdwdb.d_internal_contact b
on concat('INTERNAL_CONTACT~',ij.part1)=b.row_id
left join pan6_mdwdb.d_internal_contact c
...
left join pan6_mdwdb.d_internal_contact f
on concat('INTERNAL_CONTACT~',ij.part5)=f.row_id
left join pan6_mdwdb.d_internal_contact g
