...
where
 met_all_response_sla_flag_c <>
CASE WHEN non_cancelled_breached_count_response > 0 THEN 'N'
WHEN non_cancelled_count_response > 0 and non_cancelled_breached_count_response = 0 THEN 'Y'
WHEN response_count = 0 THEN 'X'
WHEN response_count = cancelled_count_response  THEN 'C'
ELSE 'X'
END
