SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_it_location_continuity_c.system_test_full_c
...
where ROUND(SRC.System_Test_Full,5) <> TRGT.system_test_full_c
