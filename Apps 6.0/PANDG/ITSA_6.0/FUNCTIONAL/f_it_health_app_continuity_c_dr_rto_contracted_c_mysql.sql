SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_it_health_app_continuity_c.dr_rto_contracted_c' ELSE 'SUCCESS' END as Message
 FROM
...
where SRC.DR_RTO_Contracted<>TRGT.dr_rto_contracted_c