...
from ldb.f_problem_closed a11 
join ldb.d_ag_manager_role_vp_dir_ad_c a12 on (a11.problem_assignment_group_key = a12.internal_organization_key) 
union
...
from ldb.f_problem_closed a11 
join ldb.d_calendar_date a110 on (a11.date_key = a110.row_key) 
join ldb.d_calendar_month a115 on (a110.month_start_date_key = a115.row_key) 
union
...
from ldb.f_problem_closed a11 
join ldb.d_calendar_date a110 on (a11.date_key = a110.row_key) 
join ldb.d_calendar_week a117 on (a110.week_start_date_key = a117.row_key) 
union
...
from ldb.f_problem_closed a11 
join ldb.d_calendar_date_fiscal a14 on (a11.fiscal_date_key = a14.row_key) 
join ldb.d_calendar_fiscal_quarter a124 on (a14.quarter_start_date_key = a124.row_key) 
union
...
from ldb.f_problem_closed a11 
join ldb.d_problem_urgency a132 on (a11.urgency_src_key = a132.row_key) 
union
select 'ldb.d_internal_contact_pg_root_cause_analyst_c a133 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem_closed a11 
join ldb.d_internal_contact_pg_root_cause_analyst_c a133 on (a11.pg_root_cause_analyst_c_key = a133.row_key) 
union
select 'ldb.d_internal_contact_pf_sfa_owner_c a134 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem_closed a11 
join ldb.d_internal_contact_pf_sfa_owner_c a134 on (a11.pf_sfa_owner_c_key = a134.row_key) 
union
select 'ldb.d_internal_contact_vp_c a135 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem_closed a11 
join ldb.d_ag_manager_role_vp_dir_ad_c a12 on (a11.problem_assignment_group_key = a12.internal_organization_key) 
join ldb.d_internal_contact_vp_c a135 on (a12.vp_key = a135.row_key) 
union
...
join ldb.d_business_service_criticality a138 on (a19.criticality_key = a138.row_key) 
union
select 'ldb.d_business_service_used_for a139 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem_closed a11 
join ldb.d_business_service a19 on (a11.business_service_key = a19.row_key) 
join ldb.d_business_service_used_for a139 on (a19.used_for_src_key = a139.row_key) 
union
select 'ldb.d_calendar_fiscal_year a140 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem_closed a11 
join ldb.d_calendar_date_fiscal a14 on (a11.fiscal_date_key = a14.row_key) 
join ldb.d_calendar_fiscal_year a140 on (a14.year_start_date_key = a140.row_key) 
union
...
join ldb.d_lov_pg_other_impact_c a141 on (a113.pg_other_impact_src_c_key = a141.row_key) 
union
select 'ldb.d_lov_pg_problem_identification_c a142 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem_closed a11 
join ldb.d_problem a113 on (a11.problem_key = a113.row_key) 
join ldb.d_lov_pg_problem_identification_c a142 on (a113.pg_problem_identification_src_c_key = a142.row_key) 
union
...
from ldb.f_problem_closed a11 
join ldb.d_problem a113 on (a11.problem_key = a113.row_key) 
join ldb.d_problem_state a144 on (a113.state_src_key = a144.row_key) 
union
...
from ldb.f_problem_closed a11 
join ldb.d_problem a113 on (a11.problem_key = a113.row_key) 
join ldb.d_lov_problem_root_cause_sub_code_c a146 on (a113.root_cause_sub_code_src_c_key = a146.row_key) 
union
select 'ldb.d_lov_problem_sfa_status_c a147 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem_closed a11 
join ldb.d_problem a113 on (a11.problem_key = a113.row_key) 
join ldb.d_lov_problem_sfa_status_c a147 on (a113.sfa_status_c_key = a147.row_key) 
union
