SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_dgtl_availability_report_c.end_date_c' ELSE 'SUCCESS' END as Message
 FROM
...
where SRC.END_DATE  <> TRGT.end_date_c
