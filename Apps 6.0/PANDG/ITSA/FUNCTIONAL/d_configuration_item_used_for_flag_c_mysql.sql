...
FROM png_mdsdb.cmdb_ci_final a11
LEFT JOIN png_mdsdb.cmdb_ci_appl_final a12 ON a11.sys_id = a12.sys_id AND a11.sourceinstance = a12.sourceinstance
LEFT JOIN png_mdsdb.cmdb_ci_db_instance_final a13 ON a11.sys_id = a13.sys_id AND a11.sourceinstance = a13.sourceinstance
LEFT JOIN png_mdsdb.cmdb_ci_service_final a14 ON a11.sys_id = a14.sys_id AND a11.sourceinstance = a14.sourceinstance
LEFT JOIN png_mdsdb.service_offering_final a15 ON a11.sys_id = a15.sys_id AND a11.sourceinstance = a15.sourceinstance
) src
