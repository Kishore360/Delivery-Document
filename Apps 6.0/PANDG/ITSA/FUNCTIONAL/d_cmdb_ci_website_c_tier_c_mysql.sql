SELECT CASE WHEN cnt> 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN cnt>0 THEN 'MDS to DWH data validation failed for d_cmdb_ci_website_c.tier_c' ELSE 'SUCCESS' END as Message
...
where case when SRC.u_pg_business_criticality='1 - most critical'  then 'T1' 
          ...
          else 'UNSPECIFIED' end <>TRGT.tier_c and SRC.cdctype<>'D')ma
