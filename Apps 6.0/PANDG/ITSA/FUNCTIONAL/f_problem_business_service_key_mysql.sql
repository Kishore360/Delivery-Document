...
SELECT CASE WHEN cnt THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN cnt THEN 'MDS to DWH data validation failed for f_problem.business_service_key' ELSE 'SUCCESS' END as Message from 
 (select count(1) cnt 
 FROM pandg_mdsdb.problem_final SRC 
JOIN pandg_mdwdb.f_problem TRGT 
