...
JOIN png_mdwdb.d_lov LKP ON  (concat('MULTI_SERVICE_IMPACT_C~CHANGE_REQUEST~~~',upper(u_pg_multi_service_impact))= LKP.row_id AND SRC.sourceinstance= LKP.source_id)
