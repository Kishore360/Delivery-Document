SELECT 
 ...
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_change_request.service_offering_c_key' ELSE 'SUCCESS' END as Message
...
LEFT JOIN png_mdwdb.d_configuration_item lkp ON src.service_offering = lkp.row_id AND src.sourceinstance = lkp.source_id
