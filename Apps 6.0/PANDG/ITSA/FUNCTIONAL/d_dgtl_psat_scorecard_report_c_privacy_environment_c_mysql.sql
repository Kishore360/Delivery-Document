SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_dgtl_psat_scorecard_report_c.privacy_environment_c' ELSE 'SUCCESS' END as Message
 FROM
...
WHERE SRC.Privacy_Environment <> TRGT.privacy_environment_c;
