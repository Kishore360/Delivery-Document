...
CASE WHEN count(1)>0 THEN 'MDS to DWH data validation failed for d_png_ot_processing_activities_inventory_c.custom_field_num6' ELSE 'SUCCESS' END as Message 
