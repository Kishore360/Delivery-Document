...
CASE WHEN count(1)>0 THEN 'MDS to DWH data validation failed for d_pandg_ot_processing_activities_inventory_c.business_process_service' ELSE 'SUCCESS' END as Message 
