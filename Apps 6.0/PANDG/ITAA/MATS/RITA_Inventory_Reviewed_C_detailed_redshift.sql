select 'ldb.f_png_ot_processing_activities_inventory_reviewed_c' as Table_Name, count(a11.row_key) Row_Count
from  ldb.f_png_ot_processing_activities_inventory_reviewed_c       a11 
union
