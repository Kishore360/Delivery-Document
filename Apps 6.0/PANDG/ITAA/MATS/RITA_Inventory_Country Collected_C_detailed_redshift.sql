select 'ldb.f_pandg_ot_processing_activity_countries_collected_c' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_pandg_ot_processing_activity_countries_collected_c       a11 
union
