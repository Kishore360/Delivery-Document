...
union
select 'ldb.d_outage a15 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_outage a11
join ldb.d_outage a15
on (a11.outage_key = a15.row_key)
union
...
on (a14.priority_src_key = a16.row_key)
union
...
on (a15.outage_type_src_key = a17.row_key)