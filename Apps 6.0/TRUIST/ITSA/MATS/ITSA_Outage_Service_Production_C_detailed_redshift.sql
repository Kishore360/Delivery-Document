...
on (a11.incident_related_problem_c_key = a115.row_key)
union
...
on (a12.tier_src_key = a122.row_key)
union
...
on (a12.used_for_src_key = a123.row_key)
union
...
union
select 'ldb.d_ci_manufacturer a127 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_outage a11
join ldb.d_configuration_item a14
on (a11.configuration_item_key = a14.row_key)
join ldb.d_ci_manufacturer a127
on (a14.manufacturer_key = a127.row_key)
union
select 'ldb.d_lov_configuration_item_tier_rating_c a128 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_outage a11
join ldb.d_configuration_item a14
on (a11.configuration_item_key = a14.row_key) join ldb.d_configuration_item_mdm a112
on (a14.mdm_key = a112.row_key)
join ldb.d_lov_configuration_item_tier_rating_c a128
on (a112.tier_rating_c_key = a128.row_key)
union
select 'ldb.d_ci_vendor a129 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_outage a11
join ldb.d_configuration_item a14
on (a11.configuration_item_key = a14.row_key)
join ldb.d_ci_vendor a129
on (a14.vendor_key = a129.row_key)
union
...
on (a113.category_src_key = a130.row_key)
union
select 'ldb.d_incident_configuration_item_mdm a131 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_outage a11
join ldb.d_incident_configuration_item_mdm a131
on (a11.incident_configuration_item_key = a131.row_key)
union
...
on (a113.priority_src_key = a132.row_key)
union
select 'ldb.d_incident_subcategory a133 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident_outage a11
join ldb.d_incident a113
on (a11.incident_key = a113.row_key)
join ldb.d_incident_subcategory a133
on (a113.sub_category_src_key = a133.row_key)
union
...
on (a114.outage_type_src_key = a134.row_key)
union
...
on (a110.year_start_date_key = a135.row_key)