...
on (a15.mdm_key = a115.row_key)
union
select 'ldb.d_problem_caused_by_change_c a116 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem_caused_by_change_c a116
on (a11.caused_by_change_c_key = a116.row_key)
union
...
union
select 'ldb.d_lov_problem_category_c a121 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_lov_problem_category_c a121
...
union
select 'ldb.d_problem_impacted_channel_c a124 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem_impacted_channel_c a124
on (a11.impacted_channel_c_key = a124.row_key)
union
...
union
select 'ldb.d_problem_vendor_reference_c a127 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem_vendor_reference_c a127
on (a11.vendor_reference_c_key = a127.row_key)
union
select 'ldb.d_location_assigned_to a128 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_internal_contact_assigned_to a18
on (a11.assigned_to_key = a18.row_key)
join ldb.d_location_assigned_to a128
on (a18.location_key = a128.row_key)
union
...
on (a110.criticality_key = a129.row_key)
union
...
on (a110.used_for_src_key = a130.row_key)
union
...
on (a111.week_start_date_key = a131.row_key)
union
...
on (a12.cause_code_c_key = a132.row_key)
union
...
on (a12.close_code_c_key = a133.row_key)
union
...
on (a12.itlc_poc_c_key = a134.row_key)
union
...
on (a12.osi_layer_c_key = a135.row_key)
union
select 'ldb.d_lov_problem_resolution_code_c a136 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem a12
on (a11.problem_key = a12.row_key)
join ldb.d_lov_problem_resolution_code_c a136
on (a12.resolution_code_c_key = a136.row_key)
union
...
on (a12.state_src_key = a137.row_key)
union
...
on (a12.sub_cause_code_c_key = a138.row_key)
union
...
on (a12.tertiary_cause_code_c_key = a139.row_key)
union
...
on (a113.year_start_date_key = a140.row_key)