...
CASE WHEN count(1)>1 then 'Data mismatch for f_application_infra_c.webserver_product'  ELSE 'SUCCESS'  END as Message
...
where COALESCE(a11.webserver_product,'UNSPECIFIED')<>a12.webserver_product
and a11.cdctype='X';