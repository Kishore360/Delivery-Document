SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_v_server_to_product_c.sys_updated_by' ELSE 'SUCCESS' END as Message
 -- select COALESCE(src.sys_updated_by,'UNSPECIFIED'), trgt.sys_updated_by
