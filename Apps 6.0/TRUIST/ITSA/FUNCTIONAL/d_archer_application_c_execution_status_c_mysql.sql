...
left join (select row_id,apm_disposition_c,project_completion_date_c from truist_mdwdb.d_archer_application_ext_c where soft_deleted_flag='N' and row_key>0) inc
