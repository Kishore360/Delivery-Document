...
CASE WHEN CNT > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN CNT >0 THEN 'MDS to DWH data validation failed for d_problem_task.assigned_to_key' ELSE 'SUCCESS' END as Message
 FROM (SELECT count(1) as CNT
 FROM truist_mdsdb.problem_task_final SRC 
 LEFT JOIN truist_mdwdb.d_problem_task TRGT 
