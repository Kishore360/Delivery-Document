...
CASE WHEN count(1)>1 then 'Data mismatch for f_application_infra_c.ws_support_end_date'  ELSE 'SUCCESS'  END as Message
...
where a13.Support_End_Date<>a15.ws_support_end_date
and a11.cdctype<>'D';