...
from truist_mdwdb.d_archer_application_c trgt 
JOIN(select 
...
join 
(select  max(CONVERT_TZ (lastupdated,'America/New_York','GMT')) as lastupdated, source_id from truist_mdwdb.d_o_data_freshness
