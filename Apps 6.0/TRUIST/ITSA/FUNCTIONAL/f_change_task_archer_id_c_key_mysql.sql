...
CASE WHEN count(1)>1 then 'Data mismatch for f_change_task.archer_id_c_key'  ELSE 'SUCCESS'  END as Message
...
FROM truist_mdsdb.change_task_final SRC 
JOIN truist_mdwdb.f_change_task TRGT ON SRC.sys_id=TRGT.row_id AND SRC.sourceinstance=TRGT.source_id
