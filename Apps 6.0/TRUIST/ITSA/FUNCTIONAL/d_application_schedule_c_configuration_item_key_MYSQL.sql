...
JOIN truist_mdwdb.d_application_schedule_c TRGT ON (SRC.row_id=TRGT.row_id AND SRC.sourceinstance=TRGT.source_id)
JOIN truist_mdwdb.d_configuration_item lkp ON SRC.row_id=lkp.row_id and SRC.sourceinstance=lkp.source_id
