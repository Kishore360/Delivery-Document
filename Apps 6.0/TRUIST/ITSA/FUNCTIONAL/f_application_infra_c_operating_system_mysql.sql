...
CASE WHEN count(1)>1 then 'Data mismatch for f_application_infra_c.operating_system'  ELSE 'SUCCESS'  END as Message
...
where COALESCE(a11.operating_system,'UNSPECIFIED')<>a12.operating_system
and a11.cdctype='X';