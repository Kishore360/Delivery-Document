...
where
f_incident.days_since_last_incident <> DATEDIFF(CONVERT_TZ(df.lastupdated,'America/Los_Angeles','GMT'),CONVERT_TZ(d_incident.opened_on,'America/Los_Angeles','GMT')) and f_incident.soft_deleted_flag='N')ma; 
