...
CASE WHEN count(1)>1 then 'Data mismatch for f_application_infra_c.database_product'  ELSE 'SUCCESS'  END as Message
...
where COALESCE(a11.Database_Product,'UNSPECIFIED')<>a12.database_product
and a11.cdctype='X';