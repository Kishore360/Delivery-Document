SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_application_infra_c.db_extended_end_of_support_date' ELSE 'SUCCESS' END as Message
...
where a11.cdctype='X' 
and  a12.Extended_Support<>a15.db_extended_end_of_support_date ; 
