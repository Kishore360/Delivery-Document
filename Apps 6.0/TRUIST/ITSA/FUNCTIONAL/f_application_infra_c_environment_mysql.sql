...
CASE WHEN count(1)>1 then 'Data mismatch for f_application_infra_c.environment'  ELSE 'SUCCESS'  END as Message
...
where COALESCE(a11.u_environment,'UNSPECIFIED')<>a12.environment
and a11.cdctype='X';
