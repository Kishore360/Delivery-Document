SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_application_infra_c.db_supplier' ELSE 'SUCCESS' END as Message
...
where a11.cdctype='X' 
and  coalesce(a12.Supplier,'UNSPECIFIED')<>a15.db_supplier ; 
