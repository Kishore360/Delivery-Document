...
from truist_mdwdb.f_archer_application_c trgt
join truist_mdsdb.us_Third_Party_SLA_SLO_Targets_final src
on trgt.application_name_c=src.application_name
where slo_c<>src.Target_perc_2 and src.cdctype='X';
