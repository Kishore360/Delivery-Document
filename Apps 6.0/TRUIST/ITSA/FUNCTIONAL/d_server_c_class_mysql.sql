SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_server_c.class' ELSE 'SUCCESS' END as Message
 FROM truist_mdsdb.cmdb_ci_server_final SRC 
 LEFT JOIN truist_mdsdb.sys_db_object_final SRC2 
