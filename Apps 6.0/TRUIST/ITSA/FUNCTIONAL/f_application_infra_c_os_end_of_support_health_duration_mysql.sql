...
CASE WHEN count(1)>1 then 'Data mismatch for f_application_infra_c.os_end_of_support_health_duration'  ELSE 'SUCCESS'  END as Message
...
where timestampdiff(SECOND, CONVERT_TZ(a16.lastupdated,'America/New_York','GMT'),a12.Support_End_Date)<>a15.os_end_of_support_health_duration
