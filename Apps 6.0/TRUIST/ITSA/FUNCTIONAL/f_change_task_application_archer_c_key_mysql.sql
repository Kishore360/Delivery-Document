...
CASE WHEN count(1)>1 then 'Data mismatch for f_application_project_c.application_archer_c_key'  ELSE 'SUCCESS'  END as Message
...
JOIN truist_mdwdb.f_change_task
