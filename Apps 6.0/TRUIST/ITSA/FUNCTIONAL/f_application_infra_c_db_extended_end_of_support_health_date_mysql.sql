SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_application_infra_c.db_extended_end_of_support_health_date' ELSE 'SUCCESS' END as Message/*select distinct a11.Database_Product,a12.Supplier,a12.Extended_Support,a12.Support_End_Date,
...
on (a11.Database_Product=a12.Name and a11.sourceinstance=a12.sourceinstance )
...
then coalesce(a12.Extended_Support,a12.Support_End_Date) else a12.Support_End_Date end<>a15.db_extended_end_of_support_health_date;
