...
left join truist_mdwdb.d_configuration_item a13 
on COALESCE(a11.u_cmdb_sys_id,'UNSPECIFIED')=a13.row_id -- and a11.sourceinstance=a13.source_id
where COALESCE(a13.row_key,CASE WHEN a11.u_cmdb_sys_id IS NULL THEN 0 ELSE -1 END)<>a12.configuration_item_key 
and a11.cdctype='X';