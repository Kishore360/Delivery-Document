...
CASE WHEN count(1)>1 then 'Data mismatch for f_application_infra_c.install_status'  ELSE 'SUCCESS'  END as Message
...
where COALESCE(a11.install_status,'UNSPECIFIED')<>a12.install_status
and a11.cdctype='X';