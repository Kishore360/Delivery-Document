...
CASE WHEN count(1)>0 THEN 'MDS to DWH data validation failed for d_application.cio_group_c' ELSE 'SUCCESS' END as Message
...
where trg.cio_group_c<>coalesce(pl1.u_cio_group_name,'UNSPECIFIED') and app.cdctype<>'D'
