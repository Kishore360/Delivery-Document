...
ON (SRC.sys_id = TRGT.row_id  AND SRC.sourceinstance = TRGT.source_id ) 
 WHERE TRGT.soft_deleted_flag='N' and current_flag='Y'  and  COALESCE(SRC.u_is_application_outage_required,'UNSPECIFIED') <> (TRGT.is_application_outage_required_c) and (
