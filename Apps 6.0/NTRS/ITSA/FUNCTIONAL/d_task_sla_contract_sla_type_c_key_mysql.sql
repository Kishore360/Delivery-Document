...
LEFT JOIN ntrustccs_mdwdb.d_task_sla TRGT2 ON (SRC.sys_id=TRGT2.row_id AND SRC.sourceinstance=TRGT2.source_id)
Left JOIN ntrustccs_mdwdb.d_lov LKP ON CONCAT('TYPE~CONTRACT_SLA','~',UPPER(SRC.type))=LKP.row_id  AND SRC.sourceinstance=LKP.source_id
