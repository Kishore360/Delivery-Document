...
select 'ldb.d_request a12 ' as Table_name, count(a11.row_key) Row_Count
 ...
 on (a11.request_key = a12.row_key) 
  union
select 'ldb.d_sc_request_from_request_state a12 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_request_activity a11 
 join ldb.d_sc_request_from_request_state a12 
 on (a11.from_state_key = a12.row_key) 
   union
select 'ldb.d_sc_request_from_stage a12 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_request_activity a11 
 join ldb.d_sc_request_from_stage a12 
 on (a11.from_stage_key = a12.row_key) 
   union
select 'ldb.d_sc_request_priority a12 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_request_activity a11 
  join ldb.d_sc_request_priority a12 
 on (a11.priority_src_key = a12.row_key) 

    union
select 'ldb.d_sc_request_request_state a12 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_request_activity a11
 join ldb.d_sc_request_request_state a13
 on (a11.current_state_src_key = a13.row_key) 
     union
select 'ldb.d_sc_request_stage a12 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_request_activity a11
 join ldb.d_sc_request_stage a13
 on (a11.current_stage_src_key = a13.row_key) 
     union
select 'ldb.d_sc_request_to_request_state a12 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_request_activity a11 
 join ldb.d_sc_request_to_request_state a12 
 on (a11.to_state_key = a12.row_key) 
      union
select 'ldb.d_sc_request_to_stage a12 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_request_activity a11 
 join ldb.d_sc_request_to_stage a12 
