SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_it_location_continuity_c.tests_documented_c
...
where ROUND(SRC.Tests_Documented,5) <> TRGT.tests_documented_c
