SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_it_health_app_continuity_c.last_type_of_dr_exercise' ELSE 'SUCCESS' END as Message
 FROM
...
where SRC.Last_type_of_DR_exercise<>TRGT.last_type_of_dr_exercise