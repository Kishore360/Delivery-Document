...
SELECT count(1) cnt  from(
   select number, substring_index( timestampdiff(day,u_pg_planned_development_start,u_pg_planned_development_end) ,".",1)
planned_development_duration,f.planned_development_duration_c planned_development_duration_c
...
where planned_development_duration<>planned_development_duration_c  )b;