...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for d_dgtl_psat_scorecard_report_c.brand_c' ELSE 'SUCCESS' END as Message
FROM 
(
...
WHERE SRC1.u_brand <> TRGT.brand_c
AND SRC.cdctype<>'D'
) temp;
