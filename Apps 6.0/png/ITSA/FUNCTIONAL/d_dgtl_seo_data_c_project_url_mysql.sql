...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for d_dgtl_seo_data_c.project_url' ELSE 'SUCCESS' END as Message
FROM 
(
...
WHERE SRC.project_url <> TRGT.project_url
and SRC.TP_ID <> 0
AND SRC.cdctype<>'D'
) temp;
