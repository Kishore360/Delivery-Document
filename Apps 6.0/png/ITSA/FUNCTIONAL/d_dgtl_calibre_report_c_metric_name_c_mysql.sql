...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for d_dgtl_calibre_report_c.metric_name_c' ELSE 'SUCCESS' END as Message
FROM 
(
...
WHERE  MetricName   <>TRGT.metric_name_c
AND SRC.cdctype='X'
) temp;
