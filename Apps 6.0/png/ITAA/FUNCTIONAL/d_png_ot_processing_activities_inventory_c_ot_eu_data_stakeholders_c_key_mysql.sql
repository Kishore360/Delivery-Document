...
CASE WHEN count(1)>0 THEN 'MDS to DWH data validation failed for d_png_ot_processing_activities_inventory_c.ot_eu_data_stakeholders_c_key' ELSE 'SUCCESS' END as Message 
