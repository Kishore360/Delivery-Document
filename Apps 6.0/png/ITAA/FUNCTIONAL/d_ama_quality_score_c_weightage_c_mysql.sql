...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for d_ama_quality_score_c.weightage_c' ELSE 'SUCCESS' END as Message FROM png_mdsdb.pg_ot_ama_quality_score_c_final  SRC 
...
WHERE SRC.Weightage <> (TRGT.weightage_c) and SRC.cdctype='X' 
