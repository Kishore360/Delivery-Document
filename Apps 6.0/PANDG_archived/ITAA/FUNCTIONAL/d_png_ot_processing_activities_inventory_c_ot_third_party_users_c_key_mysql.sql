...
CASE WHEN count(1)>0 THEN 'MDS to DWH data validation failed for d_png_ot_processing_activities_inventory_c.ot_third_party_users_c_key' ELSE 'SUCCESS' END as Message 
