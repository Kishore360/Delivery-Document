select 'ldb.f_work_item_affected_version a11 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_work_item_affected_version a11 
union
...
union
select 'ldb.d_work_item_affected_version a16 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_work_item_affected_version a11 
join ldb.d_work_item_affected_version a16 
on (a11.project_affected_version_key = a16.row_key) 
union
