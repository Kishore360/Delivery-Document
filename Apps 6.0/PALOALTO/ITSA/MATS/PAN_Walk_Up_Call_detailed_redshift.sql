...
union
select 'ldb.d_walk_up_c a111 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_walk_up_c a11 
join ldb.d_walk_up_c a111 
on (a11.walk_up_c_key = a111.row_key) 
union
select 'ldb.d_internal_contact_walkup_opened_by_c a112 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_walk_up_c a11 
join ldb.d_internal_contact_walkup_opened_by_c a112 
...
union
select 'ldb.d_internal_contact_closed_by_c a114 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_walk_up_c a11 
join ldb.d_internal_contact_closed_by_c a114 
...
on (a11.opened_by_employee_duration_c = a115.row_key) 
union
select 'ldb.d_lov_walk_up_priority_c a116 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_walk_up_c a11 
join ldb.d_lov_walk_up_priority_c a116 
on (a11.priority_src_key = a116.row_key) 
union
select 'ldb.d_internal_contact_walkup_requestor_c a117 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_walk_up_c a11 
join ldb.d_internal_contact_walkup_requestor_c a117 
on (a11.requestor_c_key = a117.row_key) 
union
select 'ldb.d_lov_walk_up_state_c a118 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_walk_up_c a11 
join ldb.d_lov_walk_up_state_c a118 
on (a11.state_src_key = a118.row_key) 
union
select 'ldb.d_lov_walk_up_type_c a119 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_walk_up_c a11 
join ldb.d_lov_walk_up_type_c a119 
on (a11.walkup_type_src_key = a119.row_key) 
union
select 'ldb.d_lov_sys_user_group_portfolio_c a120 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_walk_up_c a11 
join ldb.d_internal_organization_group a13 
on (a11.assignment_group_key = a13.row_key) 
join ldb.d_lov_sys_user_group_portfolio_c a120 
on (a13.portfolio_src_c_key = a120.row_key) 
union
select 'ldb.d_lov_walk_up_employee_type_c a121 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_walk_up_c a11 
join ldb.d_internal_contact_walkup_opened_by_c a112 
on (a11.opened_by_key = a112.row_key) 
join ldb.d_lov_walk_up_employee_type_c a121 
on (a112.employee_type_c_key = a121.row_key) 
