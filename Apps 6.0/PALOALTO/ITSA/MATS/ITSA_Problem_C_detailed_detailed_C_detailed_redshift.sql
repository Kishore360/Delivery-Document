...
union
select 'ldb.d_calendar_date_problem_c a12 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11 
join ldb.d_calendar_date_problem_c a12 
on (a11.actual_start_c_key = a12.row_key) 
union
...
on (a11.fiscal_date_key = a112.row_key) 
union
...
on (a112.quarter_start_date_key = a115.row_key) 
union
...
union
select 'ldb.d_lov_configuration_item_application_tier_src_c a125 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11 
join ldb.d_configuration_item a14 
on (a11.configuration_item_key = a14.row_key) 
join ldb.d_lov_configuration_item_application_tier_src_c a125 
on (a14.application_tier_src_c_key = a125.row_key) 
union
...
on (a16.portfolio_src_c_key = a127.row_key) 
union
...
on (a111.department_key = a130.row_key) 
union
...
on (a111.employee_mdm_key = a131.row_key) 
union
...
on (a13.state_src_key = a133.row_key) 