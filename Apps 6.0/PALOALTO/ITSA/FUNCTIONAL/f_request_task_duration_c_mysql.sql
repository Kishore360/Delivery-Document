SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_request_task.duration_c' ELSE 'SUCCESS' END as Message
 from
paloalto_mdwdb.f_request_task f 
JOIN paloalto_mdsdb.sc_task_final a 
