...
Left join paloalto_mdsdb.sc_request_final scr
 on sri.request = scr.sys_id and scr.sourceinstance=sri.sourceinstance
 LEFT JOIN paloalto_mdwdb.d_internal_contact dio 
 on concat('INTERNAL_CONTACT~',scr.requested_for) = dio.row_id
