...
from 
(select sys_id,sourceinstance, state from  paloalto_mdsdb.u_service_request_final where CDCTYPE<>'D') SRC 
...
LEFT JOIN paloalto_mdwdb.d_service_request_c TRGT  ON (SRC.sys_id =TRGT.row_id  
