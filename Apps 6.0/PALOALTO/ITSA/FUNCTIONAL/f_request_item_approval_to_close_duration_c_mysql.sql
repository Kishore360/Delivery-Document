...
where   (approval_to_close_duration_c-
 timestampdiff(second, CONVERT_TZ(src.approval_set,'GMT','America/Los_Angeles'), CONVERT_TZ(src.closed_at,'GMT','America/Los_Angeles'))) not in (3600,-3600)
and   approval_to_close_duration_c<>
