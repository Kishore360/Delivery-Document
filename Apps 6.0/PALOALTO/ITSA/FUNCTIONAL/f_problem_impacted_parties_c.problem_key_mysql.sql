...
CASE WHEN cnt > 0 THEN 'MDS to DWH data validation failed for f_problem_impacted_parties_c.problem_key' ELSE 'SUCCESS' END as Message
from
(
...
left join paloalto_mdwdb.d_impacted_parties_c LKP on COALESCE(SRC.sys_id,'UNSPECIFIED')=LKP.row_id
