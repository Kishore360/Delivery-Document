...
from 
(select sys_id, sourceinstance,u_subcategory from  paloalto_mdsdb.u_service_request_final where cdctype<>'D') SRC
 
LEFT JOIN (select row_key, source_id,row_id from paloalto_mdwdb.d_lov where soft_deleted_flag<>'Y') LKP 
