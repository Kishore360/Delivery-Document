...
left join paloalto_mdwdb.d_internal_organization b
on concat('GROUP~',ij.part1)=b.row_id
left join paloalto_mdwdb.d_internal_organization c
on concat('GROUP~',ij.part2)=c.row_id
left join paloalto_mdwdb.d_internal_organization d
on concat('GROUP~',ij.part3)=d.row_id
left join paloalto_mdwdb.d_internal_organization e
on concat('GROUP~',ij.part4)=e.row_id
left join paloalto_mdwdb.d_internal_organization f
on concat('GROUP~',ij.part5)=f.row_id
left join paloalto_mdwdb.d_internal_organization g
