...
FROM paloalto_mdsdb.task_final task
join paloalto_mdsdb.task_sla_final src on task.sys_id=src.task and task.sourceinstance=src.sourceinstance
LEFT OUTER JOIN paloalto_mdwdb.d_incident_tasks_c x 
...
join paloalto_mdwdb.f_task_sla a on a.row_id=src.sys_id and a.source_id=src.sourceinstance
