...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for f_work_item.product_manager_assigned_c' ELSE 'SUCCESS' END as Message 
...
WHERE  
CASE WHEN SRC.product_manager_assigned_c ='Yes' THEN 1 ELSE 0 END <> (LKP.product_manager_assigned_c) and LKP.soft_deleted_flag ='N';