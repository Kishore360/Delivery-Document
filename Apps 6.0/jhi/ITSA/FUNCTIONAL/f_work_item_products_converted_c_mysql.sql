...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for f_work_item.products_converted_c' ELSE 'SUCCESS' END as Message 
...
WHERE  
CASE WHEN d_lov.dimension_name in ('Phase 2','Phase 3') THEN 1 ELSE 0 END <>(LKP.products_converted_c) and TRGT.soft_deleted_flag ='N';