...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for f_work_item.Product_OKRs_identified_c' ELSE 'SUCCESS' END as Message 
...
(LKP.Product_OKRs_identified_c) and LKP.soft_deleted_flag ='N';