...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for f_work_item.level_1_product_management_ready_c' ELSE 'SUCCESS' END as Message
...
WHERE  CASE             
            WHEN LKP.product_manager_assigned_c = 1 AND LKP.taxonomies_completed_c = 1
            THEN 1             
            ELSE 0          
        END  <> (LKP.level_1_product_management_ready_c) and LKP.soft_deleted_flag ='N';