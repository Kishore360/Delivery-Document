...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for f_work_item.Product_Vision_initiated_c' ELSE 'SUCCESS' END as Message 
...
(LKP.Product_Vision_initiated_c) and LKP.soft_deleted_flag ='N';