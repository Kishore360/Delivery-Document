...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for f_work_item.roadmaps_in_aha_c' ELSE 'SUCCESS' END as Message
...
WHERE  CASE             
            ...
            AND LKP.roadmaps_reviewed_with_tech_org_c = 1
            THEN 1             
            ELSE 0          
        END  <> (LKP.roadmaps_in_aha_c) and LKP.soft_deleted_flag ='N';