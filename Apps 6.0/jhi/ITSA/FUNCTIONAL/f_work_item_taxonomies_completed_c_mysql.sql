...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for f_work_item.taxonomies_completed_c' ELSE 'SUCCESS' END as Message 
...
WHERE  
CASE WHEN SRC.Product_Taxonomy_Identified_and_documented_c ='Yes' THEN 1 ELSE 0 END <> (LKP.taxonomies_completed_c) and LKP.soft_deleted_flag ='N';