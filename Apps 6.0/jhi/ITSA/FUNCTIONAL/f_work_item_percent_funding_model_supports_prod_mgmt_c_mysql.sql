...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for f_work_item.percent_funding_model_supports_prod_mgmt_c' ELSE 'SUCCESS' END as Message 
...
(LKP.percent_funding_model_supports_prod_mgmt_c) and LKP.soft_deleted_flag ='N';