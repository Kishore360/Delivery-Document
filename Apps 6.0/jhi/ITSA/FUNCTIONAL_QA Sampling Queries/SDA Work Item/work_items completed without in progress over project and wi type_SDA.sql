...
to_char(count(case when cal_cmptd_mon.lagging_count_of_month between 0 and 12 and resolution.wi_res <> 'CANCELLED' and status.wi_sts in ('COMPLETED') and D.workitems_not_inprog_flag = 'N' then F.row_key else null end),'FM999,999,999,999,990') cmpltd_without_inp
