...
WHERE d.row_key = t.project_key AND d.new_project_started_on_c IS NULL
and d.new_project_started_on_c <> CASE WHEN t.effective_from = '1970-01-01 00:00:00' THEN t.inserted_on ELSE t.effective_from END;