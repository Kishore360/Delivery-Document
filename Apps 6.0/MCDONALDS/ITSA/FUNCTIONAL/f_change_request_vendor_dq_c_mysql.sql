...
FROM (
select number,u_third_party ,vendor_dq_c,
case when incident.u_third_party  is  null  then 0 
when incident.u_third_party  is not  null  and  u_integration_srms_location.sys_id is null then 0 
...
left join mcd_mdsdb.core_company_final  u_integration_srms_location 
on incident.u_third_party=u_integration_srms_location.sys_id and incident.sourceinstance= u_integration_srms_location.sourceinstance
