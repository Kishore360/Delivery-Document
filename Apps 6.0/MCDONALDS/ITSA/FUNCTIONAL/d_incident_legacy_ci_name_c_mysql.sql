...
from 
(select count(1) as cnt  from (select sys_id, sourceinstance,cdctime,u_legacy_ci from  mcd_mdsdb.incident_final) src 
left join mcd_mdsdb.u_legacy_configuration_item_final src1 on src.u_legacy_ci=src1.sys_id and src.sourceinstance=src1.sourceinstance
