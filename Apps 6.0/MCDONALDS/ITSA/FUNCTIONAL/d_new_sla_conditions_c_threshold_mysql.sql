...
select count(1) cnt 
            ...
            LEFT OUTER JOIN
				...
				left join mcd_mdwdb.d_internal_organization d on CONCAT('GROUP~',sys_user_group.sys_id)=d.row_id
join mcd_mdwdb.d_new_sla_conditions_c d1 on 
            ...
            'UNSPECIFIED')),
            255) =d1.row_id and serv.sourceinstance=d1.source_id and serv.sourceinstance=d1.source_id
			where us_sla.Threshold<>d1.Threshold)a