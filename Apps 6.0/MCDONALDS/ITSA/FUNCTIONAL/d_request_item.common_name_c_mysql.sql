...
CASE WHEN cnt>0  THEN 'MDS to DWH data validation failed for d_request_item.common_name_c' ELSE 'SUCCESS' END as Message
from 
...
where (src.cdctime<=f1.lastupdated) and  COALESCE(src1.common_name ,'UNSPECIFIED') <> trgt.common_name_c) temp;