...
from 
( 
select d.row_key as change_request_key,d.assignment_group_key, d.failure_flag, coalesce(d.work_start_on, d.planned_start_on,d.opened_on) as change_start_date, 
d.closed_on as change_end_date
from mcd_mdwdb.d_change_request d 
join 
(select distinct f.assignment_group_key  
from mcd_mdwdb.f_change_request f) t 
...
WHERE coalesce(t1.prior_success_changes,0) <> trgt.assignment_group_prior_success_changes_c
