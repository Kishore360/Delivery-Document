...
from 
(select count(1) as cnt  from  mcd_mdsdb.us_vendor_group_map_c_final src 
left join mcd_mdwdb.d_internal_organization trgt  ON trgt.organization_name = src.vendor
