 ...
 FROM mcd_mdsdb.incident_final SRC 
  JOIN mcd_mdwdb.f_incident TRGT 
...
FROM mcd_mdwdb.d_o_data_freshness WHERE sourcename like 'ServiceNow%' and etl_run_number=TRGT.etl_run_number),'US/Central','GMT')),0)<> TRGT.dormancy_age )b
