...
union
select 'ldb.d_cab_recommendation_c a133 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request_planned_start_date a11
join ldb.d_change_request a111
on (a11.change_request_key = a111.row_key)
join ldb.d_cab_recommendation_c a133
on (a111.cab_recommendation_c_key = a133.row_key)
union
