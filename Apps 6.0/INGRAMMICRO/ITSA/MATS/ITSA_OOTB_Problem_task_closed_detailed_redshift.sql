select 'ldb.f_problem_task_closed' as Table_Name, count(1) Row_Count
...
union
select'ldb.d_problem_task_reported_type' as Table_Name, count(1) Row_Count
 from  ldb.f_problem_task_closed       a11 
join ldb.d_problem_task_reported_type       a116
on (a11.reported_type_src_key = a116.row_key)
union
select'ldb.d_problem_task_impact' as Table_Name, count(1) Row_Count
 from  ldb.f_problem_task_closed       a11 
join ldb.d_problem_task_impact       a117
on (a11.impact_src_key = a117.row_key)
union
select'ldb.d_problem_task_priority' as Table_Name, count(1) Row_Count
 from  ldb.f_problem_task_closed       a11 
...
union
select'ldb.d_problem_task_urgency' as Table_Name, count(1) Row_Count
 from  ldb.f_problem_task_closed       a11 
