...
union
select 'ldb.d_responsible_owner_c a124 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_responsible_owner_c a124
on (a11.u_responsible_owner_c_key = a124.row_key)
union
select 'ldb.d_senior_staff_owner_c a125 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_senior_staff_owner_c a125
on (a11.u_senior_staff_owner_c_key = a125.row_key)
union
...
on (a19.criticality_key = a127.row_key)
union
...
on (a19.used_for_src_key = a128.row_key)
union
...
on (a110.week_start_date_key = a129.row_key)
union
select 'ldb.d_problem_category_c a130 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem a18
on (a11.problem_key = a18.row_key)
join ldb.d_problem_category_c a130
on (a18.u_problem_category_c_key = a130.row_key)
union
...
on (a18.state_src_key = a131.row_key)
union
select 'ldb.d_rca_ola_met_c a132 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem a18
on (a11.problem_key = a18.row_key)
join ldb.d_rca_ola_met_c a132
on (a18.u_rca_ola_met_c_key = a132.row_key)
union
select 'ldb.d_related_to_change_c a133 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem a18
on (a11.problem_key = a18.row_key)
join ldb.d_related_to_change_c a133
on (a18.u_related_to_change_c_key = a133.row_key)
union
select 'ldb.d_root_cause_category_c a134 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem a18
on (a11.problem_key = a18.row_key)
join ldb.d_root_cause_category_c a134
on (a18.u_root_cause_category_c_key = a134.row_key)
union
select 'ldb.d_root_cause_sub_category_c a135 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem a18
on (a11.problem_key = a18.row_key)
join ldb.d_root_cause_sub_category_c a135
on (a18.u_root_cause_sub_category_c_key = a135.row_key)
union
select 'ldb.d_sir_meeting_attendance_c a136 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem a18
on (a11.problem_key = a18.row_key)
join ldb.d_sir_meeting_attendance_c a136
on (a18.u_sir_meeting_attendance_c_key = a136.row_key)
union
