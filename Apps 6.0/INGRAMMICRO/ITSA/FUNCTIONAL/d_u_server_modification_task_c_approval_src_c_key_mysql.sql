...
'MDS to DWH data validation failed for d_u_server_modification_task_c.approval_src_c_key' ELSE 'SUCCESS' END as Message
...
CONCAT('SERVER_MODIFICATION_TASK_C','~','APPROVAL','~',SRC.approval)=LKP.row_id AND SRC.sourceinstance=LKP.source_id
