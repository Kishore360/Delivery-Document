...
left JOIN ingrammicro_mdwdb.d_location LKP on LKP.row_id=coalesce(SRC.u_customer_location,'UNSPECIFIED')
AND SRC.sourceinstance=LKP.source_id
WHERE COALESCE(LKP.row_key,CASE WHEN SRC.u_customer_location is NULL THEN 0 ELSE -1 END)<>TRGT.u_customer_location_c_key ) temp;
