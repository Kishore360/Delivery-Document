...
'MDS to DWH data validation failed for d_change_request.change_request_priority_c_key' ELSE 'SUCCESS' END as Message
FROM 
...
CONCAT('PRIORITY','~','CHANGE_REQUEST','~',upper(SRC.priority))=LKP.row_id AND SRC.sourceinstance=LKP.source_id
