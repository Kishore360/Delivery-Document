...
left JOIN ingrammicro_mdwdb.d_application LKP ON COALESCE(CONCAT('APPLICATION~',SRC.cmdb_ci),'UNSPECIFIED')= LKP.row_id
WHERE COALESCE(LKP.row_key,CASE WHEN SRC.cmdb_ci is NULL THEN 0 ELSE -1 END)<>TRGT.application_key) temp;
