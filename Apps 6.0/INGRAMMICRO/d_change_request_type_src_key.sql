...
'MDS to DWH data validation failed for d_change_request.type_src_key' ELSE 'SUCCESS' END as Message
FROM 
...
CONCAT('TYPE','~','CHANGE_REQUEST','~',upper(SRC.u_type))=LKP.row_id AND SRC.sourceinstance=LKP.source_id
