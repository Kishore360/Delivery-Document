SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_it_location_continuity_c.network_score_c' ELSE 'SUCCESS' END as Message
 FROM
...
where SRC.Network_Score <> TRGT.network_score_c
