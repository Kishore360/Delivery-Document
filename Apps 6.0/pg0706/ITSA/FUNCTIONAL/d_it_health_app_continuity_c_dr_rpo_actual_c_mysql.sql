SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_it_health_app_continuity_c.dr_rpo_actual_c' ELSE 'SUCCESS' END as Message
 FROM
...
where SRC.DR_RPO_Actual<>TRGT.dr_rpo_actual_c