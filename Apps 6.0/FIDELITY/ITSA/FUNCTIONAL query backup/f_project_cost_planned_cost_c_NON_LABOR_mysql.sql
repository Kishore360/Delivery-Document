...
from fidelity_mdsdb.financials_static_final a where metric_type in ('Non Labor','RE-BILL NON LABOR') and BILL_TYPE not in ('SUB-BILL')
and SPONSORSHIP_PERCENTAGE>0 and FORECAST_TYPE='Forecast' 
group by 1,2,3,4)a
left join 
