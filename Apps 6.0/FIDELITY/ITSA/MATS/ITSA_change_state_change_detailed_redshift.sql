select ' f_change_request_state_activity ' as Table_name, count(a11.row_key) Row_Count 
...
from      ldb.f_change_request_state_activity   a11
                ...
                join        ldb.d_calendar_month  a16
				  ...
				  union 
				  select ' d_change_request_from_state ' as Table_name, count(a11.row_key) Row_Count 
from      ldb.f_change_request_state_activity   a11
...
from      ldb.f_change_request_state_activity   a11
                join        ldb.d_change_request_state      a110
				  ...
				  union 
				  select ' d_change_request_to_state ' as Table_name, count(a11.row_key) Row_Count 
from      ldb.f_change_request_state_activity   a11
