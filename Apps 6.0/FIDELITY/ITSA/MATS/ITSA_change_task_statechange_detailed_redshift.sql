...
select ' f_change_task_state_activity ' as Table_name, count(a11.row_key) Row_Count 
from  
 
 ldb.f_change_task_state_activity             a11
...
from   ldb.f_change_task_state_activity             a11
                join        ldb.d_change_request  a15
				  ...
				  select ' d_change_task ' as Table_name, count(a11.row_key) Row_Count 
from   ldb.f_change_task_state_activity             a11
...
from  
 ...
 ldb.f_change_task_state_activity             a11
				...
				select ' d_change_task_from_state ' as Table_name, count(a11.row_key) Row_Count 
from  
 ...
 ldb.f_change_task_state_activity             a11
				...
				select ' d_change_task_to_state ' as Table_name, count(a11.row_key) Row_Count 
from  
...
from  
 ...
 ldb.f_change_task_state_activity             a11
				...
				select ' d_change_task_approval ' as Table_name, count(a11.row_key) Row_Count 
from  
 ...
 ldb.f_change_task_state_activity             a11
   join        ldb.d_change_task          a16
			...
			select ' d_change_task_impact ' as Table_name, count(a11.row_key) Row_Count 
from  
 ...
 ldb.f_change_task_state_activity             a11
   join        ldb.d_change_task          a16
                ...
                join        ldb.d_change_task_impact          a113
				  ...
				  select ' d_change_task_priority ' as Table_name, count(a11.row_key) Row_Count 
from  
 ...
 ldb.f_change_task_state_activity             a11
          join        ldb.d_change_task          a16
                ...
                join        ldb.d_change_task_state             a115
				  ...
				  select ' d_change_task_task_type ' as Table_name, count(a11.row_key) Row_Count 
from  
 ...
 ldb.f_change_task_state_activity             a11
                ...
                join        ldb.d_change_task_task_type    a116
				  ...
				  select ' d_change_task_upon_approval ' as Table_name, count(a11.row_key) Row_Count 
from  
 ...
 ldb.f_change_task_state_activity             a11
                ...
                join        ldb.d_change_task_upon_approval         a117
				  ...
				  select ' d_change_task_upon_reject ' as Table_name, count(a11.row_key) Row_Count 
from  
