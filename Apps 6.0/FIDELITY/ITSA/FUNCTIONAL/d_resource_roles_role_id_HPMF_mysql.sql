...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for d_resource_roles.role_id' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC.role_id,'')<>coalesce(TRGT.role_id,'')