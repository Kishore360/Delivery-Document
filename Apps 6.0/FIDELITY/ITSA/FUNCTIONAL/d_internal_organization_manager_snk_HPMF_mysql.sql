...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for d_internal_organization.manager_snk' ELSE 'SUCCESS' END as Message
...
where coalesce(TRGT.manager_snk,'') <> null