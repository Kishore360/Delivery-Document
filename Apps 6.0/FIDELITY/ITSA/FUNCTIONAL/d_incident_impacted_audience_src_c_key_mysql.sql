...
and LKP.source_id=SRC.sourceinstance and LKP.dimension_class='U_IMPACTED_AUDIENCE~INCIDENT'
WHERE COALESCE(LKP.row_key,case when SRC.u_impacted_audience is null then 0 else -1 end ) <> TRGT.impacted_audience_src_c_key and SRC.cdctype<>'D'
;  