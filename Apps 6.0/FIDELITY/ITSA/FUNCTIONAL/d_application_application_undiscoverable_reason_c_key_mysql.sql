...
WHERE COALESCE(LKP.row_key,CASE WHEN SRC.u_application_undiscoverable_reason IS NULL THEN 0 else -1 end)<>(TRGT.application_undiscoverable_reason_c_key)  and SRC.cdctype<>'D'
