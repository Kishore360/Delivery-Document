...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for d_internal_organization.location_key' ELSE 'SUCCESS' END as Message
...
where coalesce(TRGT.location_key,'') <> -1