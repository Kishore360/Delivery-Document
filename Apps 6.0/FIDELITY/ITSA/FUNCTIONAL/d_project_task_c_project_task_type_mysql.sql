...
FROM  (select Driver.TASK_ID,
                    Driver.sourceinstance,Driver.TASK_TYPE_CODE  from( SELECT
                    TASK_ID,
                    sourceinstance,
                    null as TASK_TYPE_CODE,
                    CASE 
...
WHERE  COALESCE(SRC.TASK_TYPE_CODE,'UNSPECIFIED') <> TRGT.project_task_type; 