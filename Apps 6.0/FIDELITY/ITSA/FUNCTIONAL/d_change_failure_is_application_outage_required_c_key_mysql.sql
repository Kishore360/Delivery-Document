...
WHERE COALESCE(LKP.row_key,CASE WHEN SRC.u_is_application_outage_required IS NULL THEN 0 else -1 end) <> (TRGT.is_application_outage_required_src_c_key)) temp; 
