...
WHERE   year(TRGT.effective_to)=2999 and coalesce(lkp.row_key,case when SRC.u_change_trigger is null then 0 else -1 end)  <>trgt1.change_trigger_src_c_key and SRC.cdctype<>'D'
