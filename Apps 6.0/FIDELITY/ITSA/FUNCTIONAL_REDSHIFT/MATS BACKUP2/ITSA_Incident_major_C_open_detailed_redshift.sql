...
on (a17.customer_mdm_key = a122.row_key)
union
select 'ldb.d_lov_incident_discovery_method_c a123 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11
join ldb.d_incident a12
on (a11.incident_key = a12.row_key)
join ldb.d_lov_incident_discovery_method_c a123
on (a12.discovery_method_src_c_key = a123.row_key)
union
...
union
select 'ldb.d_lov_incident_environment_c a125 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11
join ldb.d_incident a12
on (a11.incident_key = a12.row_key)
join ldb.d_lov_incident_environment_c a125
on (a12.environment_src_c_key = a125.row_key)
union
...
union
select 'ldb.d_internal_contact_major_incident_manager_c a129 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11
join ldb.d_internal_contact_major_incident_manager_c a129
on (a11.major_incident_manager_c_key = a129.row_key)
union
...
union
select 'ldb.d_lov_incident_loss_of_service_c a132 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11
join ldb.d_incident a12
on (a11.incident_key = a12.row_key)
join ldb.d_lov_incident_loss_of_service_c a132
on (a12.loss_of_service_src_c_key = a132.row_key)
union
...
union
select 'ldb.d_internal_organization_originating_group_c a134 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11
join ldb.d_incident a12
on (a11.incident_key = a12.row_key)
join ldb.d_internal_organization_originating_group_c a134
on (a12.originating_group_c_key = a134.row_key)
union
...
on (a13.week_start_date_key = a135.row_key)
union
select 'ldb.d_lov_incident_impacted_audience_c a136 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11
join ldb.d_incident a12
on (a11.incident_key = a12.row_key)
join ldb.d_lov_incident_impacted_audience_c a136
on (a12.impacted_audience_src_c_key = a136.row_key)
union
select 'ldb.d_incident_caller a137 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11
join ldb.d_incident a12
on (a11.incident_key = a12.row_key)
join ldb.d_incident_caller a137
on (a12.caller_key = a137.row_key)
union
...
union
select 'ldb.d_lov_vendor_related_c a146 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11
join ldb.d_incident a12
on (a11.incident_key = a12.row_key)
join ldb.d_lov_vendor_related_c a146
on (a12.vendor_related_c_key = a146.row_key)
union
select 'ldb.d_internal_contact_service_offering_manager_c a147 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11
join ldb.d_application a16
on (a11.application_key = a16.row_key) join ldb.d_fmr_product_c a116
on (a16.fmr_product_c_key = a116.row_key)
join ldb.d_internal_contact_service_offering_manager_c a147
on (a116.service_offering_manager_c_key = a147.row_key)
union
...
on (a113.year_start_date_key = a148.row_key)
union
select 'ldb.d_internal_contact_business_service_manager_c a149 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11
join ldb.d_application a16
on (a11.application_key = a16.row_key) join ldb.d_fmr_product_c a116
on (a16.fmr_product_c_key = a116.row_key) join ldb.d_fmr_product_line_c a117
on (a116.fmr_product_line_c_key = a117.row_key)
join ldb.d_internal_contact_business_service_manager_c a149
on (a117.business_service_manager_c_key = a149.row_key)