...
WHERE CASE WHEN SRC.u_subtype in ('Business Application', 'Infrastructure Application', 'Non-Core Application') THEN 'Primary' ELSE 'Subsystem' END<>(TRGT.application_level_c) 
