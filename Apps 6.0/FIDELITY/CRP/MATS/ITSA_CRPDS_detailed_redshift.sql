...
union
select 'ldb.d_change_application_c a17 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_failure_opened a11
join ldb.d_change_request a16
on (a11.change_request_key = a16.row_key)
join ldb.d_change_application_c a17
on (a16.application_c_key = a17.row_key)
union
select 'ldb.d_change_configuration_item_c a18 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_failure_opened a11
join ldb.d_change_request a16
on (a11.change_request_key = a16.row_key)
join ldb.d_change_configuration_item_c a18
on (a16.configuration_item_c_key = a18.row_key)
union
select 'ldb.d_change_failure a19 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_failure_opened a11
join ldb.d_change_failure a19
on (a11.change_failure_key = a19.row_key)
union
...
from ldb.f_change_failure_opened a11
join ldb.d_calendar_date a15
on (a11.date_key = a15.row_key) join ldb.d_calendar_month a112
on (a15.month_start_date_key = a112.row_key)
...
join ldb.d_calendar_date a15
on (a11.date_key = a15.row_key) join ldb.d_calendar_month a112
on (a15.month_start_date_key = a112.row_key) join ldb.d_calendar_quarter a113
on (a112.quarter_start_date_key = a113.row_key)
...
union
select 'ldb.d_assignment_group_leader a121 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_failure_opened a11
join ldb.d_internal_organization_group a14
on (a11.assignment_group_key = a14.row_key)
join ldb.d_assignment_group_leader a121
on (a14.assignment_group_leader_key = a121.row_key)