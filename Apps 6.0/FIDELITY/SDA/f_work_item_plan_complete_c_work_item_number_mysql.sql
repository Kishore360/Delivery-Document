...
union
select  distinct 
cdctype,source_id,row_id,work_item_number,sum(is_reopened) from (
SELECT 
ics.cdctype,
...
WHERE COALESCE(SRC.work_item_number,'UNSPECIFIED')<>(TRGT.work_item_number) 
