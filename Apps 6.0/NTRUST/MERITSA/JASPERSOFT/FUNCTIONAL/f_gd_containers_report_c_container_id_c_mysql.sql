...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_gd_containers_report_c.container_id_c' 
...
count(1) as CNT
 ...
 where coalesce(SRC.Container_ID,'UNSPECIFIED')<>TRGT.container_id_c)a;