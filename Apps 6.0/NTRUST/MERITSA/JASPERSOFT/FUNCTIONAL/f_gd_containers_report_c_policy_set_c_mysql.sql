...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_gd_containers_report_c.policy_set_c' 
...
count(1) as CNT
 ...
 where coalesce(SRC.Policy_Set,'UNSPECIFIED') <>TRGT.policy_set_c)A;