...
'TICKET','U_ASC_TICKET','U_INCIDENT_TASK','U_PROBLEM_TASK','U_SHIFT_TURNOVER_REPORT','VTB_TASK') and CONVERT_TZ(SRC.expected_start,'GMT','America/Los_Angeles') <>TRGT.expected_start_c