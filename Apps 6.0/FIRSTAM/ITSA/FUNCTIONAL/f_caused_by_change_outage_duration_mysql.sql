...
from
(select COALESCE(cmdb_ci_outage.sys_id, incident.sys_id) AS row_id,change_request.sourceinstance AS source_id,IF(timestampdiff(SECOND, '1970-01-01 00:00:00', cmdb_ci_outage.duration)>=0, timestampdiff(SECOND, '1970-01-01 00:00:00', cmdb_ci_outage.duration), 0) AS outage_duration from
...
union  all
select cmdb_ci_outage.sys_id AS row_id ,change_request.sourceinstance AS source_id,IF(timestampdiff(SECOND, '1970-01-01 00:00:00', cmdb_ci_outage.duration)>=0, timestampdiff(SECOND, '1970-01-01 00:00:00', cmdb_ci_outage.duration), 0) AS outage_duration FROM
...
where 
SRC.outage_duration <>TRGT.outage_duration)a