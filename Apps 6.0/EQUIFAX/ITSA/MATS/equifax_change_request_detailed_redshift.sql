...
union
select 'ldb.d_internal_contact_manager_expedited_c a116 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_internal_contact_manager_expedited_c a116 
on (a11.manager_expedited_c_key = a116.row_key) 
union
...
union
select 'ldb.d_internal_organization_requester_group_c a119 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_internal_organization_requester_group_c a119 
on (a11.requester_group_c_key = a119.row_key) 
union
...
union
select 'ldb.d_internal_contact_slt_expedited_c a121 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11 
join ldb.d_internal_contact_slt_expedited_c a121 
on (a11.slt_expedited_c_key = a121.row_key) 
union
...
on (a12.employee_mdm_key = a128.row_key) 
union
...
on (a15.criticality_key = a130.row_key) 
union
...
on (a15.used_for_src_key = a131.row_key) 
union
