...
where soft_deleted_flag = 'N' and predictor_variable_c = 'ci_manufacturer_c'
) LKP
on TRGT.ci_manufacturer_c =LKP.value_c and TRGT.source_id=LKP.source_id
where TRGT.numerify_change_failure_flag <> 'X'  
and SRC.cdctype<>'D' and TRGT.current_flag='Y'
and TRGT.soft_deleted_flag = 'N'
and CASE WHEN LKP.value_c is null then 'num_grouped_others' ELSE LKP.grouped_value_c end <> TRGT.ci_manufacturer_cardinal_c 
and  SRC.cdctype<>'D';