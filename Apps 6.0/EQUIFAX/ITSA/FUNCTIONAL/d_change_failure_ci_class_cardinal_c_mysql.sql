...
where soft_deleted_flag = 'N' and predictor_variable_c = 'ci_class'
) LKP
...
and CASE WHEN LKP.value_c is null then 'num_grouped_others' ELSE LKP.grouped_value_c end <> TRGT.ci_class_cardinal_c 
and  SRC.cdctype<>'D';
