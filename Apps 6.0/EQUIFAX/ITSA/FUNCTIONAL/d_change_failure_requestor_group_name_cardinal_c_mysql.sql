...
where soft_deleted_flag = 'N' and predictor_variable_c = 'requestor_group_name'
) LKP
...
and CASE WHEN LKP.value_c is null then 'num_grouped_others' ELSE LKP.grouped_value_c end <> TRGT.requestor_group_name_cardinal_c 
and  SRC.cdctype<>'D';
