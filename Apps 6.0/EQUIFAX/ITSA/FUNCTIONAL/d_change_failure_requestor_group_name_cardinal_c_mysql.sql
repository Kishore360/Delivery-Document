...
WHERE CASE WHEN REPLACE(REPLACE(REPLACE(LKP.value,'_DO NOT USE GROUP',''),'_DONOTUSE',''),'_DONOT USE','') is null then TRGT.requestor_group_name_c else 'OTHERS' end <>requestor_group_name_cardinal_c
and  SRC.cdctype<>'D'
