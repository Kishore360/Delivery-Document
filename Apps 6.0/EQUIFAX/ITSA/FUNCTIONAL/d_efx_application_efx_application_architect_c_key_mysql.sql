...
WHERE COALESCE(lkp.row_key, case when SRC.u_efx_application_architect is null then 0 else -1 end) <> TRGT.efx_application_architect_c_key and SRC.cdctype<>'D')b
