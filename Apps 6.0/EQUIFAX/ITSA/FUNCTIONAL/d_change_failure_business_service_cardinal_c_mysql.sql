...
left join (select row_id, sourceinstance as source_id,cdctype,
...
on TRGT.business_service=LKP.value and TRGT.source_id=LKP.source_id and LKP.predictor_variable='business_service'
WHERE CASE WHEN LKP.value is null then TRGT.business_service else 'OTHERS' end <>TRGT.business_service_cardinal_c and  SRC.cdctype<>'D'
