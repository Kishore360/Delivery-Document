...
union
select 'ldb.d_change_failure a14 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_failure a11
join ldb.d_change_failure a14
on (a11.change_failure_key = a14.row_key)
union
...
on (a11.change_state_src_key = a16.row_key)
union
...
union
select 'ldb.d_change_request_close_code a110 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_failure a11
join ldb.d_change_request a15
on (a11.change_request_key = a15.row_key)
join ldb.d_change_request_close_code a110
on (a15.close_code_src_key = a110.row_key)
