...
union
select 'ldb.d_calendar_fiscal_week a111 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_dgtl_psat_scorecard_c a11 
join ldb.d_calendar_date_fiscal a14 
on (a11.fiscal_date_key_c = a14.row_key) 
join ldb.d_calendar_fiscal_week a111 
on (a14.week_start_date_key = a111.row_key) 
union
select 'ldb.d_website_vendor_c a112 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_dgtl_psat_scorecard_c a11 
join ldb.d_configuration_item a13 
on (a11.configuration_item_key = a13.row_key) 
join ldb.d_website_vendor_c a112 
on (a13.website_vendor_key = a112.row_key) 
union
...
on (a14.quarter_start_date_key = a113.row_key) 
union
