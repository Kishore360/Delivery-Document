SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_it_location_continuity_c.server_switches_c
...
where ROUND(SRC.Server_Switches,5) <> TRGT.server_switches_c
