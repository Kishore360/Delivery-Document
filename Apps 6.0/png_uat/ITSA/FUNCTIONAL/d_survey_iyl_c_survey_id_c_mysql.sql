...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for d_survey_iyl_c.survey_id_c' ELSE 'SUCCESS' END as Message 
...
WHERE   
 SRC.survey_id   <> (TRGT.survey_id_c) and TRGT.soft_deleted_flag ='N'
