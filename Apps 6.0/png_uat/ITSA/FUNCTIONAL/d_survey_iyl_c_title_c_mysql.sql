...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for d_survey_iyl_c.title_c' ELSE 'SUCCESS' END as Message 
...
WHERE   
 SRC.title   <> (TRGT.title_c) and TRGT.soft_deleted_flag ='N'
