SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_it_location_continuity_c.tier1_itc_score_c
...
where ROUND(SRC.Tier1_ITC_Score,5) <> TRGT.tier1_itc_score_c
