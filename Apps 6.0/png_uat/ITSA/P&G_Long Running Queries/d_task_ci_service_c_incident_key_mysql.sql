...
LEFT JOIN png_mdwdb.d_task_ci_service_c TRGT ON (SRC.sys_id =TRGT.row_id  AND SRC.sourceinstance= TRGT.source_id  )
LEFT JOIN png_mdwdb.d_incident LKP ON ( COALESCE(SRC.task,'UNSPECIFIED')= LKP.row_id AND SRC.sourceinstance= LKP.source_id )
