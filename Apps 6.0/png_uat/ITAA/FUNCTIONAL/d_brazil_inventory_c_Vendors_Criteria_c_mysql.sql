...
CASE WHEN CNT > 0   THEN 'MDS to DWH data validation failed for d_brazil_inventory_c.Vendors_Criteria_c' ELSE 'SUCCESS' END as Message 
FROM 
(
...
WHERE SRC.Vendors_Criteria <> (TRGT.Vendors_Criteria_c) 
AND SRC.cdctype='X'
) temp;
