...
LEFT JOIN png_jul_mdwdb.d_lov LKP ON ( concat( 'AMA_QUALITY_ISSUE_TYPE_C~PROCESSING_ACTIVITIES~' ,upper( SRC.Class)) = LKP.row_id AND SRC.sourceinstance = LKP.source_id ) 
