...
CASE WHEN count(1)>0 THEN 'MDS to DWH data validation failed for d_png_ot_processing_activities_inventory_c.third_party_contact' ELSE 'SUCCESS' END as Message 
