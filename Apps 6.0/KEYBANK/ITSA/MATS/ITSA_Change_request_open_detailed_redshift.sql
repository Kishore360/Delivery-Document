...
union
select 'ldb.d_change_request_executed_as_planned_c a132 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_change_request a11 
 join ldb.d_change_request a14 
 on (a11.change_request_key = a14.row_key) 
	join ldb.d_change_request_executed_as_planned_c a132 
	on (a14.change_request_executed_as_planned_c_key = a132.row_key)  
union
select 'ldb.d_change_request_expected_outage_c a133 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_change_request a11 
 join ldb.d_change_request a14 
 on (a11.change_request_key = a14.row_key) 
	join ldb.d_change_request_expected_outage_c a133 
	on (a14.change_request_expected_outage_c_key = a133.row_key)  
union
select 'ldb.d_change_request_model_c a134 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_change_request a11 
 join ldb.d_change_request a14 
 on (a11.change_request_key = a14.row_key) 
	join ldb.d_change_request_model_c a134 
	on (a14.change_request_model_c_key = a134.row_key)  
union
select 'ldb.d_change_request_process_followed_c a135 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_change_request a11 
 join ldb.d_change_request a14 
 on (a11.change_request_key = a14.row_key) 
...
union
select 'ldb.d_change_request_backout_c a136 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_change_request a11 
 join ldb.d_change_request a14 
 on (a11.change_request_key = a14.row_key) 
	join ldb.d_change_request_backout_c a136 
	on (a14.change_request_backout_c_key = a136.row_key)  
union
select 'ldb.d_change_request_likelihhod_c a137 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_change_request a11 
 join ldb.d_change_request a14 
 on (a11.change_request_key = a14.row_key) 
	join ldb.d_change_request_likelihhod_c a137 
	on (a14.change_request_likelihood_c_key = a137.row_key)  
union
select 'ldb.d_change_request_substate_c a138 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_change_request a11 
 join ldb.d_change_request a14 
 on (a11.change_request_key = a14.row_key) 
	join ldb.d_change_request_substate_c a138 
	on (a14.change_request_substate_c_key = a138.row_key)  
union
select 'ldb.d_change_request_verification_produced_expected_results_c a139 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_change_request a11 
 join ldb.d_change_request a14 
 on (a11.change_request_key = a14.row_key) 
	join ldb.d_change_request_verification_produced_expected_results_c a139 
	on (a14.change_request_verification_produced_results_c_key = a139.row_key)  
union
