...
left join (
select d.row_key,sum(coalesce(ci_inc_cnt,0)) as ci_inc_cnt_total from keybank_mdwdb.d_change_request d 
join keybank_mdwdb.f_change_request f on f.change_request_key=d.row_key 
left join(
