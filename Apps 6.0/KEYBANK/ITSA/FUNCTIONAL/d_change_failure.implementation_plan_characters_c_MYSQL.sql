...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for d_change_failure.implementation_plan_characters_c' ELSE 'SUCCESS' END as Message
FROM 
(
...
WHERE coalesce(char_length(REPLACE(SRC.implementation_plan,' ','')),-1)
