...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for d_u_rp_user_history_c.u_manager_3' ELSE 'SUCCESS' END as Message
FROM 
(
...
WHERE coalesce(SRC.u_manager_3,'UNSPECIFIED')<>TRGT.u_manager_3_c
