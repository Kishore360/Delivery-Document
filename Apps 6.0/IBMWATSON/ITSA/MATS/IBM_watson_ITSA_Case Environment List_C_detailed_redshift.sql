...
union
select 'ldb.d_case_environment_c a13 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_case_environment_list_c a11
join ldb.d_case_environment_c a13
on (a11.case_environment_c_key = a13.row_key)
union
