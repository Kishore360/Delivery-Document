...
union
select 'ldb.d_sla_c a16 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_sla_c a11
join ldb.d_sla_c a16
on (a11.sla_c_key = a16.row_key)
union
...
union
select 'ldb.d_sla_tribe_c a110 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_sla_c a11
join ldb.d_sla_tribe_c a110
on (a11.tribe_c_key = a110.row_key)
union
select 'ldb.d_lov_segment_type_c a111 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_sla_c a11
join ldb.d_segment_c a12
on (a11.segment_c_key = a12.row_key)
join ldb.d_lov_segment_type_c a111
on (a12.segment_type_c_key = a111.row_key)
union
...
on (a15.sla_category_key = a112.row_key)