...
union
select 'ldb.d_internal_contact_general_manager_c a139 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_tribe_c a112
on (a11.tribe_c_key = a112.row_key) join ldb.d_segment_c a113
on (a112.segment_c_key = a113.row_key)
join ldb.d_internal_contact_general_manager_c a139
on (a113.general_manager_c_key = a139.row_key)
union
select 'ldb.d_lov_segment_type_c a140 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_tribe_c a112
on (a11.tribe_c_key = a112.row_key) join ldb.d_segment_c a113
on (a112.segment_c_key = a113.row_key)
join ldb.d_lov_segment_type_c a140
on (a113.segment_type_c_key = a140.row_key)
union
