...
JOIN ibmwatson_mdwdb.d_pagerduty_c LKP ON sys_id=LKP.row_id AND SRC.sourceinstance=LKP.source_id
WHERE COALESCE(LKP.row_key,CASE WHEN SRC.sys_id IS NULL THEN 0 ELSE -1 END )<>TRGT.pagerduty_c_key
