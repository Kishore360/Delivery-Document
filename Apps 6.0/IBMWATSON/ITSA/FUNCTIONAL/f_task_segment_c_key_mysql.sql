...
from ibmwatson_mdsdb.task_final a1 
join ibmwatson_mdsdb.cmdb_ci_final a on a1.cmdb_ci=a.sys_id and a1.sourceinstance=2 and a1.sys_class_name='problem'
join ibmwatson_mdwdb.d_tribe_c d on a.u_tribe=d.row_id and a.sourceinstance=d.source_id and a.cdctype<>'D'
join ibmwatson_mdwdb.f_task f on a1.sys_id=f.row_id and f.source_id=2
