...
union
select'ldb.d_three_month_rolling' as Table_Name, count(1) Row_Count
 from  ldb.f_change_request_closed       a11 
 join ldb.d_calendar_date       a12
on (a11.closed_on_key = a12.row_key)
...
union
select'ldb.d_three_week_rolling' as Table_Name, count(1) Row_Count
 from  ldb.f_change_request_closed       a11 
 join ldb.d_calendar_date       a12
on (a11.closed_on_key = a12.row_key)
...
union
select'ldb.d_calendar_month_three_rolling' as Table_Name, count(1) Row_Count
 from  ldb.f_change_request_closed       a11 
  join ldb.d_calendar_date       a12
on (a11.closed_on_key = a12.row_key)
join ldb.d_three_month_rolling       a13
...
union
select'ldb.d_calendar_week_three_rolling' as Table_Name, count(1) Row_Count
 from  ldb.f_change_request_closed       a11
  join ldb.d_calendar_date       a12
on (a11.closed_on_key = a12.row_key)
join ldb.d_three_week_rolling       a16
