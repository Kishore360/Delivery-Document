...
from (select * from ge_mdwdb.f_change_request where soft_deleted_flag='N') chg_f
left join (select * from ge_mdwdb.d_change_failure where current_flag='Y' and soft_deleted_flag='N')chg_fai
