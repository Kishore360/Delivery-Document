...
'TICKET','U_ASC_TICKET','U_INCIDENT_TASK','U_PROBLEM_TASK','U_SHIFT_TURNOVER_REPORT','VTB_TASK') and coalesce(lkp.row_key,case when SRC.company is null then 0 else -1 end) <>TRGT.company_key