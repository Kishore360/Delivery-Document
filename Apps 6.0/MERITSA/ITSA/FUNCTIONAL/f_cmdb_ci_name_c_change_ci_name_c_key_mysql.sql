...
(select count(1) cnt  from meritsa_mdwdb.f_cmdb_ci_name_c t right join (
...
from meritsa_mdsdb.change_request_final a 
...
left join meritsa_mdwdb.d_configuration_item b on a.name_id=b.row_id  
