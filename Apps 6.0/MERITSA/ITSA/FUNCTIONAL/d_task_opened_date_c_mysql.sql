...
'TICKET','U_ASC_TICKET','U_INCIDENT_TASK','U_PROBLEM_TASK','U_SHIFT_TURNOVER_REPORT','VTB_TASK') and  CONVERT_TZ(SRC.u_opened_date,'GMT','America/Los_Angeles') <>TRGT.opened_date_c