...
JOIN meritsa_mdwdb.d_lov_map br ON d.state_src_key = br.src_key AND br.dimension_wh_code  IN ('OPEN')
JOIN (SELECT MAX(lastupdated) AS lastupdated,source_id FROM meritsa_mdwdb.d_o_data_freshness GROUP BY source_id) dat 
