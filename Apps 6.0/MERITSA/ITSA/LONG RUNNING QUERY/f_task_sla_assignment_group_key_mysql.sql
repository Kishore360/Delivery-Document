create index task_sla_fin_index on mercuryins_mdsdb.task_sla_final (sys_id,sourceinstance);
create index task_fin_index on mercuryins_mdsdb.task_final (sys_id,sourceinstance);  -- ,u_ci_name: 0.59 sec
create index org_index on mercuryins_mdwdb.d_internal_organization (row_id,source_id);  -- ,change_request_key : 0.18 sec
...
Drop index task_sla_fin_index on mercuryins_mdsdb.task_sla_final;
Drop index task_fin_index on mercuryins_mdsdb.task_final;
Drop index org_index on mercuryins_mdwdb.d_internal_organization;
