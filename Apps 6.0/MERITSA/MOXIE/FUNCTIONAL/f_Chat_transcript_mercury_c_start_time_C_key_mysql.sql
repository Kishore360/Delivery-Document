...
from meritsa_mdsdb.mox_ais_transcript_final a
left join meritsa_mdwdb.f_chat_transcript_c f on concat('AIS~',a.row_id)=f.row_id 
join  meritsa_mdwdb.d_calendar_date d on str_to_date(datetime,'%d/%m/%Y')=d.row_id 
