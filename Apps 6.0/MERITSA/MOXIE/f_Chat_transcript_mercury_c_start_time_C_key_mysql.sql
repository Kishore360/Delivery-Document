...
from mercury_mdsdb.us_ais_transcript_final a
left join mercury_mdwdb.f_chat_transcript f on concat('AIS~',a.row_id)=f.row_id 
join  mercury_mdwdb.d_calendar_date d on str_to_date(datetime,'%d/%m/%Y')=d.row_id 
