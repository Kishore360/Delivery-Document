...
union
select 'ldb.d_calendar_date_period_end_date_c a13 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.a_incident_weekly_c a11 
 join ldb.d_calendar_date_period_end_date_c a13 
	on (a11.period_end_c_key = a13.row_key)  
union
...
union
select 'ldb.d_region_c a19 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.a_incident_weekly_c a11 
...
union
select 'ldb.d_task_contacttype a111 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.a_incident_weekly_c a11 
