...
union
select 'ldb.d_customer a123 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
 join ldb.d_customer a123 
	on (a11.customer_key = a123.row_key)  
union
select 'ldb.d_internal_contact a124 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
 join ldb.d_internal_contact a124 
	on (a11.opened_by_key = a124.row_key)  
union
select 'ldb.d_calendar_time a125 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
 join ldb.d_calendar_time a125 
	on (a11.opened_time_key = a125.row_key)  
union
select 'ldb.d_calendar_date a126 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
 join ldb.d_calendar_date a126 
	on (a11.opened_on_key = a126.row_key)  
union
select 'ldb.d_calendar_month a127 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
 join ldb.d_calendar_date a126 
 on (a11.opened_on_key = a126.row_key) 
...
union
select 'ldb.d_internal_contact_mdm a14 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
 join ldb.d_internal_contact a124 
 on (a11.opened_by_key = a124.row_key) 
...
union
select 'ldb.d_employee_location a15 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
 join ldb.d_internal_contact a124 
...
union
select 'ldb.d_incident a16 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
...
union
select 'ldb.d_internal_organization_legalentity a19 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
 join ldb.d_internal_organization_legalentity a19 
	on (a11.company_key = a19.row_key)  
union
select 'ldb.d_customer_mdm a110 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
  join ldb.d_customer a123 
	on (a11.customer_key = a123.row_key)  
...
union
select 'ldb.d_domain a111 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
 join ldb.d_domain a111 
	on (a11.domain_key = a111.row_key)  
union
select 'ldb.d_calendar_time_hour a112 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
  join ldb.d_calendar_time a125 
	on (a11.opened_time_key = a125.row_key)  
...
union
select 'ldb.d_task_impact a113 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
...
union
select 'ldb.d_task_priority a115 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
 join ldb.d_task_priority a115 
	on (a11.priority_src_key = a115.row_key)  
union
select 'ldb.d_task_contacttype a116 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
 join ldb.d_task_contacttype a116 
	on (a11.reported_type_src_key = a116.row_key)  
union
select 'ldb.d_task_urgency a117 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
 join ldb.d_task_urgency a117 
	on (a11.urgency_src_key = a117.row_key)  
union
select 'ldb.d_incident_category a118 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
 join ldb.d_incident a16 
 on (a11.incident_key = a16.row_key) 
...
union
select 'ldb.d_incident_close_code a119 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
 join ldb.d_incident a16 
 on (a11.incident_key = a16.row_key) 
...
union
select 'ldb.d_incident_severity a120 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
 join ldb.d_incident a16 
 on (a11.incident_key = a16.row_key) 
...
union
select 'ldb.d_incident_state a121 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
 join ldb.d_incident a16 
 on (a11.incident_key = a16.row_key) 
...
union
select 'ldb.d_incident_subcategory a122 ' as Table_name, count(1) Row_Count
 from ldb.f_incident_keyword a11 
 join ldb.d_incident a16 
 on (a11.incident_key = a16.row_key) 
