...
whirlpool_mdsdb.incident_final x  left join 
whirlpool_mdwdb.d_internal_contact y on 
CONCAT('INTERNAL_CONTACT~',x.closed_by)=row_id  AND sourceinstance= source_id 
 JOIN   whirlpool_mdwdb.f_incident B on x.sourceinstance=B.source_id AND B.ROW_ID=SYS_ID
