...
and b.substatus is not null and b.location is not null and b.support_group is not null and b.u_support_vendor is not null )then 'Y'else 'N' end<>a.is_complete_c_flag and b.cdctype='X'
