...
union
select 'ldb.d_problem_assignment_group a114 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_task a11 
 join ldb.d_problem_assignment_group a114 
 on (a11.problem_assignment_group_key = a114.row_key)  
union
select 'ldb.d_problem_priority a115 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_task a11 
 join ldb.d_problem_priority a115 
 on (a11.problem_priority_src_key = a115.row_key)  
union
select 'ldb.d_problem_task_approval a116 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_task a11 
 join ldb.d_problem_task_approval a116 
 on (a11.approval_src_key = a116.row_key)  
union
select 'ldb.d_problem_task_reported_type a117 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_task a11 
 join ldb.d_problem_task_reported_type a117 
 on (a11.reported_type_src_key = a117.row_key)  
union
select 'ldb.d_problem_task_impact a118 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_task a11 
 join ldb.d_problem_task_impact a118 
 on (a11.impact_src_key = a118.row_key)  
union
select 'ldb.d_problem_task_priority a119 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_task a11 
 join ldb.d_problem_task_priority a119 
 on (a11.priority_src_key = a119.row_key)  
union
select 'ldb.d_problem_task_state a120 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_task a11 
 join ldb.d_problem_task_state a120 
 on (a11.state_src_key = a120.row_key)  
union
select 'ldb.d_problem_task_urgency a121 ' as Table_name, count(a11.row_key) Row_Count
 from ldb.f_problem_task a11 
 join ldb.d_problem_task_urgency a121 
