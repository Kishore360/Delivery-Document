...
LEFT JOIN ntrust_mdwdb.f_sla_c TRGT2 ON (SRC.sys_id=TRGT2.row_id AND SRC.sourceinstance=TRGT2.source_id)
where 
CASE WHEN SRC.duration is null  THEN NULL WHEN TIMESTAMPDIFF(SECOND,'1970-01-01 00:00:00',
SRC.duration) < 0 THEN NULL WHEN TIMESTAMPDIFF(SECOND,'1970-01-01 00:00:00',SRC.duration) > 214748364 
THEN NULL  ELSE TIMESTAMPDIFF(SECOND,'1970-01-01 00:00:00',SRC.duration) 
