...
where 
 TIMESTAMPDIFF(SECOND,COALESCE(CONVERT_TZ( SRC.work_start, 'UTC','America/Los_Angeles'),
CONVERT_TZ( SRC.sys_created_on,'UTC','America/Los_Angeles')),CONVERT_TZ( SRC.closed_at,
