...
FROM   ntrust_mdsdb.problem_final SRC
 ...
 left JOIN ntrust_mdwdb.d_lov TRGT2 ON COALESCE(CONCAT('ROOT_CAUSE_SUB_CATEGORY_C~PROBLEM~',UPPER(problem.u_root_cause_sub_category)),'UNSPECIFIED')=TRGT2.row_id
