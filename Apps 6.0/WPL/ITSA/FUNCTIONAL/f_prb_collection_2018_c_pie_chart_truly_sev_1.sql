...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for f_prb_collection_2018_c_fact.pie_chart_truly_sev_1' ELSE 'SUCCESS' END as Message  
FROM 
(
...
where src.cdctype<>'D' and   src.piechartonlysevtrulysev <> pie_chart_truly_sev_1) temp; 