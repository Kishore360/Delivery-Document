...
FROM ( select count(1) cnt  from  wpl_mdsdb.sys_user_final
left join wpl_mdwdb.d_internal_contact on concat('INTERNAL_CONTACT~',sys_id)=row_id and sourceinstance=source_id
