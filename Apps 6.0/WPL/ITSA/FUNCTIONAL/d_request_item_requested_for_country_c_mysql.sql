...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for d_request_item.requested_for_country_c' 
...
WHERE d_request_item.requested_for_country_c<>coalesce(d_location_country_c.country_name_c,'UNSPECIFIED');