...
CASE WHEN cnt>0 THEN 'MDS to DWH data validation failed for d_sap_backup_sow_compliance_c.result_c' ELSE 'SUCCESS' END as Message 
...
where src.cdctype<>'D' and src.results<>trgt.result_c)ma
;