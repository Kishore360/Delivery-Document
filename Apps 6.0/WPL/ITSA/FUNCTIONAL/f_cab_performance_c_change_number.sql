...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for f_cab_performance_c.change_number' ELSE 'SUCCESS' END as Message  
FROM 
(
...
where src.cdctype<>'D' and   src.changenumber <> trgt.change_number
) temp; 
