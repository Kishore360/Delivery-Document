SELECT CASE WHEN count(1)  THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for f_prb_collection_2018_c_fact .re_reclassified_manual'
 ...
 WHERE SRC.rereclassifiedmanual <> (TRGT.re_reclassified_manual)
 and SRC.CDCTYPE='X';
