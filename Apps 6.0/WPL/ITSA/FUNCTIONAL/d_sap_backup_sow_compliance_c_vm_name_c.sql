...
CASE WHEN cnt>0 THEN 'MDS to DWH data validation failed for d_sap_backup_sow_compliance_c.vm_name_c' ELSE 'SUCCESS' END as Message 
...
where src.cdctype<>'D' and src.vmname<>trgt.vm_name_c)ma
;