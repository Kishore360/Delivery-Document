SELECT CASE WHEN count(1)  THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for f_prb_collection_2018_c_fact .group_caused_the_issue'
 ...
 WHERE SRC.groupcausedtheissue <> (TRGT.group_caused_the_issue)
 and SRC.CDCTYPE='X';