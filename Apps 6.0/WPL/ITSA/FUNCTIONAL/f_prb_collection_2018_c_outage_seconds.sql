...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for f_prb_collection_2018_c_fact.outage_seconds' ELSE 'SUCCESS' END as Message  
FROM 
(
...
where src.cdctype<>'D' and   src.outateseconds <> outage_seconds) temp; 