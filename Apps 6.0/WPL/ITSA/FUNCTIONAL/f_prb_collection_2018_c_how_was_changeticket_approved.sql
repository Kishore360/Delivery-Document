...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for f_prb_collection_2018_c_fact.how_was_changeticket_approved' ELSE 'SUCCESS' END as Message  
FROM 
(
...
where src.cdctype<>'D' and   src.howwasthechangeticketapproved <> trgt.how_was_changeticket_approved) temp; 