SELECT CASE WHEN count(1)  THEN 'FAILURE' ELSE 'SUCCESS' END as Result, CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for f_ad_hoc_request_c.business_duration' ELSE 'SUCCESS' END as Message FROM wpl_mdwdb.f_ad_hoc_request_c a
join wpl_mdsdb.u_ad_hoc_request_final b
on a.row_id=b.sys_id
and a.source_id=b.sourceinstance
left join wpl_mdsdb.sys_user_final c
on b.requested_for=c.sys_id and b.sourceinstance=c.sourceinstance
left join wpl_mdsdb.cmn_location_final d
