...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for f_prb_collection_2018_c_fact.piechart_change_mgmt' ELSE 'SUCCESS' END as Message  
FROM 
(
...
where src.cdctype<>'D' and   src.piechartchangemgmtnocmnonchange <> piechart_change_mgmt) temp; 