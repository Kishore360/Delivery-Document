...
SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 ...
 FROM 
 wpl_mdsdb.asmt_assessment_instance_final tsd 
 JOIN wpl_mdsdb.task_final tf 
...
join wpl_mdwdb.f_task_survey ts on  ts.row_id=tsd.sys_id and ts.source_id=tsd.sourceinstance
