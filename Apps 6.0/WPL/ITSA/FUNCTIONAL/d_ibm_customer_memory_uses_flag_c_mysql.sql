...
CASE WHEN count(1)  THEN 'MDS to DWH data validation failed for d_ibm_customer_memory_uses.flag_c' ELSE 'SUCCESS' END as Message FROM 
...
where cm.flag<>TRGT.flag_c		and cm.cdctype<>'D'	