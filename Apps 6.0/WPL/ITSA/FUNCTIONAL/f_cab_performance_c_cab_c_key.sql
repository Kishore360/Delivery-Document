...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for f_cab_performance_c.cab_c_key' ELSE 'SUCCESS' END as Message  
FROM 
(
...
where src.cdctype<>'D' and  src.cabdateid <> trgt.cab_c_key
) temp; 
