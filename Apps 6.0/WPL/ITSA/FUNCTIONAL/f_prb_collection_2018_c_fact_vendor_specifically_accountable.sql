...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for f_prb_collection_2018_c_fact.vendor_specifically_accountable' ELSE 'SUCCESS' END as Message  
FROM 
(
...
where src.cdctype<>'D' and   src.whichvendorspecificallyaccountable <> vendor_specifically_accountable) temp; 