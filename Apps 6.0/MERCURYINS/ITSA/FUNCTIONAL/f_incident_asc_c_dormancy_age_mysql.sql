 ...
 left join mercury_mdwdb.d_lov_map lm 
...
FROM mercury_mdwdb.d_o_data_freshness WHERE sourcename like 'ServiceNow%'),'America/Los_Angeles','GMT')),0)<> TRGT.dormancy_age 
