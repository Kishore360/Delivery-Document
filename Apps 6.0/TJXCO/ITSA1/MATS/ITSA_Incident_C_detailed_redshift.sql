...
on (a112.parent_incident_key = a114.row_key) 
union
...
on (a12.customer_mdm_key = a118.row_key) 
union
...
union
select 'ldb.d_internal_contact_resolved_by	a127 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident	a11 
join	ldb.d_internal_contact_resolved_by	a127 
on (a11.last_resolved_by_key = a127.row_key) 
union
select 'ldb.d_internal_organization_c	a128 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident	a11 
join	ldb.d_internal_organization_c	a128 
on (a11.resolved_by_group_key = a128.row_key) 
union
...
on (a112.category_src_key = a132.row_key) 
union
...
on (a112.close_code_src_key = a133.row_key) 
union
...
on (a112.priority_src_key = a134.row_key) 
union
...
on (a112.met_resolution_sla_flag_key = a135.row_key) 
union
...
on (a112.met_response_sla_flag_key = a136.row_key) 
union
...
on (a112.severity_src_key = a137.row_key) 
union
...
on (a112.state_src_key = a138.row_key) 
union
...
on (a112.sub_category_src_key = a139.row_key) 
union
select 'ldb.d_lov_incident_first_pass_reason_c	a140 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident	a11 
join	ldb.d_incident	a112 
on (a11.incident_key = a112.row_key) 
join	ldb.d_lov_incident_first_pass_reason_c	a140 
on (a112.first_pass_reason_c_key = a140.row_key) 
union
select 'ldb.d_lov_on_hold_reason_c	a141 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident	a11 
join	ldb.d_incident	a112 
on (a11.incident_key = a112.row_key) 
join	ldb.d_lov_on_hold_reason_c	a141 
on (a112.on_hold_reason_c_key = a141.row_key) 
union
