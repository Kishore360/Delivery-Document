																																																																																																																																																																																																																																																																																																																																																																																																																																																																								-- If change_start_on>closed_on ,then the ci_prior_changes value will be -2. ITSM-3636
...
else round((cmdb_ci_prior_Y/ci_prior_changes),10) end as prior_failure_rate_qa
from
(
