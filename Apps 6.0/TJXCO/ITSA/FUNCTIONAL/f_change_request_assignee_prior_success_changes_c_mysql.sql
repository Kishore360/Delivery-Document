...
from 
( 
select d.row_key as change_request_key,d.assigned_to_key, d.failure_flag, coalesce(d.work_start_on, d.planned_start_on,d.opened_on) as change_start_date, d.closed_on as change_end_date
...
WHERE coalesce(t1.prior_success_changes,0) <> trgt.assignee_prior_success_changes_c