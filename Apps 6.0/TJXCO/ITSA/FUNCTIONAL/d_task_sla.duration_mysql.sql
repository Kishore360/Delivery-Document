...
FROM tjxco_mdsdb.contract_sla_final a 
JOIN tjxco_mdwdb.d_task_sla b ON a.sys_id=b.row_id and a.sourceinstance=b.source_id
...
ELSE TIMESTAMPDIFF(SECOND,'1970-01-01 00:00:00',a.duration) end <> b.sla_duration )temp;