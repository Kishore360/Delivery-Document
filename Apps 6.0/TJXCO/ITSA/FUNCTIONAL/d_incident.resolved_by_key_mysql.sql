...
join tjxco_mdwdb.d_lov lov1 on b.state_src_key=lov1.row_key 

left join tjxco_mdwdb.d_lov_map lov on lov1.row_key=lov.src_key
 
WHERE lov.dimension_wh_code='RESOLVED' and  COALESCE(c.row_key,CASE WHEN a.resolved_by IS NULL THEN 0 ELSE -1 END)<>
 b.resolved_by_key)temp;