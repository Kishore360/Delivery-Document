																																																																																																																																																																																																																																																																																																																																																																																																																																																																								-- If change_start_on>closed_on ,then the ci_class_prior_changes value will be -2. ITSM-3636
...
else round((ci_class_key_prior_Y/ci_class_prior_changes),10) end as prior_failure_rate_qa
from
(
