select 'ldb.f_incident_activity	a11 ' as Table_name, count(1) Row_Count
...
union
select 'ldb.d_internal_organization_assignment_group_from_c	a17 ' as Table_name, count(1) Row_Count
from ldb.f_incident_activity	a11 
join	ldb.d_internal_organization_assignment_group_from_c	a17 
on (a11.from_assignment_group_key = a17.row_key) 
union
select 'ldb.d_calendar_quarter	a19 ' as Table_name, count(1) Row_Count
from ldb.f_incident_activity	a11 
join	ldb.d_calendar_date	a12 
on (a11.assigned_on_key = a12.row_key) 
...
union
select 'ldb.d_calendar_week	a110 ' as Table_name, count(1) Row_Count
from ldb.f_incident_activity	a11 
join	ldb.d_calendar_date	a12 
on (a11.assigned_on_key = a12.row_key) 
...
union
select 'ldb.d_calendar_year	a111 ' as Table_name, count(1) Row_Count
from ldb.f_incident_activity	a11 
join	ldb.d_calendar_date	a12 
on (a11.assigned_on_key = a12.row_key) 
...
union
select 'ldb.d_internal_contact_to	a112 ' as Table_name, count(1) Row_Count
from ldb.f_incident_activity	a11 
join	ldb.d_internal_contact_to	a112 
on (a11.to_assigned_to_key = a112.row_key) 
union
select 'ldb.d_internal_organization_group_to	a113 ' as Table_name, count(1) Row_Count
from ldb.f_incident_activity	a11 
join	ldb.d_internal_organization_group_to	a113 
on (a11.to_assignment_group_key = a113.row_key) 
union
select 'ldb.d_internal_contact_from	a114 ' as Table_name, count(1) Row_Count
from ldb.f_incident_activity	a11 
join	ldb.d_internal_contact_from	a114 
on (a11.from_assigned_to_key = a114.row_key) 
union
select 'ldb.d_incident_priority	a115 ' as Table_name, count(1) Row_Count
from ldb.f_incident_activity	a11 
...
union
select 'ldb.d_incident_state	a116 ' as Table_name, count(1) Row_Count
from ldb.f_incident_activity	a11 
join	ldb.d_incident	a13
	  on 	(a11.incident_key = a13.row_key)
...
union
select 'ldb.d_incident_subcategory	a117 ' as Table_name, count(1) Row_Count
from ldb.f_incident_activity	a11 
join	ldb.d_incident	a13
	  on 	(a11.incident_key = a13.row_key)
