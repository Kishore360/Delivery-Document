...
where sla='1.3.6' and d.hcl_schedule_ac_attachment_ref ='Availability' )a1
right join 
(
...
where component_criticality_c='Critical'   and dc.subcategory in ('Unix Server','HPUX server','AIX server','Solaris server')
  -- New addition 
