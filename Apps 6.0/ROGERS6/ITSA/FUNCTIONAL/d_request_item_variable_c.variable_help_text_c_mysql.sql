...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for d_request_item_variable_c.variable_help_text_c' ELSE 'SUCCESS' END as Message
FROM 
(
...
WHERE    coalesce(SRC2.help_text,'UNSPECIFIED')<>
 TRGT.variable_help_text_c
