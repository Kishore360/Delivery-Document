...
from (select sys_id,sourceinstance,sys_class_name,opened_at from rogers6_mdsdb.task_final where cdctype<>'D' and
...
join rogers6_mdwdb.d_calendar_date dc on a.date_key=dc.row_key where dc.lagging_count_of_month<>d.opened_lagging_count_of_month_c;