...
join rogers6_mdsdb.sys_user_group_final sug on sug.name=dc.affected_assignment_group and sug.sourceinstance=dc.sourceinstance
join rogers6_mdwdb.d_internal_organization c on COALESCE(CONCAT('GROUP~',sug.sys_id),'UNSPECIFIED') = c.row_id
