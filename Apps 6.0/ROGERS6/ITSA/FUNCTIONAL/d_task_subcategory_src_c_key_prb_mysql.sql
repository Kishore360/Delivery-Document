...
join rogers6_mdwdb.d_lov l on d.task_type_src_key=l.row_key where l.dimension_name='Problem') TRGT
ON SRC.sys_id= TRGT.row_id AND SRC.sourceinstance = TRGT.source_id and SRC.cdctype<>'D'
JOIN rogers6_mdwdb.f_problem LKP ON SRC.sys_id=LKP.row_id AND SRC.sourceinstance=LKP.source_id
