...
FROM rogers6_mdwdb.d_incident d 
join rogers6_mdwdb.f_incident f 
on d.row_key=f.incident_key AND d.source_id=f.source_id
 JOIN rogers6_mdwdb.d_lov dl on f.priority_src_key=dl.row_key AND dl.source_id=f.source_id
