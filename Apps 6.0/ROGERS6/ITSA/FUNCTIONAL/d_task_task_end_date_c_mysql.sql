...
from (select sys_id,sourceinstance,sys_class_name,closed_at from rogers6_mdsdb.task_final where cdctype<>'D' and
sys_class_name in ('incident','problem','change_request')) t join rogers6_mdwdb.d_task d on t.sys_id=d.row_id and t.sourceinstance=d.source_id
left join rogers6_mdsdb.change_request_final c on t.sys_id=c.sys_id and t.sourceinstance=c.sourceinstance
left join rogers6_mdsdb.incident_final i on t.sys_id=i.sys_id and t.sourceinstance=i.sourceinstance
