...
b34.name='Rogers Priority 1 - Resolution' 
...
and b.CDCTYPE='X' and a.CDCTYPE='X' and b34.CDCTYPE='X' and d12.soft_deleted_flag='N' and d32.soft_deleted_flag='N' 
and d11.soft_deleted_flag='N'
group by 1)b on a.month_start_date_key=b.month_start_date_key   )b2  
on a.xy1=b2.month_start_date_key where coalesce(attained_response_and_resolution,0)<>cnt)a;
