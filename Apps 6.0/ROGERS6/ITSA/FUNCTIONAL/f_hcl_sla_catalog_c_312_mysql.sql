...
-- question_key,response,response_value,question
 from rogers6_mdwdb.f_task_survey f
join rogers6_mdwdb.f_incident f11 on f.incident_key=f11.incident_key
join rogers6_mdwdb.d_survey_instance d on f.survey_instance_key=d.row_key
join rogers6_mdwdb.d_survey_wizard_c dw on d.survey_wizard_c_key=dw.row_key
join rogers6_mdwdb.f_response fr on f.survey_instance_key=fr.survey_instance_key
join rogers6_mdwdb.d_survey_question dq on fr.question_key=dq.row_key
join rogers6_mdwdb.d_calendar_date d32 on f11.opened_on_key=d32.row_key 
left join rogers6_mdwdb.d_internal_organization d11 on assignment_group_key=d11.row_key
join rogers6_mdwdb.d_lov fl on priority_src_key=fl.row_key 
