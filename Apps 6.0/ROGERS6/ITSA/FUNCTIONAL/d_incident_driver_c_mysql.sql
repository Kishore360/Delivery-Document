...
select count(1) cnt from  rogers6_mdwdb.d_incident d
JOIN rogers6_mdsdb.incident_final i ON  d.row_id=i.sys_id and d.source_id=i.sourceinstance
LEFT JOIN rogers6_mdsdb.us_driver_c_final c 
