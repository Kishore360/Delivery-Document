...
rogers6_mdwdb.d_change_request config 
JOIN rogers6_mdsdb.change_request_final ci
...
where d.soft_deleted_flag='N' and failed_change_src_c_key <> coalesce(d.row_key,case when u_failed_change is null then 0 else -1 end) AND ci.cdctype='X')a