...
where sla='2.6.9')a
join 
(select distinct month_start_date_key,month_end_date_key, substring(month_end_date_key,7,2) as tot_days_month from rogers6_mdwdb.d_calendar_date )c 
...
join rogers6_mdwdb.f_outage f1 on f.incident_key=f1.incident_key
join rogers6_mdwdb.d_application  d1 on f1.application_key=d1.row_key
join rogers6_mdwdb.f_application_availability_c f2 on f2.outage_key=f1.outage_key
