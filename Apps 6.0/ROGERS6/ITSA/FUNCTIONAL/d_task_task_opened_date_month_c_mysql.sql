...
,t.sys_id,t.sourceinstance from (select sys_id,sourceinstance,sys_class_name,opened_at from rogersdev6_mdsdb.task_final where cdctype<>'D' and
...
join rogersdev6_mdwdb.d_calendar_date dc on a.date_key=dc.row_key where concat(dc.month_name_abbreviated,' ',dc.year_id)<>d.task_opened_date_month_c;