...
where 
os_version_c <> COALESCE(ser.os_version,ins.u_os_version,comp.os_version,'UNSPECIFIED') and ci.cdctype='X' and ser.CDCTYPE='X' and ins.CDCTYPE='X' and comp.CDCTYPE='X' )a