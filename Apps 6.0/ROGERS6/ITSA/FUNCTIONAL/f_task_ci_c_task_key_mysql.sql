...
CASE WHEN a.cnt  THEN 'MDS to DWH data validation failed for f_task_ci_c.task_key' ELSE 'SUCCESS' END as Message 
...
left join rogers6_mdwdb.d_task  lkp 
on COALESCE( src.task ,'UNSPECIFIED')=lkp.row_id  and src.sourceinstance=lkp.source_id
