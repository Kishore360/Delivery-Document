...
FROM rogers6_mdsdb.cmdb_ci_appl_final b 
LEFT JOIN rogers6_mdsdb.cmdb_ci_server_final ser
ON b.sys_id = ser.sys_id and b.sourceinstance= ser.sourceinstance 
LEFT JOIN rogers6_mdsdb.cmdb_model_final model
ON b.model_id = model.sys_id
LEFT JOIN rogers6_mdsdb.cmdb_ci_netgear_final netgear
...
LEFT JOIN rogers6_mdsdb.cmdb_ci_cluster_final clust
...
JOIN rogers6_mdwdb.d_configuration_item TRGT 
