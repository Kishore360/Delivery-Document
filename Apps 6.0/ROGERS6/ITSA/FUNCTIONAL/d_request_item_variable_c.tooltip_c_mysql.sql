...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for d_request_item_variable_c.tooltip_c' ELSE 'SUCCESS' END as Message
FROM 
(
...
WHERE    coalesce(SRC2.tooltip,'UNSPECIFIED')<>
 TRGT.tooltip_c
