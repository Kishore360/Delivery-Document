...
CASE WHEN CNT > 0 THEN 'MDS to DWH data validation failed for d_request_item_variable_c.variable_question_c' ELSE 'SUCCESS' END as Message
FROM 
(
...
WHERE    coalesce(SRC2.question_text,'UNSPECIFIED')<>
 TRGT.variable_question_c
