...
join rogersdev6_mdwdb.d_lov l on d.task_type_src_key=l.row_key where l.dimension_name='Incident') TRGT
ON SRC.sys_id= TRGT.row_id AND SRC.sourceinstance = TRGT.source_id and SRC.cdctype<>'D'
JOIN rogersdev6_mdwdb.d_incident LKP ON SRC.sys_id=LKP.row_id AND SRC.sourceinstance=LKP.source_id
