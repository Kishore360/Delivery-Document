...
where sla='3.3.25' and d.hcl_schedule_ac_attachment_ref ='Availability' )a1
left join 
(
...
where component_criticality_c='Productivity'   and dc.subcategory in ('Windows Servers','Linux Servers')  
                    -- New addition 
