...
union
select 'ldb.d_lov_fact_source_c a121 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_lov_fact_source_c a121
on (a11.fact_source_c_key = a121.row_key)
union
...
on (a13.hour_key = a122.row_key)
union
select 'ldb.d_internal_contact_investigation_lead_c a123 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_internal_contact_investigation_lead_c a123
on (a11.investigation_lead_c_key = a123.row_key)
union
...
on (a11.problem_category_c_key = a125.row_key)
union
...
union
select 'ldb.d_lov_problem_contact_type_c a129 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_lov_problem_contact_type_c a129
on (a11.problem_reported_type_src_c_key = a129.row_key)
union
select 'ldb.d_problem_urgency a130 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem_urgency a130
on (a11.urgency_src_key = a130.row_key)
union
select 'ldb.d_lov_problem_rca_agebucket_c a131 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_lov_problem_rca_agebucket_c a131
on (a11.rca_age_c_key = a131.row_key)
union
select 'ldb.d_kb_knowledge_c a132 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_kb_knowledge_c a132
on (a11.kb_knowledge_c_key = a132.row_key)
union
select 'ldb.d_problem_related_problem_c a133 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem_related_problem_c a133
on (a11.related_problem_c_key = a133.row_key)
union
select 'ldb.d_request_item a134 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_request_item a134
on (a11.request_item_c_key = a134.row_key)
union
select 'ldb.d_location_assigned_to a135 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_internal_contact_assigned_to a16
on (a11.assigned_to_key = a16.row_key)
join ldb.d_location_assigned_to a135
...
on (a115.priority_src_key = a138.row_key)
union
select 'ldb.d_lov_problem_primary_closure_code_c a139 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem a14
on (a11.problem_key = a14.row_key)
join ldb.d_lov_problem_primary_closure_code_c a139
on (a14.primary_closure_code_src_c_key = a139.row_key)
union
...
union
select 'ldb.d_lov_problem_substatus_c a141 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem a14
on (a11.problem_key = a14.row_key)
join ldb.d_lov_problem_substatus_c a141
on (a14.substatus_src_c_key = a141.row_key)
union
select 'ldb.d_lov_problem_reason_for_disqualification_c a142 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem a14
on (a11.problem_key = a14.row_key)
join ldb.d_lov_problem_reason_for_disqualification_c a142
on (a14.reason_for_disqualification_src_c_key = a142.row_key)
union
select 'ldb.d_lov_problem_reason_for_non_implementation_c a143 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem a14
on (a11.problem_key = a14.row_key)
join ldb.d_lov_problem_reason_for_non_implementation_c a143
on (a14.reason_for_non_implementation_src_c_key = a143.row_key)
union
select 'ldb.d_lov_problem_swat_code_c a144 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem a14
on (a11.problem_key = a14.row_key)
join ldb.d_lov_problem_swat_code_c a144
on (a14.swat_code_src_c_key = a144.row_key)
union
select 'ldb.d_lov_problem_secondary_closure_code_c a145 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem a14
on (a11.problem_key = a14.row_key)
join ldb.d_lov_problem_secondary_closure_code_c a145
on (a14.secondary_closure_code_src_c_key = a145.row_key)
union
select 'ldb.d_lov_problem_sub_status_c a146 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem a14
on (a11.problem_key = a14.row_key)
join ldb.d_lov_problem_sub_status_c a146
on (a14.sub_status_src_c_key = a146.row_key)
