...
union
select 'ldb.d_support_group_business_unit_c a112 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_internal_organization_support_group_c a111
on (a11.change_initiator_workgroup_c_key = a111.row_key)
join ldb.d_support_group_business_unit_c a112
on (a111.business_unit_c_key = a112.row_key)
union
...
on (a11.incident_c_key = a115.row_key)
union
...
on (a18.week_start_date_key = a116.row_key)
union
...
union
select 'ldb.d_change_request_category a119 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_change_request_category a119
on (a11.category_src_key = a119.row_key)
union
select 'ldb.d_change_request_reported_type a120 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_change_request_reported_type a120
...
union
select 'ldb.d_internal_contact_requested_by_c a122 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_internal_contact_requested_by_c a122
on (a11.requested_by_key = a122.row_key)
union
...
union
select 'ldb.d_internal_contact_task_for_c a125 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_internal_contact_task_for_c a125
on (a11.task_for_c_key = a125.row_key)
union
...
on (a12.employee_mdm_key = a133.row_key)
union
select 'ldb.d_lov_fact_source_c a134 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_lov_fact_source_c a134
on (a11.fact_source_c_key = a134.row_key)
union
...
on (a11.problem_c_key = a136.row_key)
union
...
union
select 'ldb.d_lov_change_request_sub_status_c a139 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_change_request a13
on (a11.change_request_key = a13.row_key)
join ldb.d_lov_change_request_sub_status_c a139
on (a13.sub_status_src_c_key = a139.row_key)
union
select 'ldb.d_lov_change_request_environment_c a140 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_change_request a13
on (a11.change_request_key = a13.row_key)
join ldb.d_lov_change_request_environment_c a140
on (a13.environment_src_c_key = a140.row_key)
union
select 'ldb.d_lov_change_request_failed_change_c a141 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_change_request a11
join ldb.d_change_request a13
on (a11.change_request_key = a13.row_key)
join ldb.d_lov_change_request_failed_change_c a141
on (a13.failed_change_src_c_key = a141.row_key)
union
...
on (a115.priority_src_key = a142.row_key)
