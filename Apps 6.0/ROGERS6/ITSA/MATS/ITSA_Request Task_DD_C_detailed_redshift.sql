...
union
select 'ldb.d_request_task a112 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_request_task a11
join ldb.d_request_task a112
on (a11.request_task_key = a112.row_key)
union
...
union
select 'ldb.d_sc_task_state a116 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_request_task a11
join ldb.d_sc_task_state a116
