...
on (a15.priority_src_key = a17.row_key)
union
select 'ldb.d_lov_incident_sub_status_c a18 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_incident a11
join ldb.d_incident a15
on (a11.incident_key = a15.row_key)
join ldb.d_lov_incident_sub_status_c a18
on (a15.sub_status_src_c_key = a18.row_key)
