...
union
select 'ldb.d_configuration_item_task_ci_c a14 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_task_ci_c a11
...
union
select 'ldb.d_internal_contact_owned_by_c a17 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_task_ci_c a11
join ldb.d_configuration_item a13
on (a11.configuration_item_key = a13.row_key)
...
union
select 'ldb.d_internal_organization_configuration_item_support_group_c a18 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_task_ci_c a11
join ldb.d_configuration_item a13
on (a11.configuration_item_key = a13.row_key)
