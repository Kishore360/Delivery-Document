...
FROM rogers_mdwdb.f_problem p 
JOIN (select SUM(f.total_ci_c) as total_ci_c, f.problem_key,f.source_id,soft_deleted_flag from rogers_mdwdb.f_incident f group by problem_key) i
