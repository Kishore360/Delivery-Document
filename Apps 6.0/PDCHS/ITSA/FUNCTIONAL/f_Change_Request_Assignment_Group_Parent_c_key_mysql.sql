...
CASE WHEN count(1)>0 THEN 'MDS to DWH data validation failed for Change_Request.Change_Request_assignment_group_parent_c_key' ELSE 'SUCCESS' END as Message 
from pdchs_mdsdb.Change_Request_final src 
