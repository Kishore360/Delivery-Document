...
JOIN pdchs_mdwdb.d_configuration_item d 
ON COALESCE(UPPER(a.parent),'UNSPECIFIED')=d.row_id 
AND a.sourceinstance=d.source_id
WHERE COALESCE(d.row_key,CASE WHEN a.parent IS NULL THEN 0 ELSE -1 END)<>c.parent_configuration_item_c_key
) temp;
