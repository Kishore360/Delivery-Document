...
left join pdchs_mdwdb.d_category_c lkp on  src.u_category=lkp.row_id
where coalesce(lkp.row_key, case when src.u_category is null then 0 else -1 end) <> trgt.incident_category_c_key ) temp;
