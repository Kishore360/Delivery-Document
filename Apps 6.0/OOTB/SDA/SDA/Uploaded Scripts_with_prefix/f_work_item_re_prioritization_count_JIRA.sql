...
left join
(
select tmp.issue_changelog_issueid, tmp.issue_changelog_sourceinstance, count(*) re_prioritization_count
...
on SRC.id=re_prioritization_count.issue_changelog_issueid
and SRC.sourceinstance=re_prioritization_count.issue_changelog_sourceinstance
