SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 ...
 on SRC.customfield_10016=LKP.row_id
 ...
 where coalesce(LKP.row_key,case when SRC.customfield_10016 is null then 0 else -1 end )<>coalesce(TRGT.work_item_epic_key,'')