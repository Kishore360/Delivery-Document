...
from (
select tmp.issue_changelog_issueid, tmp.issue_changelog_sourceinstance, tmp.field, count(*)-1 state_chng_cnt
...
left join #DWH_TABLE_SCHEMA.d_work_item TRGT
 ON (concat(SRC.issue_changelog_issueid, '')=TRGT.row_id 
