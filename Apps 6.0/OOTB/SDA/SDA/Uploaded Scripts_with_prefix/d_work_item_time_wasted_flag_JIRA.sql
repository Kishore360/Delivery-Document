...
left join (
select tmp.issue_changelog_issueid,tmp.issue_changelog_sourceinstance, count(1) as time_wasted_count
...
on SRC.id=time_wasted_cnt.issue_changelog_issueid
and SRC.sourceinstance=time_wasted_cnt.issue_changelog_sourceinstance
