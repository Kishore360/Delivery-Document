...
failed for f_work_item_label.work_item_m2m_key' ELSE 'SUCCESS' END as Message
...
from #MDS_TABLE_SCHEMA.issue_labels_final SRC
left join #DWH_TABLE_SCHEMA.f_work_item_label TRGT
...
where coalesce(LKP.row_key, 0) <> COALESCE(TRGT.work_item_m2m_key, 0);
