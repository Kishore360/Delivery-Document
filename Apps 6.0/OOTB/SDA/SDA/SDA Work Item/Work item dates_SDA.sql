...
order by D.work_item_number, D.row_id, lower(PROJ.project_name), lower(D.environment), D.created_on, D.due_on, D.work_start_on, D.resolved_on, D.changed_on, D.completed_on