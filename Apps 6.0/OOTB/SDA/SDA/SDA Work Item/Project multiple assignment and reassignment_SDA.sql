...
group by PROJ.project_name, D.row_key, D.work_item_number, type.row_key, type.sor_lov_name,INTC_ASGN.full_name,INTC_RPT.full_name,INTC_CRT.full_name,D.multiple_assignment_flag
order by lower(PROJ.project_name), D.row_key, D.work_item_number, type.row_key, lower(type.sor_lov_name), upper(INTC_ASGN.full_name), upper(INTC_RPT.full_name), upper(INTC_CRT.full_name), upper(D.multiple_assignment_flag)