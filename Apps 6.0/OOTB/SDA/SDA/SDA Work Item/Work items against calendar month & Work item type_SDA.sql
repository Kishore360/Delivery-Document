select  -- F.*,
concat(concat(cal_crtd_mon.month_name_abbreviated, ' '), cal_crtd_mon.year_id) mon_nm,
cal_crtd_mon.year_id yr_nm,
...
group by cal_crtd_mon.month_id, mon_nm, cal_crtd_mon.year_id, type.row_key, type.sor_lov_name
having crtd_wi > 0
order by cal_crtd_mon.month_id desc, mon_nm, cal_crtd_mon.year_id desc, type.row_key, lower(type.sor_lov_name)