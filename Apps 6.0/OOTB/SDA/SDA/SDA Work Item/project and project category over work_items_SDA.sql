...
proj_cat.proj_cat proj_category,
...
group by PROJ.project_name, proj_cat.row_key, proj_cat.proj_cat
order by lower(PROJ.project_name), proj_cat.row_key, upper(proj_cat.proj_cat)