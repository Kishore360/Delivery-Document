...
group by PROJ.project_name, D.work_item_number, D.row_id, type.sor_lov_name, priority.wi_prio, D.priority_deescalated_flag, D.priority_escalated_flag
order by lower(PROJ.project_name), D.work_item_number, D.row_id, lower(type.sor_lov_name), upper(priority.wi_prio), upper(D.priority_deescalated_flag), upper(D.priority_escalated_flag)