SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 ...
 then 'Failing due to timezone conversion issue for f_work_item_snapshot_weekly.age_since_creation'
 ELSE  'MDS to DWH data validation failed for f_work_item_snapshot_weekly.age_since_creation' END ELSE 'SUCCESS' END as Message
