drop table if exists sda64_d1_workdb.hier_data_temp;

create table if not exists sda64_d1_workdb.hier_data_temp (
...
insert into sda64_d1_workdb.hier_data_temp
...
alter table sda64_d1_workdb.hier_data_temp
...
update sda64_d1_workdb.hier_base hier_base
join (
...
from sda64_d1_workdb.hier_data_temp base
) SQ
