...
update #STG_TABLE_SCHEMA.issue_changelog_link_temp TMP
left join #MDS_TABLE_SCHEMA.issue_issuelinks_final LKP
on TMP.parent_id = LKP.issueid and TMP.child_id = LKP.inwardIssue_id
set TMP.invalid_flag = 'Y'
where TMP.issue_field not in ('Epic Link' , 'Parent') and LKP.outwardIssue_id is null;
