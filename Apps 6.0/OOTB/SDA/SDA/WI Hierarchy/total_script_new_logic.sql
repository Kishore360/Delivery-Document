...
and link_type.dimension_wh_code in ('EPIC')
...
join (
select base.sys_id, base.sourceinstance, base.lev_0_id, base.lev_2_id, base.lev_3_id,
case when base.lev_0_id = base.lev_2_id then 2
else case when base.lev_0_id = base.lev_3_id then 3
     else case when base.lev_0_id = base.lev_4_id then 4
          else case when base.lev_0_id = base.lev_5_id then 5
               else case when base.lev_0_id = base.lev_6_id then 6
                    else 0 end
               end
          end
     end
...
update #STG_TABLE_SCHEMA.hier_base hier_base
join (
select base.sys_id, base.sourceinstance, base.lev_1_id, base.lev_3_id, base.lev_4_id,
case when base.lev_1_id = base.lev_3_id then 3
else case when base.lev_1_id = base.lev_4_id then 4
     else case when base.lev_1_id = base.lev_5_id then 5
          else case when base.lev_1_id = base.lev_6_id then 6
               else 0 end
          end
     end
end
...
update #STG_TABLE_SCHEMA.hier_base hier_base
join (
select base.sys_id, base.sourceinstance, base.lev_2_id, base.lev_4_id, base.lev_5_id,
case when base.lev_2_id = base.lev_4_id then 4
else case when base.lev_2_id = base.lev_5_id then 5
     else case when base.lev_2_id = base.lev_6_id then 6
          else 0 end
     end
end
level_cycle
...
update #STG_TABLE_SCHEMA.hier_base hier_base
join (
select base.sys_id, base.sourceinstance, base.lev_3_id, base.lev_5_id, base.lev_6_id,
case when base.lev_3_id = base.lev_5_id then 5
else case when base.lev_3_id = base.lev_6_id then 6
     else 0 end
end
level_cycle
...
update #STG_TABLE_SCHEMA.hier_base hier_base
join (
select base.sys_id, base.sourceinstance, base.lev_4_id, base.lev_6_id, base.lev_7_id,
case when base.lev_4_id = base.lev_6_id then 6
else 0 
end
level_cycle
