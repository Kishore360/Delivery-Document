...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_lov_risk_work_item_work_item.dimension_class' ELSE 'SUCCESS' END as Message
...
WHERE COALESCE('RISK~WORK_ITEM','')<>COALESCE(TRGT.dimension_class,'')