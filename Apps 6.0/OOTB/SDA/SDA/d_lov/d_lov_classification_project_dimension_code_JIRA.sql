...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_lov_classification_project.dimension_code' ELSE 'SUCCESS' END as Message
...
WHERE  COALESCE(SRC.`key`,'')<>COALESCE(TRGT.dimension_code,'') 