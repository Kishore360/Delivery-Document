select 'ldb.f_request_item_activity a11 ' as Table_name, count(1) Row_Count
...
union
select 'ldb.d_master_item a111 ' as Table_name, count(1) Row_Count
from ldb.f_request_item_activity a11 
join ldb.d_master_item a111 
on (a11.item_key = a111.row_key) 
union
select 'ldb.d_request_item_from_stage a112 ' as Table_name, count(1) Row_Count
from ldb.f_request_item_activity a11 
join ldb.d_request_item_from_stage a112 
on (a11.from_stage_key = a112.row_key) 
union
select 'ldb.d_request_item_from_state a113 ' as Table_name, count(1) Row_Count
from ldb.f_request_item_activity a11 
join ldb.d_request_item_from_state a113 
on (a11.from_state_key = a113.row_key) 
union
select 'ldb.d_sc_req_item_priority a114 ' as Table_name, count(1) Row_Count
from ldb.f_request_item_activity a11 
...
union
select 'ldb.d_request_item_to_stage a117 ' as Table_name, count(1) Row_Count
from ldb.f_request_item_activity a11 
join ldb.d_request_item_to_stage a117 
on (a11.to_stage_key = a117.row_key) 
union
select 'ldb.d_request_item_to_state a118 ' as Table_name, count(1) Row_Count
from ldb.f_request_item_activity a11 
