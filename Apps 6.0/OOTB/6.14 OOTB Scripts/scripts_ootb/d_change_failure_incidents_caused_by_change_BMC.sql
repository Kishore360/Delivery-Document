...
SRC1.Request_ID02 AS request_id FROM  #MDS_TABLE_SCHEMA.hlx_chg_infrastructure_change_final SRC      
...
INNER JOIN #MDS_TABLE_SCHEMA.hlx_hpd_associations_final hpd_associations
                ON SRC1.request_ID01=hpd_associations.Request_ID02
                AND SRC1.sourceinstance=hpd_associations.sourceinstance
INNER JOIN  #MDS_TABLE_SCHEMA.hlx_field_enum_values_final field_enum_values 
ON SRC1.Association_Type01=field_enum_values.value 
