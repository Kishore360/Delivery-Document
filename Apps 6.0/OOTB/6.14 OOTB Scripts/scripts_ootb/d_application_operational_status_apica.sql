...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_application.operational_status' ELSE 'SUCCESS' END as Message
...
and SRC.source_id=TRGT.source_id 
 where coalesce(SRC.operational_status,'')<>coalesce(TRGT.operational_status,'') ;
