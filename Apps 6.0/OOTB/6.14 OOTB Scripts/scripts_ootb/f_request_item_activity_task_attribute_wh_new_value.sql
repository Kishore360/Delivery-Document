...
on (F.request_item_key=TGT2.request_item_key AND SRC.sourceinstance=TGT2.source_id and TGT2.primary_sequence_id = 1)
where TGT.primary_sequence_id = 0 and TGT.soft_deleted_flag = 'N' and D.soft_deleted_flag = 'N' AND TGT.task_attribute_wh_name = 'state'
