SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_asset.asset_age_month_bucket_key' ELSE 'SUCCESS' END as Message
...
where lo.row_key <> coalesce(TRGT.asset_age_month_bucket_key,'') 
