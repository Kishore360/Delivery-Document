...
group by cal_crtd_mon.month_id, mon_nm, cal_crtd_mon.year_id, type.row_key, type.wi_type
order by cal_crtd_mon.month_id desc, mon_nm, cal_crtd_mon.year_id desc, type.row_key, upper(type.wi_type)