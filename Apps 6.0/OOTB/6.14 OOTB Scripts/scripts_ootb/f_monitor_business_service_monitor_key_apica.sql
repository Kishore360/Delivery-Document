...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_monitor_business_service.monitor_key' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC.monitor_key, 'Unspecified')<>coalesce(trgt.monitor_key, 'Unspecified')
