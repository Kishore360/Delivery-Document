...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for d_test_step.step_name' ELSE 'SUCCESS' END as Message
...
where COALESCE(SRC1.labelname,'')<>COALESCE(TRGT.step_name,'')
