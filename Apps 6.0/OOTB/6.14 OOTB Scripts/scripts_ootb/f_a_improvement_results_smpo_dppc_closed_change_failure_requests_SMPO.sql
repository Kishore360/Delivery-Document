SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_a_improvement_results_smpo_dppc.closed_change_failure_requests' ELSE 'SUCCESS' END as Message
...
WHERE TRGT.soft_deleted_flag = 'N' and COALESCE(SRC.closed_change_failure_requests,0) <> COALESCE(TRGT.closed_change_failure_requests ,'');