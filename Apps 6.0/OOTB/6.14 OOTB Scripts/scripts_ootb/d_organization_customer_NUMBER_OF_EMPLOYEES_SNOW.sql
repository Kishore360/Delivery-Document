...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.NUMBER_OF_EMPLOYEES' ELSE 'SUCCESS' END as Message
-- select TRGT.NUMBER_OF_EMPLOYEES
...
where customer=1 and TRGT.NUMBER_OF_EMPLOYEES is not null;