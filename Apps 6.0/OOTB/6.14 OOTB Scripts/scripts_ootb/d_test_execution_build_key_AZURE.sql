...
CASE WHEN count(1) >0 THEN 'MDS to DWH validation failed for d_test_execution.build_key' ELSE 'SUCCESS' END as Message
...
where coalesce(null, 0) <>coalesce(TRGT.build_key,'');