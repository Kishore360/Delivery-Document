SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_a_improvement_results_smpo_dppc.resolved_incidents' ELSE 'SUCCESS' END as Message
...
WHERE TRGT.soft_deleted_flag = 'N' and COALESCE(SRC.resolved_incidents,0) <> COALESCE(TRGT.resolved_incidents ,'');