...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_project.PLANNED_BENEFIT' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC2.PLANNED_BEN_TOTAL,0) <> COALESCE(TRGT.PLANNED_BENEFIT,'')								