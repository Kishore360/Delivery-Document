SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_change_request.scope_src_key' ELSE 'SUCCESS' END as Message
 ...
 WHERE COALESCE('0','')<> COALESCE(TRGT.scope_src_key ,'')
