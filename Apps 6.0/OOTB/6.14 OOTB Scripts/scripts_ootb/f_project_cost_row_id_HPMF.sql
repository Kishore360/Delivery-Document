...
WHERE concat(SRC.PRJ_PROJECT_ID,'~',SRC.PRJ_FINANCIAL_SUMMARY_ID,'~',COALESCE(C.FORECAST_ACTUAL_PERIOD_SUM_ID,'UNSPECIFIED'),
'~',COALESCE(D.actual_row_id,'UNSPECIFIED'))<>COALESCE(TRGT.row_id,'') 
