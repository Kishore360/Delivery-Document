...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_demand.PLANNED_LOC_COST' ELSE 'SUCCESS' END as Message
...
where coalesce(TRGT.PLANNED_LOC_COST,0)<> 0
