...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.LINE_OF_BUSINESS' ELSE 'SUCCESS' END as Message
-- select TRGT.LINE_OF_BUSINESS
...
where customer=1 and TRGT.LINE_OF_BUSINESS is not null;