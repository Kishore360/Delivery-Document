...
parent_task.task_number tsk_num,
...
(
 ...
 or D.backlog_flag = 'Y'
 group by tsk_typ.source_dimension_name, parent_task.row_key, parent_task.task_number
 order by upper(tsk_typ.source_dimension_name), parent_task.row_key, upper(parent_task.task_number)