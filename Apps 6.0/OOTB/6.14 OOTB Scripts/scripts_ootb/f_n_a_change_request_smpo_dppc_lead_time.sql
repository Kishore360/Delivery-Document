...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_n_a_change_request_smpo_dppc.lead_time' ELSE 'SUCCESS' END as Message
...
WHERE COALESCE(SRC.lead_time, 0)<> COALESCE(TRGT.lead_time ,'');