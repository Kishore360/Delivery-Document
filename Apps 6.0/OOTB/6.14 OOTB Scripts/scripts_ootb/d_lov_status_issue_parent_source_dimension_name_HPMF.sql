...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for d_lov_status_issue.parent_source_dimension_name' ELSE 'SUCCESS' END as Message
...
where coalesce(TRGT.parent_source_dimension_name,'')<>null;