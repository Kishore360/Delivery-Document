...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.customer_account_number' ELSE 'SUCCESS' END as Message
-- select TRGT.customer_account_number
...
where customer=1 and TRGT.customer_account_number is not null;