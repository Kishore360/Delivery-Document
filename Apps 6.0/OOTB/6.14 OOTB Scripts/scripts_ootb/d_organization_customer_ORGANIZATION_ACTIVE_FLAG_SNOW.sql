...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.ORGANIZATION_ACTIVE_FLAG' ELSE 'SUCCESS' END as Message
-- select TRGT.ORGANIZATION_ACTIVE_FLAG
...
where customer=1 and TRGT.ORGANIZATION_ACTIVE_FLAG <>'Y';