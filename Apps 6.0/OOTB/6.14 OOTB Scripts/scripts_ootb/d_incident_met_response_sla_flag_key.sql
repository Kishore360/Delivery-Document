select CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_incident.met_response_sla_flag_key' ELSE 'SUCCESS' END as Message
...
and coalesce(TRGT.met_response_sla_flag_key, '') <> coalesce(res_key.row_key, '');