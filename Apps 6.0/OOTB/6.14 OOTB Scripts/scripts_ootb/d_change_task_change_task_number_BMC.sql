...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_change_task.change_task_number' ELSE 'SUCCESS' END as Message
...
WHERE COALESCE(SRC.Task_ID,'') <> COALESCE(TRGT.change_task_number,'')
