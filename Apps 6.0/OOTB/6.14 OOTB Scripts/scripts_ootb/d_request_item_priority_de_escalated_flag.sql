 ...
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_request_item.priority_de_escalated_flag' ELSE 'SUCCESS' END as Message
...
where TA.tablename = 'sc_req_item' 
