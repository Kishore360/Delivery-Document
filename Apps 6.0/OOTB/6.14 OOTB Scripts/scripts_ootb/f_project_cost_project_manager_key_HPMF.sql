...
on concat('INTERNAL_CONTACT~',SUBSTRING(SRC.PRJ_PROJECT_MANAGER_USER_ID,1,6)) = LKP.row_id
and SRC.sourceinstance=LKP.source_id
WHERE COALESCE(LKP.row_key,CASE WHEN SRC.PRJ_PROJECT_MANAGER_USER_ID IS NULL THEN 0 else '-1' end)
