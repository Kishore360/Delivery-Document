...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_n_a_change_request_smpo_dppc.assignment_group_manager_key' ELSE 'SUCCESS' END as Message
