 ...
 select *
 from
 (select count(*) count_src from #STG_TABLE_SCHEMA.issue_activity_azure_base SRC where SRC.field in ('STATUS', 'ITERATION', 'STORY POINTS', 'TIMEORIGINALESTIMATE', 'BUSINESS VALUE', 'ASSIGNEE', 'PRIORITY')) count_src,
