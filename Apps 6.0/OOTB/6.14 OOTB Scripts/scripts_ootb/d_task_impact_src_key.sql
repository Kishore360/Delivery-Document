...
-- select distinct SRC.sys_class_name ,TRGT.impact_src_key,inc.impact_src_key
...
WHERE COALESCE(inc.impact_src_key,prob.impact_src_key,prob_tas.impact_src_key,req_item.impact_src_key
,req_tas.impact_src_key,req.impact_src_key,chan_req.impact_src_key,chan_tas.impact_src_key,LKP.row_key
,CASE WHEN SRC.impact IS NULL THEN 0 else '-1' end)<> COALESCE(TRGT.impact_src_key ,'')
