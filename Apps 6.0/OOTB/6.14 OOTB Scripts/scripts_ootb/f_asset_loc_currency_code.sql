SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_asset.loc_currency_code' ELSE 'SUCCESS' END as Message
...
and SRC.sourceinstance=SRC.sourceinstance
 and cst.field='cost'
