...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.account_owner_id' ELSE 'SUCCESS' END as Message
-- select TRGT.account_owner_id
...
where customer=1 and TRGT.account_owner_id is not null;