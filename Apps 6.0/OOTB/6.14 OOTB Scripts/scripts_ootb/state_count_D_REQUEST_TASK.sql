...
left join (
select base.request_task_key, base.source_id, 
...
group by base.request_task_key, base.source_id 
) state
on state.request_task_key = TRGT.row_key and state.source_id = TRGT.source_id
