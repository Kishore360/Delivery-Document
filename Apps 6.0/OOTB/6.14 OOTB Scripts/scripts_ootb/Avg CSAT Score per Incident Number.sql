...
coalesce(case when SUR_STATE.state = 'Completed' then D.survey_instance_key else null end, 0) sur_inst_num,
...
group by mon, yr, inc, sur_nm, inst_takn, sur_inst_num
order by mon, yr, inc, sur_nm, inst_takn, sur_inst_num