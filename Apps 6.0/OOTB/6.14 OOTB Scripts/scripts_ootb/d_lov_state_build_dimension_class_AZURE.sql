...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_lov_state_build.dimension_class' ELSE 'SUCCESS' END as Message
...
WHERE  COALESCE('STATE~BUILD','')<>COALESCE(TRGT.dimension_class,'') 