...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for d_project_risk.detailed_description' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC2.VISIBLE_PARAMETER43,'')<>coalesce(TRGT.detailed_description,'');