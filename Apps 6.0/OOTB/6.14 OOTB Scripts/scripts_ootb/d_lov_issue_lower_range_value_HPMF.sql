...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for d_lov_issue.lower_range_value' ELSE 'SUCCESS' END as Message
...
and 
coalesce(TRGT.lower_range_value,'')<>null;