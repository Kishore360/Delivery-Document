...
group by PROJ.project_name, D.work_item_number, D.row_id,type.wi_type,INTC_ASGN.full_name,INTC_RPT.full_name,INTC_CRT.full_name,D.multiple_assignment_flag
order by upper(PROJ.project_name), D.work_item_number, D.row_id, upper(type.wi_type), upper(INTC_ASGN.full_name), upper(INTC_RPT.full_name), upper(INTC_CRT.full_name), upper(D.multiple_assignment_flag)