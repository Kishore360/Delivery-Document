...
from 
(
select resource,calendar_date, department, 
...
order by upper(resource),upper(department),to_char(calendar_date,'yyyy-mm-dd'),resource_actual_hours,resource_allocated_hour
