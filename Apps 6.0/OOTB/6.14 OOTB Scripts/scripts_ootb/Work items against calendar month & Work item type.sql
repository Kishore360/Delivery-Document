...
D.proposed_flag = 'Y')
group by cal_crtd_mon.month_id, mon_nm, cal_crtd_mon.year_id, type.wi_type
order by cal_crtd_mon.month_id desc, mon_nm, cal_crtd_mon.year_id desc, upper(type.wi_type)