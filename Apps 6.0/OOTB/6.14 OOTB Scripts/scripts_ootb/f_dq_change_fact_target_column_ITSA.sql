 ...
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_dq_change_fact.target_column' ELSE 'SUCCESS' END as Message
 FROM 
...
on cast(ch_req.changed_on as date)=cal1.calendar_date
 where d_dq_rules.rule='State=NEW' and rule_type='Complex' and ch_req.dimension_wh_code='OPEN'  and (cal1.lagging_count_of_month between 0 and 12) 
...
left join #DWH_TABLE_SCHEMA.d_calendar_date cal1
on cast(ch_req.changed_on as date)=cal1.calendar_date
 where d_dq_rules.rule='State=CLOSED' and rule_type='Complex' and ch_req.dimension_wh_code in ('CLOSED', 'RESOLVED')  and (cal1.lagging_count_of_month between 0 and 12) 
...
left join #DWH_TABLE_SCHEMA.d_calendar_date cal1
on cast(ch_req.changed_on as date)=cal1.calendar_date
 where d_dq_rules.rule='State=INPROGRESS' and rule_type='Complex' and ch_req.dimension_wh_code='CANCELED' and (cal1.lagging_count_of_month between 0 and 12) 
...
left join #DWH_TABLE_SCHEMA.d_calendar_date cal1
on cast(ch_req.changed_on as date)=cal1.calendar_date
 where d_dq_rules.rule='State=INPROGRESS' and rule_type='Individual' and ch_req.dimension_wh_code='CANCELED'  and (cal1.lagging_count_of_month between 0 and 12) 
...
left join #DWH_TABLE_SCHEMA.d_calendar_date cal1
on cast(ch_req.changed_on as date)=cal1.calendar_date
 where d_dq_rules.rule='State=NEW' and rule_type='Individual' and ch_req.dimension_wh_code='OPEN'  and (cal1.lagging_count_of_month between 0 and 12) 
...
left join #DWH_TABLE_SCHEMA.d_calendar_date cal1
on cast(ch_req.changed_on as date)=cal1.calendar_date
 where d_dq_rules.rule='State=CLOSED' and rule_type='Individual' and ch_req.dimension_wh_code in ('CLOSED', 'RESOLVED')  and (cal1.lagging_count_of_month between 0 and 12) 
...
left join #DWH_TABLE_SCHEMA.d_calendar_date cal1
on cast(ch_req.changed_on as date)=cal1.calendar_date
where /*ch_req.dimension_wh_code in ('CLOSED', 'RESOLVED') and */ (cal1.lagging_count_of_month between 0 and 12) 
