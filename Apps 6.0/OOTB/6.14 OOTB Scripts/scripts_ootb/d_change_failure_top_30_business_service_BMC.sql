...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_change_failure.top_30_business_service' ELSE 'SUCCESS' END as Message
...
WHERE COALESCE(TRGT.top_30_business_service,'')<> coalesce(null,'')
