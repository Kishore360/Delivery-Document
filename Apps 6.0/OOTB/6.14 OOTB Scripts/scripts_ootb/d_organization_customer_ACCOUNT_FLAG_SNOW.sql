...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.ACCOUNT_FLAG' ELSE 'SUCCESS' END as Message
-- select TRGT.ACCOUNT_FLAG
...
where customer=1 and TRGT.ACCOUNT_FLAG <>'N';