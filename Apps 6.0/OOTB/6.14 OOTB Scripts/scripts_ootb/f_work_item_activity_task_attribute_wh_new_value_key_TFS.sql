...
select base.system_id, base.teamprojectsk, base.sourceinstance, prev.System_State prev_state, base.System_State current_state, /*next.System_State next_state,*/ base.System_Rev sys_rev
 ...
 on LM.dimension_code = SRC.current_state and LM.dimension_class = 'STATUS~WORK_ITEM' 
 ...
 where TRGT.task_attribute_wh_name in ('STATUS') and 
 coalesce(LM.row_key, case when SRC.current_state is null then 0 else -1 end) <>coalesce(TRGT.task_attribute_wh_new_value_key,'');