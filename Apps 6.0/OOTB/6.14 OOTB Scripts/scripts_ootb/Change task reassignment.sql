...
asgn_to.full_name asgn_nm,
asgn_to_mgr.full_name asgn_to_mgr_nm,
asgn_grp.organization_name asgn_grp_nm,
asgn_grp_mgr.full_name asgn_grp_mgr_nm,
sum(F.reassignment_count) rsgn_cn
-- , round(sum(F.reassignment_count) * 1.00/count(F.row_key),0) avg_rsgn_cn
...
or D.backlog_flag = 'Y'
group by ctn, ctn1, D.opened_on, asgn_nm, asgn_to_mgr_nm, asgn_grp_nm, asgn_grp_mgr_nm
order by ctn, ctn1, D.opened_on, asgn_nm, asgn_to_mgr_nm, asgn_grp_nm, asgn_grp_mgr_nm