...
AND fieldname =  'priority' and oldvalue is not null and newvalue is not null
 ...
 join #MDS_TABLE_SCHEMA.problem_final c on b.documentkey=c.sys_id
join #DWH_TABLE_SCHEMA.d_problem d on c.sys_id = d.row_id and c.sourceinstance = d. source_id
