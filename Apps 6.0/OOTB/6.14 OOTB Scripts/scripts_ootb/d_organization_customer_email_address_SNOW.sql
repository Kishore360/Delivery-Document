...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.email_address' ELSE 'SUCCESS' END as Message
-- select TRGT.email_address
...
where customer=1 and TRGT.email_address is not null;