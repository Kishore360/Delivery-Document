...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_lov_result_build.dimension_class' ELSE 'SUCCESS' END as Message
...
WHERE coalesce('RESULT~BUILD','')<>coalesce(TRGT.dimension_class,'')