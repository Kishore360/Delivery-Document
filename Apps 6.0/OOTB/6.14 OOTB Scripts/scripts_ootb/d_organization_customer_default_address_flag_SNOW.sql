...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.default_address_flag' ELSE 'SUCCESS' END as Message
-- select TRGT.default_address_flag
...
where customer=1 and TRGT.default_address_flag <>'N';