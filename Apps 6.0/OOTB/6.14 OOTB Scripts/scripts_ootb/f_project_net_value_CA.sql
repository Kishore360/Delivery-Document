...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_project.NET_VALUE' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC2.PLANNED_NPV,0) <> COALESCE(TRGT.NET_VALUE,'')								