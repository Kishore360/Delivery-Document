select dri.opened_by_department, dri.opened_by , '' as metric , count(frt.row_key) from 
...
group by dri.opened_by_department, dri.opened_by
order by lower(dri.opened_by_department),lower( dri.opened_by)