SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_dq_rules_configuration_dim.primary_entity' ELSE 'primary_entity-SUCCESS' END as Message
 from 
(select 
...
where SRC.primary_entity<>TGT.primary_entity;