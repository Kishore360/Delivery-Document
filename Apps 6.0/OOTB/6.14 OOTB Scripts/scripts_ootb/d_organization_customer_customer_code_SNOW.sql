...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.customer_code' ELSE 'SUCCESS' END as Message
-- select TRGT.customer_code
...
where customer=1 and TRGT.customer_code is not null;