...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.customer_segment' ELSE 'SUCCESS' END as Message
-- select TRGT.customer_segment
...
where customer=1 and round(TRGT.customer_segment,0) <>0;