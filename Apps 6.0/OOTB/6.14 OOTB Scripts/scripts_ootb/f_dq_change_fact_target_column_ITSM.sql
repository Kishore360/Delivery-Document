...
on cast(d_dq_rules.dw_inserted_on as date)=cal.calendar_date
 where d_dq_rules.rule='State=NEW' and rule_type='Complex' and ch_req.dimension_wh_code='OPEN'  and ch_req.opened_on>'2018-11-05 16:00:00'
...
left join #DWH_TABLE_SCHEMA.d_calendar_date cal
on cast(d_dq_rules.dw_inserted_on as date)=cal.calendar_date
 where d_dq_rules.rule='State=CLOSED' and rule_type='Complex' and ch_req.dimension_wh_code='CLOSED'  and ch_req.opened_on>'2018-11-05 16:00:00'
...
left join #DWH_TABLE_SCHEMA.d_calendar_date cal
on cast(d_dq_rules.dw_inserted_on as date)=cal.calendar_date
 where d_dq_rules.rule='State=INPROGRESS' and rule_type='Complex' and ch_req.dimension_wh_code='CANCELED' and ch_req.opened_on>'2018-11-05 16:00:00'
...
left join #DWH_TABLE_SCHEMA.d_calendar_date cal
on cast(d_dq_rules.dw_inserted_on as date)=cal.calendar_date
 where d_dq_rules.rule='State=INPROGRESS' and rule_type='Individual' and ch_req.dimension_wh_code='CANCELED'  and ch_req.opened_on>'2018-11-05 16:00:00'
...
left join #DWH_TABLE_SCHEMA.d_calendar_date cal
on cast(d_dq_rules.dw_inserted_on as date)=cal.calendar_date
 where d_dq_rules.rule='State=NEW' and rule_type='Individual' and ch_req.dimension_wh_code='OPEN'  and ch_req.opened_on>'2018-11-05 16:00:00'
...
left join #DWH_TABLE_SCHEMA.d_calendar_date cal
on cast(d_dq_rules.dw_inserted_on as date)=cal.calendar_date
 where d_dq_rules.rule='State=CLOSED' and rule_type='Individual' and ch_req.dimension_wh_code='CLOSED'  and ch_req.opened_on>'2018-11-05 16:00:00'
...
left join #DWH_TABLE_SCHEMA.d_calendar_date cal
on cast(d_dq_rules.dw_inserted_on as date)=cal.calendar_date
where /*ch_req.dimension_wh_code='CLOSED' and */ ch_req.opened_on>'2018-11-05 16:00:00'
