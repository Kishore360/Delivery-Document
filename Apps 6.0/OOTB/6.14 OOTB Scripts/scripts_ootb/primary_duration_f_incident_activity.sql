...
WHERE A.primary_duration <> (case when A.incident_key = -1 then null when A.primary_duration1 < 0 then 0 else A.primary_duration1 end) -- OR A.primary_duration is null