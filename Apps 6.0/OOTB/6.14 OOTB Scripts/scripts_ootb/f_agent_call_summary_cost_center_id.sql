...
SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_agent_call_summary.cost_center_id' ELSE 'SUCCESS' END as Message
...
WHERE TRGT.cost_center_id IS NOT NULL
