...
CASE WHEN count(1) >0 THEN 'MDS to DWH validation failed for d_test_execution.user_count' ELSE 'SUCCESS' END as Message
...
where coalesce(null, 0) <>coalesce(TRGT.user_count,'');