...
on LKP.row_id  = SRC2.role_id and LKP.source_id  = SRC.sourceinstance
WHERE COALESCE(LKP.row_key,CASE WHEN SRC2.role_id is null THEN 0 else '-1' end)<> COALESCE(TRGT.resource_role_key,''); 
