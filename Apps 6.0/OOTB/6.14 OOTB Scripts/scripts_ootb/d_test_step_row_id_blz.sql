...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for d_test_step.row_id' ELSE 'SUCCESS' END as Message
...
where COALESCE(SRC1.labelid,'')<>COALESCE(TRGT.row_id,'')
