...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.CUSTOMER_SINCE_DATE' ELSE 'SUCCESS' END as Message
-- select TRGT.CUSTOMER_SINCE_DATE
...
where customer=1 and TRGT.CUSTOMER_SINCE_DATE is not null;