...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_monitor_business_unit.monitor_business_unit_key' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC.monitor_business_unit_key, 'Unspecified')<>coalesce(trgt.monitor_business_unit_key, 'Unspecified')
