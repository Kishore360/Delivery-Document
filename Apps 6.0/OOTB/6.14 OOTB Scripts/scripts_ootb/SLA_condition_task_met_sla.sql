...
cast(sla_start_condition as varchar(255)) start_cond,
cast(sla_stop_condition as varchar(255)) stop_cond,
D.active_flag actv, 
F.outcome_flag oucm,
...
group by task_type_name, stage_name, D.sla_start_condition, D.sla_stop_condition, actv, oucm
order by task_type_name, stage_name, upper(D.sla_start_condition), upper(D.sla_stop_condition), actv, oucm