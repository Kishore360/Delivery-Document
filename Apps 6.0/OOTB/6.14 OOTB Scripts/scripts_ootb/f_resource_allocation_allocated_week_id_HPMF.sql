...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_resource_allocation.week_id' ELSE 'SUCCESS' END as Message
...
WHERE COALESCE(TRGT.week_id,'')<>null
