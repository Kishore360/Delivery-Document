...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for fiscal d_calendar_date.week_end_date_of_month' ELSE 'SUCCESS' END as Message
FROM  
(
...
WHERE SRC_1.src_week_end_date <> tgt.week_end_date_of_month 