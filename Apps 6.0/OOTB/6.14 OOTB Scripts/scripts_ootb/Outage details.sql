...
outage_type.dimension_name Outage_Type_name,
...
group by F.outage_key, des, Outage_Type_name, Outage_message,
startdt, enddt
order by F.outage_key, des, Outage_Type_name, Outage_message,
startdt, enddt