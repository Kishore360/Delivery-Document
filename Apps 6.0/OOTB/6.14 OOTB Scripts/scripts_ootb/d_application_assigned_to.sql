...
CASE WHEN count(1) >0 THEN 'assigned_to validation failed for d_application' ELSE 'SUCCESS' END as Message
...
where TRGT.assigned_to is not NULL and row_key not in (0,-1);
