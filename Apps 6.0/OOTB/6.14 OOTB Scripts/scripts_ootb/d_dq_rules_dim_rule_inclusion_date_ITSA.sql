SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_dq_rules_dim.rule_inclusion_date' ELSE 'rule_inclusion_date-SUCCESS' END as Message
 from 
(select 
...
where SRC.rule_inclusion_date<>TGT.rule_inclusion_date;