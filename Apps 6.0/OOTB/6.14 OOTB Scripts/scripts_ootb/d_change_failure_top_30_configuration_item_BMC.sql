...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_change_failure.top_30_configuration_item' ELSE 'SUCCESS' END as Message
...
WHERE COALESCE(TRGT.top_30_configuration_item,'')<> coalesce(null,'')
