...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for d_project_risk.closure_criteria' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC2.VISIBLE_PARAMETER41,'')<>coalesce(TRGT.closure_criteria,'');