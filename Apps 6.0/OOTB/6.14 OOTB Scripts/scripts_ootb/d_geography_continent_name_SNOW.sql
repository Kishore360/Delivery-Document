...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_geography.continent_name' ELSE 'SUCCESS' END as Message
-- select TRGT.continent_name
...
where TRGT.continent_name is not null;