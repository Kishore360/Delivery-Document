...
trim(to_char(coalesce(round(sum(F.parent_age_at_task_open/86400.00),1),0), '9,999,999,990D9')) parent_at_open,
trim(to_char(coalesce(round(sum(F.parent_age_at_task_closure/86400.00),1),0), '9,999,999,990D9')) parent_at_close
from
(
