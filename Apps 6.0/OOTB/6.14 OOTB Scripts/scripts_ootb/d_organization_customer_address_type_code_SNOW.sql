...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.address_type_code' ELSE 'SUCCESS' END as Message
-- select TRGT.address_type_code
...
where customer=1 and TRGT.address_type_code is not null;