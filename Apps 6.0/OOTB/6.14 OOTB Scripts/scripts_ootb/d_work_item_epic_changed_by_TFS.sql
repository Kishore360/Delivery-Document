SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_work_item_epic.changed_by' ELSE 'SUCCESS' END as Message
...
left join #DWH_TABLE_SCHEMA.d_work_item_epic TRGT
 ...
 coalesce(SRC.System_ChangedBy__PersonSK,'')<>coalesce(TRGT.changed_by,'')