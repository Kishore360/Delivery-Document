...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for d_demand.demand_name' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC1.proposal_name,'')<>coalesce(TRGT.demand_name,'')