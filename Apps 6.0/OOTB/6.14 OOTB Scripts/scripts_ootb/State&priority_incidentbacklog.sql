select concat(concat(CAL_MONTH.month_name_abbreviated,' '), CAL_MONTH.year_name),state.dimension_name As State,priority.dimension_name As Priority,					
...
group by  CAL_MONTH.month_name_abbreviated, CAL_MONTH.year_name, CAL_MONTH.month_id,state.dimension_name,priority.dimension_name
order by CAL_MONTH.month_id desc,CAL_MONTH.month_name_abbreviated, CAL_MONTH.year_name,state.dimension_name,priority.dimension_name