...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for d_lov_issue.dimension_class' ELSE 'SUCCESS' END as Message
...
WHEN UPPER(SRC.LOOKUP_TYPE)='PMO - ISSUE IMPACT LEVEL' THEN 'PROJECT_ISSUE~ESCALATION' 
WHEN UPPER(SRC.LOOKUP_TYPE)='ISSUE_PRIORITY' THEN 'PROJECT_ISSUE~PRIORITY' 
WHEN UPPER(SRC.LOOKUP_TYPE)='PMO - ISSUE TYPE' THEN 'PROJECT_ISSUE~TYPE' END,'')
