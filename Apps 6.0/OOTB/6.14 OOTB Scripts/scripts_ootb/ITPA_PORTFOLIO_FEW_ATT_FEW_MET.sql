SELECT  portfolio_category, portfolio_goal_alignment, portfolio_innovation_level, portfolio_manager, portfolio_overall_health, portfolio_probability_of_success, 
portfolio_risk, 
...
group by portfolio_category, portfolio_goal_alignment, portfolio_innovation_level, portfolio_manager, portfolio_overall_health, portfolio_probability_of_success, 
portfolio_risk

order by UPPER(portfolio_category), UPPER(portfolio_goal_alignment), UPPER(portfolio_innovation_level), UPPER(portfolio_manager), UPPER(portfolio_overall_health), 
UPPER(portfolio_probability_of_success), UPPER(portfolio_risk)