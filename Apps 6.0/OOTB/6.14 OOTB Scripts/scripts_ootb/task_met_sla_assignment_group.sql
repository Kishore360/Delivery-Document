...
coalesce(lev1_hier.lev1_org_name, 'UNSPECIFIED') hier1,
coalesce(lev2_hier.lev2_org_name, 'UNSPECIFIED') hier2,
coalesce(lev3_hier.lev3_org_name, 'UNSPECIFIED') hier3,
coalesce(lev4_hier.lev4_org_name, 'UNSPECIFIED') hier4,
...
max(lev1_hier.lev1_ag_count) hier1_cnt,
max(lev2_hier.lev2_ag_count) hier2_cnt,
max(lev3_hier.lev3_ag_count) hier3_cnt,
max(lev4_hier.lev4_ag_count) hier4_cnt
from 
(
