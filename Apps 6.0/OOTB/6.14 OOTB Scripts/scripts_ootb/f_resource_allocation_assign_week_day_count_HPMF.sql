...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_resource_allocation.week_day_count' ELSE 'SUCCESS' END as Message
...
where COALESCE(TRGT.week_day_count)<>null