...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_internal_organization.location_key' ELSE 'SUCCESS' END as Message
FROM  
...
where COALESCE(TRGT.location_key,0) <> -1