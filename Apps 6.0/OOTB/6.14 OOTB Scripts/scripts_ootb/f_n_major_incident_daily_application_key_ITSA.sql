 ...
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_n_major_incident_daily.application_key' ELSE 'SUCCESS' END as Message
...
WHERE  COALESCE(SRC.application_key, '0') <> COALESCE(TRGT.application_key, '0'); 