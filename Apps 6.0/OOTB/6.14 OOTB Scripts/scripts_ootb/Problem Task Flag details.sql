...
D.backlog_flag bflag,
D.over_due_flag odflag,
D.dormant_flag dflag,
D.met_sla_flag slaflag,
...
group by D.problem_task_number, DPROB.problem_number, D.short_description, bflag, odflag, dflag, slaflag
order by D.problem_task_number, DPROB.problem_number, D.short_description, bflag, odflag, dflag, slaflag