...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.last_activity_date' ELSE 'SUCCESS' END as Message
-- select TRGT.last_activity_date
...
where customer=1 and TRGT.last_activity_date is not null;