...
LEFT JOIN ( select year_start_date, year_end_date from   #DWH_TABLE_SCHEMA.d_calendar_date where calendar_date=year_start_date and lagging_count_of_year=0 and calendar_code = 0) cal  
ON
