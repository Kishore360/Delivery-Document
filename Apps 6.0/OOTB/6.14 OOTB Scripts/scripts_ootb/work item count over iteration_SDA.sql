...
TO_CHAR((DIT.start_date),'fmMM/fmDD/YYYY fmHH:MI:SS AM') strt_dt,
TO_CHAR((DIT.end_date),'fmMM/fmDD/YYYY fmHH:MI:SS AM') plnd_end_dt,
TO_CHAR((DIT.completion_date),'fmMM/fmDD/YYYY fmHH:MI:SS AM') actl_end_dt,
...
group by DIT.row_key, DIT.name, DIT.start_date, DIT.end_date, DIT.completion_date
order by DIT.row_key, upper(DIT.name), DIT.start_date, DIT.end_date, DIT.completion_date