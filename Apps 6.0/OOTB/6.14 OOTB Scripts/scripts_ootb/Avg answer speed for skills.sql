...
from #DWH_TABLE_SCHEMA.f_skill_call_summary F
 ...
 JOIN #DWH_TABLE_SCHEMA.d_shift shift
...
group by CAL_MONTH.month_id,CAL_MONTH.month_name_abbreviated,D.name,D.row_key ,cal_month.year_name
