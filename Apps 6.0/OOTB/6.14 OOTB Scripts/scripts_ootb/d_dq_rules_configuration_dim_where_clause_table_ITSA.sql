SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_dq_rules_configuration_dim.where_clause_table' ELSE 'where_clause_table-SUCCESS' END as Message
 from 
(select 
...
where SRC.where_clause_table<>TGT.where_clause_table;