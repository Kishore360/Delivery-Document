 ...
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_problem_task_task.priority_de_escalated_flag' ELSE 'SUCCESS' END as Message
...
where TA.tablename = 'problem_task' 
