SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_dq_rules_configuration_dim.join_condition' ELSE 'join_condition-SUCCESS' END as Message
 from 
(select 
...
where SRC.join_condition<>TGT.join_condition;