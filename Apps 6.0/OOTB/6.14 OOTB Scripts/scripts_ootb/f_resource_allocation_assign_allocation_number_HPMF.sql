...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_resource_allocation.allocation_number' ELSE 'SUCCESS' END as Message
...
where COALESCE(TRGT.allocation_number,'')<>0;
