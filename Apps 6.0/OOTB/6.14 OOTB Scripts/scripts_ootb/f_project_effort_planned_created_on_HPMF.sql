...
and SRC.sourceinstance=planned_effort.sourceinstance
...
and COALESCE(convert_tz(planned_effort.creation_date,'<<TENANT_SSI_TIME_ZONE>>','<<DW_TARGET_TIME_ZONE>>'),'')<>coalesce(TRGT.created_on,'')
