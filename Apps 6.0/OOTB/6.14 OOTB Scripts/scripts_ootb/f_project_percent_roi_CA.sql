...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_project.PERCENT_ROI' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC2.PLANNED_ROI,0) <> COALESCE(TRGT.PERCENT_ROI,'')								