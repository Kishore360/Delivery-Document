...
FROM #MDS_TABLE_SCHEMA.incident_final 
 ...
 JOIN  
(SELECT  f.last_resolved_on_key,f.source_id,f.ROW_ID FROM  #DWH_TABLE_SCHEMA.f_incident f
join #DWH_TABLE_SCHEMA.d_lov_map dlm ON f.state_src_key = dlm.src_key and f.state_src_code=dlm.dimension_code 
