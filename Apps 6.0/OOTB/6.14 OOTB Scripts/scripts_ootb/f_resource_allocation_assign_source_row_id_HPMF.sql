...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_resource_allocation.source_row_id' ELSE 'SUCCESS' END as Message
...
where  COALESCE(TRGT.source_row_id,'')<>null
