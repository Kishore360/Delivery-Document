 ...
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_n_major_incident_daily.source_id' ELSE 'SUCCESS' END as Message
...
WHERE  COALESCE(SRC.source_id, '0') <> COALESCE(TRGT.source_id, '0'); 	