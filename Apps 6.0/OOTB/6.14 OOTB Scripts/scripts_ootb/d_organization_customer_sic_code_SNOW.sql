...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.sic_code' ELSE 'SUCCESS' END as Message
-- select TRGT.sic_code
...
where customer=1 and TRGT.sic_code is not null;