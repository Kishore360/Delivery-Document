...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.geo_key' ELSE 'SUCCESS' END as Message
-- select TRGT.geo_key
...
where customer=1 and TRGT.geo_key <>-1;