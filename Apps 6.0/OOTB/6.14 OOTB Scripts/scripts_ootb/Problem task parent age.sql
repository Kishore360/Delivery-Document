...
round(sum(distinct F.parent_age_at_task_open/86400.00),1) parent_at_open,

round(sum(distinct F.parent_age_at_task_closure/86400.00),1) parent_at_close
...
group by pt_num, pt_num_desc, D.opened_on, D.due_on, D.closed_on
order by pt_num, pt_num_desc, D.opened_on, D.due_on, D.closed_on