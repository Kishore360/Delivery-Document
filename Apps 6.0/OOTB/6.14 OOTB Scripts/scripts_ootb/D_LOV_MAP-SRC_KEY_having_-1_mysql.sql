...
from  #DWH_TABLE_SCHEMA.d_lov_map map
 join #DWH_TABLE_SCHEMA.d_lov lov on lov.src_rowid=map.src_rowid and lov.source_id=map.source_id
left join
...
left join #MDS_TABLE_SCHEMA.sys_choice_final scf on conf.table_value= scf.name and conf.column_value = scf.element
