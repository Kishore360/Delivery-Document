...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_project.row_id' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC.project_id,'')<>coalesce(TRGT.row_id,'');