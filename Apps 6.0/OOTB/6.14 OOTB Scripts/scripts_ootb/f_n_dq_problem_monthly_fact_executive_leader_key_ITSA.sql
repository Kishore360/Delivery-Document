SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_n_dq_problem_monthly_fact.executive_leader_key' ELSE 'SUCCESS' END as Message
...
WHERE COALESCE(lev3.row_key, '') <> COALESCE(TRGT.executive_leader_key, '');  
