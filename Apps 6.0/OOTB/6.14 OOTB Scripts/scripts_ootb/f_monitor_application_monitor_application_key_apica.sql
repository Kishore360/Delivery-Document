...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_monitor_application.monitor_application_key' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC.monitor_application_key, 'Unspecified')<>coalesce(trgt.monitor_application_key, 'Unspecified')
