select 
F.task_type task_type_name,
sla_stage.dimension_name stage_name,
cast(D.sla_condition as varchar) cond, 
D.active_flag actv, 
F.outcome_flag oucm,
...
group by task_type_name, stage_name, cond, actv, oucm
order by task_type_name, stage_name, cond, actv, oucm