...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.CUSTOMER_CATEGORY_CODE' ELSE 'SUCCESS' END as Message
-- select TRGT.CUSTOMER_CATEGORY_CODE
...
where customer=1 and TRGT.CUSTOMER_CATEGORY_CODE is not null;