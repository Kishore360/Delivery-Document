...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.ST_ADDRESS2' ELSE 'SUCCESS' END as Message
-- select TRGT.ST_ADDRESS2
...
where customer=1 and TRGT.ST_ADDRESS2 is not null;