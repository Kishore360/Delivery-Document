...
FROM #DWH_TABLE_SCHEMA.d_service_entitlement d 
left join #DWH_TABLE_SCHEMA.d_o_data_freshness o
on o.source_id=d.source_id
where d.row_key not in (0, -1) and 
(TIMESTAMPDIFF(DAY,DATE(o.lastupdated),coalesce(d.entitlement_end_on)) + 1) <> d.entitlement_expiry_age;