...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for d_resource_plan.actual_start_on' ELSE 'SUCCESS' END as Message
...
where coalesce(TRGT.actual_start_on,'')<>null