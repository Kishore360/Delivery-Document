...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.account_name' ELSE 'SUCCESS' END as Message
-- select TRGT.account_name
...
where customer=1 and TRGT.account_name is not null;