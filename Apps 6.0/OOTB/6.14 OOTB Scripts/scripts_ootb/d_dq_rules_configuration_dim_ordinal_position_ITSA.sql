SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_dq_rules_configuration_dim.ordinal_position' ELSE 'ordinal_position-SUCCESS' END as Message
 from 
(select 
...
where SRC.ordinal_position<>TGT.ordinal_position;