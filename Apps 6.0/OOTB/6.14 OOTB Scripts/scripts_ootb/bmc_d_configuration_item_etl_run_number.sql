...
SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_configuration_item.etl_run_number' ELSE 'SUCCESS' END as Message
...
WHERE @#PARENT_ETL_RUN_ID@#<> TRGT.etl_run_number
