...
((select count(*) from #DWH_TABLE_SCHEMA.f_change_request_activity ftt1 where ftt1.task_wh_type = 'change_request' and ftt1.task_attribute_wh_name = 'state' 
 AND ftt.change_request_key = ftt1.change_request_key and (ftt1.created_on < ftt.created_on or (ftt1.created_on = ftt.created_on and ftt1.task_attribute_wh_name < ftt.task_attribute_wh_name))))  as primary_sequence_id1 
