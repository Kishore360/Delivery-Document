...
max(efrt_ver_color.dimension_code) efrt_vrnc_color,
...
group by D_P.row_key, Portfolio_name, Portfolio_category, D.row_key, D.Project_name, TOP_PRJ.row_key, Top_Project_Name, WK, efrt_color
