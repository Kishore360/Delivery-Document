...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_a_change_request_smpo_dppc.planned_caused_by_change_outages' ELSE 'SUCCESS' END as Message
