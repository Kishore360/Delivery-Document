 ...
 from (select * from 
 (select count(*) count_src from #MDS_TABLE_SCHEMA.azure_project_final  where cdctype <> 'D') count_src,
 
 (select count(*) count_trgt from #DWH_TABLE_SCHEMA.d_project  TRGT 
