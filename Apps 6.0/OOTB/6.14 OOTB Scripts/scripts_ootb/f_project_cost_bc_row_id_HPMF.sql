...
WHERE concat(SRC.PRJ_PROJECT_ID,'~',SRC.PRJ_FINANCIAL_SUMMARY_ID,'~',SRC3.fiscal_period_id,'~',
COALESCE(SRC2.LABOR_TYPE_CODE,'UNSPECIFIED'),'~',COALESCE(SRC2.EXPENSE_TYPE_CODE,'UNSPECIFIED'))<>COALESCE(TRGT.row_id,'')