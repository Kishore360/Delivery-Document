...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_change_failure.top_30_application' ELSE 'SUCCESS' END as Message
...
WHERE COALESCE(TRGT.top_30_application,'')<> coalesce(null,'')
