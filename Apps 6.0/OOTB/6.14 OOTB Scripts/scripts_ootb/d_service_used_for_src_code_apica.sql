	...
	CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_service.used_for_src_code' ELSE 'SUCCESS' END as Message
	...
	and SRC.source_id=TRGT.source_id 
	 where coalesce(SRC.used_for_src_code,'')<>coalesce(TRGT.used_for_src_code,'') ;
