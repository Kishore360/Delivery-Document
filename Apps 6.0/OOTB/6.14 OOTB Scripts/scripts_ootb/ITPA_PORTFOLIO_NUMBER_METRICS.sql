SELECT  portfolio_cost_variance_color, portfolio_effort_variance_color,portfolio_schedule_variance,
...
group by portfolio_cost_variance_color, portfolio_effort_variance_color,portfolio_schedule_variance


order by portfolio_cost_variance_color, portfolio_effort_variance_color,portfolio_schedule_variance
