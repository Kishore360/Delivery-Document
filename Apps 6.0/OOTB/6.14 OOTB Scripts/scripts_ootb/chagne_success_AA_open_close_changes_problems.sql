...
-- All_Col.state, 
All_Col.change_number, All_Col.assigned_to,All_Col.assignment_group,All_Col.caused_problem_flag,All_Col.close_code, All_Col.numerify_change_failure_flag,
