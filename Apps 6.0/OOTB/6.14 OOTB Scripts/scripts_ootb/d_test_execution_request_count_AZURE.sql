...
CASE WHEN count(1) >0 THEN 'MDS to DWH validation failed for d_test_execution.request_count' ELSE 'SUCCESS' END as Message
...
where coalesce(null, 0) <>coalesce(TRGT.request_count,'');