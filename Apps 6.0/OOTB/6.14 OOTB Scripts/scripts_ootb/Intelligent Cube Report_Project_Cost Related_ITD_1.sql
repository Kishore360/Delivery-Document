...
cast(D2.project_name as varchar(200)) Top_Project_Name,
...
concat('$',coalesce(case when round(sum(F.budget_doc_cost),0)>=1000
then concat(trim(to_char(round(sum(F.budget_doc_cost/1000),0) ,'9,999,999,999')),'K') 
else cast(round(sum(F.budget_doc_cost),0) as varchar(200)) end, cast(0 as varchar(200)))) budgeted_cost,
...
case when round(((sum(F.total_actual_doc_cost)) - sum(F.budget_doc_cost::numeric(12,3))),0) <0
then concat('-$',(cast((coalesce((round(((sum(F.total_actual_doc_cost)) - sum(F.budget_doc_cost::numeric(12,3))),0)*(-1)),0)) as varchar(200))))
when round(((sum(F.total_actual_doc_cost)) - sum(F.budget_doc_cost::numeric(12,3))),0) >=1000
then concat('$',concat(trim(to_char(coalesce(round((((sum(F.total_actual_doc_cost)) - sum(F.budget_doc_cost::numeric(12,3)))/1000),0),0), '9,999,999,999')),'K')) 
else concat('$',(trim(to_char(coalesce(round(((sum(F.total_actual_doc_cost)) - sum(F.budget_doc_cost::numeric(12,3)))),0), '9,999,999,999')))) end Cost_variance_act_vs_budgeted,
...
case when abs(round(((sum(F.total_actual_doc_cost)) - sum(F.estimated_doc_cost::numeric(12,3) * (f.actual_percent_complete/100.00))),0)) >=1000
then concat('$',concat(trim(to_char(coalesce(abs(round((((sum(F.total_actual_doc_cost)) - sum(F.estimated_doc_cost::numeric(12,3) * (f.actual_percent_complete/100.00)))/1000),0)),0), '9,999,999,999')),'K')) 
else concat('$',(trim(to_char(coalesce(abs(round(((sum(F.total_actual_doc_cost)) - sum(F.estimated_doc_cost::numeric(12,3) * (f.actual_percent_complete/100.00))),0)), 0),'9,999,999,999')))) end Cost_variance_act_vs_plnd_abs,

case when round(((sum(F.estimated_doc_cost)) - sum(F.budget_doc_cost::numeric(12,3))),0) <0
then concat('-$',(cast((coalesce((round(((sum(F.estimated_doc_cost)) - sum(F.budget_doc_cost::numeric(12,3))),0)*(-1)),0)) as varchar(200))))
when round(((sum(F.estimated_doc_cost)) - sum(F.budget_doc_cost::numeric(12,3))),0) >=1000
then concat('$',concat(trim(to_char(coalesce(round((((sum(F.estimated_doc_cost)) - sum(F.budget_doc_cost::numeric(12,3)))/1000),0),0), '9,999,999,999')),'K')) 
else concat('$',(trim(to_char(coalesce(round(((sum(F.estimated_doc_cost)) - sum(F.budget_doc_cost::numeric(12,3)))),0), '9,999,999,999')))) end Cost_variance_plnd_vs_bud,

concat(round((sum(coalesce(F.percent_roi,0))*100),0),'%') ROI,

case when round((sum((coalesce(F.actual_percent_complete, 0)/100)::Numeric(17,4)* F.estimated_doc_cost::Numeric(17,4))),0) <0
then concat('-$',(cast((coalesce((round((sum((coalesce(F.actual_percent_complete, 0)/100)::Numeric(17,4)* F.estimated_doc_cost::Numeric(17,4))),0)*(-1)),0)) as varchar(200))))
when round((sum((coalesce(F.actual_percent_complete, 0)/100)::Numeric(17,4)* F.estimated_doc_cost::Numeric(17,4))),0) >=1000
then concat('$',concat(trim(to_char(coalesce(round(((sum((coalesce(F.actual_percent_complete, 0)/100)::Numeric(17,4)* F.estimated_doc_cost::Numeric(17,4)))/1000),0),0), '9,999,999,999')),'K')) 
else concat('$',(trim(to_char(coalesce(round((sum((coalesce(F.actual_percent_complete, 0)/100)::Numeric(17,4)* F.estimated_doc_cost::Numeric(17,4)))),0), '9,999,999,999')))) end Earned_value
...
group by D_P.row_key, Portfolio_name, Portfolio_category, D.row_key, D.Project_name, D2.row_key, D2.project_name, cost_variance_color, Perc_Cost_Variance
