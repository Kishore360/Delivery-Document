...
CASE WHEN count(1) >0 THEN 'support_group validation failed for d_application' ELSE 'SUCCESS' END as Message
...
where TRGT.support_group is not NULL and row_key not in (0,-1);