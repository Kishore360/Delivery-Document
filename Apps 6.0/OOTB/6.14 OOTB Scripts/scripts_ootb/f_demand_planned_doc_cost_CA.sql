...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_demand.PLANNED_DOC_COST' ELSE 'SUCCESS' END as Message
...
where COALESCE(SRC2.PLANNED_CST_TOTAL,0)<>coalesce(TRGT.PLANNED_DOC_COST,0);