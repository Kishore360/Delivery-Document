...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_project.configuration_item_key' ELSE 'SUCCESS' END as Message
...
where  0
<> COALESCE(TRGT.configuration_item_key,0);
