SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_n_a_request_item_smpo_dppc.request_items_met_all_slas' ELSE 'SUCCESS' END as Message
...
WHERE COALESCE(SRC.request_items_met_all_slas, 0)<> COALESCE(TRGT.request_items_met_all_slas ,'');