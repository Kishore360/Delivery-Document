...
from #DWH_TABLE_SCHEMA.f_incident f
 join #DWH_TABLE_SCHEMA.d_lov_map d on src_key=state_src_key
 join #DWH_TABLE_SCHEMA.d_lov lov on lov.dimension_class=d.dimension_class and lov.dimension_code=d.dimension_code 
