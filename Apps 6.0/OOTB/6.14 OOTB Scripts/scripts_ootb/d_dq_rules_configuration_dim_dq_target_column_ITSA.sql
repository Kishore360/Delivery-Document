SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_dq_rules_configuration_dim.dq_target_column' ELSE 'dq_target_column-SUCCESS' END as Message
 from 
(select 
...
where SRC.dq_target_column<>TGT.dq_target_column;