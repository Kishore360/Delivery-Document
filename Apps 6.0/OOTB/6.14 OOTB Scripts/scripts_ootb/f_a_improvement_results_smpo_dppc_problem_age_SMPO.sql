SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_a_improvement_results_smpo_dppc.problem_age' ELSE 'SUCCESS' END as Message
...
WHERE TRGT.soft_deleted_flag = 'N' and COALESCE(SRC.problem_age,0) <> COALESCE(TRGT.problem_age ,'');