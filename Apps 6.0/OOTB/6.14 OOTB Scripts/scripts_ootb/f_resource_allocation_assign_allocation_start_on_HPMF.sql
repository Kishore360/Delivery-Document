...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_resource_allocation.allocation_start_on' ELSE 'SUCCESS' END as Message
...
where COALESCE(TRGT.allocation_start_on,'')<>null;