...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_resource_allocation.allocation_end_on' ELSE 'SUCCESS' END as Message
...
where COALESCE(TRGT.allocation_end_on_key,'')<>0