...
CASE WHEN count(1) >0 THEN 'MDS to DWH validation failed for d_work_item.source_url' ELSE 'SUCCESS' END as Message
...
coalesce(CONCAT('<a href=\"https://dev.azure.com/',org.organizationName,'/_workitems/edit/',SRC.id,'">'), '') <> coalesce(TRGT.source_url,'');