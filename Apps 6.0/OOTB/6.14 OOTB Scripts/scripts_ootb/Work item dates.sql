...
D.proposed_flag = 'Y')
group by D.work_item_number, D.row_id, PROJ.project_name, D.created_on, D.due_on, D.work_start_on, D.resolved_on, D.changed_on, D.completed_on
order by D.work_item_number, D.row_id, upper(PROJ.project_name), D.created_on, D.due_on, D.work_start_on, D.resolved_on, D.changed_on, D.completed_on