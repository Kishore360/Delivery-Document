...
SRVC.name BS_name,
CI.name CI_name,
DIO.organization_name as comp_name,
DOM.domain_name dom_name,
LOC.location_name as Loc_name,
risk_ver_color.risk_color risk_color_cde,
...
group by D_P.name , D_P.row_key, Portfolio_category,D.project_name, D.row_key, TOP_PRJ.row_key, TOP_PRJ.project_name, week_nm, Parent_project_name,
Project_Manager, Status_src, BS_name, CI_name, comp_name, dom_name, Loc_name, is_top, risk_color_cde
order by D_P.row_key, lower(D_P.name), D.row_key, lower(D.Project_name), TOP_PRJ.row_key, lower(TOP_PRJ.project_name), week_nm