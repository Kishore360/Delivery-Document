 ...
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_n_major_incident_daily.major_incident_flag' ELSE 'SUCCESS' END as Message
...
WHERE  COALESCE(SRC.major_incident_flag, '0') <> COALESCE(TRGT.major_incident_flag, '0'); 