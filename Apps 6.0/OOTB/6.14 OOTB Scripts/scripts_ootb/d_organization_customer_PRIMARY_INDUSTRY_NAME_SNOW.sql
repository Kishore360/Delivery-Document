...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.PRIMARY_INDUSTRY_NAME' ELSE 'SUCCESS' END as Message
-- select TRGT.PRIMARY_INDUSTRY_NAME
...
where customer=1 and TRGT.PRIMARY_INDUSTRY_NAME is not null;