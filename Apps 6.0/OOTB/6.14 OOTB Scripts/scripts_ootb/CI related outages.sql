...
group by CI.row_key, CI.class, CI.CI_Type, CI.category, CI.subcategory,
CI.name, CI.vendor, CI.manufacturer, CI.row_key
order by CI.row_key, lower(CI.class), lower(CI.CI_Type), lower(CI.category), lower(CI.subcategory),
