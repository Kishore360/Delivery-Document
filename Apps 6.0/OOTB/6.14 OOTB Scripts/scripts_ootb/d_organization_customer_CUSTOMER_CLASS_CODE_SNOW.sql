...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.CUSTOMER_CLASS_CODE' ELSE 'SUCCESS' END as Message
-- select TRGT.CUSTOMER_CLASS_CODE
...
where customer=1 and TRGT.CUSTOMER_CLASS_CODE is not null;