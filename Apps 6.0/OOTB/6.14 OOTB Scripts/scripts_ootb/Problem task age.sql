...
to_char(round(sum(distinct (case when state.state = 'CLOSED' then null else F.age end)/86400.00) / count(distinct F.problem_task_key),1), 'FM999,999,999,999D9') avg_age
