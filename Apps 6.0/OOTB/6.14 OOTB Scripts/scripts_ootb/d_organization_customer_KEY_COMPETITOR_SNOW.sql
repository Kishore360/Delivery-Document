...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.KEY_COMPETITOR' ELSE 'SUCCESS' END as Message
-- select TRGT.KEY_COMPETITOR
...
where customer=1 and TRGT.KEY_COMPETITOR is not null;