...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_monitor_geography.monitor_geography_key' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC.monitor_geography_key, 'Unspecified')<>coalesce(trgt.monitor_geography_key, 'Unspecified')
