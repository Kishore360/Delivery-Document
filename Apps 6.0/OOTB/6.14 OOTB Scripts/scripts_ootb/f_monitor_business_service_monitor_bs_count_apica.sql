...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_monitor_business_service.monitor_bs_count' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC.monitor_bs_count, 'Unspecified')<>coalesce(trgt.monitor_bs_count, 'Unspecified')
