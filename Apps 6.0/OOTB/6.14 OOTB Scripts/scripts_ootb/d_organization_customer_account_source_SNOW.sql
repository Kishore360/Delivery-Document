...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.account_source' ELSE 'SUCCESS' END as Message
-- select TRGT.account_source
...
where customer=1 and TRGT.account_source is not null;