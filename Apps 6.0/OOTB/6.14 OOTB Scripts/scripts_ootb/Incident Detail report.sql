...
D.incident_number incn_desc,
D.short_description shrt,
to_char(D.opened_on, 'fmmm/fmdd/fmyyyy fmHH:MI:SS AM') opndt,
to_char(D.due_on, 'fmmm/fmdd/fmyyyy fmHH:MI:SS AM') duedt,
asgn_to.full_name asn_to_nm,
asgn_grp.organization_name asgn_grp_name,
state.dimension_name st,
CONTACT_TYPE.dimension_name cnt_typ,
priority.dimension_name prio,
CATEGORY.dimension_name cat,
SUBCATEGORY.dimension_name subca,
...
group by incn, incn_desc, shrt, D.opened_on, D.due_on, asn_to_nm, asgn_grp_name, st, cnt_typ, prio, cat, subca
order by incn, incn_desc, shrt, D.opened_on, D.due_on, asn_to_nm, asgn_grp_name, st, cnt_typ, prio, cat, subca