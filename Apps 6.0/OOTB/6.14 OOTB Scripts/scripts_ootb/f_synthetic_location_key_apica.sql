...
left outer join #DWH_TABLE_SCHEMA.d_location D_LOC
on COALESCE(checks.location,'UNSPECIFIED')=D_LOC.row_id collate utf8_unicode_ci
and D_LOC.source_id=check_results.sourceinstance
...
where SRC.location_key<>trgt.location_key
