SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_a_request_item_backlog_smpo_dppc.request_item_backlog_last_30_day' ELSE 'SUCCESS' END as Message
...
WHERE COALESCE(SRC.request_item_backlog_last_30_day, '')<> COALESCE(TRGT.request_item_backlog_last_30_day ,'');