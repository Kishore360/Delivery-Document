...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_project.PLANNED_CAPITAL_LOC_COST' ELSE 'SUCCESS' END as Message
...
where  0
<> ROUND(COALESCE(TRGT.PLANNED_CAPITAL_LOC_COST,''),7);