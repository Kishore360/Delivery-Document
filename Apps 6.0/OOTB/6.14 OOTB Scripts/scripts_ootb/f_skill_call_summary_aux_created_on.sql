...
SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_skill_call_summary_aux.created_on' ELSE 'SUCCESS' END as Message
...
WHERE SRC.row_date<> TRGT.created_on 
AND transformation
