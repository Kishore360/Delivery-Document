SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_dq_rules_configuration_dim.rule_key' ELSE 'rule_key-SUCCESS' END as Message
 from 
(select 
...
where SRC.rule_key<>TGT.rule_key;