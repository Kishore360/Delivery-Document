SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_change_credit_score.task_priority' ELSE 'SUCCESS' END as Message
 ...
 where COALESCE( SRC.task_priority,'')<> COALESCE(TRGT.task_priority,'')
