...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for d_project_risk.action_plan' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC2.VISIBLE_PARAMETER42,'')<>coalesce(TRGT.action_plan,'');