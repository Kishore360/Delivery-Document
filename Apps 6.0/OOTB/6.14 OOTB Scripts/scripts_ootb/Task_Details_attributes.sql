...
D.task_number tsk_num,
to_char(cast(D.opened_on as timestamp),'FMmm/FMdd/yyyy FMhh12:mi:ss AM')  as opened,
to_char(cast(D.closed_on as timestamp),'FMmm/FMdd/yyyy FMhh12:mi:ss AM')  as closed,
to_char(cast(D.due_on as timestamp),'FMmm/FMdd/yyyy FMhh12:mi:ss AM')  as due_on,
D.met_sla_flag sla_flg,
...
(
 ...
 or D.backlog_flag = 'Y'
 group by tsk_typ.source_dimension_name, D.row_key, D.task_number, D.opened_on, D.closed_on, D.due_on, D.met_sla_flag, D.short_description
 order by upper(tsk_typ.source_dimension_name), D.row_key, D.task_number, D.opened_on, D.closed_on, D.due_on, D.met_sla_flag, D.short_description