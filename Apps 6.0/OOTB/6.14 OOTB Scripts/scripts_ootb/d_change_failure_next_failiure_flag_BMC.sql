...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_change_failure.next_failure_flag' ELSE 'SUCCESS' END as Message
...
WHERE  COALESCE(TRGT.next_failure_flag,'')<>'N'
