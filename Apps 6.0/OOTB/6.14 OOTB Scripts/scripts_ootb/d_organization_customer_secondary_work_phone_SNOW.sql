...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.SECONDARY_WORK_PHONE' ELSE 'SUCCESS' END as Message
-- select TRGT.SECONDARY_WORK_PHONE
...
where customer=1 and TRGT.SECONDARY_WORK_PHONE is not null;