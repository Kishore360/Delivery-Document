...
as planned_row_id,PRJ_PROJECT_ID,sum(forecast_value), position_forecast.last_updated_by 
...
and COALESCE(planned_effort.last_updated_by,'')<>coalesce(TRGT.changed_by,'')
