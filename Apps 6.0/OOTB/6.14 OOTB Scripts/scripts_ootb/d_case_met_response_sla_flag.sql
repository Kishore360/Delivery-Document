...
,case  when count(1)>0 then 'MDS to DWH data validation failed:d_case.met_response_sla_flag' else 'SUCCESS' end as message
...
left join #DWH_TABLE_SCHEMA.d_lov LOV
on D.met_Response_sla_flag = LOV.dimension_code
