 ...
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_n_major_incident_daily.upcoming_changes' ELSE 'SUCCESS' END as Message
...
WHERE  COALESCE(SRC.upcoming_changes, '0') <> COALESCE(TRGT.upcoming_changes, '0'); 