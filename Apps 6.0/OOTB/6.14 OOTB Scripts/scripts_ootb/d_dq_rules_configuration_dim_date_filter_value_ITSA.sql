SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_dq_rules_configuration_dim.date_filter_value' ELSE 'date_filter_value-SUCCESS' END as Message
 from 
(select 
...
where SRC.date_filter_value<>TGT.date_filter_value;