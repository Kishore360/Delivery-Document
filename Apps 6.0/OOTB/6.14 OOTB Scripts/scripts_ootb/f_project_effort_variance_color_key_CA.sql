...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_project.effort_variance_color_key' ELSE 'SUCCESS' END as Message
...
ON coalesce(TRGT.effort_variance,0) BETWEEN LKP.lower_range_value AND LKP.upper_range_value
