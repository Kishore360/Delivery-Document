...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.COMPETITOR_FLAG' ELSE 'SUCCESS' END as Message
-- select TRGT.COMPETITOR_FLAG
...
where customer=1 and TRGT.COMPETITOR_FLAG <>'N';