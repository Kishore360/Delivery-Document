...
group by ITE.row_key, ITE.name, ITE.start_date, ITE.end_date, ITE.completion_date
order by ITE.row_key, upper(ITE.name), ITE.start_date, ITE.end_date, ITE.completion_date
