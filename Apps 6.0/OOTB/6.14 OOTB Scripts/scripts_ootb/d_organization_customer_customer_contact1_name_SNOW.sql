...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.customer_contact1_name' ELSE 'SUCCESS' END as Message
-- select TRGT.customer_contact1_name
...
where customer=1 and TRGT.customer_contact1_name<> 'UNSPECIFIED';