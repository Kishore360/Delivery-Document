...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_resource_allocation.loc_currency_code' ELSE 'SUCCESS' END as Message
...
where TRGT.loc_currency_code is not null;