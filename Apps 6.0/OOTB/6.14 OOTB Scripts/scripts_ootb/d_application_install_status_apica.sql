...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_application.install_status' ELSE 'SUCCESS' END as Message
...
and SRC.source_id=TRGT.source_id 
 where coalesce(SRC.install_status,'')<>coalesce(TRGT.install_status,'') ;
