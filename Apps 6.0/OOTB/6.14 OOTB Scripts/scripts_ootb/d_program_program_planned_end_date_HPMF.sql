...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for d_program.PLANNED_END_DATE' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC1.PGM_PLAN_FINISH_PERIOD_ID,0) <> coalesce(TRGT.PLANNED_END_DATE,0)