...
CASE WHEN count(1) >0 THEN 'managed_by validation failed for d_application' ELSE 'SUCCESS' END as Message
...
where TRGT.managed_by is not NULL and row_key not in (0,-1);