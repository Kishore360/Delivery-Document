...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.PARENT_DUNS_NUMBER' ELSE 'SUCCESS' END as Message
-- select TRGT.PARENT_DUNS_NUMBER
...
where customer=1 and TRGT.PARENT_DUNS_NUMBER is not null;