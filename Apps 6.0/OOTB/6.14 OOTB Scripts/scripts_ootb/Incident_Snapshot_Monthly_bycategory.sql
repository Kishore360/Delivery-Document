select concat(concat(CAL_MONTH.month_name_abbreviated,' '), CAL_MONTH.year_name),CAT.dimension_name as Category,
    SM.reopened_flag,
...
group by  CAL_MONTH.month_name_abbreviated, CAL_MONTH.month_id, CAL_MONTH.year_name,CAT.row_key,CAT.dimension_name,SM.reopened_flag
order by CAL_MONTH.month_id desc,CAL_MONTH.month_name_abbreviated, CAL_MONTH.year_name,CAT.dimension_name,SM.reopened_flag