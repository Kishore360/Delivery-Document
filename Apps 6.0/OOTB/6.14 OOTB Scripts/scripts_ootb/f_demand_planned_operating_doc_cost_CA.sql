...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_demand.PLANNED_OPERATING_DOC_COST' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC2.PLANNED_CST_OPERATING_TOTAL,0)<>coalesce(TRGT.PLANNED_OPERATING_DOC_COST,0)
