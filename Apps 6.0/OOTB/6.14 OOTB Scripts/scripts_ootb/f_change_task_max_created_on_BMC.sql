...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_change_task.max_created_on' ELSE 'SUCCESS' END as Message
...
WHERE COALESCE(null,'') <> COALESCE(TRGT.max_created_on,'')
