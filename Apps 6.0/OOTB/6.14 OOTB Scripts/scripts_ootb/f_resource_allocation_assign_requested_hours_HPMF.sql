...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_resource_allocation.requested_hours' ELSE 'SUCCESS' END as Message
...
where COALESCE(TRGT.requested_hours,'')<>0
