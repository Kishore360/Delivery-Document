SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_portfolio.others_actual_loc_cost' ELSE 'SUCCESS' END as Message
...
where coalesce(port.others_actual_loc_cost,'')<>0;