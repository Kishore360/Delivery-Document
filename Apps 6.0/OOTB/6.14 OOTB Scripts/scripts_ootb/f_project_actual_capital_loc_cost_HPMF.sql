...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_project.remaining_duration' ELSE 'SUCCESS' END as Message
...
WHERE COALESCE(ACTUAL_CAPITAL_LOC_COST,'')<>COALESCE(0.0000000000,'')
