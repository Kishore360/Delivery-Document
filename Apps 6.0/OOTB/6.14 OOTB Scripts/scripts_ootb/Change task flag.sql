...
D.backlog_flag bclg_flg,
D.dormant_flag dorm_flg,
D.met_sla_flag sla_flg,
D.overdue_flag od_flg,
sum(F.reassignment_count) reasgn_cn
...
or D.backlog_flag = 'Y'
group by ctn, ctn1, D.opened_on, bclg_flg, dorm_flg, sla_flg, od_flg
order by ctn, ctn1, D.opened_on, bclg_flg, dorm_flg, sla_flg, od_flg