...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_resource_allocation.assigned_loc_cost' ELSE 'SUCCESS' END as Message
...
where COALESCE(TRGT.assigned_loc_cost,'')<>0
