...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_resource_allocation.percent_allocated' ELSE 'SUCCESS' END as Message
...
where TRGT.percent_allocated is not null;