...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.PRIMARY_COMPETITOR_ID' ELSE 'SUCCESS' END as Message
-- select TRGT.PRIMARY_COMPETITOR_ID
...
where customer=1 and TRGT.PRIMARY_COMPETITOR_ID is not null;