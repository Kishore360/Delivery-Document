...
else null end as prt,task_info_id,sourceinstance from #MDS_TABLE_SCHEMA.hp_wp_task_info_final where cdctype<>'D')SRC1
left join (select * from #MDS_TABLE_SCHEMA.hp_wp_tasks_final where cdctype<>'D') SRC 
