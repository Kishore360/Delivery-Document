...
case when count(1) > 0 then 'MDS to DWH data validation failed for row_id between survey_final & asmt_metric_type_final to d_survey' else 'SUCCESS' end as Message
from 
(
select DWH.row_id
