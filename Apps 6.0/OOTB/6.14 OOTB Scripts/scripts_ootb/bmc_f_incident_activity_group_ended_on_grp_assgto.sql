...
join (select l.group_ended_on,l.incident_key,l.primary_sequence_id
...
where case when TRGT_A.task_attribute_wh_name ='assignment_group' then adddate( TRGT_A.created_on, INTERVAL TRGT_A.primary_duration SECOND) 
when TRGT_A.task_attribute_wh_name = 'assigned_to' then TRGT_S.group_ended_on 
else null
end <> TRGT_A.group_ended_on ;