...
CASE WHEN count(1)>0  THEN 'MDS to DWH data validation failed for d_service.MANAGER' ELSE 'SUCCESS' END as Message 
...
WHERE COALESCE('UNSPECIFIED','UNKNOWN') <> COALESCE(TRGT.MANAGER,'UNSPECIFIED') 
