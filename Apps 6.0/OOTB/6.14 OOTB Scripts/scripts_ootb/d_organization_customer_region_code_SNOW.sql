...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.region_code' ELSE 'SUCCESS' END as Message
-- select TRGT.region_code
...
where customer=1 and TRGT.region_code is not null;