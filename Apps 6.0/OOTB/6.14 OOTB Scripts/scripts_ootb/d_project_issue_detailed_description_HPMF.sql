...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for d_project_issue.detailed_description' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC2.parameter43,'')<>coalesce(TRGT.detailed_description,'');