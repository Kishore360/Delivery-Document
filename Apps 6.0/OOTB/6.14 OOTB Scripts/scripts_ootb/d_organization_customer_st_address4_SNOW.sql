...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.ST_ADDRESS4' ELSE 'SUCCESS' END as Message
-- select TRGT.ST_ADDRESS4
...
where customer=1 and TRGT.ST_ADDRESS4 is not null;