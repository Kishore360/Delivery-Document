...
CASE WHEN count(1) >0 THEN 'manufacturer validation failed for d_application' ELSE 'SUCCESS' END as Message
...
where TRGT.manufacturer is not NULL and row_key not in (0,-1);