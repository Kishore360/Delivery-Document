SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_project_cost.planned_capital_doc_cost' ELSE 'SUCCESS' END as Message
...
ELSE 0  END,'')<>round(COALESCE(TRGT.planned_capital_doc_cost,''),10)
