...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.SUPPLIER_FLAG' ELSE 'SUCCESS' END as Message
-- select TRGT.SUPPLIER_FLAG
...
where customer=1 and TRGT.SUPPLIER_FLAG <>'N';