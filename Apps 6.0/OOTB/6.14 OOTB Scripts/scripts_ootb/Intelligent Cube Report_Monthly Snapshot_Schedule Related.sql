...
max(sch_ver_color.sch_ver_color) Sch_Variance_clr_cde,
...
D2.row_key, Top_Project_Name, mnth_nm, cal.month_id,act_strt_date,act_end_date,plnd_strt_date,D.is_in_schedule_flag
