...
CASE WHEN count(1) >0 THEN 'location validation failed for d_application' ELSE 'SUCCESS' END as Message
...
where TRGT.location is not NULL and row_key not in (0,-1);
