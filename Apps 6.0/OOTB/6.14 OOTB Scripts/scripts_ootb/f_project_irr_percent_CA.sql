...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_project.IRR_PERCENT' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC2.PLANNED_IRR,0) <> COALESCE(TRGT.IRR_PERCENT,'')								