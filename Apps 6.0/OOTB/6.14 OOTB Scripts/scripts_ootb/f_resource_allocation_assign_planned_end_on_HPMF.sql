...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_resource_allocation.planned_end_on' ELSE 'SUCCESS' END as Message
...
where TRGT.planned_end_on is not null;