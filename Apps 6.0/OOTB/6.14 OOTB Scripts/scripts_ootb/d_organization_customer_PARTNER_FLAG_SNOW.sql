...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.PARTNER_FLAG' ELSE 'SUCCESS' END as Message
-- select TRGT.PARTNER_FLAG
...
where customer=1 and TRGT.PARTNER_FLAG <>'N';