 ...
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_n_major_incident_daily.soft_deleted_flag' ELSE 'SUCCESS' END as Message
...
WHERE  COALESCE(SRC.soft_deleted_flag, '0') <> COALESCE(TRGT.soft_deleted_flag, '0'); 