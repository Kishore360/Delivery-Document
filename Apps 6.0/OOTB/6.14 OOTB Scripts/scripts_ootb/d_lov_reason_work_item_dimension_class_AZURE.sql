...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_lov_reason_work_item.dimension_class' ELSE 'SUCCESS' END as Message
...
WHERE COALESCE('REASON~WORK_ITEM','')<>COALESCE(TRGT.dimension_class,'')