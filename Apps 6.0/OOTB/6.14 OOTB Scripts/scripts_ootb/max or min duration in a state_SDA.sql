...
case when max(FA.primary_duration) < 0
then '('||trim(to_char(coalesce(round((max(FA.primary_duration * (-1))/86400.00),1),0), '999,999,990D0'))||')'
else trim(to_char(coalesce(round((max(FA.primary_duration)/86400.00),1),0), '999,999,990D0')) end max_state_dur,

case when min(FA.primary_duration) < 0
then '('||trim(to_char(coalesce(round((min(FA.primary_duration) * (-1)/86400.00),1),0), '999,999,990D0'))||')'
else trim(to_char(coalesce(round((min(FA.primary_duration)/86400.00),1),0), '999,999,990D0')) end min_state_dur
...
group by from_status.dimension_name
order by upper(from_status.dimension_name)
