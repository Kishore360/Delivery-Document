...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.ST_ADDRESS3' ELSE 'SUCCESS' END as Message
-- select TRGT.ST_ADDRESS3
...
where customer=1 and TRGT.ST_ADDRESS3 is not null;