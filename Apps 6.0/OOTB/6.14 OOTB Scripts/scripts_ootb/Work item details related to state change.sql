...
nxt_st.dimension_name next_state,
ITE.name it_nm,
INTC_ASGN.full_name asgn_nm,
pv.description fx_ver,
priority.wi_prio wi_priority,
FA.primary_sequence_id st_seq_no,
max(FA.primary_sequence_id) as st_chng_count,
D.reopened_flag ro_flg,

max(FA.primary_sequence_id) state_chang_count,
...
FA.state_created_on,prv_st.dimension_name,status.dimension_name,nxt_st.dimension_name, ITE.name, INTC_ASGN.full_name, pv.description, priority.wi_prio, FA.primary_sequence_id, D.reopened_flag
...
upper(status_category.wi_sts_ctgy), FA.state_created_on, upper(prv_st.dimension_name), upper(status.dimension_name), upper(nxt_st.dimension_name), upper(ITE.name), 
upper(INTC_ASGN.full_name), upper(pv.description), upper(priority.wi_prio), FA.primary_sequence_id, upper(D.reopened_flag)
