...
DIC_INC.full_name ob,
INC_PRIO.dimension_name priority,
INC_CI.name ci_name,
case when SUR_STATE.state = 'Completed' then F.task_typ else null end typ,
...
group by sur_nm, inc, ob, priority, ci_name, typ
order by sur_nm, inc, ob, priority, ci_name, typ