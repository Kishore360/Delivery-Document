...
on (F.request_key=TGT2.request_key AND TGT2.task_attribute_wh_name = 'request_state' AND SRC.sourceinstance=TGT2.source_id and TGT2.primary_sequence_id = 1)
where TGT.primary_sequence_id = 0 AND TGT.task_attribute_wh_name = 'request_state' and D.soft_deleted_flag = 'N'
