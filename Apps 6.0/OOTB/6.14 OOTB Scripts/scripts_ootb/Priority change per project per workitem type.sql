...
to_char(count(case when d.priority_escalated_flag='Y' then F.work_item_key else null end),'FM999,999,999,999,999')  as priority_escalated_work_item,

to_char(count(case when d.priority_deescalated_flag='Y' then F.work_item_key else null end),'FM999,999,999,999,999')  as priority_deescalated_work_item
