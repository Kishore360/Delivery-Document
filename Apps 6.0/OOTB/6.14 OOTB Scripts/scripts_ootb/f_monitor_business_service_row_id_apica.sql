...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_monitor_business_service.row_id' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC.row_id, 'Unspecified')<>coalesce(trgt.row_id, 'Unspecified')
