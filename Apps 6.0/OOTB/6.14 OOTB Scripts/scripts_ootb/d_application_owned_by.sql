...
CASE WHEN count(1) >0 THEN 'owned_by validation failed for d_application' ELSE 'SUCCESS' END as Message
...
where TRGT.owned_by is not NULL and row_key not in (0,-1);