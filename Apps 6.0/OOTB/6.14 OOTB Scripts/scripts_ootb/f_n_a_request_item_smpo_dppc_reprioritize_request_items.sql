SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_n_a_request_item_smpo_dppc.reprioritize_request_items' ELSE 'SUCCESS' END as Message
...
WHERE COALESCE(SRC.reprioritize_request_items, 0)<> COALESCE(TRGT.reprioritize_request_items ,'');