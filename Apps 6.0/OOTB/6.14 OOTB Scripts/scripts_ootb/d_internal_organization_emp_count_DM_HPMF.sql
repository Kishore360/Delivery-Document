...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for d_internal_organization.emp_count' ELSE 'SUCCESS' END as Message
...
where coalesce(TRGT.emp_count,'') <> null