...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.SOLICITATION_FLAG' ELSE 'SUCCESS' END as Message
-- select TRGT.SOLICITATION_FLAG
...
where customer=1 and TRGT.SOLICITATION_FLAG <>'N';