...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_test_execution_result.response_time_95_perc' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC.95line,'')<>coalesce(TRGT.response_time_95_perc,'')
