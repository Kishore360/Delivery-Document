...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for d_project_issue.business_function' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC2.parameter41,'')<>coalesce(TRGT.business_function,'');