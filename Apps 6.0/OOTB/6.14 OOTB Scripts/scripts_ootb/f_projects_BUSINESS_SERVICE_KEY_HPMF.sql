...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_project.BUSINESS_SERVICE_KEY' ELSE 'SUCCESS' END as Message
...
where  0
<> COALESCE(TRGT.BUSINESS_SERVICE_KEY,0);