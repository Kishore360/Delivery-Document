...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_change_task.short_description' ELSE 'SUCCESS' END as Message
...
WHERE COALESCE(null,'') <> COALESCE(TRGT.short_description,'')
