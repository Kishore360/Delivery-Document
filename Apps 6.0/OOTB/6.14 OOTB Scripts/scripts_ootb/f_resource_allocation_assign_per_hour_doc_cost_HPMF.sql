...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_resource_allocation.per_hour_doc_cost' ELSE 'SUCCESS' END as Message
...
where TRGT.per_hour_doc_cost is not null
