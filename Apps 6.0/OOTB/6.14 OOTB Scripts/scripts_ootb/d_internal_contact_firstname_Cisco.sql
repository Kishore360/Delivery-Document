SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_problem.first_name' ELSE 'SUCCESS' END as Message
 ...
 WHERE coalesce(pe.firstname,'')  <> TRGT.first_name
