SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_n_dq_incident_monthly_fact.executive_leader_key' ELSE 'SUCCESS' END as Message
/*select 
SRC.row_id,TRGT.row_id 
,SRC.n_key,TRGT.n_key
,COALESCE(SRC.executive_leader_key, '') ,COALESCE(TRGT.executive_leader_key, '')
*/
