...
coalesce(D.component_list, 'UNKNOWN')  cmp,
D.component_list cmp_lst,
...
D.proposed_flag = 'Y')
group by D.work_item_number, D.row_id, PROJ.project_name, D.component_list, D.created_on, D.work_start_on, D.due_on, D.changed_on, D.resolved_on, D.completed_on, D.proposed_flag, D.in_progress_flag, D.reopened_flag, D.overdue_flag
order by D.work_item_number, D.row_id, upper(PROJ.project_name), upper(D.component_list), D.created_on, D.work_start_on, D.due_on, D.changed_on, D.resolved_on, D.completed_on, upper(D.proposed_flag), upper(D.in_progress_flag), upper(D.reopened_flag), upper(D.overdue_flag)
