...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.PROSPECT_FLAG' ELSE 'SUCCESS' END as Message
-- select TRGT.PROSPECT_FLAG
...
where customer=1 and TRGT.PROSPECT_FLAG <>'N';