select dr.requested_for_department, dr.requested_for , '' as metric ,  count(frt.row_key) from 
...
group by dr.requested_for_department, dr.requested_for
order by lower(dr.requested_for_department),lower( dr.requested_for)
