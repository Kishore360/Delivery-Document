...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.CHANNEL_FLAG' ELSE 'SUCCESS' END as Message
-- select TRGT.CHANNEL_FLAG
...
where customer=1 and TRGT.CHANNEL_FLAG <>'N';