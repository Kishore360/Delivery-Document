...
to_char(d.opened_on  ,'fmMM/fmDD/YYYY fmHH:MI:SS AM') opened,
to_char(d.closed_on  ,'fmMM/fmDD/YYYY fmHH:MI:SS AM') closed,
d.reopened_flag reopened_flag,
to_char(d.last_resolved_on  ,'fmMM/fmDD/YYYY fmHH:MI:SS AM') resolved,
