drop table if exists #STG_TABLE_SCHEMA.burn_down_temp_azure;

create table if not exists #STG_TABLE_SCHEMA.burn_down_temp_azure (
  sys_id VARCHAR(255) DEFAULT NULL,
  source_id SMALLINT(6) DEFAULT NULL,
  iteration_id VARCHAR(255) DEFAULT NULL,
  started_on_key BIGINT(20) DEFAULT NULL,
  burn_on_key BIGINT(20) DEFAULT NULL,
  work_item_id VARCHAR(255) DEFAULT NULL,
...
insert into #STG_TABLE_SCHEMA.burn_down_temp_azure
