...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for d_internal_organization.state_code' ELSE 'SUCCESS' END as Message
from (select TRGT.state_code
...
where TRGT.state_code is not null)inter_org;