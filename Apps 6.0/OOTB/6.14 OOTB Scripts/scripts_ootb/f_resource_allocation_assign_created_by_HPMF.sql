...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_resource_allocation.created_by' ELSE 'SUCCESS' END as Message
from (select SRC23.created_by,SRC23.sourceinstance,concat(SRC23.resource_id,'~',SRC23.task_id) as row_id,SRC23.task_id,
