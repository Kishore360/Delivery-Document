...
D.reassignment_count_numerify tot_reasgn_per_inc,

coalesce(count(distinct INCACT.to_assignment_group_key), 0) num_asgn_grps_invld,
...
group by inc_key, inc_num, tot_reasgn_per_inc
order by inc_key, inc_num, tot_reasgn_per_inc