...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.PREFERRED_LANGUAGE' ELSE 'SUCCESS' END as Message
-- select TRGT.PREFERRED_LANGUAGE
...
where customer=1 and TRGT.PREFERRED_LANGUAGE is not null;