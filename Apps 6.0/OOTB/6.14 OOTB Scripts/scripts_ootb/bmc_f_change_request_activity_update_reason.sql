SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_change_request_activity.update_reason' ELSE 'SUCCESS' END as Message
 ...
 RIGHT JOIN #DWH_TABLE_SCHEMA.f_change_request_activity TRGT 
