...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for d_project_issue.proposed_solution' ELSE 'SUCCESS' END as Message
...
where coalesce(SRC2.parameter42,'')<>coalesce(TRGT.proposed_solution,'');