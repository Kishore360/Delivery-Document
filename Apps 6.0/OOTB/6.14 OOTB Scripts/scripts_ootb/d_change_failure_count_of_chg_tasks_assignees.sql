...
left outer join
(
select sys_id,sourceinstance,change_request,COALESCE(opened_at,work_start,planned_start_date) as task_dt, assigned_to from #MDS_TABLE_SCHEMA.change_task_final where change_request is not null 
) task
