/*Report Name: Project_Task_Resource_Actual_Date_Planned_Date_QA*/

select distinct project,Resource,project_task,
TO_CHAR((actual_end_on),'fmMM/fmDD/YYYY fmHH:MI:SS AM') aeon, 
TO_CHAR((actual_start_on),'fmMM/fmDD/YYYY fmHH:MI:SS AM') ason, 
TO_CHAR((planned_end_on),'fmMM/fmDD/YYYY fmHH:MI:SS AM') peon,
TO_CHAR((planned_start_on),'fmMM/fmDD/YYYY fmHH:MI:SS AM') pson, 
resource_role,
...
from
(
select distinct project,Resource,project_task,planned_start_on, planned_end_on, 
actual_start_on, actual_end_on,resource_role,
...
group by project, Resource,project_task, planned_start_on, planned_end_on, 
actual_start_on, actual_end_on,resource_key,resource_role
)
-- where resource not in ('UNKNOWN')
order by upper(project),upper(Resource),upper(project_task),upper(resource_role), aeon,ason,peon,pson,resource_assigned_hours
