...
SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_agent_call_summary.hold_calls' ELSE 'SUCCESS' END as Message
...
coalesce(SRC.incomingcallsonhold + SRC.agentoutcallsonhold,0)
