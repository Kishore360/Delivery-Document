...
status.wi_sts wi_status,
status_category.wi_sts_ctgy wi_status_category,
wi_rsn.wi_rsn wi_reason,
wi_rsk.wi_rsk wi_risk,
wi_sev.wi_sev wi_severity,

to_char(coalesce(avg(F.age_since_in_progress/86400.00),0),'FM999,999,999,999,990.0') avg_cycle_time,
to_char(coalesce(avg(F.age_since_creation/86400.00),0),'FM999,999,999,999,999.0') avg_lead_time
...
D.proposed_flag = 'Y')
group by D.work_item_number, D.row_id, PROJ.project_name, priority.wi_prio, resolution.wi_res, status.wi_sts, status_category.wi_sts_ctgy, wi_rsn.wi_rsn, wi_rsk.wi_rsk, wi_sev.wi_sev
order by D.work_item_number, D.row_id, upper(PROJ.project_name), upper(priority.wi_prio), upper(resolution.wi_res), upper(status.wi_sts), upper(status_category.wi_sts_ctgy), upper(wi_rsn.wi_rsn), upper(wi_rsk.wi_rsk), upper(wi_sev.wi_sev)