...
on(LKP.row_id=coalesce(case when assoc_type_val='Related To' then SRC.latest_change end,'UNSPECIFIED'))


where coalesce(TGT.change_request_key,'') <>  coalesce(LKP.row_key,'')