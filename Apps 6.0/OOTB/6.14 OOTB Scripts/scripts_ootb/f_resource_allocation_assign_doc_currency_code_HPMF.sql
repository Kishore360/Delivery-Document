...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_resource_allocation.doc_currency_code' ELSE 'SUCCESS' END as Message
...
where COALESCE(TRGT.doc_currency_code,'')<>null;