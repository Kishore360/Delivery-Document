...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for d_internal_organization.country_code' ELSE 'SUCCESS' END as Message
...
where TRGT.country_code is not null)inter_org;