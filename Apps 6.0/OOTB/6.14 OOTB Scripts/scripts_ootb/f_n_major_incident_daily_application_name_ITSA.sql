SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_n_major_incident_daily.application_name' ELSE 'SUCCESS' END as Message
...
WHERE  COALESCE(SRC.application_name, '0') <> COALESCE(TRGT.application_name, '0');