...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.distributor_flag' ELSE 'SUCCESS' END as Message
-- select TRGT.distributor_flag
...
where customer=1 and TRGT.distributor_flag <>'N';