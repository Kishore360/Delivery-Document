...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.BUSINESS_UNIT_NAME' ELSE 'SUCCESS' END as Message
-- select TRGT.BUSINESS_UNIT_NAME
...
where customer=1 and TRGT.BUSINESS_UNIT_NAME is not null;