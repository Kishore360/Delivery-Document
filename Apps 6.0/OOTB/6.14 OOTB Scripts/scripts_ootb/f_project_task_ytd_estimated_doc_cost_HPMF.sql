SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 ...
 where COALESCE(TRGT.estimated_doc_cost,'UNSPECIFIED') <> COALESCE(SRC4.PLAN_CAP_LABOR_BSE,0)+COALESCE(SRC4.PLAN_CAP_NON_LABOR_BSE,0) + COALESCE(SRC4.PLAN_OP_LABOR_BSE,0)+COALESCE(SRC4.PLAN_OP_NON_LABOR_BSE,0);