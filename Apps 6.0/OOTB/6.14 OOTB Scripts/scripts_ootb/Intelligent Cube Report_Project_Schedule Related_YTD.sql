...
TO_CHAR((F.planned_end_on),'fmMM/fmDD/YYYY fmHH:MI:SS AM') plnd_strt_date,
...
sum(case when D.is_in_schedule_flag = 'Y' and D.task_type = 'PROJECT' then 1 else 0 end) no_of_projects_in_sch,
...
group by D_P.row_key, Portfolio_name, Portfolio_category, D.row_key, D.Project_name, D2.row_key, Top_Project_Name, act_strt_date, act_end_date, plnd_strt_date, in_sch
