select
ASGNGRP.organization_name asgngrpnm,
ASGNGRP.manager man_name,
...
(
 ...
 or D.backlog_flag = 'Y'
 group by ASGNGRP.organization_name, ASGNGRP.manager
 order by upper(ASGNGRP.organization_name), upper(ASGNGRP.manager)