...
and SRC2.sourceinstance = source_id) = 'CAPITAL' then COALESCE(DATEDIFF(SRC3.FINISH_DATE,SRC3.START_DATE)*SRC3.SLICE,0) end,0)
<> COALESCE(TRGT.planned_capital_doc_cost,0);