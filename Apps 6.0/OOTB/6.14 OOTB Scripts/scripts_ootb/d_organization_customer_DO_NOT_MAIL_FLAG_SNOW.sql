...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.DO_NOT_MAIL_FLAG' ELSE 'SUCCESS' END as Message
-- select TRGT.DO_NOT_MAIL_FLAG
...
where customer=1 and TRGT.DO_NOT_MAIL_FLAG <>'N';