...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_project.DOC_CURRENCY_CODE' ELSE 'SUCCESS' END as Message
...
where COALESCE(SRC3.CURRENCY_CODE,'')
<> COALESCE(TRGT.DOC_CURRENCY_CODE ,'');
