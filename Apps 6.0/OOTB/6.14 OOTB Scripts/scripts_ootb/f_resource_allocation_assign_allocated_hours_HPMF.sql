...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_resource_allocation.allocated_hours' ELSE 'SUCCESS' END as Message
...
where COALESCE(TRGT.allocated_hours,'')<>0
