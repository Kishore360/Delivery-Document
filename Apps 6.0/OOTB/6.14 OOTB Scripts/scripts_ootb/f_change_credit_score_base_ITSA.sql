drop table if exists #STG_TABLE_SCHEMA.f_change_credit_score_base;
...
join (select distinct problem_key from #DWH_TABLE_SCHEMA.f_caused_by_change where problem_key > 0)cc
