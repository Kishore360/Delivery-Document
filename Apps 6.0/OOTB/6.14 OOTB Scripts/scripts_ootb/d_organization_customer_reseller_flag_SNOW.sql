...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.reseller_flag' ELSE 'SUCCESS' END as Message
-- select TRGT.reseller_flag
...
where customer=1 and TRGT.reseller_flag <>'N';