select  -- F.*,
concat(concat(cal.month_name_abbreviated, ' '), cal.year_id) mon_nm,
cal.year_id yr_nm,
type.wi_type wi_typ,
...
D.proposed_flag = 'Y')
group by cal.month_id, mon_nm, type.wi_type, cal.year_id
order by cal.month_id desc, mon_nm, cal.year_id desc, upper(type.wi_type)