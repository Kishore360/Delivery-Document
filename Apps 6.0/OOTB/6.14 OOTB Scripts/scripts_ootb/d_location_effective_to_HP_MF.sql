 ...
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_location.effective_to' ELSE 'SUCCESS' END as Message
...
AND SRC.SOURCEINSTANCE=TRGT.SOURCE_ID
 where COALESCE(TRGT.effective_to,'')<>COALESCE('2999-12-31 00:00:00','');