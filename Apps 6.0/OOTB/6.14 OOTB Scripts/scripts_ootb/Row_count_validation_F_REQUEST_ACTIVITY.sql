...
(select count(*)*3 count_2 from #DWH_TABLE_SCHEMA.f_request F join #DWH_TABLE_SCHEMA.d_request D on D.row_key = F.request_key 
...
where SRC.tablename = 'sc_request' and SRC.fieldname in ('assignment_group', 'request_state', 'stage') and F.soft_deleted_flag = 'N') C
