...
coalesce(DIO.lev_1_organization_name, 'UNSPECIFIED') hier1,
coalesce(DIO.lev_2_organization_name, 'UNSPECIFIED') hier2,
coalesce(DIO.lev_3_organization_name, 'UNSPECIFIED') hier3,
coalesce(DIO.lev_4_organization_name, 'UNSPECIFIED') hier4,

sum(distinct case when CAL.lagging_count_of_days between 0 and 29 and DIO.lev_1_organization_name not in ('UNSPECIFIED', 'UNKNOWN') then 1 else null end) hier1_cnt,
sum(distinct case when CAL.lagging_count_of_days between 0 and 29 and DIO.lev_2_organization_name not in ('UNSPECIFIED', 'UNKNOWN') then 1 else null end) hier2_cnt,
sum(distinct case when CAL.lagging_count_of_days between 0 and 29 and DIO.lev_3_organization_name not in ('UNSPECIFIED', 'UNKNOWN') then 1 else null end) hier3_cnt,
sum(distinct case when CAL.lagging_count_of_days between 0 and 29 and DIO.lev_4_organization_name not in ('UNSPECIFIED', 'UNKNOWN') then 1 else null end) hier4_cnt,

sum (case when CAL.lagging_count_of_days between 0 and 29 and F.incident_key is not null then 1 else 0 end) opened_inc
...
group by asgn_grp_name, hier1, hier2, hier3, hier4
order by upper(asgn_grp.organization_name), hier1, hier2, hier3, hier4