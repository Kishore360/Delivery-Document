...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.FORMED_DATE' ELSE 'SUCCESS' END as Message
-- select TRGT.FORMED_DATE
...
where customer=1 and TRGT.FORMED_DATE is not null;