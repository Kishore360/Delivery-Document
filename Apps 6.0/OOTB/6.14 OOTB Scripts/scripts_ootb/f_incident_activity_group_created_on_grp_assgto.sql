...
join (select l.group_created_on,l.incident_key,l.primary_sequence_id
...
where case when TRGT_A.task_attribute_wh_name ='assignment_group'then TRGT_A.created_on
when TRGT_A.task_attribute_wh_name = 'assigned_to' then TRGT_S.group_created_on 
else null
end <> TRGT_A.group_created_on ;
