...
group by D.work_item_number, D.row_id, type.wi_type, PROJ.project_name, D.short_description, D.description, ITE.row_key, ITE.name, D.labels_list, INTC_ASGN.full_name, INTC_RPT.full_name, INTC_CRT.full_name, INTC_UPDTBY.full_name, INTC_RSLVDBY.full_name, INTC_CLSDBY.full_name, pv.row_key, pv.name
order by D.work_item_number, D.row_id, upper(type.wi_type), upper(PROJ.project_name), upper(D.short_description), upper(D.description), ITE.row_key, upper(ITE.name), upper(D.labels_list), upper(INTC_ASGN.full_name), upper(INTC_RPT.full_name), upper(INTC_CRT.full_name), upper(INTC_UPDTBY.full_name), upper(INTC_RSLVDBY.full_name), upper(INTC_CLSDBY.full_name), pv.row_key, upper(pv.name)