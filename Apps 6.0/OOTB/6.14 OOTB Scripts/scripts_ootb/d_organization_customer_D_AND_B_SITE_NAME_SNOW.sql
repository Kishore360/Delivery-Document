...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.D_AND_B_SITE_NAME' ELSE 'SUCCESS' END as Message
-- select TRGT.D_AND_B_SITE_NAME
...
where customer=1 and TRGT.D_AND_B_SITE_NAME is not null;