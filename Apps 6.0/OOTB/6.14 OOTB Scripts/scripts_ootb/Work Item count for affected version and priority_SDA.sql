select DAV.name af_vname,
priority.dimension_name wi_prio,
...
group by DAV.row_key, DAV.name, priority.dimension_name
order by DAV.row_key, upper(DAV.name), upper(priority.dimension_name)