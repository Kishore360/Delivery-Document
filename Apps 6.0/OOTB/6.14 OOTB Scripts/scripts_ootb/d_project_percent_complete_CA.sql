SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_project.percent_complete' ELSE 'SUCCESS' END as Message
...
where COALESCE(SRC1.percent_complete,'') <> COALESCE(round(TRGT.percent_complete,6),'0.000000')