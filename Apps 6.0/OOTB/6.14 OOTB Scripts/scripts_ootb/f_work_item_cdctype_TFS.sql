SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_work_item.cdctype' ELSE 'SUCCESS' END as Message
FROM (
...
join #MDS_TABLE_SCHEMA.factcurrentworkitem F
on F.
