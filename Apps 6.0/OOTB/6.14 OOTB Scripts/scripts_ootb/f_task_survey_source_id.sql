...
case when count(1)> 0 then 'MDS to DWH fact validation failed for row_id and source_id between task_survey_final and f_task_survey' else 'SUCCESS' end as Message
