...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.HOME_PAGE_URL' ELSE 'SUCCESS' END as Message
-- select TRGT.HOME_PAGE_URL
...
where customer=1 and TRGT.HOME_PAGE_URL is not null;