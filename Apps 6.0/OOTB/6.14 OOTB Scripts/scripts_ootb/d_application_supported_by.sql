...
CASE WHEN count(1) >0 THEN 'supported_by validation failed for d_application' ELSE 'SUCCESS' END as Message
...
where TRGT.supported_by is not NULL and row_key not in (0,-1);