...
SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'd_h_all_hierarchies for ASSIGNMENT GROUP TIER failed' ELSE 'SUCCESS' END as Message
 FROM 
(SELECT CONCAT(a.s0,'~ASSIGNMENT GROUP TIER') AS row_id,
...
WHERE hierarchy_class ='ASSIGNMENT GROUP TIER' AND current_flag='Y') TRGT
