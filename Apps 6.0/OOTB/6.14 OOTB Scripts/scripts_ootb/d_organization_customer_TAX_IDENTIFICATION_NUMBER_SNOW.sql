...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.TAX_IDENTIFICATION_NUMBER' ELSE 'SUCCESS' END as Message
-- select TRGT.TAX_IDENTIFICATION_NUMBER
...
where customer=1 and TRGT.TAX_IDENTIFICATION_NUMBER is not null;