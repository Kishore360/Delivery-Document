SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_dq_rules_configuration_dim.source_column' ELSE 'source_column-SUCCESS' END as Message
 from 
(select 
...
where SRC.source_column<>TGT.source_column;