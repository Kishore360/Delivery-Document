...
select CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_request_item.dormancy_age' ELSE 'SUCCESS' END as Message
...
where lm.dimension_class = 'STATE~SC_REQ_ITEM'
