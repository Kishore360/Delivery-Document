drop table if exists #STG_TABLE_SCHEMA.ci_rel_upstream_temp;

create table if not exists #STG_TABLE_SCHEMA.ci_rel_upstream_temp 
...
drop table if exists #STG_TABLE_SCHEMA.ci_rel_upstream_base;

create table if not exists #STG_TABLE_SCHEMA.ci_rel_upstream_base (
...
insert into #STG_TABLE_SCHEMA.ci_rel_upstream_base
...
select SRC_REL_0.sys_id as sys_id, SRC_REL_0.parent lev_0_id, SRC_REL_0.child lev_1_id, SRC_REL_1.child lev_2_id, SRC_REL_2.child lev_3_id, SRC_REL_3.child lev_4_id, SRC_REL_4.child lev_5_id, SRC_REL_5.child lev_6_id, SRC_REL_0.parent start_node_id, 
SRC_REL_0.`type` as lev_0_rel_id, SRC_REL_1.`type` as lev_1_rel_id, SRC_REL_2.`type` as lev_2_rel_id, SRC_REL_3.`type` as lev_3_rel_id, SRC_REL_4.`type` as lev_4_rel_id, SRC_REL_5.`type` as lev_5_rel_id,
concat(SRC_REL_0.parent,'~',SRC_REL_0.`type`,'~',SRC_REL_0.child,coalesce(concat('::',SRC_REL_1.parent,'~',SRC_REL_1.`type`,'~',SRC_REL_1.child,coalesce(concat('::',SRC_REL_2.parent,'~',SRC_REL_2.`type`,'~',SRC_REL_2.child,coalesce(concat('::',SRC_REL_3.parent,'~',SRC_REL_3.`type`,'~',SRC_REL_3.child,coalesce(concat('::',SRC_REL_4.parent,'~',SRC_REL_4.`type`,'~',SRC_REL_4.child,coalesce(concat('::',SRC_REL_5.parent,'~',SRC_REL_5.`type`,'~',SRC_REL_5.child),'')),'')),'')),'')),'')) as tot_path,
SRC_REL_0.sourceinstance,
'UPSTREAM' as behaviour,
'N' as is_cyclic_flag,
'N' as is_invalid_flag,
SRC_REL_0.sys_created_on, 
current_timestamp as inserted_on
from #STG_TABLE_SCHEMA.ci_rel_upstream_temp SRC_REL_0
left join #STG_TABLE_SCHEMA.ci_rel_upstream_temp SRC_REL_1
on SRC_REL_0.child = SRC_REL_1.parent
left join #STG_TABLE_SCHEMA.ci_rel_upstream_temp SRC_REL_2
on SRC_REL_1.child = SRC_REL_2.parent
left join #STG_TABLE_SCHEMA.ci_rel_upstream_temp SRC_REL_3
on SRC_REL_2.child = SRC_REL_3.parent
left join #STG_TABLE_SCHEMA.ci_rel_upstream_temp SRC_REL_4
on SRC_REL_3.child = SRC_REL_4.parent
left join #STG_TABLE_SCHEMA.ci_rel_upstream_temp SRC_REL_5
on SRC_REL_4.child = SRC_REL_5.parent
...
update #STG_TABLE_SCHEMA.ci_rel_upstream_base SRC
...
delete SRC
from #STG_TABLE_SCHEMA.ci_rel_upstream_base SRC
where SRC.is_invalid_flag = 'Y';

-- base lev 0 --

update #STG_TABLE_SCHEMA.ci_rel_upstream_base base
join (
...
from #STG_TABLE_SCHEMA.ci_rel_upstream_base ci_rel_base
) SQ
...
update #STG_TABLE_SCHEMA.ci_rel_upstream_base bs
