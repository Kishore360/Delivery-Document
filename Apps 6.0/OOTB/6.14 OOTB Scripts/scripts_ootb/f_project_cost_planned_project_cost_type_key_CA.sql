...
on CONCAT('Project~Cost_Type~',SRC2.COST_TYPE_ID) = LKP.src_rowid
...
and
COALESCE(LKP.row_key,CASE WHEN SRC2.COST_TYPE_ID IS NULL THEN 0 else '-1' end)
<> COALESCE(TRGT.project_cost_type_key,'');