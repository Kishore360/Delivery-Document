...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_application.tier_src_key' ELSE 'SUCCESS' END as Message
...
and SRC.source_id=TRGT.source_id 
 where coalesce(SRC.tier_src_key,'')<>coalesce(TRGT.tier_src_key,'') ;
