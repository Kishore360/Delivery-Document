...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_application.install_type' ELSE 'SUCCESS' END as Message
...
and SRC.source_id=TRGT.source_id 
 where coalesce(SRC.install_type,'')<>coalesce(TRGT.install_type,'') ;
