...
AND CASE WHEN YEAR(SRC4.QUARTER_START_DATE)=YEAR(converttz_sys_val) 
THEN QUARTER(converttz_sys_val)-QUARTER(SRC4.QUARTER_START_DATE)
ELSE TIMESTAMPDIFF(QUARTER,SRC4.QUARTER_START_DATE,converttz_sys_val) END <>TRGT.lagging_count_of_quarter
