...
sum(case when d.is_milestone_flag = 'Y' and d.is_milestone_slipped_flag = 'Y' then 1 else 0 end) No_of_milestone_slipped,
...
concat(round((case when sum(case when d.is_milestone_flag = 'Y' then 1 else 0 end) = 0 then null
else (Sum (case when d.is_milestone_flag = 'Y' and d.is_milestone_slipped_flag = 'Y' then 1.00 else 0.00 end)/
