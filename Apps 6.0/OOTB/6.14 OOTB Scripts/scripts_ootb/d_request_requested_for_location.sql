...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_request.requested_for_location' ELSE 'SUCCESS' END as Message
...
WHERE TRGT.requested_for_location <> '';