...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.DUNS_NUMBER' ELSE 'SUCCESS' END as Message
-- select TRGT.DUNS_NUMBER
...
where customer=1 and TRGT.DUNS_NUMBER is not null;