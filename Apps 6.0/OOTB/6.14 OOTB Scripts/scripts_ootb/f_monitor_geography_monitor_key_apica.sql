...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_monitor_geography.monitor_key' ELSE 'SUCCESS' END as Message
...
,D_MONGEO.row_key as monitor_environment_key
...
left outer join #DWH_TABLE_SCHEMA.monitor_geography_key D_MONGEO
