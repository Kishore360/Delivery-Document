...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_work_item_iteration.project_key' ELSE 'SUCCESS' END as Message
...
ON SRC.projectkey = LKP.row_id and SRC.sourceinstance = LKP.source_id
