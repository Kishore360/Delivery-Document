...
tsk_impct.source_dimension_name impactnm,
tsk_urg.source_dimension_name urgencynm,
...
(
 ...
 or D.backlog_flag = 'Y'
 group by tsk_typ.source_dimension_name, tsk_impct.row_key, tsk_impct.source_dimension_name, tsk_urg.row_key, tsk_urg.source_dimension_name
 order by upper(tsk_typ.source_dimension_name), tsk_impct.row_key, upper(tsk_impct.source_dimension_name), tsk_urg.row_key, upper(tsk_urg.source_dimension_name)