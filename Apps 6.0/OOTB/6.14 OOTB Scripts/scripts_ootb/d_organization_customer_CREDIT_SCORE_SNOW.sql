...
CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for d_organization_customer.CREDIT_SCORE' ELSE 'SUCCESS' END as Message
-- select TRGT.CREDIT_SCORE
...
where customer=1 and TRGT.CREDIT_SCORE is not null;