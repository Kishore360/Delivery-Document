...
round(sum(distinct case when D.backlog_flag = 'Y' then F.dormancy_age/86400.00 else 0.0 end),1) days_since_lst_updt
...
group by pt_num, p_num, shrt
order by pt_num, p_num, shrt