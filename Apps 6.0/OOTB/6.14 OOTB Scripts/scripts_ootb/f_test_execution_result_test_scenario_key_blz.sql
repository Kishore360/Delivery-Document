...
CASE WHEN count(1) >0 THEN 'MDS to DWH row count failed for f_test_execution_result.test_scenario_key' ELSE 'SUCCESS' END as Message
...
where  COALESCE(TRGT.test_scenario_key,'')<>-1
