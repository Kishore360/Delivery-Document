...
FROM (
 select SRCD.*, SRCF.microsoft_vsts_scheduling_originalestimate, SRCF.microsoft_vsts_scheduling_remainingwork, SRCF.microsoft_vsts_scheduling_completedwork, SRCF.LastUpdatedDateTime lstupdt, SRCF.Microsoft_VSTS_Scheduling_StoryPoints
...
coalesce(SRC.Microsoft_VSTS_Scheduling_StoryPoints,'')<>coalesce(TRUNCATE(TRGT.story_points,0),'')