...
from (select u_programmer,a.sys_id,b.name name,a.sourceinstance ,CASE
WHEN lower(b.name) like '%srv%' then 'Y'

ELSE 'N' 
end as programmer_automated_flag
from  fidelity_mdsdb.change_request_final a
left join  fidelity_mdsdb.sys_user_final b on u_programmer=b.sys_id WHERE  a.CDCTYPE<>'D'
