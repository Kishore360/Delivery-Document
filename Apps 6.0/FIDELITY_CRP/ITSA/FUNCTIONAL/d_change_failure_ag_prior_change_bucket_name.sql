...
from (SELECT row_id,source_id,ag_prior_change_bucket_name,assignment_group_prior_changes FROM fidelity_mdwdb.d_change_failure where row_key not in (-1,0) and soft_deleted_flag = 'N' and current_flag='Y') TRGT 
