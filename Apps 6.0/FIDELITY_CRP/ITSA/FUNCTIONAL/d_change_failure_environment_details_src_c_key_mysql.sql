...
WHERE  SRC.CDCTYPE<>'D'and year(trgt1.effective_to)=2999 and coalesce(lkp.row_key,case when SRC.u_environment_details is null then 0 else -1 end)  <>trgt1.environment_details_src_c_key and SRC.cdctype<>'D'
