...
from (select * from fidelity_mdwdb.f_change_request where soft_deleted_flag='N') chg_f
left join (select * from fidelity_mdwdb.d_change_failure where current_flag='Y' and soft_deleted_flag='N')chg_fai
