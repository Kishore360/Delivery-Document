...
union
select 'ldb.d_problem_oversight_contact_c a124 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem_oversight_contact_c a124
on (a11.problem_oversight_contact_c_key = a124.row_key)
union
select 'ldb.d_problem_oversight_group_c a125 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem_oversight_group_c a125
on (a11.problem_oversight_group_c_key = a125.row_key)
union
...
union
select 'ldb.d_lov_problem_meeting_status_c a132 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem a16
on (a11.problem_key = a16.row_key)
join ldb.d_lov_problem_meeting_status_c a132
on (a16.problem_meeting_status_c_key = a132.row_key)
union
select 'ldb.d_lov_problem_oversight_action_c a133 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem a16
on (a11.problem_key = a16.row_key)
join ldb.d_lov_problem_oversight_action_c a133
on (a16.problem_oversight_action_c_key = a133.row_key)
union
select 'ldb.d_lov_problem_phase_c a134 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem a16
on (a11.problem_key = a16.row_key)
join ldb.d_lov_problem_phase_c a134
on (a16.problem_phase_c_key = a134.row_key)
union
...
union
select 'ldb.d_lov_problem_root_cause_c a136 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem a16
on (a11.problem_key = a16.row_key)
join ldb.d_lov_problem_root_cause_c a136
on (a16.problem_root_cause_code_c_key = a136.row_key)
union
select 'ldb.d_lov_problem_secondary_root_cause_c a137 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11
join ldb.d_problem a16
on (a11.problem_key = a16.row_key)
join ldb.d_lov_problem_secondary_root_cause_c a137
on (a16.problem_secondary_root_cause_c_key = a137.row_key)