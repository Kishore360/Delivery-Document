...
union
select'ldb.d_request_item_contacttype' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_request_item       a11 
...
union
select'ldb.d_request_location' as Table_Name, count(a11.row_key) Row_Count
 from  ldb.f_request_item       a11 
 join ldb.d_request       a110
on (a11.request_key=a110.row_key)
