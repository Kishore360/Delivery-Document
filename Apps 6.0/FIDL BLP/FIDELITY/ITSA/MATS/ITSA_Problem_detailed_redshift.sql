...
union
select 'ldb.d_problem_oversight_contact_c a121 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11 
join ldb.d_problem_oversight_contact_c a121 
on (a11.problem_oversight_contact_c_key = a121.row_key) 
union
select 'ldb.d_problem_oversight_group_c a122 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11 
join ldb.d_problem_oversight_group_c a122 
on (a11.problem_oversight_group_c_key = a122.row_key) 
union
...
union
select 'ldb.d_problem_meeting_status_c a129 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11 
join ldb.d_problem a17 
on (a11.problem_key = a17.row_key) 
join ldb.d_problem_meeting_status_c a129 
on (a17.problem_meeting_status_c_key = a129.row_key) 
union
select 'ldb.d_problem_oversight_action_c a130 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11 
join ldb.d_problem a17 
on (a11.problem_key = a17.row_key) 
join ldb.d_problem_oversight_action_c a130 
on (a17.problem_oversight_action_c_key = a130.row_key) 
union
...
on (a17.state_src_key = a131.row_key) 
union
select 'ldb.d_problem_secondary_root_cause_c a132 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_problem a11 
join ldb.d_problem a17 
on (a11.problem_key = a17.row_key) 
join ldb.d_problem_secondary_root_cause_c a132 
on (a17.problem_secondary_root_cause_c_key = a132.row_key) 
union
...
on (a111.year_start_date_key = a133.row_key) 
