...
left join  mercury_mdsdb.hp_kcrt_request_details_final kcrt_req_request_details on kcrt_req_request_details.REQUEST_ID=kcrt_req_header_details.REQUEST_ID and kcrt_requests.sourceinstance=kcrt_req_request_details.sourceinstance
join  mercury_mdwdb.d_demand TRGT on kcrt_fg_pfm_proposal.REQUEST_ID=TRGT.row_id

where coalesce(kcrt_req_request_details.VISIBLE_PARAMETER42,'UNSPECIFIED')<> TRGT.business_justification_c)a