...
left join  mercury_mdsdb.hp_kcrt_req_header_details_final kcrt_req_header_details on kcrt_requests.REQUEST_ID=kcrt_req_header_details.REQUEST_ID
 and kcrt_requests.sourceinstance=kcrt_req_header_details.sourceinstance
join  mercury_mdwdb.d_demand TRGT on kcrt_fg_pfm_proposal.REQUEST_ID=TRGT.row_id
where (kcrt_req_header_details.VISIBLE_PARAMETER33 )<> TRGT.funded_year_c)a