...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_gd_containers_report_c.app_name_c' 
...
count(1) as CNT
 ...
 where coalesce(nullif(SRC.App_Name,''),'UNSPECIFIED') <>TRGT.app_name_c)a;
