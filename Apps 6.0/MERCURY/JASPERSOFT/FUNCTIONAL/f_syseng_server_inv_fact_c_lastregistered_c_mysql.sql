...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_syseng_server_inv_fact_c.lastregistered_c' 
...
(			
				...
				where 
COALESCE(syseng_server_inv.LastRegistered,'UNSPECIFIED')    <>TRGT.lastregistered_c
				)a
