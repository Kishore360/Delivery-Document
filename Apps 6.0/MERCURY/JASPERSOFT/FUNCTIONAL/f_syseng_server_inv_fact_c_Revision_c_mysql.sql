...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_syseng_server_inv_fact_c.Revision_c' 
...
(			
				...
				where 
COALESCE(syseng_server_inv.Revision,'UNSPECIFIED')   <>TRGT.Revision_c
				)a
