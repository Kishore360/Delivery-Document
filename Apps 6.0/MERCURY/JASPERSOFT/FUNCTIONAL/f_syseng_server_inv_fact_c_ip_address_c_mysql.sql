...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_syseng_server_inv_fact_c.ip_address_c' 
...
(			
				...
				where 
 COALESCE(syseng_server_inv.IP_Address,'UNSPECIFIED')     <>TRGT.ip_address_c
				)a
