...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_syseng_server_inv_fact_c.Cluster_Name_C' 
...
(			
				...
				where COALESCE(syseng_server_inv.Cluster_Name,'UNSPECIFIED')<>TRGT.Cluster_Name_C
				)a