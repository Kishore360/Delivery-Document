...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_syseng_server_inv_fact_c.VM_PowerState_c' 
...
(			
				...
				where 
COALESCE(syseng_server_inv.VM_PowerState,'UNSPECIFIED')   <>TRGT.VM_PowerState_c
				)a
