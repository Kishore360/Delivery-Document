...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_gd_containers_report_c.carrier_c' 
...
count(1) as CNT
 ...
 where coalesce(nullif(SRC.Carrier,''),'UNSPECIFIED') <>TRGT.carrier_c )a;