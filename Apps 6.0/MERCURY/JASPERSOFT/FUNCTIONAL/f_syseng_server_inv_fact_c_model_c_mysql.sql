...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_syseng_server_inv_fact_c.model_c' 
...
(			
			   ...
			   COALESCE(syseng_server_inv.Model,'UNSPECIFIED')      <>TRGT.model_c
				)a