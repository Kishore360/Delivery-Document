...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_syseng_server_inv_fact_c.OS_Name_c' 
...
(			
				...
				where 
COALESCE(syseng_server_inv.OS_Name,'UNSPECIFIED')   <>TRGT.OS_Name_c
				)a
