...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_syseng_server_inv_fact_c.dc_name_c' 
...
(			
				...
				where 
COALESCE(syseng_server_inv.DC_Name,'UNSPECIFIED')   <>TRGT.dc_name_c
				)a
