...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_syseng_server_inv_fact_c.esx_build_c' 
...
(			
				...
				where 
COALESCE(syseng_server_inv.ESX_Build,'UNSPECIFIED')   <>TRGT.esx_build_c
				)a
