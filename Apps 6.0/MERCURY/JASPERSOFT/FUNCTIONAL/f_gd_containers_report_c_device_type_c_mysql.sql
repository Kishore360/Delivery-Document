...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_gd_containers_report_c.device_type_c' 
...
count(1) as CNT
 ...
 where coalesce(nullif(SRC.Device_Type,''),'UNSPECIFIED') <>TRGT.device_type_c)A;