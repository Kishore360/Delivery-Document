...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_syseng_server_inv_fact_c.network_zones_c' 
...
(			
				...
				where 
COALESCE(syseng_server_inv.Network_Zones,'UNSPECIFIED')   <>TRGT.network_zones_c
				)a
