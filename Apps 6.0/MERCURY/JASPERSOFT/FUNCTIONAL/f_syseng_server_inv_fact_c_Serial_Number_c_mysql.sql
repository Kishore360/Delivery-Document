...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_syseng_server_inv_fact_c.Serial_Number_c' 
...
(			
				...
				where 
COALESCE(syseng_server_inv.Serial_Number,'UNSPECIFIED')   <>TRGT.Serial_Number_c
				)a
