...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_syseng_server_inv_history_fact_c.server_type_c' 
...
(select count(1) as CNT from 
				...
				where coalesce(SRC.server_type,'UNSPECIFIED')<>TRGT.server_type_c
				)a
