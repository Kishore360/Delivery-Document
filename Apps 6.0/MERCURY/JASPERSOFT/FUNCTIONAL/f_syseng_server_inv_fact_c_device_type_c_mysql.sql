...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_syseng_server_inv_fact_c.device_type_c' 
...
(			
				...
				where 
COALESCE(syseng_server_inv.device_type,'UNSPECIFIED')   <>TRGT.device_type_c
				)a
