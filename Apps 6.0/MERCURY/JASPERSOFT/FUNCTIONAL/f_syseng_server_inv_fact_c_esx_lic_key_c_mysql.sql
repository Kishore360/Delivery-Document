...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_syseng_server_inv_fact_c.esx_lic_key_c' 
...
(			
				...
				where 
COALESCE(syseng_server_inv.ESX_LIC_KEY,'UNSPECIFIED')    <>TRGT.esx_lic_key_c
				)a
