...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_syseng_server_inv_fact_c.manufacturer_c' 
...
(			
  ...
  COALESCE(syseng_server_inv.Manufacturer,'UNSPECIFIED')  <>TRGT.manufacturer_c
				)a
