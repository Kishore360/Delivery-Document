...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_syseng_server_inv_fact_c.VM_PorgGroups_c' 
...
(			
				...
				where 
COALESCE(syseng_server_inv.VM_PorgGroups,'UNSPECIFIED')   <>TRGT.VM_PorgGroups_c
				)a
