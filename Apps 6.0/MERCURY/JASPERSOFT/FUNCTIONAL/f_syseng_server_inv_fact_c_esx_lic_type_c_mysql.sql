...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_syseng_server_inv_fact_c.esx_lic_type_c' 
...
(			
				...
				where 
COALESCE(syseng_server_inv.ESX_LIC_TYPE,'UNSPECIFIED')      <>TRGT.esx_lic_type_c
				)a
