...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_gd_containers_report_c.device_name_c' 
...
count(1) as CNT
 ...
 where coalesce(nullif(SRC.Device_Name,''),'UNSPECIFIED') <>TRGT.device_name_c)a;