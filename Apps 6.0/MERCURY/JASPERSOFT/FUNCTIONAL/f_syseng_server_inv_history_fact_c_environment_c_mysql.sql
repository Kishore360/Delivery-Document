...
CASE WHEN CNT > 0  THEN 'MDS to DWH data validation failed for f_syseng_server_inv_history_fact_c.environment_c' 
...
(select count(1) as CNT from 
				...
				where coalesce(SRC.environment,'UNSPECIFIED')<>TRGT.environment_c
				)a  
