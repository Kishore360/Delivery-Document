...
mercury_mdsdb.task_sla_final b on a.row_id=b.sys_id and a.source_id=b.sourceinstance
 left join mercury_mdwdb.d_task  c on c.row_id=b.task and c.source_id=b.sourceinstance
left join mercury_mdsdb.sys_db_object_final d on c.task_type_src_code=d.name and a.source_id=d.sourceinstance
