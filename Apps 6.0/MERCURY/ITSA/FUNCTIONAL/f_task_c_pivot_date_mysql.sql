...
'TICKET','U_ASC_TICKET','U_INCIDENT_TASK','U_PROBLEM_TASK','U_SHIFT_TURNOVER_REPORT','VTB_TASK') and CONVERT_TZ(SRC.opened_at,'GMT','America/Los_Angeles')<>TRGT.pivot_date
