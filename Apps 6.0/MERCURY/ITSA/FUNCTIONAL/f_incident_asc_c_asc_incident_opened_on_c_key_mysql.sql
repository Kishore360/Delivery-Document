SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 CASE WHEN count(1) >0 THEN 'MDS to DWH data validation failed for f_incident_asc_c.asc_incident_opened_on_c_key' ELSE 'SUCCESS' END as Message
...
WHERE (LKP.row_key)<> (TRGT.asc_incident_opened_on_c_key)  and SRC.cdctype<>'D';