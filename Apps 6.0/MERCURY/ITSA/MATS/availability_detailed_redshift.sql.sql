select 'ldb.f_problem_ci_outage_day_lev_c a11 ' as Table_name, count(1) Row_Count
...
union
select 'ldb.d_calendar_quarter a15 ' as Table_name, count(1) Row_Count
from ldb.f_problem_ci_outage_day_lev_c a11 
join ldb.d_calendar_date a13 
...
union
select 'ldb.d_business_service_criticality a16 ' as Table_name, count(1) Row_Count
from ldb.f_problem_ci_outage_day_lev_c a11 
join ldb.d_business_service a12 
on (a11.business_service_key = a12.row_key) 
...
union
select 'ldb.d_internal_contact_business_service_c a17 ' as Table_name, count(1) Row_Count
from ldb.f_problem_ci_outage_day_lev_c a11 
join ldb.d_business_service a12 
on (a11.business_service_key = a12.row_key) 
...
union
select 'ldb.d_problem a19 ' as Table_name, count(1) Row_Count
from ldb.f_problem_ci_outage_day_lev_c a11 
join ldb.d_problem a19 
on (a11.problem_key = a19.row_key) 
union
select 'ldb.d_calendar_year a110 ' as Table_name, count(1) Row_Count
from ldb.f_problem_ci_outage_day_lev_c a11 
join ldb.d_calendar_date a13 
on (a11.calendar_date_key = a13.row_key) join ldb.d_calendar_month a14 
