...
THEN 'MDS to DWH data validation failed for d_incident.closed_on' ELSE 'SUCCESS' END as Message  
FROM gogo_mdsdb.wm_order_final SRC  LEFT JOIN gogo_mdwdb.d_work_order_c TRGT  ON 
