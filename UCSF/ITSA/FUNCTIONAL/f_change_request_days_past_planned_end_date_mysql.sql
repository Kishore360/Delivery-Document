...
where a.days_past_planned_end_date<>datediff(convert_tz((SELECT MAX(lastupdated) AS lastupdated
FROM ucsf_mdwdb.d_o_data_freshness WHERE sourcename like 'ServiceNow%')),'GMT','America/LosAngeles'),c.planned_end_on);