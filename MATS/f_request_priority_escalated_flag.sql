...
case when count(1)> 0 then 'MDS to DWH data validation failed between request_final and f_request: priority_escalated_flag' else 'SUCCESS' end as Message
...
and TA_PR.task_wh_type = 'request'
