...
select S.sys_id FROM #MDS_TABLE_SCHEMA.cmdb_ci_final S
...
left join #MDS_TABLE_SCHEMA.sys_user_final SYF_MAN
...
left join #MDS_TABLE_SCHEMA.sys_user_final SYF_SUP
...
using utf8)) from #TABLE_SCHEMA.d_configuration_item DWH);
