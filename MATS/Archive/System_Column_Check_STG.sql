...
where column_name in ('row_id','source_id','etl_run_number','soft_deleted_flag','created_by','changed_by','created_on','changed_on')and table_name = '#TABLE_NAME' and table_schema = '#TABLE_SCHEMA'
