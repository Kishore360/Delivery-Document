...
FROM #MDS_TABLE_SCHEMA.sys_user_final lev_0
LEFT JOIN #MDS_TABLE_SCHEMA.sys_user_final lev_1
ON('OTHERS' = lev_1.sys_id)
LEFT JOIN #MDS_TABLE_SCHEMA.sys_user_final lev_2
ON('OTHERS' = lev_2.sys_id)
LEFT JOIN #MDS_TABLE_SCHEMA.sys_user_final lev_3
ON('OTHERS' = lev_3.sys_id)
LEFT JOIN #MDS_TABLE_SCHEMA.sys_user_final lev_4
ON('OTHERS' = lev_4.sys_id)
LEFT JOIN #MDS_TABLE_SCHEMA.sys_user_final lev_5
ON('OTHERS' = lev_5.sys_id)
)a
LEFT JOIN  #TABLE_SCHEMA.d_internal_contact level_0
ON CONVERT(a.s0 USING utf8) = CONVERT(level_0.row_id USING utf8)
LEFT JOIN  #TABLE_SCHEMA.d_internal_contact level_1
ON CONVERT(a.s1 USING utf8) = CONVERT(level_1.row_id USING utf8)
LEFT JOIN  #TABLE_SCHEMA.d_internal_contact level_2
ON CONVERT(a.s2 USING utf8) = CONVERT(level_2.row_id USING utf8)
LEFT JOIN  #TABLE_SCHEMA.d_internal_contact level_3
ON CONVERT(a.s3 USING utf8) = CONVERT(level_3.row_id USING utf8)
LEFT JOIN  #TABLE_SCHEMA.d_internal_contact level_4
ON CONVERT(a.s4 USING utf8) = CONVERT(level_4.row_id USING utf8)
LEFT JOIN  #TABLE_SCHEMA.d_internal_contact level_5
...
WHERE hierarchy_class ='EMPLOYEE REGION CLASSIFICATION' ;