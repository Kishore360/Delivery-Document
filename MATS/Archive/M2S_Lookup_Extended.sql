...
FROM (SELECT 1 FROM #REF_TABLE_NAME DCD JOIN #MDS_TABLE_SCHEMA.#MDS_TABLE_NAME BASE
ON DCD.#REF_COL_NAME = BASE.#MDS_COL_NAME
WHERE CONCAT(BASE.#REF_COL_NAME ,#REF_RETURN_NAME)  COLLATE utf8_unicode_ci NOT IN (SELECT CONCAT( row_id, #COL_NAME)
