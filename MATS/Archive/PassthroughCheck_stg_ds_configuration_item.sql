...
FROM #MDS_TABLE_SCHEMA.cmdb_ci_final WHERE CRC32(CONCAT( IFNULL(sys_id,'UNSPECIFIED'), IFNULL(sourceinstance,''), 
...
IFNULL(company_id,'UNSPECIFIED'))) FROM #TABLE_SCHEMA.ds_configuration_item)
