...
FROM #MDS_TABLE_SCHEMA.sc_category_final lev_0
LEFT JOIN #MDS_TABLE_SCHEMA.sc_category_final lev_1
ON(lev_0.parent = lev_1.sys_id)
LEFT JOIN #MDS_TABLE_SCHEMA.sc_category_final lev_2
ON(lev_1.parent = lev_2.sys_id)
LEFT JOIN #MDS_TABLE_SCHEMA.sc_category_final lev_3
ON(lev_2.parent = lev_3.sys_id)
LEFT JOIN #MDS_TABLE_SCHEMA.sc_category_final lev_4
ON(lev_3.parent = lev_4.sys_id)
LEFT JOIN #MDS_TABLE_SCHEMA.sc_category_final lev_5
ON(lev_4.parent = lev_5.sys_id)
)a
LEFT JOIN  #TABLE_SCHEMA.d_master_item level_0
ON CONVERT(a.s0 USING utf8) = CONVERT(level_0.row_id USING utf8)
LEFT JOIN  #TABLE_SCHEMA.d_master_item level_1
ON CONVERT(a.s1 USING utf8) = CONVERT(level_1.row_id USING utf8)
LEFT JOIN  #TABLE_SCHEMA.d_master_item level_2
ON CONVERT(a.s2 USING utf8) = CONVERT(level_2.row_id USING utf8)
LEFT JOIN  #TABLE_SCHEMA.d_master_item level_3
ON CONVERT(a.s3 USING utf8) = CONVERT(level_3.row_id USING utf8)
LEFT JOIN  #TABLE_SCHEMA.d_master_item level_4
ON CONVERT(a.s4 USING utf8) = CONVERT(level_4.row_id USING utf8)
LEFT JOIN  #TABLE_SCHEMA.d_master_item level_5
...
WHERE hierarchy_class ='ITEM CATEGORY';
