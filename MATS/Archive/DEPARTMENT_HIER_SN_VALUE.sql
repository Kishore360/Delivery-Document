SELECT  CONCAT(a.s0,'~-1~DEPARTMENT') AS row_id,
...
FROM #MDS_TABLE_SCHEMA.cmn_department_final lev_0
LEFT JOIN #MDS_TABLE_SCHEMA.cmn_department_final lev_1
ON(lev_0.parent = lev_1.sys_id)
LEFT JOIN #MDS_TABLE_SCHEMA.cmn_department_final lev_2
ON(lev_1.parent = lev_2.sys_id)
LEFT JOIN #MDS_TABLE_SCHEMA.cmn_department_final lev_3
ON(lev_2.parent = lev_3.sys_id)
LEFT JOIN #MDS_TABLE_SCHEMA.cmn_department_final lev_4
ON(lev_3.parent = lev_4.sys_id)
LEFT JOIN #MDS_TABLE_SCHEMA.cmn_department_final lev_5
...
WHERE hierarchy_class ='DEPARTMENT';