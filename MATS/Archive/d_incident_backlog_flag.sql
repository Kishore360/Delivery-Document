...
WHERE COALESCE( CONVERT(CASE WHEN LM.dimension_wh_code NOT IN('RESOLVED','CLOSED') THEN 'Y' ELSE 'N' END using utf8),'')<> COALESCE(CONVERT(TRGT.backlog_flag using utf8),'')
