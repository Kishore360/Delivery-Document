...
SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 ...
 WHERE COALESCE( CONVERT(CASE WHEN  SRC.outside_maintenance_schedule= TRUE THEN 'Y' ELSE 'N' END using utf8),'')<> COALESCE(CONVERT(TRGT.outside_maintenance_schedule_flag using utf8),'')
