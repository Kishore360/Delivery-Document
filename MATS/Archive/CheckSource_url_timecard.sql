...
from #MDS_TABLE_SCHEMA.#MDS_TABLE_NAME SRC
...
WHERE concat('<a href="https://#URL/nav_to.do?uri=',replace('#MDS_TABLE_NAME','_final',''),'.do?sys_id=',COALESCE(`sys_id`,''),'" target="_blank">',COALESCE(`sys_id`,''),'</a>')
<> TRGT.source_url
