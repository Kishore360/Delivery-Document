SELECT CONCAT(a.s0,'~-1~MASTER_ITEM') AS row_id,
...
FROM apps_i6_mdsdb.us_d_master_item_final lev_0
LEFT JOIN apps_i6_mdsdb.us_d_master_item_final lev_1
ON(lev_0.parent_row_id = lev_1.row_id)
LEFT JOIN apps_i6_mdsdb.us_d_master_item_final lev_2
ON(lev_1.parent_row_id = lev_2.row_id)
LEFT JOIN apps_i6_mdsdb.us_d_master_item_final lev_3
ON(lev_2.parent_row_id = lev_3.row_id)
LEFT JOIN apps_i6_mdsdb.us_d_master_item_final lev_4
ON(lev_3.parent_row_id = lev_4.row_id)
LEFT JOIN apps_i6_mdsdb.us_d_master_item_final lev_5
ON(lev_4.parent_row_id = lev_5.row_id)
)a
LEFT JOIN  apps_i6_workdb.d_master_item level_0
ON CONVERT(a.s0 USING utf8) = CONVERT(level_0.row_id USING utf8)
LEFT JOIN  apps_i6_workdb.d_master_item level_1
ON CONVERT(a.s1 USING utf8) = CONVERT(level_1.row_id USING utf8)
LEFT JOIN  apps_i6_workdb.d_master_item level_2
ON CONVERT(a.s2 USING utf8) = CONVERT(level_2.row_id USING utf8)
LEFT JOIN  apps_i6_workdb.d_master_item level_3
ON CONVERT(a.s3 USING utf8) = CONVERT(level_3.row_id USING utf8)
LEFT JOIN  apps_i6_workdb.d_master_item level_4
ON CONVERT (a.s4 USING utf8) = CONVERT(level_4.row_id USING utf8)
LEFT JOIN  apps_i6_workdb.d_master_item level_5
...
WHERE hierarchy_class ='MASTER_ITEM' ;