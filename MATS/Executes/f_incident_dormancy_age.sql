...
AND  CASE WHEN lm.dimension_wh_code = 'OPEN' THEN TIMESTAMPDIFF( DAY,df.lastupdated,convert_tz(coalesce(SRC.sys_updated_on,0),<<TENANT_SSI_TIME_ZONE>>,<<DW_TARGET_TIME_ZONE>> ) )  
