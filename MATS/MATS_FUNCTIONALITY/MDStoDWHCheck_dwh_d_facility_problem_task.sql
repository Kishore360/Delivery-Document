...
case when count(1) >0 then 'MDS to DWH data validation failed between problem_task_final and dwh_d_problem_task' else 'SUCCESS' end as Message
...
) from <<tenant>>_mdwdb.dwh_d_problem_task DWH);
