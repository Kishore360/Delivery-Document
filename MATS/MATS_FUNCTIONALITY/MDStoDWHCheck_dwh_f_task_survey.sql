...
case when count(1)> 0 then 'MDS to DWH fact validation failed between task_survey_final and dwh_f_task_survey' else 'SUCCESS' end as Message;
...
) from <<tenant>>_mdwdb.dwh_f_task_survey DWH);
