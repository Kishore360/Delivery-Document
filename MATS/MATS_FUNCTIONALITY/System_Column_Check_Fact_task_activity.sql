...
where column_name in ('row_key','row_id','source_id','etl_run_number','soft_deleted_flag','changed_by','changed_on','dw_inserted_on','dw_updated_on')and table_name = '<<tablename>>' and table_schema = '<<tenant>>_mdwdb'
