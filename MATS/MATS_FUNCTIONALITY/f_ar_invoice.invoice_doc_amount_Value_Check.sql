...
, CASE WHEN X.CNT = 0 THEN 'Tranformation check succeed for dwh_f_ar_invoice.invoice_doc_amount'
ELSE 'Tranformation check failed for dwh_f_ar_invoice.invoice_doc_amount' END AS MESSAGE
