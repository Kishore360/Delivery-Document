...
CASE WHEN COUNT(1) > 0 THEN 'MDS to DWH data validation failed between cmdb_ci_final and dwh_d_configuration_item' ELSE 'SUCCESS' END AS Message; 
...
) from <<tenant>>_mdwdb.dwh_d_configuration_item DWH);
