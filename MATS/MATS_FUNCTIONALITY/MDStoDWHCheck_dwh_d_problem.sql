...
case when count(1) > 0 then 'MDS to DWH data validation failed between problem_final and dwh_d_final' else 'SUCCESS' end as Message
...
) from <<tenant>>_mdwdb.dwh_d_problem DWH);
