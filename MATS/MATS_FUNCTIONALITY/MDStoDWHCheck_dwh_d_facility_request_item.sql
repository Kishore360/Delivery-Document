...
case when count(1) > 0 then 'MDS to DWH data validation failed between sc_req_item_final and dwh_d_request_item' else 'SUCCESS' end as Message
...
) from <<tenant>>_mdwdb.dwh_d_request_item DWH);
