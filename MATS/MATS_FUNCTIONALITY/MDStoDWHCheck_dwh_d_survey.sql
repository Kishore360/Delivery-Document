...
case when count(1) > 0 then 'MDS to DWH data validation failed for survey_final to dwh_d_survey' else 'SUCCESS' end as Message
...
) from <<tenant>>_mdwdb.dwh_d_survey DWH);
