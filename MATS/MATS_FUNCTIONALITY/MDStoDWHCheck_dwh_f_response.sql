...
case when count(1)> 0 then 'MDS to DWH fact validation failed between survey_response_final and dwh_f_response' else 'SUCCESS' end as Message
...
left join dwh_d_survey_question DSQ
...
) from <<tenant>>_mdwdb.dwh_f_response DWH);
