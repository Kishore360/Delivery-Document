<<tenant>> CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
...
<<tenant>> CASE WHEN TA.task_attribute_wh_old_value IS NOT NULL AND TA.task_attribute_wh_new_value IS NOT NULL   
...
AND TA.task_attribute_wh_old_value IS NOT NULL 
	...
	AND TA.task_attribute_wh_new_value < TA.task_attribute_wh_old_value)A
 WHERE  A.ABC<>A.DEF 
