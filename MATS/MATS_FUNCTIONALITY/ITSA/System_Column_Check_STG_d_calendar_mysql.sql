...
where column_name in ('row_id','source_id','etl_run_number','created_by','changed_by','created_on','changed_on')and table_name = '<<tablename>>' and table_schema = '<<tenant>>_mdwdb'
