...
AND SRC.sourceinstance= LKP.source_id ) and COALESCE(CONVERT_TZ (SRC.opened_at,'@#TENANT_SSI_TIME_ZONE@#','@#DW_TARGET_TIME_ZONE@#'), CONVERT_TZ (SRC.closed_at,'@#TENANT_SSI_TIME_ZONE@#','@#DW_TARGET_TIME_ZONE@#'),'UNSPECIFIED') 
