...
where ta.task_attribute_wh_name= 'assignment_group'and ta.task_wh_type= 'facilities' and ta.task_attribute_wh_old_value is not null  and ta.task_attribute_wh_new_value is not null )upd on tac.row_key = upd.row_key where  tac.reassigned_flag <> 'Y'
