...
SELECT CONCAT(a.s0,'~1~LOCATION REGION CLASSIFICATION') AS s_row_id,
...
ON a.s5 = level_5.row_id)AA
left JOIN(
SELECT row_id,lev_0_key,lev_1_key,lev_2_key,
lev_3_key,lev_4_key,lev_5_key,source_id
FROM <<tenant>>_mdwdb.d_h_all_hierarchies
WHERE hierarchy_class ='LOCATION REGION CLASSIFICATION')BB
