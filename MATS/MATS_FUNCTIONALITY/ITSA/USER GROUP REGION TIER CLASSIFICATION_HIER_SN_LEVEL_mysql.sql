...
FROM aaa_mdsdb.sys_user_group_final lev_0
LEFT JOIN aaa_mdsdb.sys_user_group_final lev_1
ON('OTHERS' = lev_1.sys_id)
LEFT JOIN aaa_mdsdb.sys_user_group_final lev_2
ON('OTHERS' = lev_2.sys_id)
LEFT JOIN aaa_mdsdb.sys_user_group_final lev_3
ON('OTHERS' = lev_3.sys_id)
LEFT JOIN aaa_mdsdb.sys_user_group_final lev_4
ON('OTHERS' = lev_4.sys_id)
LEFT JOIN aaa_mdsdb.sys_user_group_final lev_5
ON('OTHERS' = lev_5.sys_id)
)a
LEFT JOIN  aaa_mdwdb.d_internal_organization level_0
ON a.s0 = right(level_0.row_id,32)
LEFT JOIN  aaa_mdwdb.d_internal_organization level_1
ON a.s1 = right(level_1.row_id,32)
LEFT JOIN  aaa_mdwdb.d_internal_organization level_2
ON a.s2 = right(level_2.row_id,32)
LEFT JOIN  aaa_mdwdb.d_internal_organization level_3
ON a.s3 = right(level_3.row_id,32)
LEFT JOIN  aaa_mdwdb.d_internal_organization level_4
ON a.s4 = right(level_4.row_id,32)
LEFT JOIN  aaa_mdwdb.d_internal_organization level_5
...
FROM aaa_mdwdb.d_h_all_hierarchies
