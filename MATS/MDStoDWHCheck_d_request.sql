...
case when count(1) > 0 then 'MDS to DWH data validation failed between sc_request_final and d_request' else 'SUCCESS' end as Message
...
using utf8)) from <<tenant>>_mdwdb.d_request DWH);
