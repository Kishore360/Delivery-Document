...
from      ldb.f_request_item        a11
           union select  'd_configuration_item'as Table_Name,count(a11.row_key) Row_Count from ldb.f_request_item 	a11               
			   join        ldb.d_configuration_item            a12
                  on         (a11.configuration_item_key = a12.row_key)
                union select  'd_internal_contact'as Table_Name,count(a11.row_key) Row_Count from ldb.f_request_item 	a11
				join        ldb.d_internal_contact  a13
                  on         (a11.opened_by_key = a13.row_key)
                union select  'd_master_item'as Table_Name,count(a11.row_key) Row_Count from ldb.f_request_item 	a11
                ...
                union select  'd_varaible_lov_access_action'as Table_Name,count(a11.row_key) Row_Count from ldb.f_request_item 	a11 join        ldb.d_varaible_lov_access_action            a110
                  on         (a11.access_action_c_key = a110.row_key)
                union select  'd_internal_contact'as Table_Name,count(a11.row_key) Row_Count from ldb.f_request_item 	a11 join        ldb.d_internal_contact  a111
                  on         (a11.assigned_to_key = a111.row_key)
                union select  'd_internal_contact_mdm'as Table_Name,count(a11.row_key) Row_Count from ldb.f_request_item 	a11 join        ldb.d_internal_contact_mdm    a112
                  on         (a13.row_current_key = a112.row_current_key)
                union select  'd_access_environments_c'as Table_Name,count(a11.row_key) Row_Count from ldb.f_request_item 	a11 join        ldb.d_access_environments_c  a113
                ...
                union select  'd_internal_organization_group_request_task_assignment_group_c'as Table_Name,count(a11.row_key) Row_Count from ldb.f_request_item 	a11 join        ldb.d_internal_organization_group_request_task_assignment_group_c              a117
                  on         (a11.request_task_assignment_group_key_c = a117.row_key)
                ...
                union select  'd_calendar_month'as Table_Name,count(a11.row_key) Row_Count from ldb.f_request_item 	a11 join        ldb.d_calendar_month a121
                  on         (a17.month_start_date_key = a121.row_key)
                union select  'd_internal_organization_group_request_item_c'as Table_Name,count(a11.row_key) Row_Count from ldb.f_request_item 	a11 join        ldb.d_internal_organization_group_request_item_c      a122
                  on         (a19.support_group_key = a122.row_key)
                union select  'd_calendar_week'as Table_Name,count(a11.row_key) Row_Count from ldb.f_request_item 	a11 join        ldb.d_calendar_week    a123
                  on         (a17.week_start_date_key = a123.row_key)
                union select  'd_calendar_month_closed'as Table_Name,count(a11.row_key) Row_Count from ldb.f_request_item 	a11 join        ldb.d_calendar_month_closed  a124
                  on         (a16.month_start_date_key = a124.row_key)
                union select  'd_calendar_quarter'as Table_Name,count(a11.row_key) Row_Count from ldb.f_request_item 	a11 join        ldb.d_calendar_quarter                a125
                  on         (a17.quarter_start_date_key = a125.row_key)
                union select  'd_calendar_year'as Table_Name,count(a11.row_key) Row_Count from ldb.f_request_item 	a11 join        ldb.d_calendar_year      a126
