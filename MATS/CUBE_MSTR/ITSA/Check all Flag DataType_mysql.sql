...
where table_schema ='<<tenant>>_workdb' and table_name IN (SELECT 	table_name
 from information_schema.TABLES where table_schema ='<<tenant>>_workdb' and table_type ='BASE TABLE')
