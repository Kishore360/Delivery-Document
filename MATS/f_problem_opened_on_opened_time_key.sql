...
case when count(1)> 0 then 'MDS to DWH data validation failed between problem_final and f_problem.opened_on_key: opened_on_opened_time_key.opened_on_key' else 'SUCCESS' end as Message
