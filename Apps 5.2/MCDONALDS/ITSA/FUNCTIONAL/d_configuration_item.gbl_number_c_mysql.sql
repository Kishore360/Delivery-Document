...
join FROM (select * from mcdonalds_mdsdb.cmdb_ci_final where cdctype<>'D') b on a.row_id=b.sys_id and a.source_id=b.sourceinstance
...
where (SRC.cdctime<=f1.lastupdated) and  a.gbl_number_c <> d.u_gbl
)a;