...
where (SRC.cdctime<=f1.lastupdated) and COALESCE(LKP.row_key, CASE WHEN SRC.u_cross_application_impact IS NULL THEN 0 ELSE -1 END) <> TRGT.cross_application_impact_src_key
)a;
