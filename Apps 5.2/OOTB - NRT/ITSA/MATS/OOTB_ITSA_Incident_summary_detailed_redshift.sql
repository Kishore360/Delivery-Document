...
union
select 'ldb.d_customer a13 ' as Table_name, count(1) Row_Count
from ldb.f_incident a11 
...
union
select 'ldb.dh_user_group_hierarchy a16 ' as Table_name, count(1) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_organization_group a15 
on (a11.assignment_group_key = a15.row_key) 
...
union
select 'ldb.d_calendar_week a111 ' as Table_name, count(1) Row_Count
from ldb.f_incident a11 
join ldb.d_calendar_date a12 
on (a11.opened_on_key = a12.row_key) 
...
union
select 'ldb.d_customer_mdm a112 ' as Table_name, count(1) Row_Count
from ldb.f_incident a11 
join ldb.d_customer a13 
on (a11.customer_key = a13.row_key) 
...
union
select 'ldb.d_domain a113 ' as Table_name, count(1) Row_Count
from ldb.f_incident a11 
join ldb.d_domain a113 
on (a11.domain_key = a113.row_key) 
union
select 'ldb.d_incident_category a114 ' as Table_name, count(1) Row_Count
from ldb.f_incident a11 
join ldb.d_incident a14 
on (a11.incident_key = a14.row_key) 
...
union
select 'ldb.d_incident_state a115 ' as Table_name, count(1) Row_Count
from ldb.f_incident a11 
join ldb.d_incident a14 
on (a11.incident_key = a14.row_key) 
...
union
select 'ldb.d_incident_subcategory a116 ' as Table_name, count(1) Row_Count
from ldb.f_incident a11 
join ldb.d_incident a14 
on (a11.incident_key = a14.row_key) 
...
union
select 'ldb.dh_user_group_level2 a118 ' as Table_name, count(1) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_organization_group a15 
on (a11.assignment_group_key = a15.row_key) join ldb.dh_user_group_hierarchy a16 
on (a15.row_dn_key = a16.lev_0_key) 
...
union
select 'ldb.dh_user_group_level3 a119 ' as Table_name, count(1) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_organization_group a15 
on (a11.assignment_group_key = a15.row_key) join ldb.dh_user_group_hierarchy a16 
on (a15.row_dn_key = a16.lev_0_key) 
...
union
select 'ldb.dh_user_group_level4 a120 ' as Table_name, count(1) Row_Count
from ldb.f_incident a11 
join ldb.d_internal_organization_group a15 
on (a11.assignment_group_key = a15.row_key) join ldb.dh_user_group_hierarchy a16 
on (a15.row_dn_key = a16.lev_0_key) 
