...
x.u_requested_for=REPLACE(row_id,'INTERNAL_CONTACT~','') )A
LEFT OUTER JOIN  
(SELECT  REPLACE(requested_for_c_key,'INTERNAL_CONTACT~','') AS requested_for_c_key,source_id,ROW_ID FROM  uclahealth_mdwdb.f_incident
