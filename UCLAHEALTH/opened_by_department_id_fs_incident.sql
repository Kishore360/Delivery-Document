...
SELECT A.SYS_ID,B.ROW_ID,A.  opened_by_department_id A_opened_by_department_id,B.  opened_by_department_id B_opened_by_department_id FROM
...
LEFT OUTER JOIN  
(SELECT  REPLACE(opened_by_department_id,'DEPARTMENT~','') AS opened_by_department_id ,source_id,ROW_ID 
