...
union
select 'ldb.d_request_item_variable_requested_completion_date_c a16 ' as Table_name, count(a11.row_key) Row_Count
from ldb.f_request_task a11 
join ldb.d_request_item_variable_requested_completion_date_c a16 
