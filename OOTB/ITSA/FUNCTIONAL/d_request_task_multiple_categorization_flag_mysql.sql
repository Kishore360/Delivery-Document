...
SELECT CASE WHEN count(1) > 0 THEN 'FAILURE' ELSE 'SUCCESS' END as Result,
 ...
 SELECT CASE WHEN TA.task_wh_type = 'sc_task' AND TA.task_attribute_wh_name =  'category' TA.task_attribute_wh_old_value <> TA.task_attribute_wh_new_value THEN 'Y' ELSE 'N' END ABC, (TRGT.multiple_categorization_flag) DEF
